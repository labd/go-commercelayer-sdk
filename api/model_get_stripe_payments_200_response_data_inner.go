...
// GETStripePayments200ResponseDataInner struct for GETStripePayments200ResponseDataInner
type GETStripePayments200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                            `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks             `json:"links,omitempty"`
	Attributes    *GETStripePayments200ResponseDataInnerAttributes   `json:"attributes,omitempty"`
...
func NewGETStripePayments200ResponseDataInner() *GETStripePayments200ResponseDataInner {
	this := GETStripePayments200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETStripePayments200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETStripePayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETStripePayments200ResponseDataInner struct {
	value *GETStripePayments200ResponseDataInner
	isSet bool
}

func (v NullableGETStripePayments200ResponseDataInner) Get() *GETStripePayments200ResponseDataInner {
	return v.value
}

func (v *NullableGETStripePayments200ResponseDataInner) Set(val *GETStripePayments200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETStripePayments200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETStripePayments200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETStripePayments200ResponseDataInner(val *GETStripePayments200ResponseDataInner) *NullableGETStripePayments200ResponseDataInner {
	return &NullableGETStripePayments200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETStripePayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETStripePayments200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
