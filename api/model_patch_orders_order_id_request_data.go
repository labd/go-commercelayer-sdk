...
// checks if the PATCHOrdersOrderIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHOrdersOrderIdRequestData{}

// PATCHOrdersOrderIdRequestData struct for PATCHOrdersOrderIdRequestData
type PATCHOrdersOrderIdRequestData struct {
	// The resource's type
...
func NewPATCHOrdersOrderIdRequestData(type_ interface{}, id interface{}, attributes PATCHOrdersOrderIdRequestDataAttributes) *PATCHOrdersOrderIdRequestData {
	this := PATCHOrdersOrderIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o PATCHOrdersOrderIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHOrdersOrderIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHOrdersOrderIdRequestData struct {
	value *PATCHOrdersOrderIdRequestData
	isSet bool
}

func (v NullablePATCHOrdersOrderIdRequestData) Get() *PATCHOrdersOrderIdRequestData {
	return v.value
}

func (v *NullablePATCHOrdersOrderIdRequestData) Set(val *PATCHOrdersOrderIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHOrdersOrderIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHOrdersOrderIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHOrdersOrderIdRequestData(val *PATCHOrdersOrderIdRequestData) *NullablePATCHOrdersOrderIdRequestData {
	return &NullablePATCHOrdersOrderIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHOrdersOrderIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHOrdersOrderIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
