...
// checks if the PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes{}

// PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes struct for PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes
type PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes struct {
...
func NewPATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes() *PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes {
	this := PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes struct {
	value *PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) Get() *PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) Set(val *PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes(val *PATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) *NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes {
	return &NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHFreeGiftPromotionsFreeGiftPromotionIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
