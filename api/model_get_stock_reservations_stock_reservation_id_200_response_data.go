...
// checks if the GETStockReservationsStockReservationId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETStockReservationsStockReservationId200ResponseData{}

// GETStockReservationsStockReservationId200ResponseData struct for GETStockReservationsStockReservationId200ResponseData
type GETStockReservationsStockReservationId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                      `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                               `json:"links,omitempty"`
	Attributes    *GETStockReservationsStockReservationId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETStockReservationsStockReservationId200ResponseData() *GETStockReservationsStockReservationId200ResponseData {
	this := GETStockReservationsStockReservationId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETStockReservationsStockReservationId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETStockReservationsStockReservationId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETStockReservationsStockReservationId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETStockReservationsStockReservationId200ResponseData struct {
	value *GETStockReservationsStockReservationId200ResponseData
	isSet bool
}

func (v NullableGETStockReservationsStockReservationId200ResponseData) Get() *GETStockReservationsStockReservationId200ResponseData {
	return v.value
}

func (v *NullableGETStockReservationsStockReservationId200ResponseData) Set(val *GETStockReservationsStockReservationId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETStockReservationsStockReservationId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETStockReservationsStockReservationId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETStockReservationsStockReservationId200ResponseData(val *GETStockReservationsStockReservationId200ResponseData) *NullableGETStockReservationsStockReservationId200ResponseData {
	return &NullableGETStockReservationsStockReservationId200ResponseData{value: val, isSet: true}
}

func (v NullableGETStockReservationsStockReservationId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETStockReservationsStockReservationId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
