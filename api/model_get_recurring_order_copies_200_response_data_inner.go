...
// GETRecurringOrderCopies200ResponseDataInner struct for GETRecurringOrderCopies200ResponseDataInner
type GETRecurringOrderCopies200ResponseDataInner struct {
	// The resource's id
...
func NewGETRecurringOrderCopies200ResponseDataInner() *GETRecurringOrderCopies200ResponseDataInner {
	this := GETRecurringOrderCopies200ResponseDataInner{}
	return &this
}
...
func (o GETRecurringOrderCopies200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETRecurringOrderCopies200ResponseDataInner struct {
	value *GETRecurringOrderCopies200ResponseDataInner
	isSet bool
}

func (v NullableGETRecurringOrderCopies200ResponseDataInner) Get() *GETRecurringOrderCopies200ResponseDataInner {
	return v.value
}

func (v *NullableGETRecurringOrderCopies200ResponseDataInner) Set(val *GETRecurringOrderCopies200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETRecurringOrderCopies200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETRecurringOrderCopies200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETRecurringOrderCopies200ResponseDataInner(val *GETRecurringOrderCopies200ResponseDataInner) *NullableGETRecurringOrderCopies200ResponseDataInner {
	return &NullableGETRecurringOrderCopies200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETRecurringOrderCopies200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETRecurringOrderCopies200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
