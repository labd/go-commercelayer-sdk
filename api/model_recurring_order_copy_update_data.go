...
// checks if the RecurringOrderCopyUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecurringOrderCopyUpdateData{}

// RecurringOrderCopyUpdateData struct for RecurringOrderCopyUpdateData
type RecurringOrderCopyUpdateData struct {
	// The resource's type
...
func NewRecurringOrderCopyUpdateData(type_ interface{}, id interface{}, attributes PATCHCleanupsCleanupId200ResponseDataAttributes) *RecurringOrderCopyUpdateData {
	this := RecurringOrderCopyUpdateData{}
	this.Type = type_
	this.Id = id
...
func (o RecurringOrderCopyUpdateData) MarshalJSON() ([]byte, error) {
...
func (o RecurringOrderCopyUpdateData) ToMap() (map[string]interface{}, error) {
...
type NullableRecurringOrderCopyUpdateData struct {
	value *RecurringOrderCopyUpdateData
	isSet bool
}

func (v NullableRecurringOrderCopyUpdateData) Get() *RecurringOrderCopyUpdateData {
	return v.value
}

func (v *NullableRecurringOrderCopyUpdateData) Set(val *RecurringOrderCopyUpdateData) {
	v.value = val
	v.isSet = true
}

func (v NullableRecurringOrderCopyUpdateData) IsSet() bool {
	return v.isSet
}

func (v *NullableRecurringOrderCopyUpdateData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecurringOrderCopyUpdateData(val *RecurringOrderCopyUpdateData) *NullableRecurringOrderCopyUpdateData {
	return &NullableRecurringOrderCopyUpdateData{value: val, isSet: true}
}

func (v NullableRecurringOrderCopyUpdateData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecurringOrderCopyUpdateData) UnmarshalJSON(src []byte) error {
	v.isSet = true
