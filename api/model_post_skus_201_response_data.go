...
type POSTSkus201ResponseData struct {
	...
	Attributes    *POSTSkusRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTSkusRequestDataAttributes and assigns it to the Attributes field.
