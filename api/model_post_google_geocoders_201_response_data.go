...
// checks if the POSTGoogleGeocoders201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTGoogleGeocoders201ResponseData{}

// POSTGoogleGeocoders201ResponseData struct for POSTGoogleGeocoders201ResponseData
type POSTGoogleGeocoders201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks             `json:"links,omitempty"`
	Attributes    *POSTGoogleGeocodersRequestDataAttributes      `json:"attributes,omitempty"`
...
func NewPOSTGoogleGeocoders201ResponseData() *POSTGoogleGeocoders201ResponseData {
	this := POSTGoogleGeocoders201ResponseData{}
	return &this
}
...
func (o *POSTGoogleGeocoders201ResponseData) GetAttributes() POSTGoogleGeocodersRequestDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret POSTGoogleGeocodersRequestDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given POSTGoogleGeocodersRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTGoogleGeocoders201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTGoogleGeocoders201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTGoogleGeocoders201ResponseData struct {
	value *POSTGoogleGeocoders201ResponseData
	isSet bool
}

func (v NullablePOSTGoogleGeocoders201ResponseData) Get() *POSTGoogleGeocoders201ResponseData {
	return v.value
}

func (v *NullablePOSTGoogleGeocoders201ResponseData) Set(val *POSTGoogleGeocoders201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTGoogleGeocoders201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTGoogleGeocoders201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTGoogleGeocoders201ResponseData(val *POSTGoogleGeocoders201ResponseData) *NullablePOSTGoogleGeocoders201ResponseData {
	return &NullablePOSTGoogleGeocoders201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTGoogleGeocoders201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTGoogleGeocoders201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
