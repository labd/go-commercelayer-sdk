...
// checks if the GETParcelLineItems200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETParcelLineItems200Response{}
...
func (o GETParcelLineItems200Response) ToMap() (map[string]interface{}, error) {
