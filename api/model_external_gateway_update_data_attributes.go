...
// ExternalGatewayUpdateDataAttributes struct for ExternalGatewayUpdateDataAttributes
type ExternalGatewayUpdateDataAttributes struct {
...
func NewExternalGatewayUpdateDataAttributes() *ExternalGatewayUpdateDataAttributes {
	this := ExternalGatewayUpdateDataAttributes{}
	return &this
}
...
func (o ExternalGatewayUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableExternalGatewayUpdateDataAttributes struct {
	value *ExternalGatewayUpdateDataAttributes
	isSet bool
}

func (v NullableExternalGatewayUpdateDataAttributes) Get() *ExternalGatewayUpdateDataAttributes {
	return v.value
}

func (v *NullableExternalGatewayUpdateDataAttributes) Set(val *ExternalGatewayUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalGatewayUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalGatewayUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalGatewayUpdateDataAttributes(val *ExternalGatewayUpdateDataAttributes) *NullableExternalGatewayUpdateDataAttributes {
	return &NullableExternalGatewayUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableExternalGatewayUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalGatewayUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
