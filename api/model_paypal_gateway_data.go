...
// checks if the PaypalGatewayData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaypalGatewayData{}
...
func (o PaypalGatewayData) ToMap() (map[string]interface{}, error) {
