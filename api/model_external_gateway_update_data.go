...
// checks if the ExternalGatewayUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalGatewayUpdateData{}
...
func (o ExternalGatewayUpdateData) ToMap() (map[string]interface{}, error) {
