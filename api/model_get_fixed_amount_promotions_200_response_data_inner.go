...
// GETFixedAmountPromotions200ResponseDataInner struct for GETFixedAmountPromotions200ResponseDataInner
type GETFixedAmountPromotions200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                             `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                  `json:"links,omitempty"`
	Attributes    *GETFixedAmountPromotions200ResponseDataInnerAttributes `json:"attributes,omitempty"`
...
func NewGETFixedAmountPromotions200ResponseDataInner() *GETFixedAmountPromotions200ResponseDataInner {
	this := GETFixedAmountPromotions200ResponseDataInner{}
	return &this
}
...
func (o *GETFixedAmountPromotions200ResponseDataInner) GetId() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *GETFixedAmountPromotions200ResponseDataInner) GetIdOk() (*interface{}, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *GETFixedAmountPromotions200ResponseDataInner) SetId(v interface{}) {
	o.Id = v
}

// GetType returns the Type field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GETFixedAmountPromotions200ResponseDataInner) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GETFixedAmountPromotions200ResponseDataInner) GetTypeOk() (*interface{}, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GETFixedAmountPromotions200ResponseDataInner) SetType(v interface{}) {
	o.Type = v
}
...
// SetAttributes gets a reference to the given GETFixedAmountPromotions200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETFixedAmountPromotions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETFixedAmountPromotions200ResponseDataInner struct {
	value *GETFixedAmountPromotions200ResponseDataInner
	isSet bool
}

func (v NullableGETFixedAmountPromotions200ResponseDataInner) Get() *GETFixedAmountPromotions200ResponseDataInner {
	return v.value
}

func (v *NullableGETFixedAmountPromotions200ResponseDataInner) Set(val *GETFixedAmountPromotions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETFixedAmountPromotions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETFixedAmountPromotions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETFixedAmountPromotions200ResponseDataInner(val *GETFixedAmountPromotions200ResponseDataInner) *NullableGETFixedAmountPromotions200ResponseDataInner {
	return &NullableGETFixedAmountPromotions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETFixedAmountPromotions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETFixedAmountPromotions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
