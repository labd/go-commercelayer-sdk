...
// checks if the PATCHTaxjarAccountsTaxjarAccountId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHTaxjarAccountsTaxjarAccountId200ResponseData{}
...
type PATCHTaxjarAccountsTaxjarAccountId200ResponseData struct {
	...
	Attributes    *PATCHTaxjarAccountsTaxjarAccountIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHTaxjarAccountsTaxjarAccountIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHTaxjarAccountsTaxjarAccountId200ResponseData) ToMap() (map[string]interface{}, error) {
