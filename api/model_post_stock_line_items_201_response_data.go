...
// checks if the POSTStockLineItems201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTStockLineItems201ResponseData{}

// POSTStockLineItems201ResponseData struct for POSTStockLineItems201ResponseData
type POSTStockLineItems201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                     `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks              `json:"links,omitempty"`
	Attributes    *POSTStockLineItems201ResponseDataAttributes    `json:"attributes,omitempty"`
...
func (o *POSTStockLineItems201ResponseData) GetAttributes() POSTStockLineItems201ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret POSTStockLineItems201ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given POSTStockLineItems201ResponseDataAttributes and assigns it to the Attributes field.
...
func (o POSTStockLineItems201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTStockLineItems201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTStockLineItems201ResponseData struct {
	value *POSTStockLineItems201ResponseData
	isSet bool
}

func (v NullablePOSTStockLineItems201ResponseData) Get() *POSTStockLineItems201ResponseData {
	return v.value
}

func (v *NullablePOSTStockLineItems201ResponseData) Set(val *POSTStockLineItems201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTStockLineItems201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTStockLineItems201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTStockLineItems201ResponseData(val *POSTStockLineItems201ResponseData) *NullablePOSTStockLineItems201ResponseData {
	return &NullablePOSTStockLineItems201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTStockLineItems201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTStockLineItems201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
