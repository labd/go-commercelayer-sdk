...
type LineItemDataAttributes struct {
	...
	// Calculated as total amount cents - discount cent * tax rate, in cents.
	TaxAmountCents *int32 `json:"tax_amount_cents,omitempty"`
	// Calculated as total amount cents - discount cent * tax rate, float.
	TaxAmountFloat *float32 `json:"tax_amount_float,omitempty"`
	// Calculated as total amount cents - discount cent * tax rate, formatted.
