...
// checks if the POSTExternalTaxCalculatorsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTExternalTaxCalculatorsRequestDataAttributes{}

// POSTExternalTaxCalculatorsRequestDataAttributes struct for POSTExternalTaxCalculatorsRequestDataAttributes
type POSTExternalTaxCalculatorsRequestDataAttributes struct {
...
func NewPOSTExternalTaxCalculatorsRequestDataAttributes(name interface{}, taxCalculatorUrl interface{}) *POSTExternalTaxCalculatorsRequestDataAttributes {
	this := POSTExternalTaxCalculatorsRequestDataAttributes{}
	this.Name = name
...
func (o POSTExternalTaxCalculatorsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTExternalTaxCalculatorsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTExternalTaxCalculatorsRequestDataAttributes struct {
	value *POSTExternalTaxCalculatorsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTExternalTaxCalculatorsRequestDataAttributes) Get() *POSTExternalTaxCalculatorsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTExternalTaxCalculatorsRequestDataAttributes) Set(val *POSTExternalTaxCalculatorsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTExternalTaxCalculatorsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTExternalTaxCalculatorsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTExternalTaxCalculatorsRequestDataAttributes(val *POSTExternalTaxCalculatorsRequestDataAttributes) *NullablePOSTExternalTaxCalculatorsRequestDataAttributes {
	return &NullablePOSTExternalTaxCalculatorsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTExternalTaxCalculatorsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTExternalTaxCalculatorsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
