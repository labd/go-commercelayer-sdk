...
// checks if the POSTTags201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTTags201ResponseData{}

// POSTTags201ResponseData struct for POSTTags201ResponseData
type POSTTags201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                        `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks `json:"links,omitempty"`
	Attributes    *POSTTags201ResponseDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTTags201ResponseDataAttributes and assigns it to the Attributes field.
...
func (o POSTTags201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTTags201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTTags201ResponseData struct {
	value *POSTTags201ResponseData
	isSet bool
}

func (v NullablePOSTTags201ResponseData) Get() *POSTTags201ResponseData {
	return v.value
}

func (v *NullablePOSTTags201ResponseData) Set(val *POSTTags201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTTags201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTTags201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTTags201ResponseData(val *POSTTags201ResponseData) *NullablePOSTTags201ResponseData {
	return &NullablePOSTTags201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTTags201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTTags201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
