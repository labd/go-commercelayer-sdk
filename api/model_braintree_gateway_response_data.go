...
// BraintreeGatewayResponseData struct for BraintreeGatewayResponseData
type BraintreeGatewayResponseData struct {
	// The resource's id
	...
	Relationships *BraintreeGatewayResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewBraintreeGatewayResponseData() *BraintreeGatewayResponseData {
	this := BraintreeGatewayResponseData{}
	return &this
}
...
func (o *BraintreeGatewayResponseData) GetRelationships() BraintreeGatewayResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret BraintreeGatewayResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given BraintreeGatewayResponseDataRelationships and assigns it to the Relationships field.
func (o *BraintreeGatewayResponseData) SetRelationships(v BraintreeGatewayResponseDataRelationships) {
	o.Relationships = &v
}

func (o BraintreeGatewayResponseData) MarshalJSON() ([]byte, error) {
...
type NullableBraintreeGatewayResponseData struct {
	value *BraintreeGatewayResponseData
	isSet bool
}

func (v NullableBraintreeGatewayResponseData) Get() *BraintreeGatewayResponseData {
	return v.value
}

func (v *NullableBraintreeGatewayResponseData) Set(val *BraintreeGatewayResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableBraintreeGatewayResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableBraintreeGatewayResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBraintreeGatewayResponseData(val *BraintreeGatewayResponseData) *NullableBraintreeGatewayResponseData {
	return &NullableBraintreeGatewayResponseData{value: val, isSet: true}
}

func (v NullableBraintreeGatewayResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBraintreeGatewayResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
