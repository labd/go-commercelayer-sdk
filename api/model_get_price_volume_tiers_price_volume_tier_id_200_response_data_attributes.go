...
// checks if the GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes{}

// GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes struct for GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes
...
func NewGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes() *GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes {
	this := GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes{}
	return &this
}
...
func (o GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes struct {
	value *GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) Get() *GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) Set(val *GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes(val *GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) *NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes {
	return &NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
