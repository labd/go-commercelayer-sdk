...
// checks if the GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData{}

// GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData struct for GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData
type GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                          `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                   `json:"links,omitempty"`
	Attributes    *GETCheckoutComPaymentsCheckoutComPaymentId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData() *GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData {
	this := GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData{}
	return &this
}
...
func (o *GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
// SetAttributes gets a reference to the given GETCheckoutComPaymentsCheckoutComPaymentId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData struct {
	value *GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData
	isSet bool
}

func (v NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) Get() *GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData {
	return v.value
}

func (v *NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) Set(val *GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData(val *GETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) *NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData {
	return &NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData{value: val, isSet: true}
}

func (v NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCheckoutComPaymentsCheckoutComPaymentId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
