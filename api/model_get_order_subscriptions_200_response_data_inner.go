...
// GETOrderSubscriptions200ResponseDataInner struct for GETOrderSubscriptions200ResponseDataInner
type GETOrderSubscriptions200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                                 `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                  `json:"links,omitempty"`
	Attributes    *GETOrderSubscriptions200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETOrderSubscriptions200ResponseDataInner() *GETOrderSubscriptions200ResponseDataInner {
	this := GETOrderSubscriptions200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETOrderSubscriptions200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETOrderSubscriptions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETOrderSubscriptions200ResponseDataInner struct {
	value *GETOrderSubscriptions200ResponseDataInner
	isSet bool
}

func (v NullableGETOrderSubscriptions200ResponseDataInner) Get() *GETOrderSubscriptions200ResponseDataInner {
	return v.value
}

func (v *NullableGETOrderSubscriptions200ResponseDataInner) Set(val *GETOrderSubscriptions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETOrderSubscriptions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETOrderSubscriptions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETOrderSubscriptions200ResponseDataInner(val *GETOrderSubscriptions200ResponseDataInner) *NullableGETOrderSubscriptions200ResponseDataInner {
	return &NullableGETOrderSubscriptions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETOrderSubscriptions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETOrderSubscriptions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
