...
// GETAxerveGateways200ResponseDataInnerAttributes struct for GETAxerveGateways200ResponseDataInnerAttributes
type GETAxerveGateways200ResponseDataInnerAttributes struct {
...
func NewGETAxerveGateways200ResponseDataInnerAttributes() *GETAxerveGateways200ResponseDataInnerAttributes {
	this := GETAxerveGateways200ResponseDataInnerAttributes{}
	return &this
}
...
func (o GETAxerveGateways200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
...
type NullableGETAxerveGateways200ResponseDataInnerAttributes struct {
	value *GETAxerveGateways200ResponseDataInnerAttributes
	isSet bool
}

func (v NullableGETAxerveGateways200ResponseDataInnerAttributes) Get() *GETAxerveGateways200ResponseDataInnerAttributes {
	return v.value
}

func (v *NullableGETAxerveGateways200ResponseDataInnerAttributes) Set(val *GETAxerveGateways200ResponseDataInnerAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAxerveGateways200ResponseDataInnerAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAxerveGateways200ResponseDataInnerAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAxerveGateways200ResponseDataInnerAttributes(val *GETAxerveGateways200ResponseDataInnerAttributes) *NullableGETAxerveGateways200ResponseDataInnerAttributes {
	return &NullableGETAxerveGateways200ResponseDataInnerAttributes{value: val, isSet: true}
}

func (v NullableGETAxerveGateways200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAxerveGateways200ResponseDataInnerAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
