...
// GETSatispayPayments200ResponseDataInner struct for GETSatispayPayments200ResponseDataInner
type GETSatispayPayments200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                        `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks             `json:"links,omitempty"`
	Attributes    *GETSatispayPayments200ResponseDataInnerAttributes `json:"attributes,omitempty"`
...
func NewGETSatispayPayments200ResponseDataInner() *GETSatispayPayments200ResponseDataInner {
	this := GETSatispayPayments200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETSatispayPayments200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETSatispayPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETSatispayPayments200ResponseDataInner struct {
	value *GETSatispayPayments200ResponseDataInner
	isSet bool
}

func (v NullableGETSatispayPayments200ResponseDataInner) Get() *GETSatispayPayments200ResponseDataInner {
	return v.value
}

func (v *NullableGETSatispayPayments200ResponseDataInner) Set(val *GETSatispayPayments200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETSatispayPayments200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETSatispayPayments200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETSatispayPayments200ResponseDataInner(val *GETSatispayPayments200ResponseDataInner) *NullableGETSatispayPayments200ResponseDataInner {
	return &NullableGETSatispayPayments200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETSatispayPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETSatispayPayments200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
