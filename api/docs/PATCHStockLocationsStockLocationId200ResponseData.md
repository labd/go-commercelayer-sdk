...
**Attributes** | Pointer to [**PATCHStockLocationsStockLocationIdRequestDataAttributes**](PATCHStockLocationsStockLocationIdRequestDataAttributes.md) |  | [optional] 
...
`func (o *PATCHStockLocationsStockLocationId200ResponseData) SetIdNil(b bool)`

 SetIdNil sets the value for Id to be an explicit nil

### UnsetId
`func (o *PATCHStockLocationsStockLocationId200ResponseData) UnsetId()`
...
`func (o *PATCHStockLocationsStockLocationId200ResponseData) SetTypeNil(b bool)`

 SetTypeNil sets the value for Type to be an explicit nil

### UnsetType
`func (o *PATCHStockLocationsStockLocationId200ResponseData) UnsetType()`
