...
**Attributes** | Pointer to [**PATCHAvalaraAccountsAvalaraAccountIdRequestDataAttributes**](PATCHAvalaraAccountsAvalaraAccountIdRequestDataAttributes.md) |  | [optional] 
...
`func (o *PATCHAvalaraAccountsAvalaraAccountId200ResponseData) GetId() interface{}`
...
`func (o *PATCHAvalaraAccountsAvalaraAccountId200ResponseData) SetId(v interface{})`
...
`func (o *PATCHAvalaraAccountsAvalaraAccountId200ResponseData) SetIdNil(b bool)`

 SetIdNil sets the value for Id to be an explicit nil

### UnsetId
`func (o *PATCHAvalaraAccountsAvalaraAccountId200ResponseData) UnsetId()`

UnsetId ensures that no value is present for Id, not even an explicit nil
### GetType

`func (o *PATCHAvalaraAccountsAvalaraAccountId200ResponseData) GetType() interface{}`
...
`func (o *PATCHAvalaraAccountsAvalaraAccountId200ResponseData) SetType(v interface{})`
...
`func (o *PATCHAvalaraAccountsAvalaraAccountId200ResponseData) SetTypeNil(b bool)`

 SetTypeNil sets the value for Type to be an explicit nil

### UnsetType
`func (o *PATCHAvalaraAccountsAvalaraAccountId200ResponseData) UnsetType()`
