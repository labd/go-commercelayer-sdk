...
`func (o *ShippingMethodDataRelationshipsShippingWeightTiersData) SetTypeNil(b bool)`

 SetTypeNil sets the value for Type to be an explicit nil

### UnsetType
`func (o *ShippingMethodDataRelationshipsShippingWeightTiersData) UnsetType()`
...
`func (o *ShippingMethodDataRelationshipsShippingWeightTiersData) SetIdNil(b bool)`

 SetIdNil sets the value for Id to be an explicit nil

### UnsetId
`func (o *ShippingMethodDataRelationshipsShippingWeightTiersData) UnsetId()`
