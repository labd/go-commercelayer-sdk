...
`func NewGiftCardCreateData(type_ interface{}, attributes POSTGiftCards201ResponseDataAttributes, ) *GiftCardCreateData`
...
`func (o *GiftCardCreateData) GetType() interface{}`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *GiftCardCreateData) GetTypeOk() (*interface{}, bool)`
...
`func (o *GiftCardCreateData) SetType(v interface{})`
...
`func (o *GiftCardCreateData) SetTypeNil(b bool)`

 SetTypeNil sets the value for Type to be an explicit nil

### UnsetType
`func (o *GiftCardCreateData) UnsetType()`
