...
**TotalTaxableAmountCents** | Pointer to **int32** | The order&#39;s total taxable amount, in cents (equal to total_amount_cents when prices don&#39;t include taxes). | [optional] 
