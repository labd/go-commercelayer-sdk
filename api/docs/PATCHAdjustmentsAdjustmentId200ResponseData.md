...
**Attributes** | Pointer to [**PATCHAdjustmentsAdjustmentIdRequestDataAttributes**](PATCHAdjustmentsAdjustmentIdRequestDataAttributes.md) |  | [optional] 
...
`func (o *PATCHAdjustmentsAdjustmentId200ResponseData) SetIdNil(b bool)`

 SetIdNil sets the value for Id to be an explicit nil

### UnsetId
`func (o *PATCHAdjustmentsAdjustmentId200ResponseData) UnsetId()`
...
`func (o *PATCHAdjustmentsAdjustmentId200ResponseData) SetTypeNil(b bool)`

 SetTypeNil sets the value for Type to be an explicit nil

### UnsetType
`func (o *PATCHAdjustmentsAdjustmentId200ResponseData) UnsetType()`
