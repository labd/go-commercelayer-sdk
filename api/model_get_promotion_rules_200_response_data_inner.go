...
// GETPromotionRules200ResponseDataInner struct for GETPromotionRules200ResponseDataInner
type GETPromotionRules200ResponseDataInner struct {
	// The resource's id
...
func NewGETPromotionRules200ResponseDataInner() *GETPromotionRules200ResponseDataInner {
	this := GETPromotionRules200ResponseDataInner{}
	return &this
}
...
func (o GETPromotionRules200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETPromotionRules200ResponseDataInner struct {
	value *GETPromotionRules200ResponseDataInner
	isSet bool
}

func (v NullableGETPromotionRules200ResponseDataInner) Get() *GETPromotionRules200ResponseDataInner {
	return v.value
}

func (v *NullableGETPromotionRules200ResponseDataInner) Set(val *GETPromotionRules200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPromotionRules200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPromotionRules200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPromotionRules200ResponseDataInner(val *GETPromotionRules200ResponseDataInner) *NullableGETPromotionRules200ResponseDataInner {
	return &NullableGETPromotionRules200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETPromotionRules200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPromotionRules200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
