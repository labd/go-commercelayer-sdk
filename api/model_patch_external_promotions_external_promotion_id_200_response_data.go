...
type PATCHExternalPromotionsExternalPromotionId200ResponseData struct {
	...
	Attributes    *PATCHExternalPromotionsExternalPromotionIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHExternalPromotionsExternalPromotionIdRequestDataAttributes and assigns it to the Attributes field.
