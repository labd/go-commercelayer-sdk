...
// MerchantDataAttributes struct for MerchantDataAttributes
type MerchantDataAttributes struct {
...
func (o MerchantDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableMerchantDataAttributes struct {
	value *MerchantDataAttributes
	isSet bool
}

func (v NullableMerchantDataAttributes) Get() *MerchantDataAttributes {
	return v.value
}

func (v *NullableMerchantDataAttributes) Set(val *MerchantDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantDataAttributes(val *MerchantDataAttributes) *NullableMerchantDataAttributes {
	return &NullableMerchantDataAttributes{value: val, isSet: true}
}

func (v NullableMerchantDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
