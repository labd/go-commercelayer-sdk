...
// checks if the GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData{}

// GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData struct for GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData
type GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                        `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                 `json:"links,omitempty"`
	Attributes    *GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData struct {
	value *GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData
	isSet bool
}

func (v NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) Get() *GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData {
	return v.value
}

func (v *NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) Set(val *GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData(val *GETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) *NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData {
	return &NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData{value: val, isSet: true}
}

func (v NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
