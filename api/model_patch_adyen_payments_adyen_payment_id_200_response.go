...
// checks if the PATCHAdyenPaymentsAdyenPaymentId200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHAdyenPaymentsAdyenPaymentId200Response{}
...
func (o PATCHAdyenPaymentsAdyenPaymentId200Response) ToMap() (map[string]interface{}, error) {
