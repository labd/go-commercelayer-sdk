...
// checks if the PATCHPriceVolumeTiersPriceVolumeTierId200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPriceVolumeTiersPriceVolumeTierId200Response{}
...
func (o PATCHPriceVolumeTiersPriceVolumeTierId200Response) ToMap() (map[string]interface{}, error) {
