...
// GETManualGateways200ResponseDataInnerAttributes struct for GETManualGateways200ResponseDataInnerAttributes
type GETManualGateways200ResponseDataInnerAttributes struct {
...
func NewGETManualGateways200ResponseDataInnerAttributes() *GETManualGateways200ResponseDataInnerAttributes {
	this := GETManualGateways200ResponseDataInnerAttributes{}
	return &this
}
...
func (o GETManualGateways200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
...
type NullableGETManualGateways200ResponseDataInnerAttributes struct {
	value *GETManualGateways200ResponseDataInnerAttributes
	isSet bool
}

func (v NullableGETManualGateways200ResponseDataInnerAttributes) Get() *GETManualGateways200ResponseDataInnerAttributes {
	return v.value
}

func (v *NullableGETManualGateways200ResponseDataInnerAttributes) Set(val *GETManualGateways200ResponseDataInnerAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETManualGateways200ResponseDataInnerAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETManualGateways200ResponseDataInnerAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETManualGateways200ResponseDataInnerAttributes(val *GETManualGateways200ResponseDataInnerAttributes) *NullableGETManualGateways200ResponseDataInnerAttributes {
	return &NullableGETManualGateways200ResponseDataInnerAttributes{value: val, isSet: true}
}

func (v NullableGETManualGateways200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETManualGateways200ResponseDataInnerAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
