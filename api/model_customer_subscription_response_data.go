...
// CustomerSubscriptionResponseData struct for CustomerSubscriptionResponseData
type CustomerSubscriptionResponseData struct {
	// The resource's id
...
func NewCustomerSubscriptionResponseData() *CustomerSubscriptionResponseData {
	this := CustomerSubscriptionResponseData{}
	return &this
}
...
func (o CustomerSubscriptionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCustomerSubscriptionResponseData struct {
	value *CustomerSubscriptionResponseData
	isSet bool
}

func (v NullableCustomerSubscriptionResponseData) Get() *CustomerSubscriptionResponseData {
	return v.value
}

func (v *NullableCustomerSubscriptionResponseData) Set(val *CustomerSubscriptionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerSubscriptionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerSubscriptionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerSubscriptionResponseData(val *CustomerSubscriptionResponseData) *NullableCustomerSubscriptionResponseData {
	return &NullableCustomerSubscriptionResponseData{value: val, isSet: true}
}

func (v NullableCustomerSubscriptionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerSubscriptionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
