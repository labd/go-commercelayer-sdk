...
// PackageResponseData struct for PackageResponseData
type PackageResponseData struct {
	...
	Relationships *PackageResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *PackageResponseData) GetRelationships() PackageResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret PackageResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given PackageResponseDataRelationships and assigns it to the Relationships field.
func (o *PackageResponseData) SetRelationships(v PackageResponseDataRelationships) {
	o.Relationships = &v
}

func (o PackageResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePackageResponseData struct {
	value *PackageResponseData
	isSet bool
}

func (v NullablePackageResponseData) Get() *PackageResponseData {
	return v.value
}

func (v *NullablePackageResponseData) Set(val *PackageResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePackageResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePackageResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackageResponseData(val *PackageResponseData) *NullablePackageResponseData {
	return &NullablePackageResponseData{value: val, isSet: true}
}

func (v NullablePackageResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackageResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
