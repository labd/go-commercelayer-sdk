...
// checks if the PATCHExternalGatewaysExternalGatewayIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHExternalGatewaysExternalGatewayIdRequestData{}

// PATCHExternalGatewaysExternalGatewayIdRequestData struct for PATCHExternalGatewaysExternalGatewayIdRequestData
type PATCHExternalGatewaysExternalGatewayIdRequestData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                                 `json:"id"`
	Attributes    PATCHExternalGatewaysExternalGatewayIdRequestDataAttributes `json:"attributes"`
...
func NewPATCHExternalGatewaysExternalGatewayIdRequestData(type_ interface{}, id interface{}, attributes PATCHExternalGatewaysExternalGatewayIdRequestDataAttributes) *PATCHExternalGatewaysExternalGatewayIdRequestData {
	this := PATCHExternalGatewaysExternalGatewayIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o PATCHExternalGatewaysExternalGatewayIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHExternalGatewaysExternalGatewayIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHExternalGatewaysExternalGatewayIdRequestData struct {
	value *PATCHExternalGatewaysExternalGatewayIdRequestData
	isSet bool
}

func (v NullablePATCHExternalGatewaysExternalGatewayIdRequestData) Get() *PATCHExternalGatewaysExternalGatewayIdRequestData {
	return v.value
}

func (v *NullablePATCHExternalGatewaysExternalGatewayIdRequestData) Set(val *PATCHExternalGatewaysExternalGatewayIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHExternalGatewaysExternalGatewayIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHExternalGatewaysExternalGatewayIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHExternalGatewaysExternalGatewayIdRequestData(val *PATCHExternalGatewaysExternalGatewayIdRequestData) *NullablePATCHExternalGatewaysExternalGatewayIdRequestData {
	return &NullablePATCHExternalGatewaysExternalGatewayIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHExternalGatewaysExternalGatewayIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHExternalGatewaysExternalGatewayIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
