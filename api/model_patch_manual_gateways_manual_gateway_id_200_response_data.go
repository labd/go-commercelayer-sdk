...
// checks if the PATCHManualGatewaysManualGatewayId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHManualGatewaysManualGatewayId200ResponseData{}
...
func (o PATCHManualGatewaysManualGatewayId200ResponseData) ToMap() (map[string]interface{}, error) {
