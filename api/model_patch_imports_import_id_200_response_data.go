...
// checks if the PATCHImportsImportId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHImportsImportId200ResponseData{}

// PATCHImportsImportId200ResponseData struct for PATCHImportsImportId200ResponseData
type PATCHImportsImportId200ResponseData struct {
	// The resource's id
...
func NewPATCHImportsImportId200ResponseData() *PATCHImportsImportId200ResponseData {
	this := PATCHImportsImportId200ResponseData{}
	return &this
}
...
func (o PATCHImportsImportId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHImportsImportId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHImportsImportId200ResponseData struct {
	value *PATCHImportsImportId200ResponseData
	isSet bool
}

func (v NullablePATCHImportsImportId200ResponseData) Get() *PATCHImportsImportId200ResponseData {
	return v.value
}

func (v *NullablePATCHImportsImportId200ResponseData) Set(val *PATCHImportsImportId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHImportsImportId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHImportsImportId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHImportsImportId200ResponseData(val *PATCHImportsImportId200ResponseData) *NullablePATCHImportsImportId200ResponseData {
	return &NullablePATCHImportsImportId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHImportsImportId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHImportsImportId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
