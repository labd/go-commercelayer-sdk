...
type NullableExternalPromotionDataRelationshipsPromotionRulesData struct {
	value *ExternalPromotionDataRelationshipsPromotionRulesData
	isSet bool
}

func (v NullableExternalPromotionDataRelationshipsPromotionRulesData) Get() *ExternalPromotionDataRelationshipsPromotionRulesData {
	return v.value
}

func (v *NullableExternalPromotionDataRelationshipsPromotionRulesData) Set(val *ExternalPromotionDataRelationshipsPromotionRulesData) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalPromotionDataRelationshipsPromotionRulesData) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalPromotionDataRelationshipsPromotionRulesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalPromotionDataRelationshipsPromotionRulesData(val *ExternalPromotionDataRelationshipsPromotionRulesData) *NullableExternalPromotionDataRelationshipsPromotionRulesData {
	return &NullableExternalPromotionDataRelationshipsPromotionRulesData{value: val, isSet: true}
}

func (v NullableExternalPromotionDataRelationshipsPromotionRulesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalPromotionDataRelationshipsPromotionRulesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
