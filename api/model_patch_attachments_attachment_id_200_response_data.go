...
type PATCHAttachmentsAttachmentId200ResponseData struct {
	...
	Attributes    *PATCHAttachmentsAttachmentIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHAttachmentsAttachmentIdRequestDataAttributes and assigns it to the Attributes field.
