...
type POSTOrderSubscriptionItems201ResponseData struct {
	...
	Attributes    *POSTOrderSubscriptionItemsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTOrderSubscriptionItemsRequestDataAttributes and assigns it to the Attributes field.
