...
// BillingInfoValidationRuleResponseData struct for BillingInfoValidationRuleResponseData
type BillingInfoValidationRuleResponseData struct {
	// The resource's id
	...
	Relationships *BillingInfoValidationRuleResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewBillingInfoValidationRuleResponseData() *BillingInfoValidationRuleResponseData {
	this := BillingInfoValidationRuleResponseData{}
	return &this
}
...
func (o *BillingInfoValidationRuleResponseData) GetRelationships() BillingInfoValidationRuleResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret BillingInfoValidationRuleResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given BillingInfoValidationRuleResponseDataRelationships and assigns it to the Relationships field.
func (o *BillingInfoValidationRuleResponseData) SetRelationships(v BillingInfoValidationRuleResponseDataRelationships) {
	o.Relationships = &v
}

func (o BillingInfoValidationRuleResponseData) MarshalJSON() ([]byte, error) {
...
type NullableBillingInfoValidationRuleResponseData struct {
	value *BillingInfoValidationRuleResponseData
	isSet bool
}

func (v NullableBillingInfoValidationRuleResponseData) Get() *BillingInfoValidationRuleResponseData {
	return v.value
}

func (v *NullableBillingInfoValidationRuleResponseData) Set(val *BillingInfoValidationRuleResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingInfoValidationRuleResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingInfoValidationRuleResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingInfoValidationRuleResponseData(val *BillingInfoValidationRuleResponseData) *NullableBillingInfoValidationRuleResponseData {
	return &NullableBillingInfoValidationRuleResponseData{value: val, isSet: true}
}

func (v NullableBillingInfoValidationRuleResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingInfoValidationRuleResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
