...
// checks if the GETLinksLinkId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETLinksLinkId200ResponseData{}

// GETLinksLinkId200ResponseData struct for GETLinksLinkId200ResponseData
type GETLinksLinkId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                              `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks       `json:"links,omitempty"`
	Attributes    *GETLinksLinkId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETLinksLinkId200ResponseData() *GETLinksLinkId200ResponseData {
	this := GETLinksLinkId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETLinksLinkId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETLinksLinkId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETLinksLinkId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETLinksLinkId200ResponseData struct {
	value *GETLinksLinkId200ResponseData
	isSet bool
}

func (v NullableGETLinksLinkId200ResponseData) Get() *GETLinksLinkId200ResponseData {
	return v.value
}

func (v *NullableGETLinksLinkId200ResponseData) Set(val *GETLinksLinkId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETLinksLinkId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETLinksLinkId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETLinksLinkId200ResponseData(val *GETLinksLinkId200ResponseData) *NullableGETLinksLinkId200ResponseData {
	return &NullableGETLinksLinkId200ResponseData{value: val, isSet: true}
}

func (v NullableGETLinksLinkId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETLinksLinkId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
