...
// checks if the POSTPriceVolumeTiers201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTPriceVolumeTiers201ResponseData{}
...
type POSTPriceVolumeTiers201ResponseData struct {
	...
	Attributes    *POSTPriceVolumeTiersRequestDataAttributes           `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTPriceVolumeTiersRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTPriceVolumeTiers201ResponseData) ToMap() (map[string]interface{}, error) {
