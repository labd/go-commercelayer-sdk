...
// ShippingMethodResponseData struct for ShippingMethodResponseData
type ShippingMethodResponseData struct {
	// The resource's id
	...
	Relationships *ShippingMethodResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewShippingMethodResponseData() *ShippingMethodResponseData {
	this := ShippingMethodResponseData{}
	return &this
}
...
func (o *ShippingMethodResponseData) GetRelationships() ShippingMethodResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ShippingMethodResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ShippingMethodResponseDataRelationships and assigns it to the Relationships field.
func (o *ShippingMethodResponseData) SetRelationships(v ShippingMethodResponseDataRelationships) {
	o.Relationships = &v
}

func (o ShippingMethodResponseData) MarshalJSON() ([]byte, error) {
...
type NullableShippingMethodResponseData struct {
	value *ShippingMethodResponseData
	isSet bool
}

func (v NullableShippingMethodResponseData) Get() *ShippingMethodResponseData {
	return v.value
}

func (v *NullableShippingMethodResponseData) Set(val *ShippingMethodResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingMethodResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingMethodResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingMethodResponseData(val *ShippingMethodResponseData) *NullableShippingMethodResponseData {
	return &NullableShippingMethodResponseData{value: val, isSet: true}
}

func (v NullableShippingMethodResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingMethodResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
