...
// checks if the GETFreeShippingPromotions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETFreeShippingPromotions200Response{}
...
func (o GETFreeShippingPromotions200Response) ToMap() (map[string]interface{}, error) {
