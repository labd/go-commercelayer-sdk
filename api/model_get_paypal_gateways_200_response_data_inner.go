...
// GETPaypalGateways200ResponseDataInner struct for GETPaypalGateways200ResponseDataInner
type GETPaypalGateways200ResponseDataInner struct {
	// The resource's id
...
func NewGETPaypalGateways200ResponseDataInner() *GETPaypalGateways200ResponseDataInner {
	this := GETPaypalGateways200ResponseDataInner{}
	return &this
}
...
func (o GETPaypalGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETPaypalGateways200ResponseDataInner struct {
	value *GETPaypalGateways200ResponseDataInner
	isSet bool
}

func (v NullableGETPaypalGateways200ResponseDataInner) Get() *GETPaypalGateways200ResponseDataInner {
	return v.value
}

func (v *NullableGETPaypalGateways200ResponseDataInner) Set(val *GETPaypalGateways200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPaypalGateways200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPaypalGateways200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPaypalGateways200ResponseDataInner(val *GETPaypalGateways200ResponseDataInner) *NullableGETPaypalGateways200ResponseDataInner {
	return &NullableGETPaypalGateways200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETPaypalGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPaypalGateways200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
