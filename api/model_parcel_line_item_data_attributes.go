...
// ParcelLineItemDataAttributes struct for ParcelLineItemDataAttributes
type ParcelLineItemDataAttributes struct {
...
func NewParcelLineItemDataAttributes() *ParcelLineItemDataAttributes {
	this := ParcelLineItemDataAttributes{}
	return &this
}
...
func (o ParcelLineItemDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableParcelLineItemDataAttributes struct {
	value *ParcelLineItemDataAttributes
	isSet bool
}

func (v NullableParcelLineItemDataAttributes) Get() *ParcelLineItemDataAttributes {
	return v.value
}

func (v *NullableParcelLineItemDataAttributes) Set(val *ParcelLineItemDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableParcelLineItemDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableParcelLineItemDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParcelLineItemDataAttributes(val *ParcelLineItemDataAttributes) *NullableParcelLineItemDataAttributes {
	return &NullableParcelLineItemDataAttributes{value: val, isSet: true}
}

func (v NullableParcelLineItemDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParcelLineItemDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
