...
// checks if the GETShippingWeightTiersShippingWeightTierId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETShippingWeightTiersShippingWeightTierId200ResponseData{}

// GETShippingWeightTiersShippingWeightTierId200ResponseData struct for GETShippingWeightTiersShippingWeightTierId200ResponseData
type GETShippingWeightTiersShippingWeightTierId200ResponseData struct {
	// The resource's id
...
func NewGETShippingWeightTiersShippingWeightTierId200ResponseData() *GETShippingWeightTiersShippingWeightTierId200ResponseData {
	this := GETShippingWeightTiersShippingWeightTierId200ResponseData{}
	return &this
}
...
func (o GETShippingWeightTiersShippingWeightTierId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETShippingWeightTiersShippingWeightTierId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETShippingWeightTiersShippingWeightTierId200ResponseData struct {
	value *GETShippingWeightTiersShippingWeightTierId200ResponseData
	isSet bool
}

func (v NullableGETShippingWeightTiersShippingWeightTierId200ResponseData) Get() *GETShippingWeightTiersShippingWeightTierId200ResponseData {
	return v.value
}

func (v *NullableGETShippingWeightTiersShippingWeightTierId200ResponseData) Set(val *GETShippingWeightTiersShippingWeightTierId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETShippingWeightTiersShippingWeightTierId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETShippingWeightTiersShippingWeightTierId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETShippingWeightTiersShippingWeightTierId200ResponseData(val *GETShippingWeightTiersShippingWeightTierId200ResponseData) *NullableGETShippingWeightTiersShippingWeightTierId200ResponseData {
	return &NullableGETShippingWeightTiersShippingWeightTierId200ResponseData{value: val, isSet: true}
}

func (v NullableGETShippingWeightTiersShippingWeightTierId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETShippingWeightTiersShippingWeightTierId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
