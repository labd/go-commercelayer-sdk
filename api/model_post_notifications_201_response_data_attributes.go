...
// checks if the POSTNotifications201ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTNotifications201ResponseDataAttributes{}

// POSTNotifications201ResponseDataAttributes struct for POSTNotifications201ResponseDataAttributes
type POSTNotifications201ResponseDataAttributes struct {
...
func NewPOSTNotifications201ResponseDataAttributes(name interface{}) *POSTNotifications201ResponseDataAttributes {
	this := POSTNotifications201ResponseDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTNotifications201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTNotifications201ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTNotifications201ResponseDataAttributes struct {
	value *POSTNotifications201ResponseDataAttributes
	isSet bool
}

func (v NullablePOSTNotifications201ResponseDataAttributes) Get() *POSTNotifications201ResponseDataAttributes {
	return v.value
}

func (v *NullablePOSTNotifications201ResponseDataAttributes) Set(val *POSTNotifications201ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTNotifications201ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTNotifications201ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTNotifications201ResponseDataAttributes(val *POSTNotifications201ResponseDataAttributes) *NullablePOSTNotifications201ResponseDataAttributes {
	return &NullablePOSTNotifications201ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTNotifications201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTNotifications201ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
