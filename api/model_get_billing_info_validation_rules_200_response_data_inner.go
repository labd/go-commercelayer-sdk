...
// GETBillingInfoValidationRules200ResponseDataInner struct for GETBillingInfoValidationRules200ResponseDataInner
type GETBillingInfoValidationRules200ResponseDataInner struct {
	// The resource's id
...
func NewGETBillingInfoValidationRules200ResponseDataInner() *GETBillingInfoValidationRules200ResponseDataInner {
	this := GETBillingInfoValidationRules200ResponseDataInner{}
	return &this
}
...
func (o GETBillingInfoValidationRules200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETBillingInfoValidationRules200ResponseDataInner struct {
	value *GETBillingInfoValidationRules200ResponseDataInner
	isSet bool
}

func (v NullableGETBillingInfoValidationRules200ResponseDataInner) Get() *GETBillingInfoValidationRules200ResponseDataInner {
	return v.value
}

func (v *NullableGETBillingInfoValidationRules200ResponseDataInner) Set(val *GETBillingInfoValidationRules200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBillingInfoValidationRules200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBillingInfoValidationRules200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBillingInfoValidationRules200ResponseDataInner(val *GETBillingInfoValidationRules200ResponseDataInner) *NullableGETBillingInfoValidationRules200ResponseDataInner {
	return &NullableGETBillingInfoValidationRules200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETBillingInfoValidationRules200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBillingInfoValidationRules200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
