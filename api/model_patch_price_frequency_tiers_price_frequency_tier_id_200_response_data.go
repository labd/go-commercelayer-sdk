...
type PATCHPriceFrequencyTiersPriceFrequencyTierId200ResponseData struct {
	...
	Attributes    *PATCHPriceFrequencyTiersPriceFrequencyTierIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHPriceFrequencyTiersPriceFrequencyTierIdRequestDataAttributes and assigns it to the Attributes field.
