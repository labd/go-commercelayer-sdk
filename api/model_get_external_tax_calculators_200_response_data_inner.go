...
// GETExternalTaxCalculators200ResponseDataInner struct for GETExternalTaxCalculators200ResponseDataInner
type GETExternalTaxCalculators200ResponseDataInner struct {
	// The resource's id
...
func (o *GETExternalTaxCalculators200ResponseDataInner) GetId() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *GETExternalTaxCalculators200ResponseDataInner) GetIdOk() (*interface{}, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *GETExternalTaxCalculators200ResponseDataInner) SetId(v interface{}) {
	o.Id = v
}

// GetType returns the Type field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GETExternalTaxCalculators200ResponseDataInner) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GETExternalTaxCalculators200ResponseDataInner) GetTypeOk() (*interface{}, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GETExternalTaxCalculators200ResponseDataInner) SetType(v interface{}) {
	o.Type = v
}
...
// SetAttributes gets a reference to the given GETExternalTaxCalculators200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETExternalTaxCalculators200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETExternalTaxCalculators200ResponseDataInner struct {
	value *GETExternalTaxCalculators200ResponseDataInner
	isSet bool
}

func (v NullableGETExternalTaxCalculators200ResponseDataInner) Get() *GETExternalTaxCalculators200ResponseDataInner {
	return v.value
}

func (v *NullableGETExternalTaxCalculators200ResponseDataInner) Set(val *GETExternalTaxCalculators200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETExternalTaxCalculators200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETExternalTaxCalculators200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETExternalTaxCalculators200ResponseDataInner(val *GETExternalTaxCalculators200ResponseDataInner) *NullableGETExternalTaxCalculators200ResponseDataInner {
	return &NullableGETExternalTaxCalculators200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETExternalTaxCalculators200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETExternalTaxCalculators200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
