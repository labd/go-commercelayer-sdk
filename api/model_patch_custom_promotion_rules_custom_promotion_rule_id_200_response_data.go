...
// checks if the PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData{}

// PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData struct for PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData
type PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                              `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                       `json:"links,omitempty"`
	Attributes    *PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewPATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData() *PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData {
	this := PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData{}
	return &this
}
...
func (o *PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
// SetAttributes gets a reference to the given PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData struct {
	value *PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData
	isSet bool
}

func (v NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) Get() *PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData {
	return v.value
}

func (v *NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) Set(val *PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData(val *PATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) *NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData {
	return &NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHCustomPromotionRulesCustomPromotionRuleId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
