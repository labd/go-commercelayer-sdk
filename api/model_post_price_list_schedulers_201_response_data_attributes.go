...
// checks if the POSTPriceListSchedulers201ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTPriceListSchedulers201ResponseDataAttributes{}

// POSTPriceListSchedulers201ResponseDataAttributes struct for POSTPriceListSchedulers201ResponseDataAttributes
type POSTPriceListSchedulers201ResponseDataAttributes struct {
...
func NewPOSTPriceListSchedulers201ResponseDataAttributes(name interface{}, startsAt interface{}, expiresAt interface{}) *POSTPriceListSchedulers201ResponseDataAttributes {
	this := POSTPriceListSchedulers201ResponseDataAttributes{}
	this.Name = name
...
func (o POSTPriceListSchedulers201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTPriceListSchedulers201ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTPriceListSchedulers201ResponseDataAttributes struct {
	value *POSTPriceListSchedulers201ResponseDataAttributes
	isSet bool
}

func (v NullablePOSTPriceListSchedulers201ResponseDataAttributes) Get() *POSTPriceListSchedulers201ResponseDataAttributes {
	return v.value
}

func (v *NullablePOSTPriceListSchedulers201ResponseDataAttributes) Set(val *POSTPriceListSchedulers201ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTPriceListSchedulers201ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTPriceListSchedulers201ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTPriceListSchedulers201ResponseDataAttributes(val *POSTPriceListSchedulers201ResponseDataAttributes) *NullablePOSTPriceListSchedulers201ResponseDataAttributes {
	return &NullablePOSTPriceListSchedulers201ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTPriceListSchedulers201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTPriceListSchedulers201ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
