...
// GETTaxjarAccounts200ResponseDataInner struct for GETTaxjarAccounts200ResponseDataInner
type GETTaxjarAccounts200ResponseDataInner struct {
	// The resource's id
...
func NewGETTaxjarAccounts200ResponseDataInner() *GETTaxjarAccounts200ResponseDataInner {
	this := GETTaxjarAccounts200ResponseDataInner{}
	return &this
}
...
func (o GETTaxjarAccounts200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETTaxjarAccounts200ResponseDataInner struct {
	value *GETTaxjarAccounts200ResponseDataInner
	isSet bool
}

func (v NullableGETTaxjarAccounts200ResponseDataInner) Get() *GETTaxjarAccounts200ResponseDataInner {
	return v.value
}

func (v *NullableGETTaxjarAccounts200ResponseDataInner) Set(val *GETTaxjarAccounts200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETTaxjarAccounts200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETTaxjarAccounts200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETTaxjarAccounts200ResponseDataInner(val *GETTaxjarAccounts200ResponseDataInner) *NullableGETTaxjarAccounts200ResponseDataInner {
	return &NullableGETTaxjarAccounts200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETTaxjarAccounts200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETTaxjarAccounts200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
