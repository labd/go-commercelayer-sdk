...
// checks if the POSTReturnLineItems201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTReturnLineItems201ResponseData{}
...
type POSTReturnLineItems201ResponseData struct {
	...
	Attributes    *POSTReturnLineItemsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTReturnLineItemsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTReturnLineItems201ResponseData) ToMap() (map[string]interface{}, error) {
