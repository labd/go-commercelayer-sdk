...
// checks if the POSTOrderCopies201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTOrderCopies201ResponseData{}
...
type POSTOrderCopies201ResponseData struct {
	...
	Attributes    *POSTOrderCopiesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTOrderCopiesRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTOrderCopies201ResponseData) ToMap() (map[string]interface{}, error) {
