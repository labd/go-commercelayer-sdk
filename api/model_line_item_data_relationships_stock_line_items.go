...
type LineItemDataRelationshipsStockLineItems struct {
	Data *POSTParcelLineItemsRequestDataRelationshipsStockLineItemData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given POSTParcelLineItemsRequestDataRelationshipsStockLineItemData and assigns it to the Data field.
