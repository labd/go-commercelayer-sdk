...
type LineItemDataRelationshipsStockLineItems struct {
	Data *LineItemDataRelationshipsStockLineItemsData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given LineItemDataRelationshipsStockLineItemsData and assigns it to the Data field.
