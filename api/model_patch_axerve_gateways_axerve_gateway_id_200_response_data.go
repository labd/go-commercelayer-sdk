...
type PATCHAxerveGatewaysAxerveGatewayId200ResponseData struct {
	...
	Attributes    *PATCHAxerveGatewaysAxerveGatewayIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHAxerveGatewaysAxerveGatewayIdRequestDataAttributes and assigns it to the Attributes field.
