...
// ShippingWeightTierCreateDataAttributes struct for ShippingWeightTierCreateDataAttributes
type ShippingWeightTierCreateDataAttributes struct {
...
func NewShippingWeightTierCreateDataAttributes(name string, priceAmountCents int32) *ShippingWeightTierCreateDataAttributes {
	this := ShippingWeightTierCreateDataAttributes{}
	this.Name = name
...
func (o ShippingWeightTierCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableShippingWeightTierCreateDataAttributes struct {
	value *ShippingWeightTierCreateDataAttributes
	isSet bool
}

func (v NullableShippingWeightTierCreateDataAttributes) Get() *ShippingWeightTierCreateDataAttributes {
	return v.value
}

func (v *NullableShippingWeightTierCreateDataAttributes) Set(val *ShippingWeightTierCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingWeightTierCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingWeightTierCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingWeightTierCreateDataAttributes(val *ShippingWeightTierCreateDataAttributes) *NullableShippingWeightTierCreateDataAttributes {
	return &NullableShippingWeightTierCreateDataAttributes{value: val, isSet: true}
}

func (v NullableShippingWeightTierCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingWeightTierCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
