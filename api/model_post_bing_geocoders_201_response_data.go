...
type POSTBingGeocoders201ResponseData struct {
	...
	Attributes    *POSTBingGeocodersRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTBingGeocodersRequestDataAttributes and assigns it to the Attributes field.
