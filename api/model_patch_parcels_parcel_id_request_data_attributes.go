...
// checks if the PATCHParcelsParcelIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHParcelsParcelIdRequestDataAttributes{}

// PATCHParcelsParcelIdRequestDataAttributes struct for PATCHParcelsParcelIdRequestDataAttributes
type PATCHParcelsParcelIdRequestDataAttributes struct {
...
func NewPATCHParcelsParcelIdRequestDataAttributes() *PATCHParcelsParcelIdRequestDataAttributes {
	this := PATCHParcelsParcelIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHParcelsParcelIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHParcelsParcelIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHParcelsParcelIdRequestDataAttributes struct {
	value *PATCHParcelsParcelIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHParcelsParcelIdRequestDataAttributes) Get() *PATCHParcelsParcelIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHParcelsParcelIdRequestDataAttributes) Set(val *PATCHParcelsParcelIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHParcelsParcelIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHParcelsParcelIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHParcelsParcelIdRequestDataAttributes(val *PATCHParcelsParcelIdRequestDataAttributes) *NullablePATCHParcelsParcelIdRequestDataAttributes {
	return &NullablePATCHParcelsParcelIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHParcelsParcelIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHParcelsParcelIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
