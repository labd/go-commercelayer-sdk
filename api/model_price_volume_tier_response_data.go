...
// PriceVolumeTierResponseData struct for PriceVolumeTierResponseData
type PriceVolumeTierResponseData struct {
	// The resource's id
	...
	Relationships *PriceTierResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewPriceVolumeTierResponseData() *PriceVolumeTierResponseData {
	this := PriceVolumeTierResponseData{}
	return &this
}
...
func (o *PriceVolumeTierResponseData) GetRelationships() PriceTierResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret PriceTierResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given PriceTierResponseDataRelationships and assigns it to the Relationships field.
func (o *PriceVolumeTierResponseData) SetRelationships(v PriceTierResponseDataRelationships) {
	o.Relationships = &v
}

func (o PriceVolumeTierResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePriceVolumeTierResponseData struct {
	value *PriceVolumeTierResponseData
	isSet bool
}

func (v NullablePriceVolumeTierResponseData) Get() *PriceVolumeTierResponseData {
	return v.value
}

func (v *NullablePriceVolumeTierResponseData) Set(val *PriceVolumeTierResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceVolumeTierResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceVolumeTierResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceVolumeTierResponseData(val *PriceVolumeTierResponseData) *NullablePriceVolumeTierResponseData {
	return &NullablePriceVolumeTierResponseData{value: val, isSet: true}
}

func (v NullablePriceVolumeTierResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceVolumeTierResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
