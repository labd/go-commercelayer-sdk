...
// checks if the GETPriceTiersPriceTierId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPriceTiersPriceTierId200ResponseData{}

// GETPriceTiersPriceTierId200ResponseData struct for GETPriceTiersPriceTierId200ResponseData
type GETPriceTiersPriceTierId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                           `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                    `json:"links,omitempty"`
	Attributes    *GETPriceTiersPriceTierId200ResponseDataAttributes    `json:"attributes,omitempty"`
	Relationships *GETPriceTiersPriceTierId200ResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewGETPriceTiersPriceTierId200ResponseData() *GETPriceTiersPriceTierId200ResponseData {
	this := GETPriceTiersPriceTierId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETPriceTiersPriceTierId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o *GETPriceTiersPriceTierId200ResponseData) GetRelationships() GETPriceTiersPriceTierId200ResponseDataRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret GETPriceTiersPriceTierId200ResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given GETPriceTiersPriceTierId200ResponseDataRelationships and assigns it to the Relationships field.
func (o *GETPriceTiersPriceTierId200ResponseData) SetRelationships(v GETPriceTiersPriceTierId200ResponseDataRelationships) {
	o.Relationships = &v
}

func (o GETPriceTiersPriceTierId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETPriceTiersPriceTierId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETPriceTiersPriceTierId200ResponseData struct {
	value *GETPriceTiersPriceTierId200ResponseData
	isSet bool
}

func (v NullableGETPriceTiersPriceTierId200ResponseData) Get() *GETPriceTiersPriceTierId200ResponseData {
	return v.value
}

func (v *NullableGETPriceTiersPriceTierId200ResponseData) Set(val *GETPriceTiersPriceTierId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPriceTiersPriceTierId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPriceTiersPriceTierId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPriceTiersPriceTierId200ResponseData(val *GETPriceTiersPriceTierId200ResponseData) *NullableGETPriceTiersPriceTierId200ResponseData {
	return &NullableGETPriceTiersPriceTierId200ResponseData{value: val, isSet: true}
}

func (v NullableGETPriceTiersPriceTierId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPriceTiersPriceTierId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
