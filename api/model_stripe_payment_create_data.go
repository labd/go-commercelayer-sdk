...
// checks if the StripePaymentCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StripePaymentCreateData{}
...
func (o StripePaymentCreateData) ToMap() (map[string]interface{}, error) {
