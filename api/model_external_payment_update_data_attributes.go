...
// ExternalPaymentUpdateDataAttributes struct for ExternalPaymentUpdateDataAttributes
type ExternalPaymentUpdateDataAttributes struct {
...
func NewExternalPaymentUpdateDataAttributes() *ExternalPaymentUpdateDataAttributes {
	this := ExternalPaymentUpdateDataAttributes{}
	return &this
}
...
func (o ExternalPaymentUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableExternalPaymentUpdateDataAttributes struct {
	value *ExternalPaymentUpdateDataAttributes
	isSet bool
}

func (v NullableExternalPaymentUpdateDataAttributes) Get() *ExternalPaymentUpdateDataAttributes {
	return v.value
}

func (v *NullableExternalPaymentUpdateDataAttributes) Set(val *ExternalPaymentUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalPaymentUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalPaymentUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalPaymentUpdateDataAttributes(val *ExternalPaymentUpdateDataAttributes) *NullableExternalPaymentUpdateDataAttributes {
	return &NullableExternalPaymentUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableExternalPaymentUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalPaymentUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
