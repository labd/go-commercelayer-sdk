...
// GetAsyncApi returns the AsyncApi field value if set, zero value otherwise.
...
// SetAsyncApi gets a reference to the given bool and assigns it to the AsyncApi field.
...
func (o *GETAdyenGateways200ResponseDataInnerAttributes) GetWebhookEndpointUrl() string {
...
// and a boolean to check if the value has been set.
func (o *GETAdyenGateways200ResponseDataInnerAttributes) GetWebhookEndpointUrlOk() (*string, bool) {
	if o == nil || o.WebhookEndpointUrl == nil {
		return nil, false
	}
...
func (o *GETAdyenGateways200ResponseDataInnerAttributes) SetWebhookEndpointUrl(v string) {
