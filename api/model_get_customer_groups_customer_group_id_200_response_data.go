...
// checks if the GETCustomerGroupsCustomerGroupId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETCustomerGroupsCustomerGroupId200ResponseData{}

// GETCustomerGroupsCustomerGroupId200ResponseData struct for GETCustomerGroupsCustomerGroupId200ResponseData
type GETCustomerGroupsCustomerGroupId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                         `json:"links,omitempty"`
	Attributes    *GETCustomerGroupsCustomerGroupId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETCustomerGroupsCustomerGroupId200ResponseData() *GETCustomerGroupsCustomerGroupId200ResponseData {
	this := GETCustomerGroupsCustomerGroupId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETCustomerGroupsCustomerGroupId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETCustomerGroupsCustomerGroupId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETCustomerGroupsCustomerGroupId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETCustomerGroupsCustomerGroupId200ResponseData struct {
	value *GETCustomerGroupsCustomerGroupId200ResponseData
	isSet bool
}

func (v NullableGETCustomerGroupsCustomerGroupId200ResponseData) Get() *GETCustomerGroupsCustomerGroupId200ResponseData {
	return v.value
}

func (v *NullableGETCustomerGroupsCustomerGroupId200ResponseData) Set(val *GETCustomerGroupsCustomerGroupId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomerGroupsCustomerGroupId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomerGroupsCustomerGroupId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomerGroupsCustomerGroupId200ResponseData(val *GETCustomerGroupsCustomerGroupId200ResponseData) *NullableGETCustomerGroupsCustomerGroupId200ResponseData {
	return &NullableGETCustomerGroupsCustomerGroupId200ResponseData{value: val, isSet: true}
}

func (v NullableGETCustomerGroupsCustomerGroupId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCustomerGroupsCustomerGroupId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
