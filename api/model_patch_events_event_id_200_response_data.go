...
// checks if the PATCHEventsEventId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHEventsEventId200ResponseData{}

// PATCHEventsEventId200ResponseData struct for PATCHEventsEventId200ResponseData
type PATCHEventsEventId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                   `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks            `json:"links,omitempty"`
	Attributes    *PATCHEventsEventId200ResponseDataAttributes  `json:"attributes,omitempty"`
...
func NewPATCHEventsEventId200ResponseData() *PATCHEventsEventId200ResponseData {
	this := PATCHEventsEventId200ResponseData{}
	return &this
}
...
func (o *PATCHEventsEventId200ResponseData) GetAttributes() PATCHEventsEventId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret PATCHEventsEventId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given PATCHEventsEventId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHEventsEventId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHEventsEventId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHEventsEventId200ResponseData struct {
	value *PATCHEventsEventId200ResponseData
	isSet bool
}

func (v NullablePATCHEventsEventId200ResponseData) Get() *PATCHEventsEventId200ResponseData {
	return v.value
}

func (v *NullablePATCHEventsEventId200ResponseData) Set(val *PATCHEventsEventId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHEventsEventId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHEventsEventId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHEventsEventId200ResponseData(val *PATCHEventsEventId200ResponseData) *NullablePATCHEventsEventId200ResponseData {
	return &NullablePATCHEventsEventId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHEventsEventId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHEventsEventId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
