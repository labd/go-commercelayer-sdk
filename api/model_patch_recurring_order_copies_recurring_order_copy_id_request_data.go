...
// checks if the PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData{}

// PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData struct for PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData
type PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData struct {
	// The resource's type
...
func NewPATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData(type_ interface{}, id interface{}, attributes PATCHBillingInfoValidationRulesBillingInfoValidationRuleIdRequestDataAttributes) *PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData {
	this := PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData struct {
	value *PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData
	isSet bool
}

func (v NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) Get() *PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData {
	return v.value
}

func (v *NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) Set(val *PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData(val *PATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) *NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData {
	return &NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHRecurringOrderCopiesRecurringOrderCopyIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
