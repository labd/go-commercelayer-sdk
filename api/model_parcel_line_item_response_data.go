...
// ParcelLineItemResponseData struct for ParcelLineItemResponseData
type ParcelLineItemResponseData struct {
	// The resource's id
	...
	Relationships *ParcelLineItemResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewParcelLineItemResponseData() *ParcelLineItemResponseData {
	this := ParcelLineItemResponseData{}
	return &this
}
...
func (o *ParcelLineItemResponseData) GetRelationships() ParcelLineItemResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ParcelLineItemResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ParcelLineItemResponseDataRelationships and assigns it to the Relationships field.
func (o *ParcelLineItemResponseData) SetRelationships(v ParcelLineItemResponseDataRelationships) {
	o.Relationships = &v
}

func (o ParcelLineItemResponseData) MarshalJSON() ([]byte, error) {
...
type NullableParcelLineItemResponseData struct {
	value *ParcelLineItemResponseData
	isSet bool
}

func (v NullableParcelLineItemResponseData) Get() *ParcelLineItemResponseData {
	return v.value
}

func (v *NullableParcelLineItemResponseData) Set(val *ParcelLineItemResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableParcelLineItemResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableParcelLineItemResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParcelLineItemResponseData(val *ParcelLineItemResponseData) *NullableParcelLineItemResponseData {
	return &NullableParcelLineItemResponseData{value: val, isSet: true}
}

func (v NullableParcelLineItemResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParcelLineItemResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
