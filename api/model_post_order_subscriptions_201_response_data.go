...
type POSTOrderSubscriptions201ResponseData struct {
	...
	Attributes    *POSTOrderSubscriptionsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTOrderSubscriptionsRequestDataAttributes and assigns it to the Attributes field.
