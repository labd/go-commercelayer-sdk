...
// GETCustomerAddresses200ResponseDataInnerAttributes struct for GETCustomerAddresses200ResponseDataInnerAttributes
type GETCustomerAddresses200ResponseDataInnerAttributes struct {
...
func NewGETCustomerAddresses200ResponseDataInnerAttributes() *GETCustomerAddresses200ResponseDataInnerAttributes {
	this := GETCustomerAddresses200ResponseDataInnerAttributes{}
	return &this
}
...
func (o *GETCustomerAddresses200ResponseDataInnerAttributes) GetNameOk() (*interface{}, bool) {
	if o == nil || o.Name == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o GETCustomerAddresses200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
...
type NullableGETCustomerAddresses200ResponseDataInnerAttributes struct {
	value *GETCustomerAddresses200ResponseDataInnerAttributes
	isSet bool
}

func (v NullableGETCustomerAddresses200ResponseDataInnerAttributes) Get() *GETCustomerAddresses200ResponseDataInnerAttributes {
	return v.value
}

func (v *NullableGETCustomerAddresses200ResponseDataInnerAttributes) Set(val *GETCustomerAddresses200ResponseDataInnerAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomerAddresses200ResponseDataInnerAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomerAddresses200ResponseDataInnerAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomerAddresses200ResponseDataInnerAttributes(val *GETCustomerAddresses200ResponseDataInnerAttributes) *NullableGETCustomerAddresses200ResponseDataInnerAttributes {
	return &NullableGETCustomerAddresses200ResponseDataInnerAttributes{value: val, isSet: true}
}

func (v NullableGETCustomerAddresses200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCustomerAddresses200ResponseDataInnerAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
