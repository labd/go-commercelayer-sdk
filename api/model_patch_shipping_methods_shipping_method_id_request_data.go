...
// checks if the PATCHShippingMethodsShippingMethodIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHShippingMethodsShippingMethodIdRequestData{}

// PATCHShippingMethodsShippingMethodIdRequestData struct for PATCHShippingMethodsShippingMethodIdRequestData
type PATCHShippingMethodsShippingMethodIdRequestData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                               `json:"id"`
	Attributes    PATCHShippingMethodsShippingMethodIdRequestDataAttributes `json:"attributes"`
...
func NewPATCHShippingMethodsShippingMethodIdRequestData(type_ interface{}, id interface{}, attributes PATCHShippingMethodsShippingMethodIdRequestDataAttributes) *PATCHShippingMethodsShippingMethodIdRequestData {
	this := PATCHShippingMethodsShippingMethodIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o *PATCHShippingMethodsShippingMethodIdRequestData) GetAttributes() PATCHShippingMethodsShippingMethodIdRequestDataAttributes {
	if o == nil {
		var ret PATCHShippingMethodsShippingMethodIdRequestDataAttributes
		return ret
	}
...
func (o PATCHShippingMethodsShippingMethodIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHShippingMethodsShippingMethodIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHShippingMethodsShippingMethodIdRequestData struct {
	value *PATCHShippingMethodsShippingMethodIdRequestData
	isSet bool
}

func (v NullablePATCHShippingMethodsShippingMethodIdRequestData) Get() *PATCHShippingMethodsShippingMethodIdRequestData {
	return v.value
}

func (v *NullablePATCHShippingMethodsShippingMethodIdRequestData) Set(val *PATCHShippingMethodsShippingMethodIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHShippingMethodsShippingMethodIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHShippingMethodsShippingMethodIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHShippingMethodsShippingMethodIdRequestData(val *PATCHShippingMethodsShippingMethodIdRequestData) *NullablePATCHShippingMethodsShippingMethodIdRequestData {
	return &NullablePATCHShippingMethodsShippingMethodIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHShippingMethodsShippingMethodIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHShippingMethodsShippingMethodIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
