...
type POSTPaymentMethods201ResponseData struct {
	...
	Attributes    *POSTPaymentMethodsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTPaymentMethodsRequestDataAttributes and assigns it to the Attributes field.
