...
// checks if the PATCHSkuListItemsSkuListItemIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHSkuListItemsSkuListItemIdRequestDataAttributes{}

// PATCHSkuListItemsSkuListItemIdRequestDataAttributes struct for PATCHSkuListItemsSkuListItemIdRequestDataAttributes
type PATCHSkuListItemsSkuListItemIdRequestDataAttributes struct {
...
func NewPATCHSkuListItemsSkuListItemIdRequestDataAttributes() *PATCHSkuListItemsSkuListItemIdRequestDataAttributes {
	this := PATCHSkuListItemsSkuListItemIdRequestDataAttributes{}
	return &this
}
...
func (o *PATCHSkuListItemsSkuListItemIdRequestDataAttributes) SetReference(v interface{}) {
	o.Reference = v
}
...
func (o PATCHSkuListItemsSkuListItemIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHSkuListItemsSkuListItemIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes struct {
	value *PATCHSkuListItemsSkuListItemIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes) Get() *PATCHSkuListItemsSkuListItemIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes) Set(val *PATCHSkuListItemsSkuListItemIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes(val *PATCHSkuListItemsSkuListItemIdRequestDataAttributes) *NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes {
	return &NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHSkuListItemsSkuListItemIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
