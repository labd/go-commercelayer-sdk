...
// checks if the GETLineItemOptionsLineItemOptionId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETLineItemOptionsLineItemOptionId200ResponseData{}

// GETLineItemOptionsLineItemOptionId200ResponseData struct for GETLineItemOptionsLineItemOptionId200ResponseData
type GETLineItemOptionsLineItemOptionId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                           `json:"links,omitempty"`
	Attributes    *GETLineItemOptionsLineItemOptionId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETLineItemOptionsLineItemOptionId200ResponseData() *GETLineItemOptionsLineItemOptionId200ResponseData {
	this := GETLineItemOptionsLineItemOptionId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETLineItemOptionsLineItemOptionId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETLineItemOptionsLineItemOptionId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETLineItemOptionsLineItemOptionId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETLineItemOptionsLineItemOptionId200ResponseData struct {
	value *GETLineItemOptionsLineItemOptionId200ResponseData
	isSet bool
}

func (v NullableGETLineItemOptionsLineItemOptionId200ResponseData) Get() *GETLineItemOptionsLineItemOptionId200ResponseData {
	return v.value
}

func (v *NullableGETLineItemOptionsLineItemOptionId200ResponseData) Set(val *GETLineItemOptionsLineItemOptionId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETLineItemOptionsLineItemOptionId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETLineItemOptionsLineItemOptionId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETLineItemOptionsLineItemOptionId200ResponseData(val *GETLineItemOptionsLineItemOptionId200ResponseData) *NullableGETLineItemOptionsLineItemOptionId200ResponseData {
	return &NullableGETLineItemOptionsLineItemOptionId200ResponseData{value: val, isSet: true}
}

func (v NullableGETLineItemOptionsLineItemOptionId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETLineItemOptionsLineItemOptionId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
