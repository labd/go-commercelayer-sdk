...
// checks if the GETCustomerAddressesCustomerAddressId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETCustomerAddressesCustomerAddressId200ResponseDataAttributes{}

// GETCustomerAddressesCustomerAddressId200ResponseDataAttributes struct for GETCustomerAddressesCustomerAddressId200ResponseDataAttributes
type GETCustomerAddressesCustomerAddressId200ResponseDataAttributes struct {
...
func NewGETCustomerAddressesCustomerAddressId200ResponseDataAttributes() *GETCustomerAddressesCustomerAddressId200ResponseDataAttributes {
	this := GETCustomerAddressesCustomerAddressId200ResponseDataAttributes{}
	return &this
}
...
func (o GETCustomerAddressesCustomerAddressId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETCustomerAddressesCustomerAddressId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes struct {
	value *GETCustomerAddressesCustomerAddressId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes) Get() *GETCustomerAddressesCustomerAddressId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes) Set(val *GETCustomerAddressesCustomerAddressId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes(val *GETCustomerAddressesCustomerAddressId200ResponseDataAttributes) *NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes {
	return &NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCustomerAddressesCustomerAddressId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
