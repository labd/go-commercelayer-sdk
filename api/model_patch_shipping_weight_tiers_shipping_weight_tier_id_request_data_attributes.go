...
// checks if the PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes{}

// PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes struct for PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes
type PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes struct {
...
func NewPATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes() *PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes {
	this := PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes struct {
	value *PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) Get() *PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) Set(val *PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes(val *PATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) *NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes {
	return &NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHShippingWeightTiersShippingWeightTierIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
