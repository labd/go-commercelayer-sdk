...
// checks if the AdyenGateway type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdyenGateway{}
...
func (o AdyenGateway) ToMap() (map[string]interface{}, error) {
