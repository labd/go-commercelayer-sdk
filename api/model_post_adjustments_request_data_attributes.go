...
// checks if the POSTAdjustmentsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTAdjustmentsRequestDataAttributes{}

// POSTAdjustmentsRequestDataAttributes struct for POSTAdjustmentsRequestDataAttributes
type POSTAdjustmentsRequestDataAttributes struct {
	// The adjustment name
...
func NewPOSTAdjustmentsRequestDataAttributes(name interface{}, currencyCode interface{}, amountCents interface{}) *POSTAdjustmentsRequestDataAttributes {
	this := POSTAdjustmentsRequestDataAttributes{}
	this.Name = name
...
func (o POSTAdjustmentsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTAdjustmentsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTAdjustmentsRequestDataAttributes struct {
	value *POSTAdjustmentsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTAdjustmentsRequestDataAttributes) Get() *POSTAdjustmentsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTAdjustmentsRequestDataAttributes) Set(val *POSTAdjustmentsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTAdjustmentsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTAdjustmentsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTAdjustmentsRequestDataAttributes(val *POSTAdjustmentsRequestDataAttributes) *NullablePOSTAdjustmentsRequestDataAttributes {
	return &NullablePOSTAdjustmentsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTAdjustmentsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTAdjustmentsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
