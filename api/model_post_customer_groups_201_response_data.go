...
// checks if the POSTCustomerGroups201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTCustomerGroups201ResponseData{}
...
type POSTCustomerGroups201ResponseData struct {
	...
	Attributes    *POSTCustomerGroupsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTCustomerGroupsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTCustomerGroups201ResponseData) ToMap() (map[string]interface{}, error) {
