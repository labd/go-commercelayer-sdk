...
// checks if the GETFixedPricePromotions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETFixedPricePromotions200Response{}
...
func (o GETFixedPricePromotions200Response) ToMap() (map[string]interface{}, error) {
