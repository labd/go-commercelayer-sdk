...
type PATCHCapturesCaptureId200ResponseData struct {
	...
	Attributes    *PATCHCapturesCaptureIdRequestDataAttributes      `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHCapturesCaptureIdRequestDataAttributes and assigns it to the Attributes field.
