...
// GETFixedAmountPromotions200ResponseDataInnerAttributes struct for GETFixedAmountPromotions200ResponseDataInnerAttributes
type GETFixedAmountPromotions200ResponseDataInnerAttributes struct {
...
func NewGETFixedAmountPromotions200ResponseDataInnerAttributes() *GETFixedAmountPromotions200ResponseDataInnerAttributes {
	this := GETFixedAmountPromotions200ResponseDataInnerAttributes{}
	return &this
}
...
func (o GETFixedAmountPromotions200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
...
type NullableGETFixedAmountPromotions200ResponseDataInnerAttributes struct {
	value *GETFixedAmountPromotions200ResponseDataInnerAttributes
	isSet bool
}

func (v NullableGETFixedAmountPromotions200ResponseDataInnerAttributes) Get() *GETFixedAmountPromotions200ResponseDataInnerAttributes {
	return v.value
}

func (v *NullableGETFixedAmountPromotions200ResponseDataInnerAttributes) Set(val *GETFixedAmountPromotions200ResponseDataInnerAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETFixedAmountPromotions200ResponseDataInnerAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETFixedAmountPromotions200ResponseDataInnerAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETFixedAmountPromotions200ResponseDataInnerAttributes(val *GETFixedAmountPromotions200ResponseDataInnerAttributes) *NullableGETFixedAmountPromotions200ResponseDataInnerAttributes {
	return &NullableGETFixedAmountPromotions200ResponseDataInnerAttributes{value: val, isSet: true}
}

func (v NullableGETFixedAmountPromotions200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETFixedAmountPromotions200ResponseDataInnerAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
