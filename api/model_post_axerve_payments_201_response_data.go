...
// checks if the POSTAxervePayments201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTAxervePayments201ResponseData{}

// POSTAxervePayments201ResponseData struct for POSTAxervePayments201ResponseData
type POSTAxervePayments201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks             `json:"links,omitempty"`
	Attributes    *POSTAxervePaymentsRequestDataAttributes       `json:"attributes,omitempty"`
...
func NewPOSTAxervePayments201ResponseData() *POSTAxervePayments201ResponseData {
	this := POSTAxervePayments201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTAxervePaymentsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTAxervePayments201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTAxervePayments201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTAxervePayments201ResponseData struct {
	value *POSTAxervePayments201ResponseData
	isSet bool
}

func (v NullablePOSTAxervePayments201ResponseData) Get() *POSTAxervePayments201ResponseData {
	return v.value
}

func (v *NullablePOSTAxervePayments201ResponseData) Set(val *POSTAxervePayments201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTAxervePayments201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTAxervePayments201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTAxervePayments201ResponseData(val *POSTAxervePayments201ResponseData) *NullablePOSTAxervePayments201ResponseData {
	return &NullablePOSTAxervePayments201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTAxervePayments201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTAxervePayments201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
