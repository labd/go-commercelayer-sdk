...
type POSTAxervePayments201ResponseData struct {
	...
	Attributes    *POSTAxervePayments201ResponseDataAttributes   `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTAxervePayments201ResponseDataAttributes and assigns it to the Attributes field.
