...
// checks if the POSTManualTaxCalculatorsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTManualTaxCalculatorsRequestDataAttributes{}

// POSTManualTaxCalculatorsRequestDataAttributes struct for POSTManualTaxCalculatorsRequestDataAttributes
type POSTManualTaxCalculatorsRequestDataAttributes struct {
...
func NewPOSTManualTaxCalculatorsRequestDataAttributes(name interface{}) *POSTManualTaxCalculatorsRequestDataAttributes {
	this := POSTManualTaxCalculatorsRequestDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTManualTaxCalculatorsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTManualTaxCalculatorsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTManualTaxCalculatorsRequestDataAttributes struct {
	value *POSTManualTaxCalculatorsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTManualTaxCalculatorsRequestDataAttributes) Get() *POSTManualTaxCalculatorsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTManualTaxCalculatorsRequestDataAttributes) Set(val *POSTManualTaxCalculatorsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTManualTaxCalculatorsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTManualTaxCalculatorsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTManualTaxCalculatorsRequestDataAttributes(val *POSTManualTaxCalculatorsRequestDataAttributes) *NullablePOSTManualTaxCalculatorsRequestDataAttributes {
	return &NullablePOSTManualTaxCalculatorsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTManualTaxCalculatorsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTManualTaxCalculatorsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
