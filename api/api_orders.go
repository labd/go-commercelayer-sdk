...
type OrdersApiPATCHOrdersOrderIdRequest struct {
	ctx                       context.Context
	ApiService                *OrdersApiService
	pATCHOrdersOrderIdRequest *PATCHOrdersOrderIdRequest
	orderId                   interface{}
}

func (r OrdersApiPATCHOrdersOrderIdRequest) PATCHOrdersOrderIdRequest(pATCHOrdersOrderIdRequest PATCHOrdersOrderIdRequest) OrdersApiPATCHOrdersOrderIdRequest {
	r.pATCHOrdersOrderIdRequest = &pATCHOrdersOrderIdRequest
	return r
}
...
func (a *OrdersApiService) PATCHOrdersOrderIdExecute(r OrdersApiPATCHOrdersOrderIdRequest) (*PATCHOrdersOrderId200Response, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.pATCHOrdersOrderIdRequest == nil {
		return localVarReturnValue, nil, reportError("pATCHOrdersOrderIdRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.pATCHOrdersOrderIdRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r OrdersApiPOSTOrdersRequest) POSTOrdersRequest(pOSTOrdersRequest POSTOrdersRequest) OrdersApiPOSTOrdersRequest {
