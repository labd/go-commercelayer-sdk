...
type PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData struct {
	...
	Attributes    *PATCHOrderSubscriptionItemsOrderSubscriptionItemIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHOrderSubscriptionItemsOrderSubscriptionItemIdRequestDataAttributes and assigns it to the Attributes field.
