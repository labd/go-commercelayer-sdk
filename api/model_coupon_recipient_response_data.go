...
// CouponRecipientResponseData struct for CouponRecipientResponseData
type CouponRecipientResponseData struct {
	// The resource's id
...
func NewCouponRecipientResponseData() *CouponRecipientResponseData {
	this := CouponRecipientResponseData{}
	return &this
}
...
func (o CouponRecipientResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCouponRecipientResponseData struct {
	value *CouponRecipientResponseData
	isSet bool
}

func (v NullableCouponRecipientResponseData) Get() *CouponRecipientResponseData {
	return v.value
}

func (v *NullableCouponRecipientResponseData) Set(val *CouponRecipientResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCouponRecipientResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCouponRecipientResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCouponRecipientResponseData(val *CouponRecipientResponseData) *NullableCouponRecipientResponseData {
	return &NullableCouponRecipientResponseData{value: val, isSet: true}
}

func (v NullableCouponRecipientResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCouponRecipientResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
