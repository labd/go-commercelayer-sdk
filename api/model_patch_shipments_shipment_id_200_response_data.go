...
type PATCHShipmentsShipmentId200ResponseData struct {
	...
	Attributes    *PATCHShipmentsShipmentIdRequestDataAttributes      `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHShipmentsShipmentIdRequestDataAttributes and assigns it to the Attributes field.
