...
// checks if the GETBingGeocodersBingGeocoderId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETBingGeocodersBingGeocoderId200ResponseData{}

// GETBingGeocodersBingGeocoderId200ResponseData struct for GETBingGeocodersBingGeocoderId200ResponseData
type GETBingGeocodersBingGeocoderId200ResponseData struct {
	// The resource's id
...
func NewGETBingGeocodersBingGeocoderId200ResponseData() *GETBingGeocodersBingGeocoderId200ResponseData {
	this := GETBingGeocodersBingGeocoderId200ResponseData{}
	return &this
}
...
func (o GETBingGeocodersBingGeocoderId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETBingGeocodersBingGeocoderId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETBingGeocodersBingGeocoderId200ResponseData struct {
	value *GETBingGeocodersBingGeocoderId200ResponseData
	isSet bool
}

func (v NullableGETBingGeocodersBingGeocoderId200ResponseData) Get() *GETBingGeocodersBingGeocoderId200ResponseData {
	return v.value
}

func (v *NullableGETBingGeocodersBingGeocoderId200ResponseData) Set(val *GETBingGeocodersBingGeocoderId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBingGeocodersBingGeocoderId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBingGeocodersBingGeocoderId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBingGeocodersBingGeocoderId200ResponseData(val *GETBingGeocodersBingGeocoderId200ResponseData) *NullableGETBingGeocodersBingGeocoderId200ResponseData {
	return &NullableGETBingGeocodersBingGeocoderId200ResponseData{value: val, isSet: true}
}

func (v NullableGETBingGeocodersBingGeocoderId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBingGeocodersBingGeocoderId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
