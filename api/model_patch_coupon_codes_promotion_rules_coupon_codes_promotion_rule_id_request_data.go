...
// checks if the PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData{}

// PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData struct for PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData
type PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                                                       `json:"id"`
	Attributes    PATCHBillingInfoValidationRulesBillingInfoValidationRuleIdRequestDataAttributes   `json:"attributes"`
	Relationships *PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestDataRelationships `json:"relationships,omitempty"`
}
...
func NewPATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData(type_ interface{}, id interface{}, attributes PATCHBillingInfoValidationRulesBillingInfoValidationRuleIdRequestDataAttributes) *PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData {
	this := PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o *PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) GetRelationships() PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestDataRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestDataRelationships and assigns it to the Relationships field.
...
func (o PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData struct {
	value *PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData
	isSet bool
}

func (v NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) Get() *PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData {
	return v.value
}

func (v *NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) Set(val *PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData(val *PATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) *NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData {
	return &NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHCouponCodesPromotionRulesCouponCodesPromotionRuleIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
