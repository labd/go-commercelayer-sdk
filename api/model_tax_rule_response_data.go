...
// TaxRuleResponseData struct for TaxRuleResponseData
type TaxRuleResponseData struct {
	// The resource's id
	...
	Relationships *TaxRuleResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *TaxRuleResponseData) GetRelationships() TaxRuleResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret TaxRuleResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given TaxRuleResponseDataRelationships and assigns it to the Relationships field.
func (o *TaxRuleResponseData) SetRelationships(v TaxRuleResponseDataRelationships) {
	o.Relationships = &v
}

func (o TaxRuleResponseData) MarshalJSON() ([]byte, error) {
...
type NullableTaxRuleResponseData struct {
	value *TaxRuleResponseData
	isSet bool
}

func (v NullableTaxRuleResponseData) Get() *TaxRuleResponseData {
	return v.value
}

func (v *NullableTaxRuleResponseData) Set(val *TaxRuleResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxRuleResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxRuleResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxRuleResponseData(val *TaxRuleResponseData) *NullableTaxRuleResponseData {
	return &NullableTaxRuleResponseData{value: val, isSet: true}
}

func (v NullableTaxRuleResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxRuleResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
