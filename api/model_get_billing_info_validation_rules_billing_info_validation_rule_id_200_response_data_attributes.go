...
// checks if the GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes{}
...
func (o GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes struct {
	value *GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) Get() *GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) Set(val *GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes(val *GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) *NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes {
	return &NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
