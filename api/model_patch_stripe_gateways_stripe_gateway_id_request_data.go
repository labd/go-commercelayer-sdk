...
// checks if the PATCHStripeGatewaysStripeGatewayIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHStripeGatewaysStripeGatewayIdRequestData{}

// PATCHStripeGatewaysStripeGatewayIdRequestData struct for PATCHStripeGatewaysStripeGatewayIdRequestData
type PATCHStripeGatewaysStripeGatewayIdRequestData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                             `json:"id"`
	Attributes    PATCHStripeGatewaysStripeGatewayIdRequestDataAttributes `json:"attributes"`
...
func NewPATCHStripeGatewaysStripeGatewayIdRequestData(type_ interface{}, id interface{}, attributes PATCHStripeGatewaysStripeGatewayIdRequestDataAttributes) *PATCHStripeGatewaysStripeGatewayIdRequestData {
	this := PATCHStripeGatewaysStripeGatewayIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o PATCHStripeGatewaysStripeGatewayIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHStripeGatewaysStripeGatewayIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHStripeGatewaysStripeGatewayIdRequestData struct {
	value *PATCHStripeGatewaysStripeGatewayIdRequestData
	isSet bool
}

func (v NullablePATCHStripeGatewaysStripeGatewayIdRequestData) Get() *PATCHStripeGatewaysStripeGatewayIdRequestData {
	return v.value
}

func (v *NullablePATCHStripeGatewaysStripeGatewayIdRequestData) Set(val *PATCHStripeGatewaysStripeGatewayIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHStripeGatewaysStripeGatewayIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHStripeGatewaysStripeGatewayIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHStripeGatewaysStripeGatewayIdRequestData(val *PATCHStripeGatewaysStripeGatewayIdRequestData) *NullablePATCHStripeGatewaysStripeGatewayIdRequestData {
	return &NullablePATCHStripeGatewaysStripeGatewayIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHStripeGatewaysStripeGatewayIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHStripeGatewaysStripeGatewayIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
