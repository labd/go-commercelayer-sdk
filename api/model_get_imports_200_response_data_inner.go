...
type GETImports200ResponseDataInner struct {
	...
	Attributes    *GETImports200ResponseDataInnerAttributes     `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given GETImports200ResponseDataInnerAttributes and assigns it to the Attributes field.
