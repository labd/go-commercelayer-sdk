...
// checks if the PATCHAdyenGatewaysAdyenGatewayId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHAdyenGatewaysAdyenGatewayId200ResponseData{}
...
type PATCHAdyenGatewaysAdyenGatewayId200ResponseData struct {
	...
	Attributes    *PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHAdyenGatewaysAdyenGatewayId200ResponseData) ToMap() (map[string]interface{}, error) {
