...
// GETPaymentGateways200ResponseDataInner struct for GETPaymentGateways200ResponseDataInner
type GETPaymentGateways200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                             `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks              `json:"links,omitempty"`
	Attributes    *GETKlarnaGateways200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETPaymentGateways200ResponseDataInner() *GETPaymentGateways200ResponseDataInner {
	this := GETPaymentGateways200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETKlarnaGateways200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETPaymentGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETPaymentGateways200ResponseDataInner struct {
	value *GETPaymentGateways200ResponseDataInner
	isSet bool
}

func (v NullableGETPaymentGateways200ResponseDataInner) Get() *GETPaymentGateways200ResponseDataInner {
	return v.value
}

func (v *NullableGETPaymentGateways200ResponseDataInner) Set(val *GETPaymentGateways200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPaymentGateways200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPaymentGateways200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPaymentGateways200ResponseDataInner(val *GETPaymentGateways200ResponseDataInner) *NullableGETPaymentGateways200ResponseDataInner {
	return &NullableGETPaymentGateways200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETPaymentGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPaymentGateways200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
