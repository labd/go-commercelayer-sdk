...
// GETShipments200ResponseDataInner struct for GETShipments200ResponseDataInner
type GETShipments200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                        `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks         `json:"links,omitempty"`
	Attributes    *GETShipments200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETShipments200ResponseDataInner() *GETShipments200ResponseDataInner {
	this := GETShipments200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETShipments200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETShipments200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETShipments200ResponseDataInner struct {
	value *GETShipments200ResponseDataInner
	isSet bool
}

func (v NullableGETShipments200ResponseDataInner) Get() *GETShipments200ResponseDataInner {
	return v.value
}

func (v *NullableGETShipments200ResponseDataInner) Set(val *GETShipments200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETShipments200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETShipments200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETShipments200ResponseDataInner(val *GETShipments200ResponseDataInner) *NullableGETShipments200ResponseDataInner {
	return &NullableGETShipments200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETShipments200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETShipments200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
