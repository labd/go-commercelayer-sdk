...
// checks if the PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes{}

// PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes struct for PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes
type PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes struct {
...
func NewPATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes() *PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes {
	this := PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes{}
	return &this
}
...
func (o *PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) GetPriorityOk() (*interface{}, bool) {
...
func (o *PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) HasReference() bool {
	if o != nil && IsNil(o.Reference) {
		return true
	}
...
func (o PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes struct {
	value *PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) Get() *PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) Set(val *PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes(val *PATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) *NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes {
	return &NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHInventoryReturnLocationsInventoryReturnLocationIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
