...
// checks if the BraintreePayment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BraintreePayment{}
...
func (o BraintreePayment) ToMap() (map[string]interface{}, error) {
