...
// GETBraintreeGateways200ResponseDataInner struct for GETBraintreeGateways200ResponseDataInner
type GETBraintreeGateways200ResponseDataInner struct {
	// The resource's id
...
// SetAttributes gets a reference to the given GETBraintreeGateways200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETBraintreeGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETBraintreeGateways200ResponseDataInner struct {
	value *GETBraintreeGateways200ResponseDataInner
	isSet bool
}

func (v NullableGETBraintreeGateways200ResponseDataInner) Get() *GETBraintreeGateways200ResponseDataInner {
	return v.value
}

func (v *NullableGETBraintreeGateways200ResponseDataInner) Set(val *GETBraintreeGateways200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBraintreeGateways200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBraintreeGateways200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBraintreeGateways200ResponseDataInner(val *GETBraintreeGateways200ResponseDataInner) *NullableGETBraintreeGateways200ResponseDataInner {
	return &NullableGETBraintreeGateways200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETBraintreeGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBraintreeGateways200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
