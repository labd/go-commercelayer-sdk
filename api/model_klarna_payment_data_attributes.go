...
// KlarnaPaymentDataAttributes struct for KlarnaPaymentDataAttributes
type KlarnaPaymentDataAttributes struct {
...
func NewKlarnaPaymentDataAttributes() *KlarnaPaymentDataAttributes {
	this := KlarnaPaymentDataAttributes{}
	return &this
}
...
func (o KlarnaPaymentDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableKlarnaPaymentDataAttributes struct {
	value *KlarnaPaymentDataAttributes
	isSet bool
}

func (v NullableKlarnaPaymentDataAttributes) Get() *KlarnaPaymentDataAttributes {
	return v.value
}

func (v *NullableKlarnaPaymentDataAttributes) Set(val *KlarnaPaymentDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableKlarnaPaymentDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableKlarnaPaymentDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKlarnaPaymentDataAttributes(val *KlarnaPaymentDataAttributes) *NullableKlarnaPaymentDataAttributes {
	return &NullableKlarnaPaymentDataAttributes{value: val, isSet: true}
}

func (v NullableKlarnaPaymentDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKlarnaPaymentDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
