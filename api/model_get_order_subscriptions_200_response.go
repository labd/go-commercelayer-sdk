...
// checks if the GETOrderSubscriptions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETOrderSubscriptions200Response{}
...
func (o GETOrderSubscriptions200Response) ToMap() (map[string]interface{}, error) {
