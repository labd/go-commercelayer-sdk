...
// checks if the WireTransferCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WireTransferCreateData{}
...
func (o WireTransferCreateData) ToMap() (map[string]interface{}, error) {
