...
// checks if the POSTShippingWeightTiers201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTShippingWeightTiers201ResponseData{}

// POSTShippingWeightTiers201ResponseData struct for POSTShippingWeightTiers201ResponseData
type POSTShippingWeightTiers201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                             `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                      `json:"links,omitempty"`
	Attributes    *POSTShippingWeightTiersRequestDataAttributes                           `json:"attributes,omitempty"`
...
func NewPOSTShippingWeightTiers201ResponseData() *POSTShippingWeightTiers201ResponseData {
	this := POSTShippingWeightTiers201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTShippingWeightTiersRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTShippingWeightTiers201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTShippingWeightTiers201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTShippingWeightTiers201ResponseData struct {
	value *POSTShippingWeightTiers201ResponseData
	isSet bool
}

func (v NullablePOSTShippingWeightTiers201ResponseData) Get() *POSTShippingWeightTiers201ResponseData {
	return v.value
}

func (v *NullablePOSTShippingWeightTiers201ResponseData) Set(val *POSTShippingWeightTiers201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTShippingWeightTiers201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTShippingWeightTiers201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTShippingWeightTiers201ResponseData(val *POSTShippingWeightTiers201ResponseData) *NullablePOSTShippingWeightTiers201ResponseData {
	return &NullablePOSTShippingWeightTiers201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTShippingWeightTiers201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTShippingWeightTiers201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
