...
// checks if the ImportUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportUpdateData{}

// ImportUpdateData struct for ImportUpdateData
...
func (o ImportUpdateData) MarshalJSON() ([]byte, error) {
...
func (o ImportUpdateData) ToMap() (map[string]interface{}, error) {
...
type NullableImportUpdateData struct {
	value *ImportUpdateData
	isSet bool
}

func (v NullableImportUpdateData) Get() *ImportUpdateData {
	return v.value
}

func (v *NullableImportUpdateData) Set(val *ImportUpdateData) {
	v.value = val
	v.isSet = true
}

func (v NullableImportUpdateData) IsSet() bool {
	return v.isSet
}

func (v *NullableImportUpdateData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportUpdateData(val *ImportUpdateData) *NullableImportUpdateData {
	return &NullableImportUpdateData{value: val, isSet: true}
}

func (v NullableImportUpdateData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportUpdateData) UnmarshalJSON(src []byte) error {
	v.isSet = true
