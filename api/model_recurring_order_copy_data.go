...
// checks if the RecurringOrderCopyData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecurringOrderCopyData{}

// RecurringOrderCopyData struct for RecurringOrderCopyData
type RecurringOrderCopyData struct {
	// The resource's type
...
func (o RecurringOrderCopyData) MarshalJSON() ([]byte, error) {
...
func (o RecurringOrderCopyData) ToMap() (map[string]interface{}, error) {
...
type NullableRecurringOrderCopyData struct {
	value *RecurringOrderCopyData
	isSet bool
}

func (v NullableRecurringOrderCopyData) Get() *RecurringOrderCopyData {
	return v.value
}

func (v *NullableRecurringOrderCopyData) Set(val *RecurringOrderCopyData) {
	v.value = val
	v.isSet = true
}

func (v NullableRecurringOrderCopyData) IsSet() bool {
	return v.isSet
}

func (v *NullableRecurringOrderCopyData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecurringOrderCopyData(val *RecurringOrderCopyData) *NullableRecurringOrderCopyData {
	return &NullableRecurringOrderCopyData{value: val, isSet: true}
}

func (v NullableRecurringOrderCopyData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecurringOrderCopyData) UnmarshalJSON(src []byte) error {
	v.isSet = true
