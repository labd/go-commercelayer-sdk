...
// checks if the PATCHTagsTagId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHTagsTagId200ResponseData{}

// PATCHTagsTagId200ResponseData struct for PATCHTagsTagId200ResponseData
type PATCHTagsTagId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                              `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks       `json:"links,omitempty"`
	Attributes    *PATCHTagsTagId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewPATCHTagsTagId200ResponseData() *PATCHTagsTagId200ResponseData {
	this := PATCHTagsTagId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given PATCHTagsTagId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHTagsTagId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHTagsTagId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHTagsTagId200ResponseData struct {
	value *PATCHTagsTagId200ResponseData
	isSet bool
}

func (v NullablePATCHTagsTagId200ResponseData) Get() *PATCHTagsTagId200ResponseData {
	return v.value
}

func (v *NullablePATCHTagsTagId200ResponseData) Set(val *PATCHTagsTagId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHTagsTagId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHTagsTagId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHTagsTagId200ResponseData(val *PATCHTagsTagId200ResponseData) *NullablePATCHTagsTagId200ResponseData {
	return &NullablePATCHTagsTagId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHTagsTagId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHTagsTagId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
