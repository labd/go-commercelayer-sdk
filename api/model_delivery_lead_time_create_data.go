...
// checks if the DeliveryLeadTimeCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeliveryLeadTimeCreateData{}
...
func (o DeliveryLeadTimeCreateData) ToMap() (map[string]interface{}, error) {
