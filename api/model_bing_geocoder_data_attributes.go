...
// BingGeocoderDataAttributes struct for BingGeocoderDataAttributes
type BingGeocoderDataAttributes struct {
...
func NewBingGeocoderDataAttributes() *BingGeocoderDataAttributes {
	this := BingGeocoderDataAttributes{}
	return &this
}
...
func (o BingGeocoderDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableBingGeocoderDataAttributes struct {
	value *BingGeocoderDataAttributes
	isSet bool
}

func (v NullableBingGeocoderDataAttributes) Get() *BingGeocoderDataAttributes {
	return v.value
}

func (v *NullableBingGeocoderDataAttributes) Set(val *BingGeocoderDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableBingGeocoderDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableBingGeocoderDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBingGeocoderDataAttributes(val *BingGeocoderDataAttributes) *NullableBingGeocoderDataAttributes {
	return &NullableBingGeocoderDataAttributes{value: val, isSet: true}
}

func (v NullableBingGeocoderDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBingGeocoderDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
