...
// checks if the CustomerPasswordResetUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerPasswordResetUpdateData{}
...
func (o CustomerPasswordResetUpdateData) ToMap() (map[string]interface{}, error) {
