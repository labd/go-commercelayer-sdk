...
// StockTransferResponseData struct for StockTransferResponseData
type StockTransferResponseData struct {
	// The resource's id
	...
	Relationships *StockTransferResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewStockTransferResponseData() *StockTransferResponseData {
	this := StockTransferResponseData{}
	return &this
}
...
func (o *StockTransferResponseData) GetRelationships() StockTransferResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret StockTransferResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given StockTransferResponseDataRelationships and assigns it to the Relationships field.
func (o *StockTransferResponseData) SetRelationships(v StockTransferResponseDataRelationships) {
	o.Relationships = &v
}

func (o StockTransferResponseData) MarshalJSON() ([]byte, error) {
...
type NullableStockTransferResponseData struct {
	value *StockTransferResponseData
	isSet bool
}

func (v NullableStockTransferResponseData) Get() *StockTransferResponseData {
	return v.value
}

func (v *NullableStockTransferResponseData) Set(val *StockTransferResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableStockTransferResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableStockTransferResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStockTransferResponseData(val *StockTransferResponseData) *NullableStockTransferResponseData {
	return &NullableStockTransferResponseData{value: val, isSet: true}
}

func (v NullableStockTransferResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStockTransferResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
