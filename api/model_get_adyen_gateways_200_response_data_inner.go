...
// GETAdyenGateways200ResponseDataInner struct for GETAdyenGateways200ResponseDataInner
type GETAdyenGateways200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type *string `json:"type,omitempty"`
	Links *GETAddresses200ResponseDataInnerLinks `json:"links,omitempty"`
	Attributes *GETAdyenGateways200ResponseDataInnerAttributes `json:"attributes,omitempty"`
...
func NewGETAdyenGateways200ResponseDataInner() *GETAdyenGateways200ResponseDataInner {
	this := GETAdyenGateways200ResponseDataInner{}
...
// SetAttributes gets a reference to the given GETAdyenGateways200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETAdyenGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETAdyenGateways200ResponseDataInner struct {
	value *GETAdyenGateways200ResponseDataInner
	isSet bool
}

func (v NullableGETAdyenGateways200ResponseDataInner) Get() *GETAdyenGateways200ResponseDataInner {
	return v.value
}

func (v *NullableGETAdyenGateways200ResponseDataInner) Set(val *GETAdyenGateways200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAdyenGateways200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAdyenGateways200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAdyenGateways200ResponseDataInner(val *GETAdyenGateways200ResponseDataInner) *NullableGETAdyenGateways200ResponseDataInner {
	return &NullableGETAdyenGateways200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETAdyenGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAdyenGateways200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
