...
// checks if the GETTaxjarAccountsTaxjarAccountId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETTaxjarAccountsTaxjarAccountId200ResponseData{}

// GETTaxjarAccountsTaxjarAccountId200ResponseData struct for GETTaxjarAccountsTaxjarAccountId200ResponseData
type GETTaxjarAccountsTaxjarAccountId200ResponseData struct {
	// The resource's id
...
func NewGETTaxjarAccountsTaxjarAccountId200ResponseData() *GETTaxjarAccountsTaxjarAccountId200ResponseData {
	this := GETTaxjarAccountsTaxjarAccountId200ResponseData{}
	return &this
}
...
func (o GETTaxjarAccountsTaxjarAccountId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETTaxjarAccountsTaxjarAccountId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETTaxjarAccountsTaxjarAccountId200ResponseData struct {
	value *GETTaxjarAccountsTaxjarAccountId200ResponseData
	isSet bool
}

func (v NullableGETTaxjarAccountsTaxjarAccountId200ResponseData) Get() *GETTaxjarAccountsTaxjarAccountId200ResponseData {
	return v.value
}

func (v *NullableGETTaxjarAccountsTaxjarAccountId200ResponseData) Set(val *GETTaxjarAccountsTaxjarAccountId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETTaxjarAccountsTaxjarAccountId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETTaxjarAccountsTaxjarAccountId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETTaxjarAccountsTaxjarAccountId200ResponseData(val *GETTaxjarAccountsTaxjarAccountId200ResponseData) *NullableGETTaxjarAccountsTaxjarAccountId200ResponseData {
	return &NullableGETTaxjarAccountsTaxjarAccountId200ResponseData{value: val, isSet: true}
}

func (v NullableGETTaxjarAccountsTaxjarAccountId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETTaxjarAccountsTaxjarAccountId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
