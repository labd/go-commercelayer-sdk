...
// checks if the POSTGoogleGeocodersRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTGoogleGeocodersRequestData{}

// POSTGoogleGeocodersRequestData struct for POSTGoogleGeocodersRequestData
type POSTGoogleGeocodersRequestData struct {
	// The resource's type
	Type          interface{}                              `json:"type"`
	Attributes    POSTGoogleGeocodersRequestDataAttributes `json:"attributes"`
...
func NewPOSTGoogleGeocodersRequestData(type_ interface{}, attributes POSTGoogleGeocodersRequestDataAttributes) *POSTGoogleGeocodersRequestData {
	this := POSTGoogleGeocodersRequestData{}
	this.Type = type_
...
func (o POSTGoogleGeocodersRequestData) MarshalJSON() ([]byte, error) {
...
func (o POSTGoogleGeocodersRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTGoogleGeocodersRequestData struct {
	value *POSTGoogleGeocodersRequestData
	isSet bool
}

func (v NullablePOSTGoogleGeocodersRequestData) Get() *POSTGoogleGeocodersRequestData {
	return v.value
}

func (v *NullablePOSTGoogleGeocodersRequestData) Set(val *POSTGoogleGeocodersRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTGoogleGeocodersRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTGoogleGeocodersRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTGoogleGeocodersRequestData(val *POSTGoogleGeocodersRequestData) *NullablePOSTGoogleGeocodersRequestData {
	return &NullablePOSTGoogleGeocodersRequestData{value: val, isSet: true}
}

func (v NullablePOSTGoogleGeocodersRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTGoogleGeocodersRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
