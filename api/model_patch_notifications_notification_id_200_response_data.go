...
// checks if the PATCHNotificationsNotificationId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHNotificationsNotificationId200ResponseData{}

// PATCHNotificationsNotificationId200ResponseData struct for PATCHNotificationsNotificationId200ResponseData
type PATCHNotificationsNotificationId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                         `json:"links,omitempty"`
	Attributes    *PATCHNotificationsNotificationId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewPATCHNotificationsNotificationId200ResponseData() *PATCHNotificationsNotificationId200ResponseData {
	this := PATCHNotificationsNotificationId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given PATCHNotificationsNotificationId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHNotificationsNotificationId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHNotificationsNotificationId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHNotificationsNotificationId200ResponseData struct {
	value *PATCHNotificationsNotificationId200ResponseData
	isSet bool
}

func (v NullablePATCHNotificationsNotificationId200ResponseData) Get() *PATCHNotificationsNotificationId200ResponseData {
	return v.value
}

func (v *NullablePATCHNotificationsNotificationId200ResponseData) Set(val *PATCHNotificationsNotificationId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHNotificationsNotificationId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHNotificationsNotificationId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHNotificationsNotificationId200ResponseData(val *PATCHNotificationsNotificationId200ResponseData) *NullablePATCHNotificationsNotificationId200ResponseData {
	return &NullablePATCHNotificationsNotificationId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHNotificationsNotificationId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHNotificationsNotificationId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
