...
// GeocoderResponseData struct for GeocoderResponseData
type GeocoderResponseData struct {
	// The resource's id
...
func (o GeocoderResponseData) MarshalJSON() ([]byte, error) {
...
type NullableGeocoderResponseData struct {
	value *GeocoderResponseData
	isSet bool
}

func (v NullableGeocoderResponseData) Get() *GeocoderResponseData {
	return v.value
}

func (v *NullableGeocoderResponseData) Set(val *GeocoderResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGeocoderResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGeocoderResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeocoderResponseData(val *GeocoderResponseData) *NullableGeocoderResponseData {
	return &NullableGeocoderResponseData{value: val, isSet: true}
}

func (v NullableGeocoderResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeocoderResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
