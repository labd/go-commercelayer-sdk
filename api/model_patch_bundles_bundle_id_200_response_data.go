...
type PATCHBundlesBundleId200ResponseData struct {
	...
	Attributes    *PATCHBundlesBundleIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHBundlesBundleIdRequestDataAttributes and assigns it to the Attributes field.
