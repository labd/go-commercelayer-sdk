...
// checks if the PATCHCustomersCustomerId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHCustomersCustomerId200ResponseData{}
...
type PATCHCustomersCustomerId200ResponseData struct {
	...
	Attributes    *PATCHCustomersCustomerIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHCustomersCustomerIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHCustomersCustomerId200ResponseData) ToMap() (map[string]interface{}, error) {
