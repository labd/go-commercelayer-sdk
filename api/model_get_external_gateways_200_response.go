...
// checks if the GETExternalGateways200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETExternalGateways200Response{}
...
func (o GETExternalGateways200Response) ToMap() (map[string]interface{}, error) {
