...
type POSTFixedPricePromotions201ResponseData struct {
	...
	Attributes    *POSTFixedPricePromotions201ResponseDataAttributes    `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTFixedPricePromotions201ResponseDataAttributes and assigns it to the Attributes field.
