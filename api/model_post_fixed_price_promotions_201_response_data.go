...
// checks if the POSTFixedPricePromotions201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTFixedPricePromotions201ResponseData{}

// POSTFixedPricePromotions201ResponseData struct for POSTFixedPricePromotions201ResponseData
type POSTFixedPricePromotions201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                           `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                    `json:"links,omitempty"`
	Attributes    *POSTFixedPricePromotionsRequestDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTFixedPricePromotions201ResponseData() *POSTFixedPricePromotions201ResponseData {
	this := POSTFixedPricePromotions201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTFixedPricePromotionsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTFixedPricePromotions201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTFixedPricePromotions201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTFixedPricePromotions201ResponseData struct {
	value *POSTFixedPricePromotions201ResponseData
	isSet bool
}

func (v NullablePOSTFixedPricePromotions201ResponseData) Get() *POSTFixedPricePromotions201ResponseData {
	return v.value
}

func (v *NullablePOSTFixedPricePromotions201ResponseData) Set(val *POSTFixedPricePromotions201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTFixedPricePromotions201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTFixedPricePromotions201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTFixedPricePromotions201ResponseData(val *POSTFixedPricePromotions201ResponseData) *NullablePOSTFixedPricePromotions201ResponseData {
	return &NullablePOSTFixedPricePromotions201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTFixedPricePromotions201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTFixedPricePromotions201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
