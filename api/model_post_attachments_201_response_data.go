...
type POSTAttachments201ResponseData struct {
	...
	Attributes    *POSTAttachmentsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTAttachmentsRequestDataAttributes and assigns it to the Attributes field.
