...
type POSTShippingZones201ResponseData struct {
	...
	Attributes    *POSTShippingZonesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTShippingZonesRequestDataAttributes and assigns it to the Attributes field.
