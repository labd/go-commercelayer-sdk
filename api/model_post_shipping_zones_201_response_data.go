...
// checks if the POSTShippingZones201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTShippingZones201ResponseData{}
...
func (o POSTShippingZones201ResponseData) ToMap() (map[string]interface{}, error) {
