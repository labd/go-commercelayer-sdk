...
// checks if the ShippingZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingZone{}
...
func (o ShippingZone) ToMap() (map[string]interface{}, error) {
