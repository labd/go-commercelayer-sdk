...
// ExternalPromotionUpdateDataAttributes struct for ExternalPromotionUpdateDataAttributes
type ExternalPromotionUpdateDataAttributes struct {
...
func NewExternalPromotionUpdateDataAttributes() *ExternalPromotionUpdateDataAttributes {
	this := ExternalPromotionUpdateDataAttributes{}
	return &this
}
...
func (o ExternalPromotionUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableExternalPromotionUpdateDataAttributes struct {
	value *ExternalPromotionUpdateDataAttributes
	isSet bool
}

func (v NullableExternalPromotionUpdateDataAttributes) Get() *ExternalPromotionUpdateDataAttributes {
	return v.value
}

func (v *NullableExternalPromotionUpdateDataAttributes) Set(val *ExternalPromotionUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalPromotionUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalPromotionUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalPromotionUpdateDataAttributes(val *ExternalPromotionUpdateDataAttributes) *NullableExternalPromotionUpdateDataAttributes {
	return &NullableExternalPromotionUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableExternalPromotionUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalPromotionUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
