...
// GETShippingZones200ResponseDataInner struct for GETShippingZones200ResponseDataInner
type GETShippingZones200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                            `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks             `json:"links,omitempty"`
	Attributes    *GETShippingZones200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETShippingZones200ResponseDataInner() *GETShippingZones200ResponseDataInner {
	this := GETShippingZones200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETShippingZones200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETShippingZones200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETShippingZones200ResponseDataInner struct {
	value *GETShippingZones200ResponseDataInner
	isSet bool
}

func (v NullableGETShippingZones200ResponseDataInner) Get() *GETShippingZones200ResponseDataInner {
	return v.value
}

func (v *NullableGETShippingZones200ResponseDataInner) Set(val *GETShippingZones200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETShippingZones200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETShippingZones200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETShippingZones200ResponseDataInner(val *GETShippingZones200ResponseDataInner) *NullableGETShippingZones200ResponseDataInner {
	return &NullableGETShippingZones200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETShippingZones200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETShippingZones200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
