...
// GETCustomerGroups200ResponseDataInner struct for GETCustomerGroups200ResponseDataInner
type GETCustomerGroups200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                             `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks              `json:"links,omitempty"`
	Attributes    *GETCustomerGroups200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETCustomerGroups200ResponseDataInner() *GETCustomerGroups200ResponseDataInner {
	this := GETCustomerGroups200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETCustomerGroups200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETCustomerGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETCustomerGroups200ResponseDataInner struct {
	value *GETCustomerGroups200ResponseDataInner
	isSet bool
}

func (v NullableGETCustomerGroups200ResponseDataInner) Get() *GETCustomerGroups200ResponseDataInner {
	return v.value
}

func (v *NullableGETCustomerGroups200ResponseDataInner) Set(val *GETCustomerGroups200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomerGroups200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomerGroups200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomerGroups200ResponseDataInner(val *GETCustomerGroups200ResponseDataInner) *NullableGETCustomerGroups200ResponseDataInner {
	return &NullableGETCustomerGroups200ResponseDataInner{value: val, isSet: true}
}
...
func (v *NullableGETCustomerGroups200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
