...
type PATCHStockTransfersStockTransferId200ResponseData struct {
	...
	Attributes    *PATCHStockTransfersStockTransferIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHStockTransfersStockTransferIdRequestDataAttributes and assigns it to the Attributes field.
