...
// checks if the PATCHSkusSkuId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHSkusSkuId200ResponseData{}
...
type PATCHSkusSkuId200ResponseData struct {
	...
	Attributes    *PATCHSkusSkuIdRequestDataAttributes  `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHSkusSkuIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHSkusSkuId200ResponseData) ToMap() (map[string]interface{}, error) {
