...
type POSTShippingCategories201ResponseData struct {
	...
	Attributes    *POSTShippingCategoriesRequestDataAttributes        `json:"attributes,omitempty"`
...
func (o *POSTShippingCategories201ResponseData) GetAttributes() POSTShippingCategoriesRequestDataAttributes {
...
// and a boolean to check if the value has been set.
func (o *POSTShippingCategories201ResponseData) GetAttributesOk() (*POSTShippingCategoriesRequestDataAttributes, bool) {
	if o == nil || IsNil(o.Attributes) {
		return nil, false
	}
...
// SetAttributes gets a reference to the given POSTShippingCategoriesRequestDataAttributes and assigns it to the Attributes field.
func (o *POSTShippingCategories201ResponseData) SetAttributes(v POSTShippingCategoriesRequestDataAttributes) {
	o.Attributes = &v
}
