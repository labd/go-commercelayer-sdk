...
// checks if the POSTFixedAmountPromotionsRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTFixedAmountPromotionsRequestData{}

// POSTFixedAmountPromotionsRequestData struct for POSTFixedAmountPromotionsRequestData
type POSTFixedAmountPromotionsRequestData struct {
	// The resource's type
	Type          interface{}                                     `json:"type"`
	Attributes    POSTFixedAmountPromotionsRequestDataAttributes  `json:"attributes"`
...
func NewPOSTFixedAmountPromotionsRequestData(type_ interface{}, attributes POSTFixedAmountPromotionsRequestDataAttributes) *POSTFixedAmountPromotionsRequestData {
	this := POSTFixedAmountPromotionsRequestData{}
	this.Type = type_
...
func (o *POSTFixedAmountPromotionsRequestData) GetAttributes() POSTFixedAmountPromotionsRequestDataAttributes {
	if o == nil {
		var ret POSTFixedAmountPromotionsRequestDataAttributes
		return ret
	}
...
func (o POSTFixedAmountPromotionsRequestData) MarshalJSON() ([]byte, error) {
...
func (o POSTFixedAmountPromotionsRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTFixedAmountPromotionsRequestData struct {
	value *POSTFixedAmountPromotionsRequestData
	isSet bool
}

func (v NullablePOSTFixedAmountPromotionsRequestData) Get() *POSTFixedAmountPromotionsRequestData {
	return v.value
}

func (v *NullablePOSTFixedAmountPromotionsRequestData) Set(val *POSTFixedAmountPromotionsRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTFixedAmountPromotionsRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTFixedAmountPromotionsRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTFixedAmountPromotionsRequestData(val *POSTFixedAmountPromotionsRequestData) *NullablePOSTFixedAmountPromotionsRequestData {
	return &NullablePOSTFixedAmountPromotionsRequestData{value: val, isSet: true}
}

func (v NullablePOSTFixedAmountPromotionsRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTFixedAmountPromotionsRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
