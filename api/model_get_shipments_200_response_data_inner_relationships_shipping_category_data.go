...
func (o *GETShipments200ResponseDataInnerRelationshipsShippingCategoryData) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *GETShipments200ResponseDataInnerRelationshipsShippingCategoryData) GetTypeOk() (*interface{}, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GETShipments200ResponseDataInnerRelationshipsShippingCategoryData) SetType(v interface{}) {
	o.Type = v
}

// GetId returns the Id field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GETShipments200ResponseDataInnerRelationshipsShippingCategoryData) GetId() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GETShipments200ResponseDataInnerRelationshipsShippingCategoryData) GetIdOk() (*interface{}, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *GETShipments200ResponseDataInnerRelationshipsShippingCategoryData) SetId(v interface{}) {
	o.Id = v
}
