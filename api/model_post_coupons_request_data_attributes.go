...
// checks if the POSTCouponsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTCouponsRequestDataAttributes{}

// POSTCouponsRequestDataAttributes struct for POSTCouponsRequestDataAttributes
type POSTCouponsRequestDataAttributes struct {
...
func NewPOSTCouponsRequestDataAttributes(code interface{}, usageLimit interface{}) *POSTCouponsRequestDataAttributes {
	this := POSTCouponsRequestDataAttributes{}
	this.Code = code
...
func (o POSTCouponsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTCouponsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTCouponsRequestDataAttributes struct {
	value *POSTCouponsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTCouponsRequestDataAttributes) Get() *POSTCouponsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTCouponsRequestDataAttributes) Set(val *POSTCouponsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTCouponsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTCouponsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTCouponsRequestDataAttributes(val *POSTCouponsRequestDataAttributes) *NullablePOSTCouponsRequestDataAttributes {
	return &NullablePOSTCouponsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTCouponsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTCouponsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
