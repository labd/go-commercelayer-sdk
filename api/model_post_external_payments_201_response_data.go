...
// checks if the POSTExternalPayments201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTExternalPayments201ResponseData{}
...
type POSTExternalPayments201ResponseData struct {
	...
	Attributes    *POSTExternalPaymentsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTExternalPaymentsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTExternalPayments201ResponseData) ToMap() (map[string]interface{}, error) {
