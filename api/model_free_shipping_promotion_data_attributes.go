...
// FreeShippingPromotionDataAttributes struct for FreeShippingPromotionDataAttributes
type FreeShippingPromotionDataAttributes struct {
...
func NewFreeShippingPromotionDataAttributes() *FreeShippingPromotionDataAttributes {
	this := FreeShippingPromotionDataAttributes{}
	return &this
}
...
func (o FreeShippingPromotionDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableFreeShippingPromotionDataAttributes struct {
	value *FreeShippingPromotionDataAttributes
	isSet bool
}

func (v NullableFreeShippingPromotionDataAttributes) Get() *FreeShippingPromotionDataAttributes {
	return v.value
}

func (v *NullableFreeShippingPromotionDataAttributes) Set(val *FreeShippingPromotionDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableFreeShippingPromotionDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableFreeShippingPromotionDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFreeShippingPromotionDataAttributes(val *FreeShippingPromotionDataAttributes) *NullableFreeShippingPromotionDataAttributes {
	return &NullableFreeShippingPromotionDataAttributes{value: val, isSet: true}
}

func (v NullableFreeShippingPromotionDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFreeShippingPromotionDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
