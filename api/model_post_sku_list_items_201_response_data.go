...
type POSTSkuListItems201ResponseData struct {
	...
	Attributes    *POSTSkuListItemsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTSkuListItemsRequestDataAttributes and assigns it to the Attributes field.
