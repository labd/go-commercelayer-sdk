...
// checks if the GETFlexPromotionsFlexPromotionId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETFlexPromotionsFlexPromotionId200ResponseData{}

// GETFlexPromotionsFlexPromotionId200ResponseData struct for GETFlexPromotionsFlexPromotionId200ResponseData
type GETFlexPromotionsFlexPromotionId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                         `json:"links,omitempty"`
	Attributes    *GETFlexPromotionsFlexPromotionId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETFlexPromotionsFlexPromotionId200ResponseData() *GETFlexPromotionsFlexPromotionId200ResponseData {
	this := GETFlexPromotionsFlexPromotionId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETFlexPromotionsFlexPromotionId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETFlexPromotionsFlexPromotionId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETFlexPromotionsFlexPromotionId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETFlexPromotionsFlexPromotionId200ResponseData struct {
	value *GETFlexPromotionsFlexPromotionId200ResponseData
	isSet bool
}

func (v NullableGETFlexPromotionsFlexPromotionId200ResponseData) Get() *GETFlexPromotionsFlexPromotionId200ResponseData {
	return v.value
}

func (v *NullableGETFlexPromotionsFlexPromotionId200ResponseData) Set(val *GETFlexPromotionsFlexPromotionId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETFlexPromotionsFlexPromotionId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETFlexPromotionsFlexPromotionId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETFlexPromotionsFlexPromotionId200ResponseData(val *GETFlexPromotionsFlexPromotionId200ResponseData) *NullableGETFlexPromotionsFlexPromotionId200ResponseData {
	return &NullableGETFlexPromotionsFlexPromotionId200ResponseData{value: val, isSet: true}
}

func (v NullableGETFlexPromotionsFlexPromotionId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETFlexPromotionsFlexPromotionId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
