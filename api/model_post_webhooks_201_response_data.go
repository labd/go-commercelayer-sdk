...
type POSTWebhooks201ResponseData struct {
	...
	Attributes    *POSTWebhooksRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTWebhooksRequestDataAttributes and assigns it to the Attributes field.
