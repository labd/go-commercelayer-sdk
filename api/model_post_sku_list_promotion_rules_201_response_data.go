...
type POSTSkuListPromotionRules201ResponseData struct {
	...
	Attributes    *POSTSkuListPromotionRulesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTSkuListPromotionRulesRequestDataAttributes and assigns it to the Attributes field.
