...
// checks if the POSTSatispayPaymentsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTSatispayPaymentsRequestDataAttributes{}

// POSTSatispayPaymentsRequestDataAttributes struct for POSTSatispayPaymentsRequestDataAttributes
type POSTSatispayPaymentsRequestDataAttributes struct {
...
func NewPOSTSatispayPaymentsRequestDataAttributes() *POSTSatispayPaymentsRequestDataAttributes {
	this := POSTSatispayPaymentsRequestDataAttributes{}
	return &this
}
...
func (o POSTSatispayPaymentsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTSatispayPaymentsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTSatispayPaymentsRequestDataAttributes struct {
	value *POSTSatispayPaymentsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTSatispayPaymentsRequestDataAttributes) Get() *POSTSatispayPaymentsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTSatispayPaymentsRequestDataAttributes) Set(val *POSTSatispayPaymentsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTSatispayPaymentsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTSatispayPaymentsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTSatispayPaymentsRequestDataAttributes(val *POSTSatispayPaymentsRequestDataAttributes) *NullablePOSTSatispayPaymentsRequestDataAttributes {
	return &NullablePOSTSatispayPaymentsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTSatispayPaymentsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTSatispayPaymentsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
