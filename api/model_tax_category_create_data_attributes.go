...
// TaxCategoryCreateDataAttributes struct for TaxCategoryCreateDataAttributes
type TaxCategoryCreateDataAttributes struct {
...
func NewTaxCategoryCreateDataAttributes(code string) *TaxCategoryCreateDataAttributes {
	this := TaxCategoryCreateDataAttributes{}
	this.Code = code
	return &this
}
...
func (o TaxCategoryCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableTaxCategoryCreateDataAttributes struct {
	value *TaxCategoryCreateDataAttributes
	isSet bool
}

func (v NullableTaxCategoryCreateDataAttributes) Get() *TaxCategoryCreateDataAttributes {
	return v.value
}

func (v *NullableTaxCategoryCreateDataAttributes) Set(val *TaxCategoryCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxCategoryCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxCategoryCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxCategoryCreateDataAttributes(val *TaxCategoryCreateDataAttributes) *NullableTaxCategoryCreateDataAttributes {
	return &NullableTaxCategoryCreateDataAttributes{value: val, isSet: true}
}

func (v NullableTaxCategoryCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxCategoryCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
