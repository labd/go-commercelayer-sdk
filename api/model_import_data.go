...
// checks if the ImportData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportData{}
...
func (o ImportData) ToMap() (map[string]interface{}, error) {
