...
// checks if the GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData{}

// GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData struct for GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData
type GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData struct {
	// The resource's id
...
func NewGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData() *GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData {
	this := GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData{}
	return &this
}
...
func (o GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData struct {
	value *GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData
	isSet bool
}

func (v NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) Get() *GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData {
	return v.value
}

func (v *NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) Set(val *GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData(val *GETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) *NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData {
	return &NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData{value: val, isSet: true}
}

func (v NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCouponCodesPromotionRulesCouponCodesPromotionRuleId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
