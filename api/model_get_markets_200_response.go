...
// checks if the GETMarkets200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETMarkets200Response{}
...
func (o GETMarkets200Response) ToMap() (map[string]interface{}, error) {
