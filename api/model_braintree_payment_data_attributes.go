...
// BraintreePaymentDataAttributes struct for BraintreePaymentDataAttributes
type BraintreePaymentDataAttributes struct {
...
func NewBraintreePaymentDataAttributes() *BraintreePaymentDataAttributes {
	this := BraintreePaymentDataAttributes{}
	return &this
}
...
func (o BraintreePaymentDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableBraintreePaymentDataAttributes struct {
	value *BraintreePaymentDataAttributes
	isSet bool
}

func (v NullableBraintreePaymentDataAttributes) Get() *BraintreePaymentDataAttributes {
	return v.value
}

func (v *NullableBraintreePaymentDataAttributes) Set(val *BraintreePaymentDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableBraintreePaymentDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableBraintreePaymentDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBraintreePaymentDataAttributes(val *BraintreePaymentDataAttributes) *NullableBraintreePaymentDataAttributes {
	return &NullableBraintreePaymentDataAttributes{value: val, isSet: true}
}

func (v NullableBraintreePaymentDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBraintreePaymentDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
