...
// BundleResponseData struct for BundleResponseData
type BundleResponseData struct {
	// The resource's id
	...
	Relationships *BundleResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *BundleResponseData) GetRelationships() BundleResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret BundleResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given BundleResponseDataRelationships and assigns it to the Relationships field.
func (o *BundleResponseData) SetRelationships(v BundleResponseDataRelationships) {
	o.Relationships = &v
}

func (o BundleResponseData) MarshalJSON() ([]byte, error) {
...
type NullableBundleResponseData struct {
	value *BundleResponseData
	isSet bool
}

func (v NullableBundleResponseData) Get() *BundleResponseData {
	return v.value
}

func (v *NullableBundleResponseData) Set(val *BundleResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableBundleResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableBundleResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBundleResponseData(val *BundleResponseData) *NullableBundleResponseData {
	return &NullableBundleResponseData{value: val, isSet: true}
}

func (v NullableBundleResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBundleResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
