...
// AdyenGatewayCreateDataAttributes struct for AdyenGatewayCreateDataAttributes
type AdyenGatewayCreateDataAttributes struct {
...
func NewAdyenGatewayCreateDataAttributes(name string, merchantAccount string, apiKey string, liveUrlPrefix string) *AdyenGatewayCreateDataAttributes {
	this := AdyenGatewayCreateDataAttributes{}
	this.Name = name
...
func (o AdyenGatewayCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableAdyenGatewayCreateDataAttributes struct {
	value *AdyenGatewayCreateDataAttributes
	isSet bool
}

func (v NullableAdyenGatewayCreateDataAttributes) Get() *AdyenGatewayCreateDataAttributes {
	return v.value
}

func (v *NullableAdyenGatewayCreateDataAttributes) Set(val *AdyenGatewayCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableAdyenGatewayCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableAdyenGatewayCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdyenGatewayCreateDataAttributes(val *AdyenGatewayCreateDataAttributes) *NullableAdyenGatewayCreateDataAttributes {
	return &NullableAdyenGatewayCreateDataAttributes{value: val, isSet: true}
}

func (v NullableAdyenGatewayCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdyenGatewayCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
