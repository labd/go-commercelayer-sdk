...
type PATCHParcelsParcelId200ResponseData struct {
	...
	Attributes    *PATCHParcelsParcelIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHParcelsParcelIdRequestDataAttributes and assigns it to the Attributes field.
