...
// checks if the POSTManualGatewaysRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTManualGatewaysRequestDataAttributes{}

// POSTManualGatewaysRequestDataAttributes struct for POSTManualGatewaysRequestDataAttributes
type POSTManualGatewaysRequestDataAttributes struct {
...
func NewPOSTManualGatewaysRequestDataAttributes(name interface{}) *POSTManualGatewaysRequestDataAttributes {
	this := POSTManualGatewaysRequestDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTManualGatewaysRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTManualGatewaysRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTManualGatewaysRequestDataAttributes struct {
	value *POSTManualGatewaysRequestDataAttributes
	isSet bool
}

func (v NullablePOSTManualGatewaysRequestDataAttributes) Get() *POSTManualGatewaysRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTManualGatewaysRequestDataAttributes) Set(val *POSTManualGatewaysRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTManualGatewaysRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTManualGatewaysRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTManualGatewaysRequestDataAttributes(val *POSTManualGatewaysRequestDataAttributes) *NullablePOSTManualGatewaysRequestDataAttributes {
	return &NullablePOSTManualGatewaysRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTManualGatewaysRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTManualGatewaysRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
