...
// checks if the PATCHStockLineItemsStockLineItemId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHStockLineItemsStockLineItemId200ResponseData{}

// PATCHStockLineItemsStockLineItemId200ResponseData struct for PATCHStockLineItemsStockLineItemId200ResponseData
type PATCHStockLineItemsStockLineItemId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                           `json:"links,omitempty"`
	Attributes    *PATCHStockLineItemsStockLineItemId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewPATCHStockLineItemsStockLineItemId200ResponseData() *PATCHStockLineItemsStockLineItemId200ResponseData {
	this := PATCHStockLineItemsStockLineItemId200ResponseData{}
	return &this
}
...
func (o *PATCHStockLineItemsStockLineItemId200ResponseData) GetAttributes() PATCHStockLineItemsStockLineItemId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret PATCHStockLineItemsStockLineItemId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given PATCHStockLineItemsStockLineItemId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHStockLineItemsStockLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHStockLineItemsStockLineItemId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHStockLineItemsStockLineItemId200ResponseData struct {
	value *PATCHStockLineItemsStockLineItemId200ResponseData
	isSet bool
}

func (v NullablePATCHStockLineItemsStockLineItemId200ResponseData) Get() *PATCHStockLineItemsStockLineItemId200ResponseData {
	return v.value
}

func (v *NullablePATCHStockLineItemsStockLineItemId200ResponseData) Set(val *PATCHStockLineItemsStockLineItemId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHStockLineItemsStockLineItemId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHStockLineItemsStockLineItemId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHStockLineItemsStockLineItemId200ResponseData(val *PATCHStockLineItemsStockLineItemId200ResponseData) *NullablePATCHStockLineItemsStockLineItemId200ResponseData {
	return &NullablePATCHStockLineItemsStockLineItemId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHStockLineItemsStockLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHStockLineItemsStockLineItemId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
