...
// FixedAmountPromotionCreateDataAttributes struct for FixedAmountPromotionCreateDataAttributes
type FixedAmountPromotionCreateDataAttributes struct {
...
func NewFixedAmountPromotionCreateDataAttributes(name string, startsAt string, expiresAt string, totalUsageLimit int32, fixedAmountCents int32) *FixedAmountPromotionCreateDataAttributes {
	this := FixedAmountPromotionCreateDataAttributes{}
	this.Name = name
...
func (o FixedAmountPromotionCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableFixedAmountPromotionCreateDataAttributes struct {
	value *FixedAmountPromotionCreateDataAttributes
	isSet bool
}

func (v NullableFixedAmountPromotionCreateDataAttributes) Get() *FixedAmountPromotionCreateDataAttributes {
	return v.value
}

func (v *NullableFixedAmountPromotionCreateDataAttributes) Set(val *FixedAmountPromotionCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableFixedAmountPromotionCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableFixedAmountPromotionCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFixedAmountPromotionCreateDataAttributes(val *FixedAmountPromotionCreateDataAttributes) *NullableFixedAmountPromotionCreateDataAttributes {
	return &NullableFixedAmountPromotionCreateDataAttributes{value: val, isSet: true}
}

func (v NullableFixedAmountPromotionCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFixedAmountPromotionCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
