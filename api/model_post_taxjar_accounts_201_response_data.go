...
type POSTTaxjarAccounts201ResponseData struct {
	...
	Attributes    *POSTTaxjarAccountsRequestDataAttributes         `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTTaxjarAccountsRequestDataAttributes and assigns it to the Attributes field.
