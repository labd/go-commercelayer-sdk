...
// checks if the GETInventoryModelsInventoryModelId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETInventoryModelsInventoryModelId200ResponseData{}

// GETInventoryModelsInventoryModelId200ResponseData struct for GETInventoryModelsInventoryModelId200ResponseData
type GETInventoryModelsInventoryModelId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                           `json:"links,omitempty"`
	Attributes    *GETInventoryModelsInventoryModelId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETInventoryModelsInventoryModelId200ResponseData() *GETInventoryModelsInventoryModelId200ResponseData {
	this := GETInventoryModelsInventoryModelId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETInventoryModelsInventoryModelId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETInventoryModelsInventoryModelId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETInventoryModelsInventoryModelId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETInventoryModelsInventoryModelId200ResponseData struct {
	value *GETInventoryModelsInventoryModelId200ResponseData
	isSet bool
}

func (v NullableGETInventoryModelsInventoryModelId200ResponseData) Get() *GETInventoryModelsInventoryModelId200ResponseData {
	return v.value
}

func (v *NullableGETInventoryModelsInventoryModelId200ResponseData) Set(val *GETInventoryModelsInventoryModelId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETInventoryModelsInventoryModelId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETInventoryModelsInventoryModelId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETInventoryModelsInventoryModelId200ResponseData(val *GETInventoryModelsInventoryModelId200ResponseData) *NullableGETInventoryModelsInventoryModelId200ResponseData {
	return &NullableGETInventoryModelsInventoryModelId200ResponseData{value: val, isSet: true}
}

func (v NullableGETInventoryModelsInventoryModelId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETInventoryModelsInventoryModelId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
