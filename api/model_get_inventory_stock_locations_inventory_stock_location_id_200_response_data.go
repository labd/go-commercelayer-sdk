...
// checks if the GETInventoryStockLocationsInventoryStockLocationId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETInventoryStockLocationsInventoryStockLocationId200ResponseData{}

// GETInventoryStockLocationsInventoryStockLocationId200ResponseData struct for GETInventoryStockLocationsInventoryStockLocationId200ResponseData
type GETInventoryStockLocationsInventoryStockLocationId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                           `json:"links,omitempty"`
	Attributes    *GETInventoryStockLocationsInventoryStockLocationId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETInventoryStockLocationsInventoryStockLocationId200ResponseData() *GETInventoryStockLocationsInventoryStockLocationId200ResponseData {
	this := GETInventoryStockLocationsInventoryStockLocationId200ResponseData{}
	return &this
}
...
func (o *GETInventoryStockLocationsInventoryStockLocationId200ResponseData) GetAttributes() GETInventoryStockLocationsInventoryStockLocationId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret GETInventoryStockLocationsInventoryStockLocationId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GETInventoryStockLocationsInventoryStockLocationId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETInventoryStockLocationsInventoryStockLocationId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETInventoryStockLocationsInventoryStockLocationId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData struct {
	value *GETInventoryStockLocationsInventoryStockLocationId200ResponseData
	isSet bool
}

func (v NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData) Get() *GETInventoryStockLocationsInventoryStockLocationId200ResponseData {
	return v.value
}

func (v *NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData) Set(val *GETInventoryStockLocationsInventoryStockLocationId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData(val *GETInventoryStockLocationsInventoryStockLocationId200ResponseData) *NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData {
	return &NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData{value: val, isSet: true}
}

func (v NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETInventoryStockLocationsInventoryStockLocationId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
