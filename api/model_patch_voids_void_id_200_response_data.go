...
// checks if the PATCHVoidsVoidId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHVoidsVoidId200ResponseData{}

// PATCHVoidsVoidId200ResponseData struct for PATCHVoidsVoidId200ResponseData
type PATCHVoidsVoidId200ResponseData struct {
	// The resource's id
...
func NewPATCHVoidsVoidId200ResponseData() *PATCHVoidsVoidId200ResponseData {
	this := PATCHVoidsVoidId200ResponseData{}
	return &this
}
...
func (o PATCHVoidsVoidId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHVoidsVoidId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHVoidsVoidId200ResponseData struct {
	value *PATCHVoidsVoidId200ResponseData
	isSet bool
}

func (v NullablePATCHVoidsVoidId200ResponseData) Get() *PATCHVoidsVoidId200ResponseData {
	return v.value
}

func (v *NullablePATCHVoidsVoidId200ResponseData) Set(val *PATCHVoidsVoidId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHVoidsVoidId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHVoidsVoidId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHVoidsVoidId200ResponseData(val *PATCHVoidsVoidId200ResponseData) *NullablePATCHVoidsVoidId200ResponseData {
	return &NullablePATCHVoidsVoidId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHVoidsVoidId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHVoidsVoidId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
