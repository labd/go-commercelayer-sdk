...
// GETAvalaraAccounts200ResponseDataInner struct for GETAvalaraAccounts200ResponseDataInner
type GETAvalaraAccounts200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                              `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks               `json:"links,omitempty"`
	Attributes    *GETAvalaraAccounts200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETAvalaraAccounts200ResponseDataInner() *GETAvalaraAccounts200ResponseDataInner {
	this := GETAvalaraAccounts200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETAvalaraAccounts200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETAvalaraAccounts200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETAvalaraAccounts200ResponseDataInner struct {
	value *GETAvalaraAccounts200ResponseDataInner
	isSet bool
}

func (v NullableGETAvalaraAccounts200ResponseDataInner) Get() *GETAvalaraAccounts200ResponseDataInner {
	return v.value
}

func (v *NullableGETAvalaraAccounts200ResponseDataInner) Set(val *GETAvalaraAccounts200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAvalaraAccounts200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAvalaraAccounts200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAvalaraAccounts200ResponseDataInner(val *GETAvalaraAccounts200ResponseDataInner) *NullableGETAvalaraAccounts200ResponseDataInner {
	return &NullableGETAvalaraAccounts200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETAvalaraAccounts200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAvalaraAccounts200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
