...
// ManualTaxCalculatorResponseData struct for ManualTaxCalculatorResponseData
type ManualTaxCalculatorResponseData struct {
	// The resource's id
	...
	Relationships *ManualTaxCalculatorResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewManualTaxCalculatorResponseData() *ManualTaxCalculatorResponseData {
	this := ManualTaxCalculatorResponseData{}
	return &this
}
...
func (o *ManualTaxCalculatorResponseData) GetRelationships() ManualTaxCalculatorResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ManualTaxCalculatorResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ManualTaxCalculatorResponseDataRelationships and assigns it to the Relationships field.
func (o *ManualTaxCalculatorResponseData) SetRelationships(v ManualTaxCalculatorResponseDataRelationships) {
	o.Relationships = &v
}

func (o ManualTaxCalculatorResponseData) MarshalJSON() ([]byte, error) {
...
type NullableManualTaxCalculatorResponseData struct {
	value *ManualTaxCalculatorResponseData
	isSet bool
}

func (v NullableManualTaxCalculatorResponseData) Get() *ManualTaxCalculatorResponseData {
	return v.value
}

func (v *NullableManualTaxCalculatorResponseData) Set(val *ManualTaxCalculatorResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableManualTaxCalculatorResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableManualTaxCalculatorResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualTaxCalculatorResponseData(val *ManualTaxCalculatorResponseData) *NullableManualTaxCalculatorResponseData {
	return &NullableManualTaxCalculatorResponseData{value: val, isSet: true}
}

func (v NullableManualTaxCalculatorResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualTaxCalculatorResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
