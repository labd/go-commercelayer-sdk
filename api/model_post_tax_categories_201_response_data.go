...
// checks if the POSTTaxCategories201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTTaxCategories201ResponseData{}

// POSTTaxCategories201ResponseData struct for POSTTaxCategories201ResponseData
type POSTTaxCategories201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks             `json:"links,omitempty"`
	Attributes    *POSTTaxCategoriesRequestDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTTaxCategories201ResponseData() *POSTTaxCategories201ResponseData {
	this := POSTTaxCategories201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTTaxCategoriesRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTTaxCategories201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTTaxCategories201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTTaxCategories201ResponseData struct {
	value *POSTTaxCategories201ResponseData
	isSet bool
}

func (v NullablePOSTTaxCategories201ResponseData) Get() *POSTTaxCategories201ResponseData {
	return v.value
}

func (v *NullablePOSTTaxCategories201ResponseData) Set(val *POSTTaxCategories201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTTaxCategories201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTTaxCategories201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTTaxCategories201ResponseData(val *POSTTaxCategories201ResponseData) *NullablePOSTTaxCategories201ResponseData {
	return &NullablePOSTTaxCategories201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTTaxCategories201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTTaxCategories201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
