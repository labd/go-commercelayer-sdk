...
// GETOrderAmountPromotionRules200ResponseDataInner struct for GETOrderAmountPromotionRules200ResponseDataInner
type GETOrderAmountPromotionRules200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                    `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                         `json:"links,omitempty"`
	Attributes    *GETOrderAmountPromotionRules200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETOrderAmountPromotionRules200ResponseDataInner() *GETOrderAmountPromotionRules200ResponseDataInner {
	this := GETOrderAmountPromotionRules200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETOrderAmountPromotionRules200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETOrderAmountPromotionRules200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETOrderAmountPromotionRules200ResponseDataInner struct {
	value *GETOrderAmountPromotionRules200ResponseDataInner
	isSet bool
}

func (v NullableGETOrderAmountPromotionRules200ResponseDataInner) Get() *GETOrderAmountPromotionRules200ResponseDataInner {
	return v.value
}

func (v *NullableGETOrderAmountPromotionRules200ResponseDataInner) Set(val *GETOrderAmountPromotionRules200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETOrderAmountPromotionRules200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETOrderAmountPromotionRules200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETOrderAmountPromotionRules200ResponseDataInner(val *GETOrderAmountPromotionRules200ResponseDataInner) *NullableGETOrderAmountPromotionRules200ResponseDataInner {
	return &NullableGETOrderAmountPromotionRules200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETOrderAmountPromotionRules200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETOrderAmountPromotionRules200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
