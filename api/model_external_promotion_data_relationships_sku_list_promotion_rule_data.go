...
func NewExternalPromotionDataRelationshipsSkuListPromotionRuleData() *ExternalPromotionDataRelationshipsSkuListPromotionRuleData {
	this := ExternalPromotionDataRelationshipsSkuListPromotionRuleData{}
	return &this
}
...
func (v NullableExternalPromotionDataRelationshipsSkuListPromotionRuleData) Get() *ExternalPromotionDataRelationshipsSkuListPromotionRuleData {
	return v.value
}

func (v *NullableExternalPromotionDataRelationshipsSkuListPromotionRuleData) Set(val *ExternalPromotionDataRelationshipsSkuListPromotionRuleData) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalPromotionDataRelationshipsSkuListPromotionRuleData) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalPromotionDataRelationshipsSkuListPromotionRuleData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalPromotionDataRelationshipsSkuListPromotionRuleData(val *ExternalPromotionDataRelationshipsSkuListPromotionRuleData) *NullableExternalPromotionDataRelationshipsSkuListPromotionRuleData {
	return &NullableExternalPromotionDataRelationshipsSkuListPromotionRuleData{value: val, isSet: true}
}

func (v NullableExternalPromotionDataRelationshipsSkuListPromotionRuleData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalPromotionDataRelationshipsSkuListPromotionRuleData) UnmarshalJSON(src []byte) error {
	v.isSet = true
