...
type PATCHMerchantsMerchantId200ResponseData struct {
	...
	Attributes    *PATCHMerchantsMerchantIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHMerchantsMerchantIdRequestDataAttributes and assigns it to the Attributes field.
