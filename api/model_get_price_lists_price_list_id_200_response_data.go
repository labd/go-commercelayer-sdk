...
// checks if the GETPriceListsPriceListId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPriceListsPriceListId200ResponseData{}

// GETPriceListsPriceListId200ResponseData struct for GETPriceListsPriceListId200ResponseData
type GETPriceListsPriceListId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                        `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                 `json:"links,omitempty"`
	Attributes    *GETPriceListsPriceListId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETPriceListsPriceListId200ResponseData() *GETPriceListsPriceListId200ResponseData {
	this := GETPriceListsPriceListId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETPriceListsPriceListId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETPriceListsPriceListId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETPriceListsPriceListId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETPriceListsPriceListId200ResponseData struct {
	value *GETPriceListsPriceListId200ResponseData
	isSet bool
}

func (v NullableGETPriceListsPriceListId200ResponseData) Get() *GETPriceListsPriceListId200ResponseData {
	return v.value
}

func (v *NullableGETPriceListsPriceListId200ResponseData) Set(val *GETPriceListsPriceListId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPriceListsPriceListId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPriceListsPriceListId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPriceListsPriceListId200ResponseData(val *GETPriceListsPriceListId200ResponseData) *NullableGETPriceListsPriceListId200ResponseData {
	return &NullableGETPriceListsPriceListId200ResponseData{value: val, isSet: true}
}

func (v NullableGETPriceListsPriceListId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPriceListsPriceListId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
