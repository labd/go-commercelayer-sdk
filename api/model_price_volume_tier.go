...
// checks if the PriceVolumeTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceVolumeTier{}

// PriceVolumeTier struct for PriceVolumeTier
type PriceVolumeTier struct {
	Data *PriceVolumeTierData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given PriceVolumeTierData and assigns it to the Data field.
...
func (o PriceVolumeTier) ToMap() (map[string]interface{}, error) {
