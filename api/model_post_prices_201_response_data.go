...
type POSTPrices201ResponseData struct {
	...
	Attributes    *POSTPricesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTPricesRequestDataAttributes and assigns it to the Attributes field.
