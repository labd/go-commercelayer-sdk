...
// checks if the POSTAvalaraAccountsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTAvalaraAccountsRequestDataAttributes{}

// POSTAvalaraAccountsRequestDataAttributes struct for POSTAvalaraAccountsRequestDataAttributes
type POSTAvalaraAccountsRequestDataAttributes struct {
...
func NewPOSTAvalaraAccountsRequestDataAttributes(name interface{}, username interface{}, password interface{}, companyCode interface{}) *POSTAvalaraAccountsRequestDataAttributes {
	this := POSTAvalaraAccountsRequestDataAttributes{}
	this.Name = name
...
func (o POSTAvalaraAccountsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTAvalaraAccountsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTAvalaraAccountsRequestDataAttributes struct {
	value *POSTAvalaraAccountsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTAvalaraAccountsRequestDataAttributes) Get() *POSTAvalaraAccountsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTAvalaraAccountsRequestDataAttributes) Set(val *POSTAvalaraAccountsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTAvalaraAccountsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTAvalaraAccountsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTAvalaraAccountsRequestDataAttributes(val *POSTAvalaraAccountsRequestDataAttributes) *NullablePOSTAvalaraAccountsRequestDataAttributes {
	return &NullablePOSTAvalaraAccountsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTAvalaraAccountsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTAvalaraAccountsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
