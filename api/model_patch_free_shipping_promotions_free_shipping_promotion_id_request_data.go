...
// checks if the PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData{}

// PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData struct for PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData
type PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                                             `json:"id"`
	Attributes    PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestDataAttributes `json:"attributes"`
...
func NewPATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData(type_ interface{}, id interface{}, attributes PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestDataAttributes) *PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData {
	this := PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData struct {
	value *PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData
	isSet bool
}

func (v NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) Get() *PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData {
	return v.value
}

func (v *NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) Set(val *PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData(val *PATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) *NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData {
	return &NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHFreeShippingPromotionsFreeShippingPromotionIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
