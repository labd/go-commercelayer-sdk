...
// checks if the GETExternalGatewaysExternalGatewayId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETExternalGatewaysExternalGatewayId200ResponseData{}

// GETExternalGatewaysExternalGatewayId200ResponseData struct for GETExternalGatewaysExternalGatewayId200ResponseData
type GETExternalGatewaysExternalGatewayId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                             `json:"links,omitempty"`
	Attributes    *GETExternalGatewaysExternalGatewayId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETExternalGatewaysExternalGatewayId200ResponseData() *GETExternalGatewaysExternalGatewayId200ResponseData {
	this := GETExternalGatewaysExternalGatewayId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETExternalGatewaysExternalGatewayId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETExternalGatewaysExternalGatewayId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETExternalGatewaysExternalGatewayId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETExternalGatewaysExternalGatewayId200ResponseData struct {
	value *GETExternalGatewaysExternalGatewayId200ResponseData
	isSet bool
}

func (v NullableGETExternalGatewaysExternalGatewayId200ResponseData) Get() *GETExternalGatewaysExternalGatewayId200ResponseData {
	return v.value
}

func (v *NullableGETExternalGatewaysExternalGatewayId200ResponseData) Set(val *GETExternalGatewaysExternalGatewayId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETExternalGatewaysExternalGatewayId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETExternalGatewaysExternalGatewayId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETExternalGatewaysExternalGatewayId200ResponseData(val *GETExternalGatewaysExternalGatewayId200ResponseData) *NullableGETExternalGatewaysExternalGatewayId200ResponseData {
	return &NullableGETExternalGatewaysExternalGatewayId200ResponseData{value: val, isSet: true}
}

func (v NullableGETExternalGatewaysExternalGatewayId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETExternalGatewaysExternalGatewayId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
