...
// checks if the POSTStockLocationsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTStockLocationsRequestDataAttributes{}

// POSTStockLocationsRequestDataAttributes struct for POSTStockLocationsRequestDataAttributes
type POSTStockLocationsRequestDataAttributes struct {
...
func NewPOSTStockLocationsRequestDataAttributes(name interface{}) *POSTStockLocationsRequestDataAttributes {
	this := POSTStockLocationsRequestDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTStockLocationsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTStockLocationsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTStockLocationsRequestDataAttributes struct {
	value *POSTStockLocationsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTStockLocationsRequestDataAttributes) Get() *POSTStockLocationsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTStockLocationsRequestDataAttributes) Set(val *POSTStockLocationsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTStockLocationsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTStockLocationsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTStockLocationsRequestDataAttributes(val *POSTStockLocationsRequestDataAttributes) *NullablePOSTStockLocationsRequestDataAttributes {
	return &NullablePOSTStockLocationsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTStockLocationsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTStockLocationsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
