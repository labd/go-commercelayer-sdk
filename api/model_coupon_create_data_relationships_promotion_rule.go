...
// checks if the CouponCreateDataRelationshipsPromotionRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponCreateDataRelationshipsPromotionRule{}
...
func (o CouponCreateDataRelationshipsPromotionRule) ToMap() (map[string]interface{}, error) {
