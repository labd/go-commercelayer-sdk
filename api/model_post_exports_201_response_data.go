...
// checks if the POSTExports201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTExports201ResponseData{}

// POSTExports201ResponseData struct for POSTExports201ResponseData
type POSTExports201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                              `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks       `json:"links,omitempty"`
	Attributes    *POSTExports201ResponseDataAttributes    `json:"attributes,omitempty"`
...
func NewPOSTExports201ResponseData() *POSTExports201ResponseData {
	this := POSTExports201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTExports201ResponseDataAttributes and assigns it to the Attributes field.
...
func (o POSTExports201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTExports201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTExports201ResponseData struct {
	value *POSTExports201ResponseData
	isSet bool
}

func (v NullablePOSTExports201ResponseData) Get() *POSTExports201ResponseData {
	return v.value
}

func (v *NullablePOSTExports201ResponseData) Set(val *POSTExports201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTExports201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTExports201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTExports201ResponseData(val *POSTExports201ResponseData) *NullablePOSTExports201ResponseData {
	return &NullablePOSTExports201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTExports201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTExports201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
