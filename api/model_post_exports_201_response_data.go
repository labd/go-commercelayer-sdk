...
type POSTExports201ResponseData struct {
	...
	Attributes    *POSTExportsRequestDataAttributes         `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTExportsRequestDataAttributes and assigns it to the Attributes field.
