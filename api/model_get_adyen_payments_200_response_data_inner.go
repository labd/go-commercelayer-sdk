...
// GETAdyenPayments200ResponseDataInner struct for GETAdyenPayments200ResponseDataInner
type GETAdyenPayments200ResponseDataInner struct {
	// The resource's id
...
// SetAttributes gets a reference to the given GETAdyenPayments200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETAdyenPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETAdyenPayments200ResponseDataInner struct {
	value *GETAdyenPayments200ResponseDataInner
	isSet bool
}

func (v NullableGETAdyenPayments200ResponseDataInner) Get() *GETAdyenPayments200ResponseDataInner {
	return v.value
}

func (v *NullableGETAdyenPayments200ResponseDataInner) Set(val *GETAdyenPayments200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAdyenPayments200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAdyenPayments200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAdyenPayments200ResponseDataInner(val *GETAdyenPayments200ResponseDataInner) *NullableGETAdyenPayments200ResponseDataInner {
	return &NullableGETAdyenPayments200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETAdyenPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAdyenPayments200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
