...
// checks if the GETBraintreePaymentsBraintreePaymentId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETBraintreePaymentsBraintreePaymentId200ResponseData{}

// GETBraintreePaymentsBraintreePaymentId200ResponseData struct for GETBraintreePaymentsBraintreePaymentId200ResponseData
type GETBraintreePaymentsBraintreePaymentId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                      `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                               `json:"links,omitempty"`
	Attributes    *GETBraintreePaymentsBraintreePaymentId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETBraintreePaymentsBraintreePaymentId200ResponseData() *GETBraintreePaymentsBraintreePaymentId200ResponseData {
	this := GETBraintreePaymentsBraintreePaymentId200ResponseData{}
	return &this
}
...
func (o *GETBraintreePaymentsBraintreePaymentId200ResponseData) GetAttributes() GETBraintreePaymentsBraintreePaymentId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret GETBraintreePaymentsBraintreePaymentId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GETBraintreePaymentsBraintreePaymentId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETBraintreePaymentsBraintreePaymentId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETBraintreePaymentsBraintreePaymentId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETBraintreePaymentsBraintreePaymentId200ResponseData struct {
	value *GETBraintreePaymentsBraintreePaymentId200ResponseData
	isSet bool
}

func (v NullableGETBraintreePaymentsBraintreePaymentId200ResponseData) Get() *GETBraintreePaymentsBraintreePaymentId200ResponseData {
	return v.value
}

func (v *NullableGETBraintreePaymentsBraintreePaymentId200ResponseData) Set(val *GETBraintreePaymentsBraintreePaymentId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBraintreePaymentsBraintreePaymentId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBraintreePaymentsBraintreePaymentId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBraintreePaymentsBraintreePaymentId200ResponseData(val *GETBraintreePaymentsBraintreePaymentId200ResponseData) *NullableGETBraintreePaymentsBraintreePaymentId200ResponseData {
	return &NullableGETBraintreePaymentsBraintreePaymentId200ResponseData{value: val, isSet: true}
}

func (v NullableGETBraintreePaymentsBraintreePaymentId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBraintreePaymentsBraintreePaymentId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
