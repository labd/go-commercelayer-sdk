...
// ManualTaxCalculatorDataAttributes struct for ManualTaxCalculatorDataAttributes
type ManualTaxCalculatorDataAttributes struct {
...
func NewManualTaxCalculatorDataAttributes() *ManualTaxCalculatorDataAttributes {
	this := ManualTaxCalculatorDataAttributes{}
	return &this
}
...
func (o ManualTaxCalculatorDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableManualTaxCalculatorDataAttributes struct {
	value *ManualTaxCalculatorDataAttributes
	isSet bool
}

func (v NullableManualTaxCalculatorDataAttributes) Get() *ManualTaxCalculatorDataAttributes {
	return v.value
}

func (v *NullableManualTaxCalculatorDataAttributes) Set(val *ManualTaxCalculatorDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableManualTaxCalculatorDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableManualTaxCalculatorDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualTaxCalculatorDataAttributes(val *ManualTaxCalculatorDataAttributes) *NullableManualTaxCalculatorDataAttributes {
	return &NullableManualTaxCalculatorDataAttributes{value: val, isSet: true}
}

func (v NullableManualTaxCalculatorDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualTaxCalculatorDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
