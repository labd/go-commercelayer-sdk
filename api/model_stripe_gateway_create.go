...
// checks if the StripeGatewayCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StripeGatewayCreate{}
...
func (o StripeGatewayCreate) ToMap() (map[string]interface{}, error) {
