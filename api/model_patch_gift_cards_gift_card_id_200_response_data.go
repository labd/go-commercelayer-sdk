...
// checks if the PATCHGiftCardsGiftCardId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHGiftCardsGiftCardId200ResponseData{}

// PATCHGiftCardsGiftCardId200ResponseData struct for PATCHGiftCardsGiftCardId200ResponseData
type PATCHGiftCardsGiftCardId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks             `json:"links,omitempty"`
	Attributes    *PATCHGiftCardsGiftCardIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHGiftCardsGiftCardIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHGiftCardsGiftCardId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHGiftCardsGiftCardId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHGiftCardsGiftCardId200ResponseData struct {
	value *PATCHGiftCardsGiftCardId200ResponseData
	isSet bool
}

func (v NullablePATCHGiftCardsGiftCardId200ResponseData) Get() *PATCHGiftCardsGiftCardId200ResponseData {
	return v.value
}

func (v *NullablePATCHGiftCardsGiftCardId200ResponseData) Set(val *PATCHGiftCardsGiftCardId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHGiftCardsGiftCardId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHGiftCardsGiftCardId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHGiftCardsGiftCardId200ResponseData(val *PATCHGiftCardsGiftCardId200ResponseData) *NullablePATCHGiftCardsGiftCardId200ResponseData {
	return &NullablePATCHGiftCardsGiftCardId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHGiftCardsGiftCardId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHGiftCardsGiftCardId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
