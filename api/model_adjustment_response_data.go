...
// AdjustmentResponseData struct for AdjustmentResponseData
type AdjustmentResponseData struct {
	// The resource's id
...
func (o AdjustmentResponseData) MarshalJSON() ([]byte, error) {
...
type NullableAdjustmentResponseData struct {
	value *AdjustmentResponseData
	isSet bool
}

func (v NullableAdjustmentResponseData) Get() *AdjustmentResponseData {
	return v.value
}

func (v *NullableAdjustmentResponseData) Set(val *AdjustmentResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableAdjustmentResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableAdjustmentResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdjustmentResponseData(val *AdjustmentResponseData) *NullableAdjustmentResponseData {
	return &NullableAdjustmentResponseData{value: val, isSet: true}
}

func (v NullableAdjustmentResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdjustmentResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
