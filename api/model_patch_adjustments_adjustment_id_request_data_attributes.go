...
// checks if the PATCHAdjustmentsAdjustmentIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHAdjustmentsAdjustmentIdRequestDataAttributes{}

// PATCHAdjustmentsAdjustmentIdRequestDataAttributes struct for PATCHAdjustmentsAdjustmentIdRequestDataAttributes
type PATCHAdjustmentsAdjustmentIdRequestDataAttributes struct {
	// The adjustment name
...
func NewPATCHAdjustmentsAdjustmentIdRequestDataAttributes() *PATCHAdjustmentsAdjustmentIdRequestDataAttributes {
	this := PATCHAdjustmentsAdjustmentIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHAdjustmentsAdjustmentIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHAdjustmentsAdjustmentIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes struct {
	value *PATCHAdjustmentsAdjustmentIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes) Get() *PATCHAdjustmentsAdjustmentIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes) Set(val *PATCHAdjustmentsAdjustmentIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes(val *PATCHAdjustmentsAdjustmentIdRequestDataAttributes) *NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes {
	return &NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHAdjustmentsAdjustmentIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
