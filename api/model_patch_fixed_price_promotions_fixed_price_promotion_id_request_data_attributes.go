...
// checks if the PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes{}

// PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes struct for PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes
type PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes struct {
...
func NewPATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes() *PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes {
	this := PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes struct {
	value *PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) Get() *PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) Set(val *PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes(val *PATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) *NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes {
	return &NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHFixedPricePromotionsFixedPricePromotionIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
