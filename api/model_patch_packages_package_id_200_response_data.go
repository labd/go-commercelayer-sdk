...
// checks if the PATCHPackagesPackageId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPackagesPackageId200ResponseData{}
...
type PATCHPackagesPackageId200ResponseData struct {
	...
	Attributes    *PATCHPackagesPackageIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHPackagesPackageIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHPackagesPackageId200ResponseData) ToMap() (map[string]interface{}, error) {
