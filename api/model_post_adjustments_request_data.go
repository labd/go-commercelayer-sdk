...
// checks if the POSTAdjustmentsRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTAdjustmentsRequestData{}

// POSTAdjustmentsRequestData struct for POSTAdjustmentsRequestData
type POSTAdjustmentsRequestData struct {
	// The resource's type
	Type          interface{}                          `json:"type"`
	Attributes    POSTAdjustmentsRequestDataAttributes `json:"attributes"`
...
func NewPOSTAdjustmentsRequestData(type_ interface{}, attributes POSTAdjustmentsRequestDataAttributes) *POSTAdjustmentsRequestData {
	this := POSTAdjustmentsRequestData{}
	this.Type = type_
...
func (o POSTAdjustmentsRequestData) MarshalJSON() ([]byte, error) {
...
func (o POSTAdjustmentsRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTAdjustmentsRequestData struct {
	value *POSTAdjustmentsRequestData
	isSet bool
}

func (v NullablePOSTAdjustmentsRequestData) Get() *POSTAdjustmentsRequestData {
	return v.value
}

func (v *NullablePOSTAdjustmentsRequestData) Set(val *POSTAdjustmentsRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTAdjustmentsRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTAdjustmentsRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTAdjustmentsRequestData(val *POSTAdjustmentsRequestData) *NullablePOSTAdjustmentsRequestData {
	return &NullablePOSTAdjustmentsRequestData{value: val, isSet: true}
}

func (v NullablePOSTAdjustmentsRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTAdjustmentsRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
