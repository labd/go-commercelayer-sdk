...
// checks if the PATCHManualGatewaysManualGatewayIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHManualGatewaysManualGatewayIdRequestData{}

// PATCHManualGatewaysManualGatewayIdRequestData struct for PATCHManualGatewaysManualGatewayIdRequestData
type PATCHManualGatewaysManualGatewayIdRequestData struct {
	// The resource's type
...
func NewPATCHManualGatewaysManualGatewayIdRequestData(type_ interface{}, id interface{}, attributes PATCHManualGatewaysManualGatewayIdRequestDataAttributes) *PATCHManualGatewaysManualGatewayIdRequestData {
	this := PATCHManualGatewaysManualGatewayIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o PATCHManualGatewaysManualGatewayIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHManualGatewaysManualGatewayIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHManualGatewaysManualGatewayIdRequestData struct {
	value *PATCHManualGatewaysManualGatewayIdRequestData
	isSet bool
}

func (v NullablePATCHManualGatewaysManualGatewayIdRequestData) Get() *PATCHManualGatewaysManualGatewayIdRequestData {
	return v.value
}

func (v *NullablePATCHManualGatewaysManualGatewayIdRequestData) Set(val *PATCHManualGatewaysManualGatewayIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHManualGatewaysManualGatewayIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHManualGatewaysManualGatewayIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHManualGatewaysManualGatewayIdRequestData(val *PATCHManualGatewaysManualGatewayIdRequestData) *NullablePATCHManualGatewaysManualGatewayIdRequestData {
	return &NullablePATCHManualGatewaysManualGatewayIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHManualGatewaysManualGatewayIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHManualGatewaysManualGatewayIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
