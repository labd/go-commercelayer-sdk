...
// checks if the GETResourceErrorsResourceErrorId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETResourceErrorsResourceErrorId200ResponseDataAttributes{}

// GETResourceErrorsResourceErrorId200ResponseDataAttributes struct for GETResourceErrorsResourceErrorId200ResponseDataAttributes
type GETResourceErrorsResourceErrorId200ResponseDataAttributes struct {
...
func NewGETResourceErrorsResourceErrorId200ResponseDataAttributes() *GETResourceErrorsResourceErrorId200ResponseDataAttributes {
	this := GETResourceErrorsResourceErrorId200ResponseDataAttributes{}
	return &this
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GETResourceErrorsResourceErrorId200ResponseDataAttributes) GetCreatedAtOk() (*interface{}, bool) {
...
func (o GETResourceErrorsResourceErrorId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETResourceErrorsResourceErrorId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes struct {
	value *GETResourceErrorsResourceErrorId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes) Get() *GETResourceErrorsResourceErrorId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes) Set(val *GETResourceErrorsResourceErrorId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETResourceErrorsResourceErrorId200ResponseDataAttributes(val *GETResourceErrorsResourceErrorId200ResponseDataAttributes) *NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes {
	return &NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETResourceErrorsResourceErrorId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
