...
// checks if the GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData{}

// GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData struct for GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData
type GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                         `json:"links,omitempty"`
	Attributes    *GETCustomerPasswordResetsCustomerPasswordResetId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData() *GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData {
	this := GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData{}
	return &this
}
...
func (o *GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
// SetAttributes gets a reference to the given GETCustomerPasswordResetsCustomerPasswordResetId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData struct {
	value *GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData
	isSet bool
}

func (v NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) Get() *GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData {
	return v.value
}

func (v *NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) Set(val *GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData(val *GETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) *NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData {
	return &NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData{value: val, isSet: true}
}

func (v NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCustomerPasswordResetsCustomerPasswordResetId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
