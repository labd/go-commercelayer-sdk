...
// checks if the PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes{}

// PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes struct for PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes
type PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes struct {
...
func NewPATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes() *PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes {
	this := PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes{}
	return &this
}
...
func (o PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes struct {
	value *PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes
	isSet bool
}

func (v NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) Get() *PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes {
	return v.value
}

func (v *NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) Set(val *PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes(val *PATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) *NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes {
	return &NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
