...
// checks if the EventUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventUpdateData{}

// EventUpdateData struct for EventUpdateData
type EventUpdateData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                 `json:"id"`
	Attributes    PATCHEventsEventId200ResponseDataAttributes `json:"attributes"`
...
func (o EventUpdateData) MarshalJSON() ([]byte, error) {
...
func (o EventUpdateData) ToMap() (map[string]interface{}, error) {
...
type NullableEventUpdateData struct {
	value *EventUpdateData
	isSet bool
}

func (v NullableEventUpdateData) Get() *EventUpdateData {
	return v.value
}

func (v *NullableEventUpdateData) Set(val *EventUpdateData) {
	v.value = val
	v.isSet = true
}

func (v NullableEventUpdateData) IsSet() bool {
	return v.isSet
}

func (v *NullableEventUpdateData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventUpdateData(val *EventUpdateData) *NullableEventUpdateData {
	return &NullableEventUpdateData{value: val, isSet: true}
}

func (v NullableEventUpdateData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventUpdateData) UnmarshalJSON(src []byte) error {
	v.isSet = true
