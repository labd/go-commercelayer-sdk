...
type PATCHPaymentMethodsPaymentMethodId200ResponseData struct {
	...
	Attributes    *PATCHPaymentMethodsPaymentMethodIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHPaymentMethodsPaymentMethodIdRequestDataAttributes and assigns it to the Attributes field.
