...
// checks if the GETSkuListsSkuListId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETSkuListsSkuListId200ResponseData{}

// GETSkuListsSkuListId200ResponseData struct for GETSkuListsSkuListId200ResponseData
type GETSkuListsSkuListId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks             `json:"links,omitempty"`
	Attributes    *GETSkuListsSkuListId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETSkuListsSkuListId200ResponseData() *GETSkuListsSkuListId200ResponseData {
	this := GETSkuListsSkuListId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETSkuListsSkuListId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETSkuListsSkuListId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETSkuListsSkuListId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETSkuListsSkuListId200ResponseData struct {
	value *GETSkuListsSkuListId200ResponseData
	isSet bool
}

func (v NullableGETSkuListsSkuListId200ResponseData) Get() *GETSkuListsSkuListId200ResponseData {
	return v.value
}

func (v *NullableGETSkuListsSkuListId200ResponseData) Set(val *GETSkuListsSkuListId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETSkuListsSkuListId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETSkuListsSkuListId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETSkuListsSkuListId200ResponseData(val *GETSkuListsSkuListId200ResponseData) *NullableGETSkuListsSkuListId200ResponseData {
	return &NullableGETSkuListsSkuListId200ResponseData{value: val, isSet: true}
}

func (v NullableGETSkuListsSkuListId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETSkuListsSkuListId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
