...
type POSTOrderAmountPromotionRules201ResponseData struct {
	...
	Attributes    *POSTOrderAmountPromotionRulesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTOrderAmountPromotionRulesRequestDataAttributes and assigns it to the Attributes field.
