...
// ExportResponseData struct for ExportResponseData
type ExportResponseData struct {
	...
	Relationships *ExportResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *ExportResponseData) GetRelationships() ExportResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ExportResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ExportResponseDataRelationships and assigns it to the Relationships field.
func (o *ExportResponseData) SetRelationships(v ExportResponseDataRelationships) {
	o.Relationships = &v
}

func (o ExportResponseData) MarshalJSON() ([]byte, error) {
...
type NullableExportResponseData struct {
	value *ExportResponseData
	isSet bool
}

func (v NullableExportResponseData) Get() *ExportResponseData {
	return v.value
}

func (v *NullableExportResponseData) Set(val *ExportResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableExportResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableExportResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportResponseData(val *ExportResponseData) *NullableExportResponseData {
	return &NullableExportResponseData{value: val, isSet: true}
}

func (v NullableExportResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
