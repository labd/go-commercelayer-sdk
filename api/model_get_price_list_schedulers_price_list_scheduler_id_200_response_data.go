...
// checks if the GETPriceListSchedulersPriceListSchedulerId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPriceListSchedulersPriceListSchedulerId200ResponseData{}

// GETPriceListSchedulersPriceListSchedulerId200ResponseData struct for GETPriceListSchedulersPriceListSchedulerId200ResponseData
type GETPriceListSchedulersPriceListSchedulerId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                          `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                   `json:"links,omitempty"`
	Attributes    *GETPriceListSchedulersPriceListSchedulerId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func (o *GETPriceListSchedulersPriceListSchedulerId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
// SetAttributes gets a reference to the given GETPriceListSchedulersPriceListSchedulerId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETPriceListSchedulersPriceListSchedulerId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETPriceListSchedulersPriceListSchedulerId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData struct {
	value *GETPriceListSchedulersPriceListSchedulerId200ResponseData
	isSet bool
}

func (v NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData) Get() *GETPriceListSchedulersPriceListSchedulerId200ResponseData {
	return v.value
}

func (v *NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData) Set(val *GETPriceListSchedulersPriceListSchedulerId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPriceListSchedulersPriceListSchedulerId200ResponseData(val *GETPriceListSchedulersPriceListSchedulerId200ResponseData) *NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData {
	return &NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData{value: val, isSet: true}
}

func (v NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPriceListSchedulersPriceListSchedulerId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
