...
// checks if the LineItemOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LineItemOption{}
...
func (o LineItemOption) ToMap() (map[string]interface{}, error) {
