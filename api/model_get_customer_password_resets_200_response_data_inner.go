...
// GETCustomerPasswordResets200ResponseDataInner struct for GETCustomerPasswordResets200ResponseDataInner
type GETCustomerPasswordResets200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                 `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                      `json:"links,omitempty"`
	Attributes    *GETCustomerPasswordResets200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETCustomerPasswordResets200ResponseDataInner() *GETCustomerPasswordResets200ResponseDataInner {
	this := GETCustomerPasswordResets200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETCustomerPasswordResets200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETCustomerPasswordResets200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETCustomerPasswordResets200ResponseDataInner struct {
	value *GETCustomerPasswordResets200ResponseDataInner
	isSet bool
}

func (v NullableGETCustomerPasswordResets200ResponseDataInner) Get() *GETCustomerPasswordResets200ResponseDataInner {
	return v.value
}

func (v *NullableGETCustomerPasswordResets200ResponseDataInner) Set(val *GETCustomerPasswordResets200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomerPasswordResets200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomerPasswordResets200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomerPasswordResets200ResponseDataInner(val *GETCustomerPasswordResets200ResponseDataInner) *NullableGETCustomerPasswordResets200ResponseDataInner {
	return &NullableGETCustomerPasswordResets200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETCustomerPasswordResets200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCustomerPasswordResets200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
