...
// checks if the PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes{}
...
type PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes struct {
...
func (o PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes struct {
	value *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes
	isSet bool
}

func (v NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) Get() *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes {
	return v.value
}

func (v *NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) Set(val *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes(val *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) *NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes {
	return &NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
