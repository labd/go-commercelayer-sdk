...
// checks if the ManualGatewayCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManualGatewayCreateData{}
...
func (o ManualGatewayCreateData) ToMap() (map[string]interface{}, error) {
