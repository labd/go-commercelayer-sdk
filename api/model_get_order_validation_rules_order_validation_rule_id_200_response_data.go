...
// checks if the GETOrderValidationRulesOrderValidationRuleId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETOrderValidationRulesOrderValidationRuleId200ResponseData{}

// GETOrderValidationRulesOrderValidationRuleId200ResponseData struct for GETOrderValidationRulesOrderValidationRuleId200ResponseData
type GETOrderValidationRulesOrderValidationRuleId200ResponseData struct {
	// The resource's id
...
func NewGETOrderValidationRulesOrderValidationRuleId200ResponseData() *GETOrderValidationRulesOrderValidationRuleId200ResponseData {
	this := GETOrderValidationRulesOrderValidationRuleId200ResponseData{}
	return &this
}
...
func (o *GETOrderValidationRulesOrderValidationRuleId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
func (o GETOrderValidationRulesOrderValidationRuleId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETOrderValidationRulesOrderValidationRuleId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData struct {
	value *GETOrderValidationRulesOrderValidationRuleId200ResponseData
	isSet bool
}

func (v NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData) Get() *GETOrderValidationRulesOrderValidationRuleId200ResponseData {
	return v.value
}

func (v *NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData) Set(val *GETOrderValidationRulesOrderValidationRuleId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETOrderValidationRulesOrderValidationRuleId200ResponseData(val *GETOrderValidationRulesOrderValidationRuleId200ResponseData) *NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData {
	return &NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData{value: val, isSet: true}
}

func (v NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETOrderValidationRulesOrderValidationRuleId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
