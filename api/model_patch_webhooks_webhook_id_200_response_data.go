...
type PATCHWebhooksWebhookId200ResponseData struct {
	...
	Attributes    *PATCHWebhooksWebhookIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHWebhooksWebhookIdRequestDataAttributes and assigns it to the Attributes field.
