...
// checks if the CheckoutComGateway type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckoutComGateway{}
...
func (o CheckoutComGateway) ToMap() (map[string]interface{}, error) {
