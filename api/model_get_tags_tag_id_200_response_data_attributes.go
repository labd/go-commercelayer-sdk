...
// checks if the GETTagsTagId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETTagsTagId200ResponseDataAttributes{}

// GETTagsTagId200ResponseDataAttributes struct for GETTagsTagId200ResponseDataAttributes
type GETTagsTagId200ResponseDataAttributes struct {
	// The tag name.
...
func NewGETTagsTagId200ResponseDataAttributes() *GETTagsTagId200ResponseDataAttributes {
	this := GETTagsTagId200ResponseDataAttributes{}
	return &this
}
...
func (o *GETTagsTagId200ResponseDataAttributes) GetMetadata() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o GETTagsTagId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETTagsTagId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETTagsTagId200ResponseDataAttributes struct {
	value *GETTagsTagId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETTagsTagId200ResponseDataAttributes) Get() *GETTagsTagId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETTagsTagId200ResponseDataAttributes) Set(val *GETTagsTagId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETTagsTagId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETTagsTagId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETTagsTagId200ResponseDataAttributes(val *GETTagsTagId200ResponseDataAttributes) *NullableGETTagsTagId200ResponseDataAttributes {
	return &NullableGETTagsTagId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETTagsTagId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETTagsTagId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
