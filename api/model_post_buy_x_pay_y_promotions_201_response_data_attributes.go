...
// checks if the POSTBuyXPayYPromotions201ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTBuyXPayYPromotions201ResponseDataAttributes{}

// POSTBuyXPayYPromotions201ResponseDataAttributes struct for POSTBuyXPayYPromotions201ResponseDataAttributes
type POSTBuyXPayYPromotions201ResponseDataAttributes struct {
...
func NewPOSTBuyXPayYPromotions201ResponseDataAttributes(name interface{}, startsAt interface{}, expiresAt interface{}, x interface{}, y interface{}) *POSTBuyXPayYPromotions201ResponseDataAttributes {
	this := POSTBuyXPayYPromotions201ResponseDataAttributes{}
	this.Name = name
...
func (o POSTBuyXPayYPromotions201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTBuyXPayYPromotions201ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTBuyXPayYPromotions201ResponseDataAttributes struct {
	value *POSTBuyXPayYPromotions201ResponseDataAttributes
	isSet bool
}

func (v NullablePOSTBuyXPayYPromotions201ResponseDataAttributes) Get() *POSTBuyXPayYPromotions201ResponseDataAttributes {
	return v.value
}

func (v *NullablePOSTBuyXPayYPromotions201ResponseDataAttributes) Set(val *POSTBuyXPayYPromotions201ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTBuyXPayYPromotions201ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTBuyXPayYPromotions201ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTBuyXPayYPromotions201ResponseDataAttributes(val *POSTBuyXPayYPromotions201ResponseDataAttributes) *NullablePOSTBuyXPayYPromotions201ResponseDataAttributes {
	return &NullablePOSTBuyXPayYPromotions201ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTBuyXPayYPromotions201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTBuyXPayYPromotions201ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
