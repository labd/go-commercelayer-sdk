...
// checks if the POSTPackages201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTPackages201ResponseData{}
...
type POSTPackages201ResponseData struct {
	...
	Attributes    *POSTPackagesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTPackagesRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTPackages201ResponseData) ToMap() (map[string]interface{}, error) {
