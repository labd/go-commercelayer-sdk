...
// checks if the POSTAvalaraAccounts201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTAvalaraAccounts201ResponseData{}
...
type POSTAvalaraAccounts201ResponseData struct {
	...
	Attributes    *POSTAvalaraAccountsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTAvalaraAccountsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTAvalaraAccounts201ResponseData) ToMap() (map[string]interface{}, error) {
