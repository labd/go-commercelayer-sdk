...
// checks if the ExternalPaymentUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalPaymentUpdateData{}
...
func (o ExternalPaymentUpdateData) ToMap() (map[string]interface{}, error) {
