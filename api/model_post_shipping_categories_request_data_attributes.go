...
// checks if the POSTShippingCategoriesRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTShippingCategoriesRequestDataAttributes{}

// POSTShippingCategoriesRequestDataAttributes struct for POSTShippingCategoriesRequestDataAttributes
type POSTShippingCategoriesRequestDataAttributes struct {
...
func NewPOSTShippingCategoriesRequestDataAttributes(name interface{}) *POSTShippingCategoriesRequestDataAttributes {
	this := POSTShippingCategoriesRequestDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTShippingCategoriesRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTShippingCategoriesRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTShippingCategoriesRequestDataAttributes struct {
	value *POSTShippingCategoriesRequestDataAttributes
	isSet bool
}

func (v NullablePOSTShippingCategoriesRequestDataAttributes) Get() *POSTShippingCategoriesRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTShippingCategoriesRequestDataAttributes) Set(val *POSTShippingCategoriesRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTShippingCategoriesRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTShippingCategoriesRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTShippingCategoriesRequestDataAttributes(val *POSTShippingCategoriesRequestDataAttributes) *NullablePOSTShippingCategoriesRequestDataAttributes {
	return &NullablePOSTShippingCategoriesRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTShippingCategoriesRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTShippingCategoriesRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
