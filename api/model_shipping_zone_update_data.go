...
// checks if the ShippingZoneUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingZoneUpdateData{}
...
func (o ShippingZoneUpdateData) ToMap() (map[string]interface{}, error) {
