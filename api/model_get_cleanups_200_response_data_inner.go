...
// GETCleanups200ResponseDataInner struct for GETCleanups200ResponseDataInner
type GETCleanups200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                   `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks        `json:"links,omitempty"`
	Attributes    *GETCleanups200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETCleanups200ResponseDataInner() *GETCleanups200ResponseDataInner {
	this := GETCleanups200ResponseDataInner{}
	return &this
}
...
func (o *GETCleanups200ResponseDataInner) GetId() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *GETCleanups200ResponseDataInner) GetIdOk() (*interface{}, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *GETCleanups200ResponseDataInner) SetId(v interface{}) {
	o.Id = v
}

// GetType returns the Type field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GETCleanups200ResponseDataInner) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GETCleanups200ResponseDataInner) GetTypeOk() (*interface{}, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GETCleanups200ResponseDataInner) SetType(v interface{}) {
	o.Type = v
}
...
// SetAttributes gets a reference to the given GETCleanups200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETCleanups200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETCleanups200ResponseDataInner struct {
	value *GETCleanups200ResponseDataInner
	isSet bool
}

func (v NullableGETCleanups200ResponseDataInner) Get() *GETCleanups200ResponseDataInner {
	return v.value
}

func (v *NullableGETCleanups200ResponseDataInner) Set(val *GETCleanups200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCleanups200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCleanups200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCleanups200ResponseDataInner(val *GETCleanups200ResponseDataInner) *NullableGETCleanups200ResponseDataInner {
	return &NullableGETCleanups200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETCleanups200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCleanups200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
