...
// CouponCodesPromotionRuleResponseData struct for CouponCodesPromotionRuleResponseData
type CouponCodesPromotionRuleResponseData struct {
	// The resource's id
	...
	Relationships *CouponCodesPromotionRuleResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewCouponCodesPromotionRuleResponseData() *CouponCodesPromotionRuleResponseData {
	this := CouponCodesPromotionRuleResponseData{}
	return &this
}
...
func (o *CouponCodesPromotionRuleResponseData) GetRelationships() CouponCodesPromotionRuleResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret CouponCodesPromotionRuleResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given CouponCodesPromotionRuleResponseDataRelationships and assigns it to the Relationships field.
func (o *CouponCodesPromotionRuleResponseData) SetRelationships(v CouponCodesPromotionRuleResponseDataRelationships) {
	o.Relationships = &v
}

func (o CouponCodesPromotionRuleResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCouponCodesPromotionRuleResponseData struct {
	value *CouponCodesPromotionRuleResponseData
	isSet bool
}

func (v NullableCouponCodesPromotionRuleResponseData) Get() *CouponCodesPromotionRuleResponseData {
	return v.value
}

func (v *NullableCouponCodesPromotionRuleResponseData) Set(val *CouponCodesPromotionRuleResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCouponCodesPromotionRuleResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCouponCodesPromotionRuleResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCouponCodesPromotionRuleResponseData(val *CouponCodesPromotionRuleResponseData) *NullableCouponCodesPromotionRuleResponseData {
	return &NullableCouponCodesPromotionRuleResponseData{value: val, isSet: true}
}

func (v NullableCouponCodesPromotionRuleResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCouponCodesPromotionRuleResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
