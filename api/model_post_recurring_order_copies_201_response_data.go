...
type POSTRecurringOrderCopies201ResponseData struct {
	...
	Attributes    *POSTRecurringOrderCopiesRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTRecurringOrderCopiesRequestDataAttributes and assigns it to the Attributes field.
