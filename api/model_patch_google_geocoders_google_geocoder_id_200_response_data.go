...
type PATCHGoogleGeocodersGoogleGeocoderId200ResponseData struct {
	...
	Attributes    *PATCHGoogleGeocodersGoogleGeocoderIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHGoogleGeocodersGoogleGeocoderIdRequestDataAttributes and assigns it to the Attributes field.
