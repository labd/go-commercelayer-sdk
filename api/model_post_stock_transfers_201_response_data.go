...
type POSTStockTransfers201ResponseData struct {
	...
	Attributes    *POSTStockTransfersRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTStockTransfersRequestDataAttributes and assigns it to the Attributes field.
