...
// checks if the GETEventsEventId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETEventsEventId200ResponseDataAttributes{}

// GETEventsEventId200ResponseDataAttributes struct for GETEventsEventId200ResponseDataAttributes
type GETEventsEventId200ResponseDataAttributes struct {
...
func NewGETEventsEventId200ResponseDataAttributes() *GETEventsEventId200ResponseDataAttributes {
	this := GETEventsEventId200ResponseDataAttributes{}
	return &this
}
...
func (o GETEventsEventId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETEventsEventId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETEventsEventId200ResponseDataAttributes struct {
	value *GETEventsEventId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETEventsEventId200ResponseDataAttributes) Get() *GETEventsEventId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETEventsEventId200ResponseDataAttributes) Set(val *GETEventsEventId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETEventsEventId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETEventsEventId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETEventsEventId200ResponseDataAttributes(val *GETEventsEventId200ResponseDataAttributes) *NullableGETEventsEventId200ResponseDataAttributes {
	return &NullableGETEventsEventId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETEventsEventId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETEventsEventId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
