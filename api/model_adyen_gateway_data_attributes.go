...
// AdyenGatewayDataAttributes struct for AdyenGatewayDataAttributes
type AdyenGatewayDataAttributes struct {
...
func NewAdyenGatewayDataAttributes() *AdyenGatewayDataAttributes {
	this := AdyenGatewayDataAttributes{}
	return &this
}
...
func (o AdyenGatewayDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableAdyenGatewayDataAttributes struct {
	value *AdyenGatewayDataAttributes
	isSet bool
}

func (v NullableAdyenGatewayDataAttributes) Get() *AdyenGatewayDataAttributes {
	return v.value
}

func (v *NullableAdyenGatewayDataAttributes) Set(val *AdyenGatewayDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableAdyenGatewayDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableAdyenGatewayDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdyenGatewayDataAttributes(val *AdyenGatewayDataAttributes) *NullableAdyenGatewayDataAttributes {
	return &NullableAdyenGatewayDataAttributes{value: val, isSet: true}
}

func (v NullableAdyenGatewayDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdyenGatewayDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
