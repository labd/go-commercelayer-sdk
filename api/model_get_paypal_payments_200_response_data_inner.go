...
// GETPaypalPayments200ResponseDataInner struct for GETPaypalPayments200ResponseDataInner
type GETPaypalPayments200ResponseDataInner struct {
	// The resource's id
...
// SetAttributes gets a reference to the given GETPaypalPayments200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETPaypalPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETPaypalPayments200ResponseDataInner struct {
	value *GETPaypalPayments200ResponseDataInner
	isSet bool
}

func (v NullableGETPaypalPayments200ResponseDataInner) Get() *GETPaypalPayments200ResponseDataInner {
	return v.value
}

func (v *NullableGETPaypalPayments200ResponseDataInner) Set(val *GETPaypalPayments200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPaypalPayments200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPaypalPayments200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPaypalPayments200ResponseDataInner(val *GETPaypalPayments200ResponseDataInner) *NullableGETPaypalPayments200ResponseDataInner {
	return &NullableGETPaypalPayments200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETPaypalPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPaypalPayments200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
