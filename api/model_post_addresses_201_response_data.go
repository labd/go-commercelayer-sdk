...
// checks if the POSTAddresses201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTAddresses201ResponseData{}

// POSTAddresses201ResponseData struct for POSTAddresses201ResponseData
type POSTAddresses201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks         `json:"links,omitempty"`
	Attributes    *POSTAddressesRequestDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTAddresses201ResponseData() *POSTAddresses201ResponseData {
	this := POSTAddresses201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTAddressesRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTAddresses201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTAddresses201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTAddresses201ResponseData struct {
	value *POSTAddresses201ResponseData
	isSet bool
}

func (v NullablePOSTAddresses201ResponseData) Get() *POSTAddresses201ResponseData {
	return v.value
}

func (v *NullablePOSTAddresses201ResponseData) Set(val *POSTAddresses201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTAddresses201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTAddresses201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTAddresses201ResponseData(val *POSTAddresses201ResponseData) *NullablePOSTAddresses201ResponseData {
	return &NullablePOSTAddresses201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTAddresses201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTAddresses201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
