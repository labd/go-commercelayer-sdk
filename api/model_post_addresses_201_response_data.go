...
type POSTAddresses201ResponseData struct {
	...
	Attributes    *POSTAddresses201ResponseDataAttributes    `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTAddresses201ResponseDataAttributes and assigns it to the Attributes field.
