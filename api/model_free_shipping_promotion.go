...
// checks if the FreeShippingPromotion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FreeShippingPromotion{}

// FreeShippingPromotion struct for FreeShippingPromotion
type FreeShippingPromotion struct {
	Data *FreeShippingPromotionData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given FreeShippingPromotionData and assigns it to the Data field.
...
func (o FreeShippingPromotion) ToMap() (map[string]interface{}, error) {
