...
// checks if the PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes{}

// PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes struct for PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes
type PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes struct {
...
func NewPATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes() *PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes {
	this := PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes struct {
	value *PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) Get() *PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) Set(val *PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes(val *PATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) *NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes {
	return &NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHInStockSubscriptionsInStockSubscriptionIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
