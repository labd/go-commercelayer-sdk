...
// checks if the PATCHParcelLineItemsParcelLineItemIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHParcelLineItemsParcelLineItemIdRequestData{}

// PATCHParcelLineItemsParcelLineItemIdRequestData struct for PATCHParcelLineItemsParcelLineItemIdRequestData
type PATCHParcelLineItemsParcelLineItemIdRequestData struct {
	// The resource's type
...
func NewPATCHParcelLineItemsParcelLineItemIdRequestData(type_ interface{}, id interface{}, attributes PATCHBillingInfoValidationRulesBillingInfoValidationRuleIdRequestDataAttributes) *PATCHParcelLineItemsParcelLineItemIdRequestData {
	this := PATCHParcelLineItemsParcelLineItemIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o PATCHParcelLineItemsParcelLineItemIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHParcelLineItemsParcelLineItemIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHParcelLineItemsParcelLineItemIdRequestData struct {
	value *PATCHParcelLineItemsParcelLineItemIdRequestData
	isSet bool
}

func (v NullablePATCHParcelLineItemsParcelLineItemIdRequestData) Get() *PATCHParcelLineItemsParcelLineItemIdRequestData {
	return v.value
}

func (v *NullablePATCHParcelLineItemsParcelLineItemIdRequestData) Set(val *PATCHParcelLineItemsParcelLineItemIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHParcelLineItemsParcelLineItemIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHParcelLineItemsParcelLineItemIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHParcelLineItemsParcelLineItemIdRequestData(val *PATCHParcelLineItemsParcelLineItemIdRequestData) *NullablePATCHParcelLineItemsParcelLineItemIdRequestData {
	return &NullablePATCHParcelLineItemsParcelLineItemIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHParcelLineItemsParcelLineItemIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHParcelLineItemsParcelLineItemIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
