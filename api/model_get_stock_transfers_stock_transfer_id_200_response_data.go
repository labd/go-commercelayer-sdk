...
// checks if the GETStockTransfersStockTransferId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETStockTransfersStockTransferId200ResponseData{}

// GETStockTransfersStockTransferId200ResponseData struct for GETStockTransfersStockTransferId200ResponseData
type GETStockTransfersStockTransferId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                         `json:"links,omitempty"`
	Attributes    *GETStockTransfersStockTransferId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETStockTransfersStockTransferId200ResponseData() *GETStockTransfersStockTransferId200ResponseData {
	this := GETStockTransfersStockTransferId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETStockTransfersStockTransferId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETStockTransfersStockTransferId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETStockTransfersStockTransferId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETStockTransfersStockTransferId200ResponseData struct {
	value *GETStockTransfersStockTransferId200ResponseData
	isSet bool
}

func (v NullableGETStockTransfersStockTransferId200ResponseData) Get() *GETStockTransfersStockTransferId200ResponseData {
	return v.value
}

func (v *NullableGETStockTransfersStockTransferId200ResponseData) Set(val *GETStockTransfersStockTransferId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETStockTransfersStockTransferId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETStockTransfersStockTransferId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETStockTransfersStockTransferId200ResponseData(val *GETStockTransfersStockTransferId200ResponseData) *NullableGETStockTransfersStockTransferId200ResponseData {
	return &NullableGETStockTransfersStockTransferId200ResponseData{value: val, isSet: true}
}

func (v NullableGETStockTransfersStockTransferId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETStockTransfersStockTransferId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
