...
// VoidResponseData struct for VoidResponseData
type VoidResponseData struct {
	...
	Relationships *VoidResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *VoidResponseData) GetRelationships() VoidResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret VoidResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given VoidResponseDataRelationships and assigns it to the Relationships field.
func (o *VoidResponseData) SetRelationships(v VoidResponseDataRelationships) {
	o.Relationships = &v
}

func (o VoidResponseData) MarshalJSON() ([]byte, error) {
...
type NullableVoidResponseData struct {
	value *VoidResponseData
	isSet bool
}

func (v NullableVoidResponseData) Get() *VoidResponseData {
	return v.value
}

func (v *NullableVoidResponseData) Set(val *VoidResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableVoidResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableVoidResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoidResponseData(val *VoidResponseData) *NullableVoidResponseData {
	return &NullableVoidResponseData{value: val, isSet: true}
}

func (v NullableVoidResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoidResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
