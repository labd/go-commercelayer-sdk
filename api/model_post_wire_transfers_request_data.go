...
// checks if the POSTWireTransfersRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTWireTransfersRequestData{}

// POSTWireTransfersRequestData struct for POSTWireTransfersRequestData
type POSTWireTransfersRequestData struct {
	// The resource's type
...
func NewPOSTWireTransfersRequestData(type_ interface{}, attributes POSTAdyenPaymentsRequestDataAttributes) *POSTWireTransfersRequestData {
	this := POSTWireTransfersRequestData{}
	this.Type = type_
...
func (o POSTWireTransfersRequestData) MarshalJSON() ([]byte, error) {
...
func (o POSTWireTransfersRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTWireTransfersRequestData struct {
	value *POSTWireTransfersRequestData
	isSet bool
}

func (v NullablePOSTWireTransfersRequestData) Get() *POSTWireTransfersRequestData {
	return v.value
}

func (v *NullablePOSTWireTransfersRequestData) Set(val *POSTWireTransfersRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTWireTransfersRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTWireTransfersRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTWireTransfersRequestData(val *POSTWireTransfersRequestData) *NullablePOSTWireTransfersRequestData {
	return &NullablePOSTWireTransfersRequestData{value: val, isSet: true}
}

func (v NullablePOSTWireTransfersRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTWireTransfersRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
