...
// GETCustomerAddresses200ResponseDataInner struct for GETCustomerAddresses200ResponseDataInner
type GETCustomerAddresses200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type *string `json:"type,omitempty"`
	Links *GETAddresses200ResponseDataInnerLinks `json:"links,omitempty"`
	Attributes *GETCustomerAddresses200ResponseDataInnerAttributes `json:"attributes,omitempty"`
...
func NewGETCustomerAddresses200ResponseDataInner() *GETCustomerAddresses200ResponseDataInner {
	this := GETCustomerAddresses200ResponseDataInner{}
...
// SetAttributes gets a reference to the given GETCustomerAddresses200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETCustomerAddresses200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETCustomerAddresses200ResponseDataInner struct {
	value *GETCustomerAddresses200ResponseDataInner
	isSet bool
}

func (v NullableGETCustomerAddresses200ResponseDataInner) Get() *GETCustomerAddresses200ResponseDataInner {
	return v.value
}

func (v *NullableGETCustomerAddresses200ResponseDataInner) Set(val *GETCustomerAddresses200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomerAddresses200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomerAddresses200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomerAddresses200ResponseDataInner(val *GETCustomerAddresses200ResponseDataInner) *NullableGETCustomerAddresses200ResponseDataInner {
	return &NullableGETCustomerAddresses200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETCustomerAddresses200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCustomerAddresses200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
