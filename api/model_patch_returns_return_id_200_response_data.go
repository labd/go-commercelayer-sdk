...
type PATCHReturnsReturnId200ResponseData struct {
	...
	Attributes    *PATCHReturnsReturnIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHReturnsReturnIdRequestDataAttributes and assigns it to the Attributes field.
