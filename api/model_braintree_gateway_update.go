...
// checks if the BraintreeGatewayUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BraintreeGatewayUpdate{}
...
func (o BraintreeGatewayUpdate) ToMap() (map[string]interface{}, error) {
