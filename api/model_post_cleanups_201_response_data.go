...
// checks if the POSTCleanups201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTCleanups201ResponseData{}

// POSTCleanups201ResponseData struct for POSTCleanups201ResponseData
type POSTCleanups201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                               `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks        `json:"links,omitempty"`
	Attributes    *POSTCleanupsRequestDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTCleanups201ResponseData() *POSTCleanups201ResponseData {
	this := POSTCleanups201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTCleanupsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTCleanups201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTCleanups201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTCleanups201ResponseData struct {
	value *POSTCleanups201ResponseData
	isSet bool
}

func (v NullablePOSTCleanups201ResponseData) Get() *POSTCleanups201ResponseData {
	return v.value
}

func (v *NullablePOSTCleanups201ResponseData) Set(val *POSTCleanups201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTCleanups201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTCleanups201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTCleanups201ResponseData(val *POSTCleanups201ResponseData) *NullablePOSTCleanups201ResponseData {
	return &NullablePOSTCleanups201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTCleanups201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTCleanups201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
