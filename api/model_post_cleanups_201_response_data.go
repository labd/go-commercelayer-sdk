...
type POSTCleanups201ResponseData struct {
	...
	Attributes    *POSTCleanups201ResponseDataAttributes    `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTCleanups201ResponseDataAttributes and assigns it to the Attributes field.
