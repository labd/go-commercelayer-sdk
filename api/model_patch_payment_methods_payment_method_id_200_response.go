...
// checks if the PATCHPaymentMethodsPaymentMethodId200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPaymentMethodsPaymentMethodId200Response{}
...
func (o PATCHPaymentMethodsPaymentMethodId200Response) ToMap() (map[string]interface{}, error) {
