...
// checks if the POSTBundles201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTBundles201ResponseData{}
...
type POSTBundles201ResponseData struct {
	...
	Attributes    *POSTBundlesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTBundlesRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTBundles201ResponseData) ToMap() (map[string]interface{}, error) {
