...
// GETSubscriptionModels200ResponseDataInner struct for GETSubscriptionModels200ResponseDataInner
type GETSubscriptionModels200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                             `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                  `json:"links,omitempty"`
	Attributes    *GETSubscriptionModels200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETSubscriptionModels200ResponseDataInner() *GETSubscriptionModels200ResponseDataInner {
	this := GETSubscriptionModels200ResponseDataInner{}
	return &this
}
...
func (o *GETSubscriptionModels200ResponseDataInner) GetAttributes() GETSubscriptionModels200ResponseDataInnerAttributes {
	if o == nil || o.Attributes == nil {
		var ret GETSubscriptionModels200ResponseDataInnerAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GETSubscriptionModels200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETSubscriptionModels200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETSubscriptionModels200ResponseDataInner struct {
	value *GETSubscriptionModels200ResponseDataInner
	isSet bool
}

func (v NullableGETSubscriptionModels200ResponseDataInner) Get() *GETSubscriptionModels200ResponseDataInner {
	return v.value
}

func (v *NullableGETSubscriptionModels200ResponseDataInner) Set(val *GETSubscriptionModels200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETSubscriptionModels200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETSubscriptionModels200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETSubscriptionModels200ResponseDataInner(val *GETSubscriptionModels200ResponseDataInner) *NullableGETSubscriptionModels200ResponseDataInner {
	return &NullableGETSubscriptionModels200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETSubscriptionModels200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETSubscriptionModels200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
