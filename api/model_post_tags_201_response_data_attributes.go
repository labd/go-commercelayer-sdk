...
// checks if the POSTTags201ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTTags201ResponseDataAttributes{}

// POSTTags201ResponseDataAttributes struct for POSTTags201ResponseDataAttributes
type POSTTags201ResponseDataAttributes struct {
	// The tag name.
...
func NewPOSTTags201ResponseDataAttributes(name interface{}) *POSTTags201ResponseDataAttributes {
	this := POSTTags201ResponseDataAttributes{}
	this.Name = name
	return &this
}
...
func (o *POSTTags201ResponseDataAttributes) SetName(v interface{}) {
	o.Name = v
}
...
func (o POSTTags201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTTags201ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTTags201ResponseDataAttributes struct {
	value *POSTTags201ResponseDataAttributes
	isSet bool
}

func (v NullablePOSTTags201ResponseDataAttributes) Get() *POSTTags201ResponseDataAttributes {
	return v.value
}

func (v *NullablePOSTTags201ResponseDataAttributes) Set(val *POSTTags201ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTTags201ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTTags201ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTTags201ResponseDataAttributes(val *POSTTags201ResponseDataAttributes) *NullablePOSTTags201ResponseDataAttributes {
	return &NullablePOSTTags201ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTTags201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTTags201ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
