...
// checks if the POSTKlarnaPaymentsRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTKlarnaPaymentsRequestData{}

// POSTKlarnaPaymentsRequestData struct for POSTKlarnaPaymentsRequestData
type POSTKlarnaPaymentsRequestData struct {
	// The resource's type
...
func NewPOSTKlarnaPaymentsRequestData(type_ interface{}, attributes POSTAdyenPaymentsRequestDataAttributes) *POSTKlarnaPaymentsRequestData {
	this := POSTKlarnaPaymentsRequestData{}
	this.Type = type_
...
func (o POSTKlarnaPaymentsRequestData) MarshalJSON() ([]byte, error) {
...
func (o POSTKlarnaPaymentsRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTKlarnaPaymentsRequestData struct {
	value *POSTKlarnaPaymentsRequestData
	isSet bool
}

func (v NullablePOSTKlarnaPaymentsRequestData) Get() *POSTKlarnaPaymentsRequestData {
	return v.value
}

func (v *NullablePOSTKlarnaPaymentsRequestData) Set(val *POSTKlarnaPaymentsRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTKlarnaPaymentsRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTKlarnaPaymentsRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTKlarnaPaymentsRequestData(val *POSTKlarnaPaymentsRequestData) *NullablePOSTKlarnaPaymentsRequestData {
	return &NullablePOSTKlarnaPaymentsRequestData{value: val, isSet: true}
}

func (v NullablePOSTKlarnaPaymentsRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTKlarnaPaymentsRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
