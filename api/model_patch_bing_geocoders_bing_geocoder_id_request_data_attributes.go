...
// checks if the PATCHBingGeocodersBingGeocoderIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHBingGeocodersBingGeocoderIdRequestDataAttributes{}

// PATCHBingGeocodersBingGeocoderIdRequestDataAttributes struct for PATCHBingGeocodersBingGeocoderIdRequestDataAttributes
type PATCHBingGeocodersBingGeocoderIdRequestDataAttributes struct {
...
func NewPATCHBingGeocodersBingGeocoderIdRequestDataAttributes() *PATCHBingGeocodersBingGeocoderIdRequestDataAttributes {
	this := PATCHBingGeocodersBingGeocoderIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHBingGeocodersBingGeocoderIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHBingGeocodersBingGeocoderIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes struct {
	value *PATCHBingGeocodersBingGeocoderIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes) Get() *PATCHBingGeocodersBingGeocoderIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes) Set(val *PATCHBingGeocodersBingGeocoderIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes(val *PATCHBingGeocodersBingGeocoderIdRequestDataAttributes) *NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes {
	return &NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHBingGeocodersBingGeocoderIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
