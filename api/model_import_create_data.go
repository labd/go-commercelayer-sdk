...
// checks if the ImportCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportCreateData{}
...
func (o ImportCreateData) ToMap() (map[string]interface{}, error) {
