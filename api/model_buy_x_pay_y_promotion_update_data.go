...
// checks if the BuyXPayYPromotionUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuyXPayYPromotionUpdateData{}

// BuyXPayYPromotionUpdateData struct for BuyXPayYPromotionUpdateData
type BuyXPayYPromotionUpdateData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                                         `json:"id"`
	Attributes    PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes `json:"attributes"`
...
func (o BuyXPayYPromotionUpdateData) MarshalJSON() ([]byte, error) {
...
func (o BuyXPayYPromotionUpdateData) ToMap() (map[string]interface{}, error) {
...
type NullableBuyXPayYPromotionUpdateData struct {
	value *BuyXPayYPromotionUpdateData
	isSet bool
}

func (v NullableBuyXPayYPromotionUpdateData) Get() *BuyXPayYPromotionUpdateData {
	return v.value
}

func (v *NullableBuyXPayYPromotionUpdateData) Set(val *BuyXPayYPromotionUpdateData) {
	v.value = val
	v.isSet = true
}

func (v NullableBuyXPayYPromotionUpdateData) IsSet() bool {
	return v.isSet
}

func (v *NullableBuyXPayYPromotionUpdateData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuyXPayYPromotionUpdateData(val *BuyXPayYPromotionUpdateData) *NullableBuyXPayYPromotionUpdateData {
	return &NullableBuyXPayYPromotionUpdateData{value: val, isSet: true}
}

func (v NullableBuyXPayYPromotionUpdateData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuyXPayYPromotionUpdateData) UnmarshalJSON(src []byte) error {
	v.isSet = true
