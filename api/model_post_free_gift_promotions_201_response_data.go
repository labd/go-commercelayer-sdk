...
type POSTFreeGiftPromotions201ResponseData struct {
	...
	Attributes    *POSTFreeGiftPromotionsRequestDataAttributes          `json:"attributes,omitempty"`
...
func (o *POSTFreeGiftPromotions201ResponseData) GetAttributes() POSTFreeGiftPromotionsRequestDataAttributes {
...
// and a boolean to check if the value has been set.
func (o *POSTFreeGiftPromotions201ResponseData) GetAttributesOk() (*POSTFreeGiftPromotionsRequestDataAttributes, bool) {
	if o == nil || IsNil(o.Attributes) {
		return nil, false
	}
...
// SetAttributes gets a reference to the given POSTFreeGiftPromotionsRequestDataAttributes and assigns it to the Attributes field.
func (o *POSTFreeGiftPromotions201ResponseData) SetAttributes(v POSTFreeGiftPromotionsRequestDataAttributes) {
	o.Attributes = &v
}
