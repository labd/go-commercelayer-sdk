...
// checks if the GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData{}

// GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData struct for GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData
type GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData struct {
	// The resource's id
...
func NewGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData() *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData {
	this := GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData{}
	return &this
}
...
func (o *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
func (o GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData struct {
	value *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData
	isSet bool
}

func (v NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) Get() *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData {
	return v.value
}

func (v *NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) Set(val *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData(val *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) *NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData {
	return &NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData{value: val, isSet: true}
}

func (v NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
