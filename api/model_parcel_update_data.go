...
// checks if the ParcelUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParcelUpdateData{}
...
func (o ParcelUpdateData) ToMap() (map[string]interface{}, error) {
