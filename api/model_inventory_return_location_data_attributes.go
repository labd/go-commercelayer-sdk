...
// InventoryReturnLocationDataAttributes struct for InventoryReturnLocationDataAttributes
type InventoryReturnLocationDataAttributes struct {
...
func NewInventoryReturnLocationDataAttributes() *InventoryReturnLocationDataAttributes {
	this := InventoryReturnLocationDataAttributes{}
	return &this
}
...
func (o InventoryReturnLocationDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableInventoryReturnLocationDataAttributes struct {
	value *InventoryReturnLocationDataAttributes
	isSet bool
}

func (v NullableInventoryReturnLocationDataAttributes) Get() *InventoryReturnLocationDataAttributes {
	return v.value
}

func (v *NullableInventoryReturnLocationDataAttributes) Set(val *InventoryReturnLocationDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryReturnLocationDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryReturnLocationDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryReturnLocationDataAttributes(val *InventoryReturnLocationDataAttributes) *NullableInventoryReturnLocationDataAttributes {
	return &NullableInventoryReturnLocationDataAttributes{value: val, isSet: true}
}

func (v NullableInventoryReturnLocationDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryReturnLocationDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
