...
// ShippingCategoryDataAttributes struct for ShippingCategoryDataAttributes
type ShippingCategoryDataAttributes struct {
...
func NewShippingCategoryDataAttributes() *ShippingCategoryDataAttributes {
	this := ShippingCategoryDataAttributes{}
	return &this
}
...
func (o ShippingCategoryDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableShippingCategoryDataAttributes struct {
	value *ShippingCategoryDataAttributes
	isSet bool
}

func (v NullableShippingCategoryDataAttributes) Get() *ShippingCategoryDataAttributes {
	return v.value
}

func (v *NullableShippingCategoryDataAttributes) Set(val *ShippingCategoryDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingCategoryDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingCategoryDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingCategoryDataAttributes(val *ShippingCategoryDataAttributes) *NullableShippingCategoryDataAttributes {
	return &NullableShippingCategoryDataAttributes{value: val, isSet: true}
}

func (v NullableShippingCategoryDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingCategoryDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
