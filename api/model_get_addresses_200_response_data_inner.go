...
type GETAddresses200ResponseDataInner struct {
	...
	Attributes    *GETAddresses200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given GETAddresses200ResponseDataInnerAttributes and assigns it to the Attributes field.
