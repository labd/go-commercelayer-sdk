...
func NewGETBraintreePayments200Response() *GETBraintreePayments200Response {
	this := GETBraintreePayments200Response{}
	return &this
}
...
type NullableGETBraintreePayments200Response struct {
	value *GETBraintreePayments200Response
	isSet bool
}

func (v NullableGETBraintreePayments200Response) Get() *GETBraintreePayments200Response {
	return v.value
}

func (v *NullableGETBraintreePayments200Response) Set(val *GETBraintreePayments200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBraintreePayments200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBraintreePayments200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBraintreePayments200Response(val *GETBraintreePayments200Response) *NullableGETBraintreePayments200Response {
	return &NullableGETBraintreePayments200Response{value: val, isSet: true}
}

func (v NullableGETBraintreePayments200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBraintreePayments200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
