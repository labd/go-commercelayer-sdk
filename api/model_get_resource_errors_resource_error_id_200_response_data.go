...
// checks if the GETResourceErrorsResourceErrorId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETResourceErrorsResourceErrorId200ResponseData{}

// GETResourceErrorsResourceErrorId200ResponseData struct for GETResourceErrorsResourceErrorId200ResponseData
type GETResourceErrorsResourceErrorId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                   `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                            `json:"links,omitempty"`
	Attributes    *GETResourceErrorsResourceErrorId200ResponseDataAttributes    `json:"attributes,omitempty"`
	Relationships *GETResourceErrorsResourceErrorId200ResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *GETResourceErrorsResourceErrorId200ResponseData) GetAttributes() GETResourceErrorsResourceErrorId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret GETResourceErrorsResourceErrorId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GETResourceErrorsResourceErrorId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o *GETResourceErrorsResourceErrorId200ResponseData) GetRelationships() GETResourceErrorsResourceErrorId200ResponseDataRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret GETResourceErrorsResourceErrorId200ResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given GETResourceErrorsResourceErrorId200ResponseDataRelationships and assigns it to the Relationships field.
...
func (o GETResourceErrorsResourceErrorId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETResourceErrorsResourceErrorId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETResourceErrorsResourceErrorId200ResponseData struct {
	value *GETResourceErrorsResourceErrorId200ResponseData
	isSet bool
}

func (v NullableGETResourceErrorsResourceErrorId200ResponseData) Get() *GETResourceErrorsResourceErrorId200ResponseData {
	return v.value
}

func (v *NullableGETResourceErrorsResourceErrorId200ResponseData) Set(val *GETResourceErrorsResourceErrorId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETResourceErrorsResourceErrorId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETResourceErrorsResourceErrorId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETResourceErrorsResourceErrorId200ResponseData(val *GETResourceErrorsResourceErrorId200ResponseData) *NullableGETResourceErrorsResourceErrorId200ResponseData {
	return &NullableGETResourceErrorsResourceErrorId200ResponseData{value: val, isSet: true}
}

func (v NullableGETResourceErrorsResourceErrorId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETResourceErrorsResourceErrorId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
