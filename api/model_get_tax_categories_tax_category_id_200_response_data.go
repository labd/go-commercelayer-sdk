...
// checks if the GETTaxCategoriesTaxCategoryId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETTaxCategoriesTaxCategoryId200ResponseData{}

// GETTaxCategoriesTaxCategoryId200ResponseData struct for GETTaxCategoriesTaxCategoryId200ResponseData
type GETTaxCategoriesTaxCategoryId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                             `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                      `json:"links,omitempty"`
	Attributes    *GETTaxCategoriesTaxCategoryId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETTaxCategoriesTaxCategoryId200ResponseData() *GETTaxCategoriesTaxCategoryId200ResponseData {
	this := GETTaxCategoriesTaxCategoryId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETTaxCategoriesTaxCategoryId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETTaxCategoriesTaxCategoryId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETTaxCategoriesTaxCategoryId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETTaxCategoriesTaxCategoryId200ResponseData struct {
	value *GETTaxCategoriesTaxCategoryId200ResponseData
	isSet bool
}

func (v NullableGETTaxCategoriesTaxCategoryId200ResponseData) Get() *GETTaxCategoriesTaxCategoryId200ResponseData {
	return v.value
}

func (v *NullableGETTaxCategoriesTaxCategoryId200ResponseData) Set(val *GETTaxCategoriesTaxCategoryId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETTaxCategoriesTaxCategoryId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETTaxCategoriesTaxCategoryId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETTaxCategoriesTaxCategoryId200ResponseData(val *GETTaxCategoriesTaxCategoryId200ResponseData) *NullableGETTaxCategoriesTaxCategoryId200ResponseData {
	return &NullableGETTaxCategoriesTaxCategoryId200ResponseData{value: val, isSet: true}
}

func (v NullableGETTaxCategoriesTaxCategoryId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETTaxCategoriesTaxCategoryId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
