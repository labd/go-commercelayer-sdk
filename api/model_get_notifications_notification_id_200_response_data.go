...
// checks if the GETNotificationsNotificationId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETNotificationsNotificationId200ResponseData{}

// GETNotificationsNotificationId200ResponseData struct for GETNotificationsNotificationId200ResponseData
type GETNotificationsNotificationId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                              `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                       `json:"links,omitempty"`
	Attributes    *GETNotificationsNotificationId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETNotificationsNotificationId200ResponseData() *GETNotificationsNotificationId200ResponseData {
	this := GETNotificationsNotificationId200ResponseData{}
	return &this
}
...
func (o *GETNotificationsNotificationId200ResponseData) GetAttributes() GETNotificationsNotificationId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret GETNotificationsNotificationId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GETNotificationsNotificationId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETNotificationsNotificationId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETNotificationsNotificationId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETNotificationsNotificationId200ResponseData struct {
	value *GETNotificationsNotificationId200ResponseData
	isSet bool
}

func (v NullableGETNotificationsNotificationId200ResponseData) Get() *GETNotificationsNotificationId200ResponseData {
	return v.value
}
...
func (v NullableGETNotificationsNotificationId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETNotificationsNotificationId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETNotificationsNotificationId200ResponseData(val *GETNotificationsNotificationId200ResponseData) *NullableGETNotificationsNotificationId200ResponseData {
	return &NullableGETNotificationsNotificationId200ResponseData{value: val, isSet: true}
}

func (v NullableGETNotificationsNotificationId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETNotificationsNotificationId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
