...
// checks if the GETManualGateways200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETManualGateways200Response{}
...
func (o GETManualGateways200Response) ToMap() (map[string]interface{}, error) {
