...
// FreeShippingPromotionResponseData struct for FreeShippingPromotionResponseData
type FreeShippingPromotionResponseData struct {
	// The resource's id
...
func NewFreeShippingPromotionResponseData() *FreeShippingPromotionResponseData {
	this := FreeShippingPromotionResponseData{}
	return &this
}
...
func (o FreeShippingPromotionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableFreeShippingPromotionResponseData struct {
	value *FreeShippingPromotionResponseData
	isSet bool
}

func (v NullableFreeShippingPromotionResponseData) Get() *FreeShippingPromotionResponseData {
	return v.value
}

func (v *NullableFreeShippingPromotionResponseData) Set(val *FreeShippingPromotionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableFreeShippingPromotionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableFreeShippingPromotionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFreeShippingPromotionResponseData(val *FreeShippingPromotionResponseData) *NullableFreeShippingPromotionResponseData {
	return &NullableFreeShippingPromotionResponseData{value: val, isSet: true}
}

func (v NullableFreeShippingPromotionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFreeShippingPromotionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
