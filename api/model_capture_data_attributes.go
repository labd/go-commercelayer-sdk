...
// CaptureDataAttributes struct for CaptureDataAttributes
type CaptureDataAttributes struct {
...
func (o CaptureDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableCaptureDataAttributes struct {
	value *CaptureDataAttributes
	isSet bool
}

func (v NullableCaptureDataAttributes) Get() *CaptureDataAttributes {
	return v.value
}

func (v *NullableCaptureDataAttributes) Set(val *CaptureDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableCaptureDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableCaptureDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaptureDataAttributes(val *CaptureDataAttributes) *NullableCaptureDataAttributes {
	return &NullableCaptureDataAttributes{value: val, isSet: true}
}

func (v NullableCaptureDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaptureDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
