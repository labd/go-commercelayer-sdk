...
// GETCoupons200ResponseDataInner struct for GETCoupons200ResponseDataInner
type GETCoupons200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                      `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks       `json:"links,omitempty"`
	Attributes    *GETCoupons200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETCoupons200ResponseDataInner() *GETCoupons200ResponseDataInner {
	this := GETCoupons200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETCoupons200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETCoupons200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETCoupons200ResponseDataInner struct {
	value *GETCoupons200ResponseDataInner
	isSet bool
}

func (v NullableGETCoupons200ResponseDataInner) Get() *GETCoupons200ResponseDataInner {
	return v.value
}

func (v *NullableGETCoupons200ResponseDataInner) Set(val *GETCoupons200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCoupons200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCoupons200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCoupons200ResponseDataInner(val *GETCoupons200ResponseDataInner) *NullableGETCoupons200ResponseDataInner {
	return &NullableGETCoupons200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETCoupons200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCoupons200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
