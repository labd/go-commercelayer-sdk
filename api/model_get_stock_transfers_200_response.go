...
// checks if the GETStockTransfers200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETStockTransfers200Response{}
...
func (o GETStockTransfers200Response) ToMap() (map[string]interface{}, error) {
