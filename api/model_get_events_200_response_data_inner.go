...
type GETEvents200ResponseDataInner struct {
	...
	Attributes *GETEvents200ResponseDataInnerAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given GETEvents200ResponseDataInnerAttributes and assigns it to the Attributes field.
