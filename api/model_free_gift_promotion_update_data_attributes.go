...
// FreeGiftPromotionUpdateDataAttributes struct for FreeGiftPromotionUpdateDataAttributes
type FreeGiftPromotionUpdateDataAttributes struct {
...
func NewFreeGiftPromotionUpdateDataAttributes() *FreeGiftPromotionUpdateDataAttributes {
	this := FreeGiftPromotionUpdateDataAttributes{}
	return &this
}
...
func (o FreeGiftPromotionUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableFreeGiftPromotionUpdateDataAttributes struct {
	value *FreeGiftPromotionUpdateDataAttributes
	isSet bool
}

func (v NullableFreeGiftPromotionUpdateDataAttributes) Get() *FreeGiftPromotionUpdateDataAttributes {
	return v.value
}

func (v *NullableFreeGiftPromotionUpdateDataAttributes) Set(val *FreeGiftPromotionUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableFreeGiftPromotionUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableFreeGiftPromotionUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFreeGiftPromotionUpdateDataAttributes(val *FreeGiftPromotionUpdateDataAttributes) *NullableFreeGiftPromotionUpdateDataAttributes {
	return &NullableFreeGiftPromotionUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableFreeGiftPromotionUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFreeGiftPromotionUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
