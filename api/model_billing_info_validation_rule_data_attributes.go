...
// BillingInfoValidationRuleDataAttributes struct for BillingInfoValidationRuleDataAttributes
type BillingInfoValidationRuleDataAttributes struct {
...
func NewBillingInfoValidationRuleDataAttributes() *BillingInfoValidationRuleDataAttributes {
	this := BillingInfoValidationRuleDataAttributes{}
	return &this
}
...
func (o BillingInfoValidationRuleDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableBillingInfoValidationRuleDataAttributes struct {
	value *BillingInfoValidationRuleDataAttributes
	isSet bool
}

func (v NullableBillingInfoValidationRuleDataAttributes) Get() *BillingInfoValidationRuleDataAttributes {
	return v.value
}

func (v *NullableBillingInfoValidationRuleDataAttributes) Set(val *BillingInfoValidationRuleDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingInfoValidationRuleDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingInfoValidationRuleDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingInfoValidationRuleDataAttributes(val *BillingInfoValidationRuleDataAttributes) *NullableBillingInfoValidationRuleDataAttributes {
	return &NullableBillingInfoValidationRuleDataAttributes{value: val, isSet: true}
}

func (v NullableBillingInfoValidationRuleDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingInfoValidationRuleDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
