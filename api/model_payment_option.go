...
type PaymentOption struct {
	Data *PaymentOptionData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given PaymentOptionData and assigns it to the Data field.
