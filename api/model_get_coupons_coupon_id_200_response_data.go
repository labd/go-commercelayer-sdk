...
// checks if the GETCouponsCouponId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETCouponsCouponId200ResponseData{}

// GETCouponsCouponId200ResponseData struct for GETCouponsCouponId200ResponseData
type GETCouponsCouponId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks           `json:"links,omitempty"`
	Attributes    *GETCouponsCouponId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETCouponsCouponId200ResponseData() *GETCouponsCouponId200ResponseData {
	this := GETCouponsCouponId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETCouponsCouponId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETCouponsCouponId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETCouponsCouponId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETCouponsCouponId200ResponseData struct {
	value *GETCouponsCouponId200ResponseData
	isSet bool
}

func (v NullableGETCouponsCouponId200ResponseData) Get() *GETCouponsCouponId200ResponseData {
	return v.value
}

func (v *NullableGETCouponsCouponId200ResponseData) Set(val *GETCouponsCouponId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCouponsCouponId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCouponsCouponId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCouponsCouponId200ResponseData(val *GETCouponsCouponId200ResponseData) *NullableGETCouponsCouponId200ResponseData {
	return &NullableGETCouponsCouponId200ResponseData{value: val, isSet: true}
}

func (v NullableGETCouponsCouponId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCouponsCouponId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
