...
type POSTBraintreeGateways201ResponseData struct {
	...
	Attributes    *POSTBraintreeGatewaysRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTBraintreeGatewaysRequestDataAttributes and assigns it to the Attributes field.
