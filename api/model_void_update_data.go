...
// checks if the VoidUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VoidUpdateData{}

// VoidUpdateData struct for VoidUpdateData
type VoidUpdateData struct {
	// The resource's type
...
func (o VoidUpdateData) MarshalJSON() ([]byte, error) {
...
func (o VoidUpdateData) ToMap() (map[string]interface{}, error) {
...
type NullableVoidUpdateData struct {
	value *VoidUpdateData
	isSet bool
}

func (v NullableVoidUpdateData) Get() *VoidUpdateData {
	return v.value
}

func (v *NullableVoidUpdateData) Set(val *VoidUpdateData) {
	v.value = val
	v.isSet = true
}

func (v NullableVoidUpdateData) IsSet() bool {
	return v.isSet
}

func (v *NullableVoidUpdateData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoidUpdateData(val *VoidUpdateData) *NullableVoidUpdateData {
	return &NullableVoidUpdateData{value: val, isSet: true}
}

func (v NullableVoidUpdateData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoidUpdateData) UnmarshalJSON(src []byte) error {
	v.isSet = true
