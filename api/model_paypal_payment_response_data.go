...
// PaypalPaymentResponseData struct for PaypalPaymentResponseData
type PaypalPaymentResponseData struct {
	// The resource's id
...
func NewPaypalPaymentResponseData() *PaypalPaymentResponseData {
	this := PaypalPaymentResponseData{}
	return &this
}
...
func (o PaypalPaymentResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePaypalPaymentResponseData struct {
	value *PaypalPaymentResponseData
	isSet bool
}

func (v NullablePaypalPaymentResponseData) Get() *PaypalPaymentResponseData {
	return v.value
}

func (v *NullablePaypalPaymentResponseData) Set(val *PaypalPaymentResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePaypalPaymentResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePaypalPaymentResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaypalPaymentResponseData(val *PaypalPaymentResponseData) *NullablePaypalPaymentResponseData {
	return &NullablePaypalPaymentResponseData{value: val, isSet: true}
}

func (v NullablePaypalPaymentResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaypalPaymentResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
