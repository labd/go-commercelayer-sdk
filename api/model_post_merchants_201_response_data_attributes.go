...
// checks if the POSTMerchants201ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTMerchants201ResponseDataAttributes{}

// POSTMerchants201ResponseDataAttributes struct for POSTMerchants201ResponseDataAttributes
type POSTMerchants201ResponseDataAttributes struct {
...
func NewPOSTMerchants201ResponseDataAttributes(name interface{}) *POSTMerchants201ResponseDataAttributes {
	this := POSTMerchants201ResponseDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTMerchants201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTMerchants201ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTMerchants201ResponseDataAttributes struct {
	value *POSTMerchants201ResponseDataAttributes
	isSet bool
}

func (v NullablePOSTMerchants201ResponseDataAttributes) Get() *POSTMerchants201ResponseDataAttributes {
	return v.value
}

func (v *NullablePOSTMerchants201ResponseDataAttributes) Set(val *POSTMerchants201ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTMerchants201ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTMerchants201ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTMerchants201ResponseDataAttributes(val *POSTMerchants201ResponseDataAttributes) *NullablePOSTMerchants201ResponseDataAttributes {
	return &NullablePOSTMerchants201ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTMerchants201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTMerchants201ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
