...
// checks if the GETPaymentMethodsPaymentMethodId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPaymentMethodsPaymentMethodId200ResponseData{}

// GETPaymentMethodsPaymentMethodId200ResponseData struct for GETPaymentMethodsPaymentMethodId200ResponseData
type GETPaymentMethodsPaymentMethodId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                         `json:"links,omitempty"`
	Attributes    *GETPaymentMethodsPaymentMethodId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETPaymentMethodsPaymentMethodId200ResponseData() *GETPaymentMethodsPaymentMethodId200ResponseData {
	this := GETPaymentMethodsPaymentMethodId200ResponseData{}
	return &this
}
...
func (o *GETPaymentMethodsPaymentMethodId200ResponseData) GetAttributes() GETPaymentMethodsPaymentMethodId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret GETPaymentMethodsPaymentMethodId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GETPaymentMethodsPaymentMethodId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETPaymentMethodsPaymentMethodId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETPaymentMethodsPaymentMethodId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETPaymentMethodsPaymentMethodId200ResponseData struct {
	value *GETPaymentMethodsPaymentMethodId200ResponseData
	isSet bool
}

func (v NullableGETPaymentMethodsPaymentMethodId200ResponseData) Get() *GETPaymentMethodsPaymentMethodId200ResponseData {
	return v.value
}

func (v *NullableGETPaymentMethodsPaymentMethodId200ResponseData) Set(val *GETPaymentMethodsPaymentMethodId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPaymentMethodsPaymentMethodId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPaymentMethodsPaymentMethodId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPaymentMethodsPaymentMethodId200ResponseData(val *GETPaymentMethodsPaymentMethodId200ResponseData) *NullableGETPaymentMethodsPaymentMethodId200ResponseData {
	return &NullableGETPaymentMethodsPaymentMethodId200ResponseData{value: val, isSet: true}
}

func (v NullableGETPaymentMethodsPaymentMethodId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPaymentMethodsPaymentMethodId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
