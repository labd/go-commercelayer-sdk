...
// checks if the GETAdyenPaymentsAdyenPaymentId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETAdyenPaymentsAdyenPaymentId200ResponseData{}

// GETAdyenPaymentsAdyenPaymentId200ResponseData struct for GETAdyenPaymentsAdyenPaymentId200ResponseData
type GETAdyenPaymentsAdyenPaymentId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                              `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                       `json:"links,omitempty"`
	Attributes    *GETAdyenPaymentsAdyenPaymentId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETAdyenPaymentsAdyenPaymentId200ResponseData() *GETAdyenPaymentsAdyenPaymentId200ResponseData {
	this := GETAdyenPaymentsAdyenPaymentId200ResponseData{}
	return &this
}
...
func (o *GETAdyenPaymentsAdyenPaymentId200ResponseData) GetAttributes() GETAdyenPaymentsAdyenPaymentId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret GETAdyenPaymentsAdyenPaymentId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GETAdyenPaymentsAdyenPaymentId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETAdyenPaymentsAdyenPaymentId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETAdyenPaymentsAdyenPaymentId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETAdyenPaymentsAdyenPaymentId200ResponseData struct {
	value *GETAdyenPaymentsAdyenPaymentId200ResponseData
	isSet bool
}

func (v NullableGETAdyenPaymentsAdyenPaymentId200ResponseData) Get() *GETAdyenPaymentsAdyenPaymentId200ResponseData {
	return v.value
}

func (v *NullableGETAdyenPaymentsAdyenPaymentId200ResponseData) Set(val *GETAdyenPaymentsAdyenPaymentId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAdyenPaymentsAdyenPaymentId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAdyenPaymentsAdyenPaymentId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAdyenPaymentsAdyenPaymentId200ResponseData(val *GETAdyenPaymentsAdyenPaymentId200ResponseData) *NullableGETAdyenPaymentsAdyenPaymentId200ResponseData {
	return &NullableGETAdyenPaymentsAdyenPaymentId200ResponseData{value: val, isSet: true}
}

func (v NullableGETAdyenPaymentsAdyenPaymentId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAdyenPaymentsAdyenPaymentId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
