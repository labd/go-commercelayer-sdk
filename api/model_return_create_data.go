...
// checks if the ReturnCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnCreateData{}
...
func (o ReturnCreateData) ToMap() (map[string]interface{}, error) {
