...
// checks if the POSTCheckoutComGateways201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTCheckoutComGateways201Response{}
...
func (o POSTCheckoutComGateways201Response) ToMap() (map[string]interface{}, error) {
