...
// PriceTierResponseData struct for PriceTierResponseData
type PriceTierResponseData struct {
	// The resource's id
...
func (o PriceTierResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePriceTierResponseData struct {
	value *PriceTierResponseData
	isSet bool
}

func (v NullablePriceTierResponseData) Get() *PriceTierResponseData {
	return v.value
}

func (v *NullablePriceTierResponseData) Set(val *PriceTierResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceTierResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceTierResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceTierResponseData(val *PriceTierResponseData) *NullablePriceTierResponseData {
	return &NullablePriceTierResponseData{value: val, isSet: true}
}

func (v NullablePriceTierResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceTierResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
