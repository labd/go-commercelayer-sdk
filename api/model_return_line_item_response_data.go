...
// ReturnLineItemResponseData struct for ReturnLineItemResponseData
type ReturnLineItemResponseData struct {
	// The resource's id
	...
	Relationships *ReturnLineItemResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewReturnLineItemResponseData() *ReturnLineItemResponseData {
	this := ReturnLineItemResponseData{}
	return &this
}
...
func (o *ReturnLineItemResponseData) GetRelationships() ReturnLineItemResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ReturnLineItemResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ReturnLineItemResponseDataRelationships and assigns it to the Relationships field.
func (o *ReturnLineItemResponseData) SetRelationships(v ReturnLineItemResponseDataRelationships) {
	o.Relationships = &v
}

func (o ReturnLineItemResponseData) MarshalJSON() ([]byte, error) {
...
type NullableReturnLineItemResponseData struct {
	value *ReturnLineItemResponseData
	isSet bool
}

func (v NullableReturnLineItemResponseData) Get() *ReturnLineItemResponseData {
	return v.value
}

func (v *NullableReturnLineItemResponseData) Set(val *ReturnLineItemResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnLineItemResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnLineItemResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnLineItemResponseData(val *ReturnLineItemResponseData) *NullableReturnLineItemResponseData {
	return &NullableReturnLineItemResponseData{value: val, isSet: true}
}

func (v NullableReturnLineItemResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnLineItemResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
