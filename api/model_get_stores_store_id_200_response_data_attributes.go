...
// checks if the GETStoresStoreId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETStoresStoreId200ResponseDataAttributes{}

// GETStoresStoreId200ResponseDataAttributes struct for GETStoresStoreId200ResponseDataAttributes
type GETStoresStoreId200ResponseDataAttributes struct {
...
func NewGETStoresStoreId200ResponseDataAttributes() *GETStoresStoreId200ResponseDataAttributes {
	this := GETStoresStoreId200ResponseDataAttributes{}
	return &this
}
...
func (o *GETStoresStoreId200ResponseDataAttributes) GetNameOk() (*interface{}, bool) {
...
func (o *GETStoresStoreId200ResponseDataAttributes) SetUpdatedAt(v interface{}) {
	o.UpdatedAt = v
}
...
func (o *GETStoresStoreId200ResponseDataAttributes) GetReferenceOrigin() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o GETStoresStoreId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETStoresStoreId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETStoresStoreId200ResponseDataAttributes struct {
	value *GETStoresStoreId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETStoresStoreId200ResponseDataAttributes) Get() *GETStoresStoreId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETStoresStoreId200ResponseDataAttributes) Set(val *GETStoresStoreId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETStoresStoreId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETStoresStoreId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETStoresStoreId200ResponseDataAttributes(val *GETStoresStoreId200ResponseDataAttributes) *NullableGETStoresStoreId200ResponseDataAttributes {
	return &NullableGETStoresStoreId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETStoresStoreId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETStoresStoreId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
