...
// StockItemUpdateDataAttributes struct for StockItemUpdateDataAttributes
type StockItemUpdateDataAttributes struct {
...
func NewStockItemUpdateDataAttributes() *StockItemUpdateDataAttributes {
	this := StockItemUpdateDataAttributes{}
	return &this
}
...
func (o StockItemUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableStockItemUpdateDataAttributes struct {
	value *StockItemUpdateDataAttributes
	isSet bool
}

func (v NullableStockItemUpdateDataAttributes) Get() *StockItemUpdateDataAttributes {
	return v.value
}

func (v *NullableStockItemUpdateDataAttributes) Set(val *StockItemUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableStockItemUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableStockItemUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStockItemUpdateDataAttributes(val *StockItemUpdateDataAttributes) *NullableStockItemUpdateDataAttributes {
	return &NullableStockItemUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableStockItemUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStockItemUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
