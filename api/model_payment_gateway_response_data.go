...
// PaymentGatewayResponseData struct for PaymentGatewayResponseData
...
func NewPaymentGatewayResponseData() *PaymentGatewayResponseData {
	this := PaymentGatewayResponseData{}
	return &this
}
...
func (o PaymentGatewayResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePaymentGatewayResponseData struct {
	value *PaymentGatewayResponseData
	isSet bool
}

func (v NullablePaymentGatewayResponseData) Get() *PaymentGatewayResponseData {
	return v.value
}

func (v *NullablePaymentGatewayResponseData) Set(val *PaymentGatewayResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentGatewayResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentGatewayResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentGatewayResponseData(val *PaymentGatewayResponseData) *NullablePaymentGatewayResponseData {
	return &NullablePaymentGatewayResponseData{value: val, isSet: true}
}

func (v NullablePaymentGatewayResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentGatewayResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
