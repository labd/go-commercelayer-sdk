...
// checks if the GETOrderSubscriptionsOrderSubscriptionId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETOrderSubscriptionsOrderSubscriptionId200ResponseData{}

// GETOrderSubscriptionsOrderSubscriptionId200ResponseData struct for GETOrderSubscriptionsOrderSubscriptionId200ResponseData
type GETOrderSubscriptionsOrderSubscriptionId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                        `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                 `json:"links,omitempty"`
	Attributes    *GETOrderSubscriptionsOrderSubscriptionId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETOrderSubscriptionsOrderSubscriptionId200ResponseData() *GETOrderSubscriptionsOrderSubscriptionId200ResponseData {
	this := GETOrderSubscriptionsOrderSubscriptionId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETOrderSubscriptionsOrderSubscriptionId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETOrderSubscriptionsOrderSubscriptionId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETOrderSubscriptionsOrderSubscriptionId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData struct {
	value *GETOrderSubscriptionsOrderSubscriptionId200ResponseData
	isSet bool
}

func (v NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData) Get() *GETOrderSubscriptionsOrderSubscriptionId200ResponseData {
	return v.value
}

func (v *NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData) Set(val *GETOrderSubscriptionsOrderSubscriptionId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData(val *GETOrderSubscriptionsOrderSubscriptionId200ResponseData) *NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData {
	return &NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData{value: val, isSet: true}
}

func (v NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETOrderSubscriptionsOrderSubscriptionId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
