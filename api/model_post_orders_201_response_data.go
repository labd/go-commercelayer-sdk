...
// POSTOrders201ResponseData struct for POSTOrders201ResponseData
type POSTOrders201ResponseData struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type *string `json:"type,omitempty"`
	Links *GETAddresses200ResponseDataInnerLinks `json:"links,omitempty"`
	Attributes *POSTOrders201ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewPOSTOrders201ResponseData() *POSTOrders201ResponseData {
	this := POSTOrders201ResponseData{}
...
// SetAttributes gets a reference to the given POSTOrders201ResponseDataAttributes and assigns it to the Attributes field.
...
func (o POSTOrders201ResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePOSTOrders201ResponseData struct {
	value *POSTOrders201ResponseData
	isSet bool
}

func (v NullablePOSTOrders201ResponseData) Get() *POSTOrders201ResponseData {
	return v.value
}

func (v *NullablePOSTOrders201ResponseData) Set(val *POSTOrders201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTOrders201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTOrders201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTOrders201ResponseData(val *POSTOrders201ResponseData) *NullablePOSTOrders201ResponseData {
	return &NullablePOSTOrders201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTOrders201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTOrders201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
