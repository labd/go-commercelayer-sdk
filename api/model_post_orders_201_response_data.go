...
// checks if the POSTOrders201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTOrders201ResponseData{}
...
type POSTOrders201ResponseData struct {
	...
	Attributes    *POSTOrdersRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTOrdersRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTOrders201ResponseData) ToMap() (map[string]interface{}, error) {
