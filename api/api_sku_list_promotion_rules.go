...
type SkuListPromotionRulesApiPATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest struct {
	ctx                                                     context.Context
	ApiService                                              *SkuListPromotionRulesApiService
	pATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest *PATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest
	skuListPromotionRuleId                                  interface{}
}

func (r SkuListPromotionRulesApiPATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest) PATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest(pATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest PATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest) SkuListPromotionRulesApiPATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest {
	r.pATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest = &pATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest
	return r
}
...
func (a *SkuListPromotionRulesApiService) PATCHSkuListPromotionRulesSkuListPromotionRuleIdExecute(r SkuListPromotionRulesApiPATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest) (*PATCHSkuListPromotionRulesSkuListPromotionRuleId200Response, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.pATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest == nil {
		return localVarReturnValue, nil, reportError("pATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.pATCHSkuListPromotionRulesSkuListPromotionRuleIdRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type SkuListPromotionRulesApiPOSTSkuListPromotionRulesRequest struct {
	ctx                              context.Context
	ApiService                       *SkuListPromotionRulesApiService
	pOSTSkuListPromotionRulesRequest *POSTSkuListPromotionRulesRequest
}

func (r SkuListPromotionRulesApiPOSTSkuListPromotionRulesRequest) POSTSkuListPromotionRulesRequest(pOSTSkuListPromotionRulesRequest POSTSkuListPromotionRulesRequest) SkuListPromotionRulesApiPOSTSkuListPromotionRulesRequest {
	r.pOSTSkuListPromotionRulesRequest = &pOSTSkuListPromotionRulesRequest
	return r
}
...
func (a *SkuListPromotionRulesApiService) POSTSkuListPromotionRulesExecute(r SkuListPromotionRulesApiPOSTSkuListPromotionRulesRequest) (*POSTSkuListPromotionRules201Response, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.pOSTSkuListPromotionRulesRequest == nil {
		return localVarReturnValue, nil, reportError("pOSTSkuListPromotionRulesRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.pOSTSkuListPromotionRulesRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
