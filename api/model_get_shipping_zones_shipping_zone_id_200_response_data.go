...
// checks if the GETShippingZonesShippingZoneId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETShippingZonesShippingZoneId200ResponseData{}

// GETShippingZonesShippingZoneId200ResponseData struct for GETShippingZonesShippingZoneId200ResponseData
type GETShippingZonesShippingZoneId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                              `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                       `json:"links,omitempty"`
	Attributes    *GETShippingZonesShippingZoneId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETShippingZonesShippingZoneId200ResponseData() *GETShippingZonesShippingZoneId200ResponseData {
	this := GETShippingZonesShippingZoneId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETShippingZonesShippingZoneId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETShippingZonesShippingZoneId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETShippingZonesShippingZoneId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETShippingZonesShippingZoneId200ResponseData struct {
	value *GETShippingZonesShippingZoneId200ResponseData
	isSet bool
}

func (v NullableGETShippingZonesShippingZoneId200ResponseData) Get() *GETShippingZonesShippingZoneId200ResponseData {
	return v.value
}

func (v *NullableGETShippingZonesShippingZoneId200ResponseData) Set(val *GETShippingZonesShippingZoneId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETShippingZonesShippingZoneId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETShippingZonesShippingZoneId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETShippingZonesShippingZoneId200ResponseData(val *GETShippingZonesShippingZoneId200ResponseData) *NullableGETShippingZonesShippingZoneId200ResponseData {
	return &NullableGETShippingZonesShippingZoneId200ResponseData{value: val, isSet: true}
}

func (v NullableGETShippingZonesShippingZoneId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETShippingZonesShippingZoneId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
