...
// GoogleGeocoderResponseData struct for GoogleGeocoderResponseData
type GoogleGeocoderResponseData struct {
	// The resource's id
	...
	Relationships *BingGeocoderResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewGoogleGeocoderResponseData() *GoogleGeocoderResponseData {
	this := GoogleGeocoderResponseData{}
	return &this
}
...
func (o *GoogleGeocoderResponseData) GetRelationships() BingGeocoderResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret BingGeocoderResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given BingGeocoderResponseDataRelationships and assigns it to the Relationships field.
func (o *GoogleGeocoderResponseData) SetRelationships(v BingGeocoderResponseDataRelationships) {
	o.Relationships = &v
}

func (o GoogleGeocoderResponseData) MarshalJSON() ([]byte, error) {
...
type NullableGoogleGeocoderResponseData struct {
	value *GoogleGeocoderResponseData
	isSet bool
}

func (v NullableGoogleGeocoderResponseData) Get() *GoogleGeocoderResponseData {
	return v.value
}

func (v *NullableGoogleGeocoderResponseData) Set(val *GoogleGeocoderResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGoogleGeocoderResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGoogleGeocoderResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoogleGeocoderResponseData(val *GoogleGeocoderResponseData) *NullableGoogleGeocoderResponseData {
	return &NullableGoogleGeocoderResponseData{value: val, isSet: true}
}

func (v NullableGoogleGeocoderResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoogleGeocoderResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
