...
// checks if the GoogleGeocoderUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GoogleGeocoderUpdateData{}
...
func (o GoogleGeocoderUpdateData) ToMap() (map[string]interface{}, error) {
