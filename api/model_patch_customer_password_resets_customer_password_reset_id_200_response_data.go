...
func (o *PATCHCustomerPasswordResetsCustomerPasswordResetId200ResponseData) GetRelationships() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *PATCHCustomerPasswordResetsCustomerPasswordResetId200ResponseData) GetRelationshipsOk() (map[string]interface{}, bool) {
	if o == nil || o.Relationships == nil {
		return nil, false
	}
...
func (o *PATCHCustomerPasswordResetsCustomerPasswordResetId200ResponseData) SetRelationships(v map[string]interface{}) {
	o.Relationships = v
}
