...
type PATCHCustomerPasswordResetsCustomerPasswordResetId200ResponseData struct {
	...
	Attributes    *PATCHCustomerPasswordResetsCustomerPasswordResetIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHCustomerPasswordResetsCustomerPasswordResetIdRequestDataAttributes and assigns it to the Attributes field.
