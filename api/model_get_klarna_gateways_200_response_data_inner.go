...
// GETKlarnaGateways200ResponseDataInner struct for GETKlarnaGateways200ResponseDataInner
type GETKlarnaGateways200ResponseDataInner struct {
	// The resource's id
...
func NewGETKlarnaGateways200ResponseDataInner() *GETKlarnaGateways200ResponseDataInner {
	this := GETKlarnaGateways200ResponseDataInner{}
	return &this
}
...
func (o GETKlarnaGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETKlarnaGateways200ResponseDataInner struct {
	value *GETKlarnaGateways200ResponseDataInner
	isSet bool
}

func (v NullableGETKlarnaGateways200ResponseDataInner) Get() *GETKlarnaGateways200ResponseDataInner {
	return v.value
}

func (v *NullableGETKlarnaGateways200ResponseDataInner) Set(val *GETKlarnaGateways200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETKlarnaGateways200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETKlarnaGateways200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETKlarnaGateways200ResponseDataInner(val *GETKlarnaGateways200ResponseDataInner) *NullableGETKlarnaGateways200ResponseDataInner {
	return &NullableGETKlarnaGateways200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETKlarnaGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETKlarnaGateways200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
