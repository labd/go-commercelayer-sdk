...
// checks if the ShipmentUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShipmentUpdateData{}
...
func (o ShipmentUpdateData) ToMap() (map[string]interface{}, error) {
