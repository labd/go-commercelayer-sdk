...
// checks if the ExternalTaxCalculatorUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalTaxCalculatorUpdateData{}
...
func (o ExternalTaxCalculatorUpdateData) ToMap() (map[string]interface{}, error) {
