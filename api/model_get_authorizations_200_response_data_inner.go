...
// GETAuthorizations200ResponseDataInner struct for GETAuthorizations200ResponseDataInner
type GETAuthorizations200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                             `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks              `json:"links,omitempty"`
	Attributes    *GETAuthorizations200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETAuthorizations200ResponseDataInner() *GETAuthorizations200ResponseDataInner {
	this := GETAuthorizations200ResponseDataInner{}
...
// SetAttributes gets a reference to the given GETAuthorizations200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETAuthorizations200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETAuthorizations200ResponseDataInner struct {
	value *GETAuthorizations200ResponseDataInner
	isSet bool
}

func (v NullableGETAuthorizations200ResponseDataInner) Get() *GETAuthorizations200ResponseDataInner {
	return v.value
}

func (v *NullableGETAuthorizations200ResponseDataInner) Set(val *GETAuthorizations200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAuthorizations200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAuthorizations200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAuthorizations200ResponseDataInner(val *GETAuthorizations200ResponseDataInner) *NullableGETAuthorizations200ResponseDataInner {
	return &NullableGETAuthorizations200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETAuthorizations200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAuthorizations200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
