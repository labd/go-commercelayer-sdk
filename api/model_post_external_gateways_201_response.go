...
// checks if the POSTExternalGateways201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTExternalGateways201Response{}
...
func (o POSTExternalGateways201Response) ToMap() (map[string]interface{}, error) {
