...
// checks if the LinkUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkUpdateData{}

// LinkUpdateData struct for LinkUpdateData
type LinkUpdateData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                               `json:"id"`
	Attributes    PATCHLinksLinkId200ResponseDataAttributes `json:"attributes"`
	Relationships *LinkUpdateDataRelationships              `json:"relationships,omitempty"`
}
...
func (o *LinkUpdateData) GetRelationships() LinkUpdateDataRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret LinkUpdateDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given LinkUpdateDataRelationships and assigns it to the Relationships field.
func (o *LinkUpdateData) SetRelationships(v LinkUpdateDataRelationships) {
	o.Relationships = &v
}

func (o LinkUpdateData) MarshalJSON() ([]byte, error) {
...
func (o LinkUpdateData) ToMap() (map[string]interface{}, error) {
...
type NullableLinkUpdateData struct {
	value *LinkUpdateData
	isSet bool
}

func (v NullableLinkUpdateData) Get() *LinkUpdateData {
	return v.value
}

func (v *NullableLinkUpdateData) Set(val *LinkUpdateData) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkUpdateData) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkUpdateData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkUpdateData(val *LinkUpdateData) *NullableLinkUpdateData {
	return &NullableLinkUpdateData{value: val, isSet: true}
}

func (v NullableLinkUpdateData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkUpdateData) UnmarshalJSON(src []byte) error {
	v.isSet = true
