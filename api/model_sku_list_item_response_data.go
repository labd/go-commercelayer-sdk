...
// SkuListItemResponseData struct for SkuListItemResponseData
type SkuListItemResponseData struct {
	// The resource's id
	...
	Relationships *SkuListItemResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *SkuListItemResponseData) GetRelationships() SkuListItemResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret SkuListItemResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given SkuListItemResponseDataRelationships and assigns it to the Relationships field.
func (o *SkuListItemResponseData) SetRelationships(v SkuListItemResponseDataRelationships) {
	o.Relationships = &v
}

func (o SkuListItemResponseData) MarshalJSON() ([]byte, error) {
...
type NullableSkuListItemResponseData struct {
	value *SkuListItemResponseData
	isSet bool
}

func (v NullableSkuListItemResponseData) Get() *SkuListItemResponseData {
	return v.value
}

func (v *NullableSkuListItemResponseData) Set(val *SkuListItemResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableSkuListItemResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableSkuListItemResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkuListItemResponseData(val *SkuListItemResponseData) *NullableSkuListItemResponseData {
	return &NullableSkuListItemResponseData{value: val, isSet: true}
}

func (v NullableSkuListItemResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkuListItemResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
