...
// GETGiftCards200ResponseDataInner struct for GETGiftCards200ResponseDataInner
type GETGiftCards200ResponseDataInner struct {
	// The resource's id
...
// SetAttributes gets a reference to the given GETGiftCards200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETGiftCards200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETGiftCards200ResponseDataInner struct {
	value *GETGiftCards200ResponseDataInner
	isSet bool
}

func (v NullableGETGiftCards200ResponseDataInner) Get() *GETGiftCards200ResponseDataInner {
	return v.value
}

func (v *NullableGETGiftCards200ResponseDataInner) Set(val *GETGiftCards200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETGiftCards200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETGiftCards200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETGiftCards200ResponseDataInner(val *GETGiftCards200ResponseDataInner) *NullableGETGiftCards200ResponseDataInner {
	return &NullableGETGiftCards200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETGiftCards200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETGiftCards200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
