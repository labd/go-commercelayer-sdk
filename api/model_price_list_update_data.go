...
// checks if the PriceListUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceListUpdateData{}
...
func (o PriceListUpdateData) ToMap() (map[string]interface{}, error) {
