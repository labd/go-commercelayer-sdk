...
// ReturnResponseData struct for ReturnResponseData
type ReturnResponseData struct {
	// The resource's id
	...
	Relationships *ReturnResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *ReturnResponseData) GetRelationships() ReturnResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ReturnResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ReturnResponseDataRelationships and assigns it to the Relationships field.
func (o *ReturnResponseData) SetRelationships(v ReturnResponseDataRelationships) {
	o.Relationships = &v
}

func (o ReturnResponseData) MarshalJSON() ([]byte, error) {
...
type NullableReturnResponseData struct {
	value *ReturnResponseData
	isSet bool
}

func (v NullableReturnResponseData) Get() *ReturnResponseData {
	return v.value
}

func (v *NullableReturnResponseData) Set(val *ReturnResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnResponseData(val *ReturnResponseData) *NullableReturnResponseData {
	return &NullableReturnResponseData{value: val, isSet: true}
}

func (v NullableReturnResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
