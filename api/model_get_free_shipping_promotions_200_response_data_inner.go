...
// GETFreeShippingPromotions200ResponseDataInner struct for GETFreeShippingPromotions200ResponseDataInner
type GETFreeShippingPromotions200ResponseDataInner struct {
	// The resource's id
...
func (o GETFreeShippingPromotions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETFreeShippingPromotions200ResponseDataInner struct {
	value *GETFreeShippingPromotions200ResponseDataInner
	isSet bool
}

func (v NullableGETFreeShippingPromotions200ResponseDataInner) Get() *GETFreeShippingPromotions200ResponseDataInner {
	return v.value
}

func (v *NullableGETFreeShippingPromotions200ResponseDataInner) Set(val *GETFreeShippingPromotions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETFreeShippingPromotions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETFreeShippingPromotions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETFreeShippingPromotions200ResponseDataInner(val *GETFreeShippingPromotions200ResponseDataInner) *NullableGETFreeShippingPromotions200ResponseDataInner {
	return &NullableGETFreeShippingPromotions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETFreeShippingPromotions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETFreeShippingPromotions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
