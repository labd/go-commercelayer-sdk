...
// checks if the PATCHCleanupsCleanupId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHCleanupsCleanupId200ResponseData{}

// PATCHCleanupsCleanupId200ResponseData struct for PATCHCleanupsCleanupId200ResponseData
type PATCHCleanupsCleanupId200ResponseData struct {
	// The resource's id
...
func NewPATCHCleanupsCleanupId200ResponseData() *PATCHCleanupsCleanupId200ResponseData {
	this := PATCHCleanupsCleanupId200ResponseData{}
	return &this
}
...
func (o PATCHCleanupsCleanupId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHCleanupsCleanupId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHCleanupsCleanupId200ResponseData struct {
	value *PATCHCleanupsCleanupId200ResponseData
	isSet bool
}

func (v NullablePATCHCleanupsCleanupId200ResponseData) Get() *PATCHCleanupsCleanupId200ResponseData {
	return v.value
}

func (v *NullablePATCHCleanupsCleanupId200ResponseData) Set(val *PATCHCleanupsCleanupId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHCleanupsCleanupId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHCleanupsCleanupId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHCleanupsCleanupId200ResponseData(val *PATCHCleanupsCleanupId200ResponseData) *NullablePATCHCleanupsCleanupId200ResponseData {
	return &NullablePATCHCleanupsCleanupId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHCleanupsCleanupId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHCleanupsCleanupId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
