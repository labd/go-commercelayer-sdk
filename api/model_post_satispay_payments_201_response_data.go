...
// checks if the POSTSatispayPayments201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTSatispayPayments201ResponseData{}
...
type POSTSatispayPayments201ResponseData struct {
	...
	Attributes    *POSTSatispayPaymentsRequestDataAttributes     `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTSatispayPaymentsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTSatispayPayments201ResponseData) ToMap() (map[string]interface{}, error) {
