...
// FreeGiftPromotionCreateDataAttributes struct for FreeGiftPromotionCreateDataAttributes
type FreeGiftPromotionCreateDataAttributes struct {
...
func NewFreeGiftPromotionCreateDataAttributes(name string, startsAt string, expiresAt string, totalUsageLimit int32) *FreeGiftPromotionCreateDataAttributes {
	this := FreeGiftPromotionCreateDataAttributes{}
	this.Name = name
...
func (o FreeGiftPromotionCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableFreeGiftPromotionCreateDataAttributes struct {
	value *FreeGiftPromotionCreateDataAttributes
	isSet bool
}

func (v NullableFreeGiftPromotionCreateDataAttributes) Get() *FreeGiftPromotionCreateDataAttributes {
	return v.value
}

func (v *NullableFreeGiftPromotionCreateDataAttributes) Set(val *FreeGiftPromotionCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableFreeGiftPromotionCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableFreeGiftPromotionCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFreeGiftPromotionCreateDataAttributes(val *FreeGiftPromotionCreateDataAttributes) *NullableFreeGiftPromotionCreateDataAttributes {
	return &NullableFreeGiftPromotionCreateDataAttributes{value: val, isSet: true}
}

func (v NullableFreeGiftPromotionCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFreeGiftPromotionCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
