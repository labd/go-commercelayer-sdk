...
// PaypalGatewayResponseData struct for PaypalGatewayResponseData
type PaypalGatewayResponseData struct {
	// The resource's id
	...
	Relationships *PaypalGatewayResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewPaypalGatewayResponseData() *PaypalGatewayResponseData {
	this := PaypalGatewayResponseData{}
	return &this
}
...
func (o *PaypalGatewayResponseData) GetRelationships() PaypalGatewayResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret PaypalGatewayResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given PaypalGatewayResponseDataRelationships and assigns it to the Relationships field.
func (o *PaypalGatewayResponseData) SetRelationships(v PaypalGatewayResponseDataRelationships) {
	o.Relationships = &v
}

func (o PaypalGatewayResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePaypalGatewayResponseData struct {
	value *PaypalGatewayResponseData
	isSet bool
}

func (v NullablePaypalGatewayResponseData) Get() *PaypalGatewayResponseData {
	return v.value
}

func (v *NullablePaypalGatewayResponseData) Set(val *PaypalGatewayResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePaypalGatewayResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePaypalGatewayResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaypalGatewayResponseData(val *PaypalGatewayResponseData) *NullablePaypalGatewayResponseData {
	return &NullablePaypalGatewayResponseData{value: val, isSet: true}
}

func (v NullablePaypalGatewayResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaypalGatewayResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
