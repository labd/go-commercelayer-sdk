...
// checks if the GETAdjustmentsAdjustmentId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETAdjustmentsAdjustmentId200ResponseData{}

// GETAdjustmentsAdjustmentId200ResponseData struct for GETAdjustmentsAdjustmentId200ResponseData
type GETAdjustmentsAdjustmentId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                          `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                   `json:"links,omitempty"`
	Attributes    *GETAdjustmentsAdjustmentId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETAdjustmentsAdjustmentId200ResponseData() *GETAdjustmentsAdjustmentId200ResponseData {
	this := GETAdjustmentsAdjustmentId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETAdjustmentsAdjustmentId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETAdjustmentsAdjustmentId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETAdjustmentsAdjustmentId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETAdjustmentsAdjustmentId200ResponseData struct {
	value *GETAdjustmentsAdjustmentId200ResponseData
	isSet bool
}

func (v NullableGETAdjustmentsAdjustmentId200ResponseData) Get() *GETAdjustmentsAdjustmentId200ResponseData {
	return v.value
}

func (v *NullableGETAdjustmentsAdjustmentId200ResponseData) Set(val *GETAdjustmentsAdjustmentId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAdjustmentsAdjustmentId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAdjustmentsAdjustmentId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAdjustmentsAdjustmentId200ResponseData(val *GETAdjustmentsAdjustmentId200ResponseData) *NullableGETAdjustmentsAdjustmentId200ResponseData {
	return &NullableGETAdjustmentsAdjustmentId200ResponseData{value: val, isSet: true}
}

func (v NullableGETAdjustmentsAdjustmentId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAdjustmentsAdjustmentId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
