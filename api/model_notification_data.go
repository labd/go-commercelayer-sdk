...
type NotificationData struct {
	...
	Attributes    GETNotificationsNotificationId200ResponseDataAttributes `json:"attributes"`
	Relationships *NotificationDataRelationships                          `json:"relationships,omitempty"`
}
...
func (o *NotificationData) GetRelationships() NotificationDataRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret NotificationDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given NotificationDataRelationships and assigns it to the Relationships field.
