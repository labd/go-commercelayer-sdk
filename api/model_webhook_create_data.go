...
// checks if the WebhookCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookCreateData{}
...
func (o WebhookCreateData) ToMap() (map[string]interface{}, error) {
