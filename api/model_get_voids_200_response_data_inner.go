...
// GETVoids200ResponseDataInner struct for GETVoids200ResponseDataInner
type GETVoids200ResponseDataInner struct {
	// The resource's id
...
func (o GETVoids200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETVoids200ResponseDataInner struct {
	value *GETVoids200ResponseDataInner
	isSet bool
}

func (v NullableGETVoids200ResponseDataInner) Get() *GETVoids200ResponseDataInner {
	return v.value
}

func (v *NullableGETVoids200ResponseDataInner) Set(val *GETVoids200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETVoids200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETVoids200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETVoids200ResponseDataInner(val *GETVoids200ResponseDataInner) *NullableGETVoids200ResponseDataInner {
	return &NullableGETVoids200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETVoids200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETVoids200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
