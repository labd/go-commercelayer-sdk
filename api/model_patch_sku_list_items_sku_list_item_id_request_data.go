...
// checks if the PATCHSkuListItemsSkuListItemIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHSkuListItemsSkuListItemIdRequestData{}

// PATCHSkuListItemsSkuListItemIdRequestData struct for PATCHSkuListItemsSkuListItemIdRequestData
type PATCHSkuListItemsSkuListItemIdRequestData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                         `json:"id"`
	Attributes    PATCHSkuListItemsSkuListItemIdRequestDataAttributes `json:"attributes"`
...
func NewPATCHSkuListItemsSkuListItemIdRequestData(type_ interface{}, id interface{}, attributes PATCHSkuListItemsSkuListItemIdRequestDataAttributes) *PATCHSkuListItemsSkuListItemIdRequestData {
	this := PATCHSkuListItemsSkuListItemIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o *PATCHSkuListItemsSkuListItemIdRequestData) GetAttributes() PATCHSkuListItemsSkuListItemIdRequestDataAttributes {
	if o == nil {
		var ret PATCHSkuListItemsSkuListItemIdRequestDataAttributes
		return ret
	}
...
func (o PATCHSkuListItemsSkuListItemIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHSkuListItemsSkuListItemIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHSkuListItemsSkuListItemIdRequestData struct {
	value *PATCHSkuListItemsSkuListItemIdRequestData
	isSet bool
}

func (v NullablePATCHSkuListItemsSkuListItemIdRequestData) Get() *PATCHSkuListItemsSkuListItemIdRequestData {
	return v.value
}

func (v *NullablePATCHSkuListItemsSkuListItemIdRequestData) Set(val *PATCHSkuListItemsSkuListItemIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHSkuListItemsSkuListItemIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHSkuListItemsSkuListItemIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHSkuListItemsSkuListItemIdRequestData(val *PATCHSkuListItemsSkuListItemIdRequestData) *NullablePATCHSkuListItemsSkuListItemIdRequestData {
	return &NullablePATCHSkuListItemsSkuListItemIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHSkuListItemsSkuListItemIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHSkuListItemsSkuListItemIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
