...
type PATCHTaxCategoriesTaxCategoryId200ResponseData struct {
	...
	Attributes    *PATCHTaxCategoriesTaxCategoryIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHTaxCategoriesTaxCategoryIdRequestDataAttributes and assigns it to the Attributes field.
