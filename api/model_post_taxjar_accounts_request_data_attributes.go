...
// checks if the POSTTaxjarAccountsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTTaxjarAccountsRequestDataAttributes{}

// POSTTaxjarAccountsRequestDataAttributes struct for POSTTaxjarAccountsRequestDataAttributes
type POSTTaxjarAccountsRequestDataAttributes struct {
...
func NewPOSTTaxjarAccountsRequestDataAttributes(name interface{}, apiKey interface{}) *POSTTaxjarAccountsRequestDataAttributes {
	this := POSTTaxjarAccountsRequestDataAttributes{}
	this.Name = name
	this.ApiKey = apiKey
	return &this
}
...
func (o POSTTaxjarAccountsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTTaxjarAccountsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTTaxjarAccountsRequestDataAttributes struct {
	value *POSTTaxjarAccountsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTTaxjarAccountsRequestDataAttributes) Get() *POSTTaxjarAccountsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTTaxjarAccountsRequestDataAttributes) Set(val *POSTTaxjarAccountsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTTaxjarAccountsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTTaxjarAccountsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTTaxjarAccountsRequestDataAttributes(val *POSTTaxjarAccountsRequestDataAttributes) *NullablePOSTTaxjarAccountsRequestDataAttributes {
	return &NullablePOSTTaxjarAccountsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTTaxjarAccountsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTTaxjarAccountsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
