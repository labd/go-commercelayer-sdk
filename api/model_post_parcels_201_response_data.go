...
// POSTParcels201ResponseData struct for POSTParcels201ResponseData
type POSTParcels201ResponseData struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                      `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks       `json:"links,omitempty"`
	Attributes    *POSTParcels201ResponseDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTParcels201ResponseData() *POSTParcels201ResponseData {
	this := POSTParcels201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTParcels201ResponseDataAttributes and assigns it to the Attributes field.
...
func (o POSTParcels201ResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePOSTParcels201ResponseData struct {
	value *POSTParcels201ResponseData
	isSet bool
}

func (v NullablePOSTParcels201ResponseData) Get() *POSTParcels201ResponseData {
	return v.value
}

func (v *NullablePOSTParcels201ResponseData) Set(val *POSTParcels201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTParcels201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTParcels201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTParcels201ResponseData(val *POSTParcels201ResponseData) *NullablePOSTParcels201ResponseData {
	return &NullablePOSTParcels201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTParcels201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTParcels201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
