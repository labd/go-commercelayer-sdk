...
// checks if the BraintreeGateway type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BraintreeGateway{}
...
func (o BraintreeGateway) ToMap() (map[string]interface{}, error) {
