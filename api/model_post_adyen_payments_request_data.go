...
// checks if the POSTAdyenPaymentsRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTAdyenPaymentsRequestData{}

// POSTAdyenPaymentsRequestData struct for POSTAdyenPaymentsRequestData
type POSTAdyenPaymentsRequestData struct {
	// The resource's type
...
func NewPOSTAdyenPaymentsRequestData(type_ interface{}, attributes POSTAdyenPaymentsRequestDataAttributes) *POSTAdyenPaymentsRequestData {
	this := POSTAdyenPaymentsRequestData{}
	this.Type = type_
...
func (o POSTAdyenPaymentsRequestData) MarshalJSON() ([]byte, error) {
...
func (o POSTAdyenPaymentsRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTAdyenPaymentsRequestData struct {
	value *POSTAdyenPaymentsRequestData
	isSet bool
}

func (v NullablePOSTAdyenPaymentsRequestData) Get() *POSTAdyenPaymentsRequestData {
	return v.value
}

func (v *NullablePOSTAdyenPaymentsRequestData) Set(val *POSTAdyenPaymentsRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTAdyenPaymentsRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTAdyenPaymentsRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTAdyenPaymentsRequestData(val *POSTAdyenPaymentsRequestData) *NullablePOSTAdyenPaymentsRequestData {
	return &NullablePOSTAdyenPaymentsRequestData{value: val, isSet: true}
}

func (v NullablePOSTAdyenPaymentsRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTAdyenPaymentsRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
