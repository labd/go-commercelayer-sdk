...
// LineItemResponseData struct for LineItemResponseData
type LineItemResponseData struct {
	// The resource's id
	...
	Relationships *LineItemResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *LineItemResponseData) GetRelationships() LineItemResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret LineItemResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given LineItemResponseDataRelationships and assigns it to the Relationships field.
func (o *LineItemResponseData) SetRelationships(v LineItemResponseDataRelationships) {
	o.Relationships = &v
}

func (o LineItemResponseData) MarshalJSON() ([]byte, error) {
...
type NullableLineItemResponseData struct {
	value *LineItemResponseData
	isSet bool
}

func (v NullableLineItemResponseData) Get() *LineItemResponseData {
	return v.value
}

func (v *NullableLineItemResponseData) Set(val *LineItemResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableLineItemResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableLineItemResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLineItemResponseData(val *LineItemResponseData) *NullableLineItemResponseData {
	return &NullableLineItemResponseData{value: val, isSet: true}
}

func (v NullableLineItemResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLineItemResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
