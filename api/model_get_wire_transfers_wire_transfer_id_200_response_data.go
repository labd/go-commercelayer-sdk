...
// checks if the GETWireTransfersWireTransferId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETWireTransfersWireTransferId200ResponseData{}

// GETWireTransfersWireTransferId200ResponseData struct for GETWireTransfersWireTransferId200ResponseData
type GETWireTransfersWireTransferId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                              `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                       `json:"links,omitempty"`
	Attributes    *GETWireTransfersWireTransferId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETWireTransfersWireTransferId200ResponseData() *GETWireTransfersWireTransferId200ResponseData {
	this := GETWireTransfersWireTransferId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETWireTransfersWireTransferId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETWireTransfersWireTransferId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETWireTransfersWireTransferId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETWireTransfersWireTransferId200ResponseData struct {
	value *GETWireTransfersWireTransferId200ResponseData
	isSet bool
}

func (v NullableGETWireTransfersWireTransferId200ResponseData) Get() *GETWireTransfersWireTransferId200ResponseData {
	return v.value
}

func (v *NullableGETWireTransfersWireTransferId200ResponseData) Set(val *GETWireTransfersWireTransferId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETWireTransfersWireTransferId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETWireTransfersWireTransferId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETWireTransfersWireTransferId200ResponseData(val *GETWireTransfersWireTransferId200ResponseData) *NullableGETWireTransfersWireTransferId200ResponseData {
	return &NullableGETWireTransfersWireTransferId200ResponseData{value: val, isSet: true}
}

func (v NullableGETWireTransfersWireTransferId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETWireTransfersWireTransferId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
