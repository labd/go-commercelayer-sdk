...
// checks if the POSTMerchants201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTMerchants201ResponseData{}

// POSTMerchants201ResponseData struct for POSTMerchants201ResponseData
type POSTMerchants201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks         `json:"links,omitempty"`
	Attributes    *POSTMerchantsRequestDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTMerchants201ResponseData() *POSTMerchants201ResponseData {
	this := POSTMerchants201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTMerchantsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTMerchants201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTMerchants201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTMerchants201ResponseData struct {
	value *POSTMerchants201ResponseData
	isSet bool
}

func (v NullablePOSTMerchants201ResponseData) Get() *POSTMerchants201ResponseData {
	return v.value
}

func (v *NullablePOSTMerchants201ResponseData) Set(val *POSTMerchants201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTMerchants201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTMerchants201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTMerchants201ResponseData(val *POSTMerchants201ResponseData) *NullablePOSTMerchants201ResponseData {
	return &NullablePOSTMerchants201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTMerchants201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTMerchants201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
