...
// checks if the PATCHPaymentOptionsPaymentOptionId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPaymentOptionsPaymentOptionId200ResponseData{}

// PATCHPaymentOptionsPaymentOptionId200ResponseData struct for PATCHPaymentOptionsPaymentOptionId200ResponseData
type PATCHPaymentOptionsPaymentOptionId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                           `json:"links,omitempty"`
	Attributes    *PATCHPaymentOptionsPaymentOptionId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewPATCHPaymentOptionsPaymentOptionId200ResponseData() *PATCHPaymentOptionsPaymentOptionId200ResponseData {
	this := PATCHPaymentOptionsPaymentOptionId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given PATCHPaymentOptionsPaymentOptionId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHPaymentOptionsPaymentOptionId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHPaymentOptionsPaymentOptionId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHPaymentOptionsPaymentOptionId200ResponseData struct {
	value *PATCHPaymentOptionsPaymentOptionId200ResponseData
	isSet bool
}

func (v NullablePATCHPaymentOptionsPaymentOptionId200ResponseData) Get() *PATCHPaymentOptionsPaymentOptionId200ResponseData {
	return v.value
}

func (v *NullablePATCHPaymentOptionsPaymentOptionId200ResponseData) Set(val *PATCHPaymentOptionsPaymentOptionId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHPaymentOptionsPaymentOptionId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHPaymentOptionsPaymentOptionId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHPaymentOptionsPaymentOptionId200ResponseData(val *PATCHPaymentOptionsPaymentOptionId200ResponseData) *NullablePATCHPaymentOptionsPaymentOptionId200ResponseData {
	return &NullablePATCHPaymentOptionsPaymentOptionId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHPaymentOptionsPaymentOptionId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHPaymentOptionsPaymentOptionId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
