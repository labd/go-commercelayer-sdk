...
// checks if the PATCHPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData{}
...
type PATCHPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData struct {
	...
	Attributes    *PATCHPercentageDiscountPromotionsPercentageDiscountPromotionIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHPercentageDiscountPromotionsPercentageDiscountPromotionIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) ToMap() (map[string]interface{}, error) {
