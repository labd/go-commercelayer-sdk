...
// GETWebhooks200ResponseDataInner struct for GETWebhooks200ResponseDataInner
type GETWebhooks200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                       `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks        `json:"links,omitempty"`
	Attributes    *GETWebhooks200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETWebhooks200ResponseDataInner() *GETWebhooks200ResponseDataInner {
	this := GETWebhooks200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETWebhooks200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETWebhooks200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETWebhooks200ResponseDataInner struct {
	value *GETWebhooks200ResponseDataInner
	isSet bool
}

func (v NullableGETWebhooks200ResponseDataInner) Get() *GETWebhooks200ResponseDataInner {
	return v.value
}

func (v *NullableGETWebhooks200ResponseDataInner) Set(val *GETWebhooks200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETWebhooks200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETWebhooks200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETWebhooks200ResponseDataInner(val *GETWebhooks200ResponseDataInner) *NullableGETWebhooks200ResponseDataInner {
	return &NullableGETWebhooks200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETWebhooks200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETWebhooks200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
