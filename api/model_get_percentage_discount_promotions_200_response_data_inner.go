...
// GETPercentageDiscountPromotions200ResponseDataInner struct for GETPercentageDiscountPromotions200ResponseDataInner
type GETPercentageDiscountPromotions200ResponseDataInner struct {
	// The resource's id
...
func (o *GETPercentageDiscountPromotions200ResponseDataInner) GetId() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *GETPercentageDiscountPromotions200ResponseDataInner) GetIdOk() (*interface{}, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *GETPercentageDiscountPromotions200ResponseDataInner) SetId(v interface{}) {
	o.Id = v
}

// GetType returns the Type field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GETPercentageDiscountPromotions200ResponseDataInner) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GETPercentageDiscountPromotions200ResponseDataInner) GetTypeOk() (*interface{}, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GETPercentageDiscountPromotions200ResponseDataInner) SetType(v interface{}) {
	o.Type = v
}
...
// SetAttributes gets a reference to the given GETPercentageDiscountPromotions200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETPercentageDiscountPromotions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETPercentageDiscountPromotions200ResponseDataInner struct {
	value *GETPercentageDiscountPromotions200ResponseDataInner
	isSet bool
}

func (v NullableGETPercentageDiscountPromotions200ResponseDataInner) Get() *GETPercentageDiscountPromotions200ResponseDataInner {
	return v.value
}

func (v *NullableGETPercentageDiscountPromotions200ResponseDataInner) Set(val *GETPercentageDiscountPromotions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPercentageDiscountPromotions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPercentageDiscountPromotions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPercentageDiscountPromotions200ResponseDataInner(val *GETPercentageDiscountPromotions200ResponseDataInner) *NullableGETPercentageDiscountPromotions200ResponseDataInner {
	return &NullableGETPercentageDiscountPromotions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETPercentageDiscountPromotions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPercentageDiscountPromotions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
