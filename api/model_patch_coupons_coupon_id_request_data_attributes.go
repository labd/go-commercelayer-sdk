...
// checks if the PATCHCouponsCouponIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHCouponsCouponIdRequestDataAttributes{}

// PATCHCouponsCouponIdRequestDataAttributes struct for PATCHCouponsCouponIdRequestDataAttributes
type PATCHCouponsCouponIdRequestDataAttributes struct {
...
func NewPATCHCouponsCouponIdRequestDataAttributes() *PATCHCouponsCouponIdRequestDataAttributes {
	this := PATCHCouponsCouponIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHCouponsCouponIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHCouponsCouponIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHCouponsCouponIdRequestDataAttributes struct {
	value *PATCHCouponsCouponIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHCouponsCouponIdRequestDataAttributes) Get() *PATCHCouponsCouponIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHCouponsCouponIdRequestDataAttributes) Set(val *PATCHCouponsCouponIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHCouponsCouponIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHCouponsCouponIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHCouponsCouponIdRequestDataAttributes(val *PATCHCouponsCouponIdRequestDataAttributes) *NullablePATCHCouponsCouponIdRequestDataAttributes {
	return &NullablePATCHCouponsCouponIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHCouponsCouponIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHCouponsCouponIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
