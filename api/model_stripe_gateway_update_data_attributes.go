...
// StripeGatewayUpdateDataAttributes struct for StripeGatewayUpdateDataAttributes
type StripeGatewayUpdateDataAttributes struct {
...
func NewStripeGatewayUpdateDataAttributes() *StripeGatewayUpdateDataAttributes {
	this := StripeGatewayUpdateDataAttributes{}
	return &this
}
...
func (o StripeGatewayUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableStripeGatewayUpdateDataAttributes struct {
	value *StripeGatewayUpdateDataAttributes
	isSet bool
}

func (v NullableStripeGatewayUpdateDataAttributes) Get() *StripeGatewayUpdateDataAttributes {
	return v.value
}

func (v *NullableStripeGatewayUpdateDataAttributes) Set(val *StripeGatewayUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableStripeGatewayUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableStripeGatewayUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStripeGatewayUpdateDataAttributes(val *StripeGatewayUpdateDataAttributes) *NullableStripeGatewayUpdateDataAttributes {
	return &NullableStripeGatewayUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableStripeGatewayUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStripeGatewayUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
