...
// ShippingCategoryUpdateDataAttributes struct for ShippingCategoryUpdateDataAttributes
type ShippingCategoryUpdateDataAttributes struct {
...
func NewShippingCategoryUpdateDataAttributes() *ShippingCategoryUpdateDataAttributes {
	this := ShippingCategoryUpdateDataAttributes{}
	return &this
}
...
func (o ShippingCategoryUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableShippingCategoryUpdateDataAttributes struct {
	value *ShippingCategoryUpdateDataAttributes
	isSet bool
}

func (v NullableShippingCategoryUpdateDataAttributes) Get() *ShippingCategoryUpdateDataAttributes {
	return v.value
}

func (v *NullableShippingCategoryUpdateDataAttributes) Set(val *ShippingCategoryUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingCategoryUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingCategoryUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingCategoryUpdateDataAttributes(val *ShippingCategoryUpdateDataAttributes) *NullableShippingCategoryUpdateDataAttributes {
	return &NullableShippingCategoryUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableShippingCategoryUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingCategoryUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
