...
// checks if the POSTFreeShippingPromotionsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTFreeShippingPromotionsRequestDataAttributes{}

// POSTFreeShippingPromotionsRequestDataAttributes struct for POSTFreeShippingPromotionsRequestDataAttributes
type POSTFreeShippingPromotionsRequestDataAttributes struct {
...
func NewPOSTFreeShippingPromotionsRequestDataAttributes(name interface{}, startsAt interface{}, expiresAt interface{}, totalUsageLimit interface{}) *POSTFreeShippingPromotionsRequestDataAttributes {
	this := POSTFreeShippingPromotionsRequestDataAttributes{}
	this.Name = name
...
func (o POSTFreeShippingPromotionsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTFreeShippingPromotionsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTFreeShippingPromotionsRequestDataAttributes struct {
	value *POSTFreeShippingPromotionsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTFreeShippingPromotionsRequestDataAttributes) Get() *POSTFreeShippingPromotionsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTFreeShippingPromotionsRequestDataAttributes) Set(val *POSTFreeShippingPromotionsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTFreeShippingPromotionsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTFreeShippingPromotionsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTFreeShippingPromotionsRequestDataAttributes(val *POSTFreeShippingPromotionsRequestDataAttributes) *NullablePOSTFreeShippingPromotionsRequestDataAttributes {
	return &NullablePOSTFreeShippingPromotionsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTFreeShippingPromotionsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTFreeShippingPromotionsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
