...
type PATCHExternalTaxCalculatorsExternalTaxCalculatorId200ResponseData struct {
	...
	Attributes    *PATCHExternalTaxCalculatorsExternalTaxCalculatorIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHExternalTaxCalculatorsExternalTaxCalculatorIdRequestDataAttributes and assigns it to the Attributes field.
