...
// checks if the LineItemDataRelationshipsShipmentLineItemsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LineItemDataRelationshipsShipmentLineItemsData{}
...
func (o LineItemDataRelationshipsShipmentLineItemsData) ToMap() (map[string]interface{}, error) {
