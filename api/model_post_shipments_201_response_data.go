...
// checks if the POSTShipments201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTShipments201ResponseData{}

// POSTShipments201ResponseData struct for POSTShipments201ResponseData
type POSTShipments201ResponseData struct {
	// The resource's id
...
func NewPOSTShipments201ResponseData() *POSTShipments201ResponseData {
	this := POSTShipments201ResponseData{}
	return &this
}
...
func (o POSTShipments201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTShipments201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTShipments201ResponseData struct {
	value *POSTShipments201ResponseData
	isSet bool
}

func (v NullablePOSTShipments201ResponseData) Get() *POSTShipments201ResponseData {
	return v.value
}

func (v *NullablePOSTShipments201ResponseData) Set(val *POSTShipments201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTShipments201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTShipments201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTShipments201ResponseData(val *POSTShipments201ResponseData) *NullablePOSTShipments201ResponseData {
	return &NullablePOSTShipments201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTShipments201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTShipments201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
