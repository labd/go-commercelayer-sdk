...
// checks if the PATCHParcelLineItemsParcelLineItemId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHParcelLineItemsParcelLineItemId200ResponseData{}

// PATCHParcelLineItemsParcelLineItemId200ResponseData struct for PATCHParcelLineItemsParcelLineItemId200ResponseData
type PATCHParcelLineItemsParcelLineItemId200ResponseData struct {
	// The resource's id
...
func NewPATCHParcelLineItemsParcelLineItemId200ResponseData() *PATCHParcelLineItemsParcelLineItemId200ResponseData {
	this := PATCHParcelLineItemsParcelLineItemId200ResponseData{}
	return &this
}
...
func (o PATCHParcelLineItemsParcelLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHParcelLineItemsParcelLineItemId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHParcelLineItemsParcelLineItemId200ResponseData struct {
	value *PATCHParcelLineItemsParcelLineItemId200ResponseData
	isSet bool
}

func (v NullablePATCHParcelLineItemsParcelLineItemId200ResponseData) Get() *PATCHParcelLineItemsParcelLineItemId200ResponseData {
	return v.value
}

func (v *NullablePATCHParcelLineItemsParcelLineItemId200ResponseData) Set(val *PATCHParcelLineItemsParcelLineItemId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHParcelLineItemsParcelLineItemId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHParcelLineItemsParcelLineItemId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHParcelLineItemsParcelLineItemId200ResponseData(val *PATCHParcelLineItemsParcelLineItemId200ResponseData) *NullablePATCHParcelLineItemsParcelLineItemId200ResponseData {
	return &NullablePATCHParcelLineItemsParcelLineItemId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHParcelLineItemsParcelLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHParcelLineItemsParcelLineItemId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
