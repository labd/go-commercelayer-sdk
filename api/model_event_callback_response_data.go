...
// EventCallbackResponseData struct for EventCallbackResponseData
type EventCallbackResponseData struct {
	// The resource's id
	...
	Relationships *EventCallbackResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewEventCallbackResponseData() *EventCallbackResponseData {
	this := EventCallbackResponseData{}
	return &this
}
...
func (o *EventCallbackResponseData) GetRelationships() EventCallbackResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret EventCallbackResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given EventCallbackResponseDataRelationships and assigns it to the Relationships field.
func (o *EventCallbackResponseData) SetRelationships(v EventCallbackResponseDataRelationships) {
	o.Relationships = &v
}

func (o EventCallbackResponseData) MarshalJSON() ([]byte, error) {
...
type NullableEventCallbackResponseData struct {
	value *EventCallbackResponseData
	isSet bool
}

func (v NullableEventCallbackResponseData) Get() *EventCallbackResponseData {
	return v.value
}

func (v *NullableEventCallbackResponseData) Set(val *EventCallbackResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableEventCallbackResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableEventCallbackResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventCallbackResponseData(val *EventCallbackResponseData) *NullableEventCallbackResponseData {
	return &NullableEventCallbackResponseData{value: val, isSet: true}
}

func (v NullableEventCallbackResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventCallbackResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
