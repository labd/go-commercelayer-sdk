...
// checks if the PATCHMerchantsMerchantIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHMerchantsMerchantIdRequestDataAttributes{}

// PATCHMerchantsMerchantIdRequestDataAttributes struct for PATCHMerchantsMerchantIdRequestDataAttributes
type PATCHMerchantsMerchantIdRequestDataAttributes struct {
...
func NewPATCHMerchantsMerchantIdRequestDataAttributes() *PATCHMerchantsMerchantIdRequestDataAttributes {
	this := PATCHMerchantsMerchantIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHMerchantsMerchantIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHMerchantsMerchantIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHMerchantsMerchantIdRequestDataAttributes struct {
	value *PATCHMerchantsMerchantIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHMerchantsMerchantIdRequestDataAttributes) Get() *PATCHMerchantsMerchantIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHMerchantsMerchantIdRequestDataAttributes) Set(val *PATCHMerchantsMerchantIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHMerchantsMerchantIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHMerchantsMerchantIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHMerchantsMerchantIdRequestDataAttributes(val *PATCHMerchantsMerchantIdRequestDataAttributes) *NullablePATCHMerchantsMerchantIdRequestDataAttributes {
	return &NullablePATCHMerchantsMerchantIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHMerchantsMerchantIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHMerchantsMerchantIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
