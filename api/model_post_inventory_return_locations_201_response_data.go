...
type POSTInventoryReturnLocations201ResponseData struct {
	...
	Attributes    *POSTInventoryReturnLocationsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTInventoryReturnLocationsRequestDataAttributes and assigns it to the Attributes field.
