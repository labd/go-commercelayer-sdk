...
type POSTDeliveryLeadTimes201ResponseData struct {
	...
	Attributes    *POSTDeliveryLeadTimesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTDeliveryLeadTimesRequestDataAttributes and assigns it to the Attributes field.
