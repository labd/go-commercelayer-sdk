...
// checks if the PATCHBingGeocodersBingGeocoderId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHBingGeocodersBingGeocoderId200ResponseData{}
...
type PATCHBingGeocodersBingGeocoderId200ResponseData struct {
	...
	Attributes    *PATCHBingGeocodersBingGeocoderIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHBingGeocodersBingGeocoderIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHBingGeocodersBingGeocoderId200ResponseData) ToMap() (map[string]interface{}, error) {
