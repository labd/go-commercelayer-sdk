...
// GETParcels200ResponseDataInnerAttributes struct for GETParcels200ResponseDataInnerAttributes
type GETParcels200ResponseDataInnerAttributes struct {
...
func NewGETParcels200ResponseDataInnerAttributes() *GETParcels200ResponseDataInnerAttributes {
	this := GETParcels200ResponseDataInnerAttributes{}
	return &this
}
...
func (o GETParcels200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
...
type NullableGETParcels200ResponseDataInnerAttributes struct {
	value *GETParcels200ResponseDataInnerAttributes
	isSet bool
}

func (v NullableGETParcels200ResponseDataInnerAttributes) Get() *GETParcels200ResponseDataInnerAttributes {
	return v.value
}

func (v *NullableGETParcels200ResponseDataInnerAttributes) Set(val *GETParcels200ResponseDataInnerAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETParcels200ResponseDataInnerAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETParcels200ResponseDataInnerAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETParcels200ResponseDataInnerAttributes(val *GETParcels200ResponseDataInnerAttributes) *NullableGETParcels200ResponseDataInnerAttributes {
	return &NullableGETParcels200ResponseDataInnerAttributes{value: val, isSet: true}
}

func (v NullableGETParcels200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETParcels200ResponseDataInnerAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
