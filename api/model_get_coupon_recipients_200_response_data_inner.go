...
// GETCouponRecipients200ResponseDataInner struct for GETCouponRecipients200ResponseDataInner
type GETCouponRecipients200ResponseDataInner struct {
	// The resource's id
...
func NewGETCouponRecipients200ResponseDataInner() *GETCouponRecipients200ResponseDataInner {
	this := GETCouponRecipients200ResponseDataInner{}
	return &this
}
...
func (o GETCouponRecipients200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETCouponRecipients200ResponseDataInner struct {
	value *GETCouponRecipients200ResponseDataInner
	isSet bool
}

func (v NullableGETCouponRecipients200ResponseDataInner) Get() *GETCouponRecipients200ResponseDataInner {
	return v.value
}

func (v *NullableGETCouponRecipients200ResponseDataInner) Set(val *GETCouponRecipients200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCouponRecipients200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCouponRecipients200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCouponRecipients200ResponseDataInner(val *GETCouponRecipients200ResponseDataInner) *NullableGETCouponRecipients200ResponseDataInner {
	return &NullableGETCouponRecipients200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETCouponRecipients200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCouponRecipients200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
