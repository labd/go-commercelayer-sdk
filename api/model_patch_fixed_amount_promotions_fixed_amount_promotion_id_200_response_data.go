...
type PATCHFixedAmountPromotionsFixedAmountPromotionId200ResponseData struct {
	...
	Attributes    *PATCHFixedAmountPromotionsFixedAmountPromotionIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHFixedAmountPromotionsFixedAmountPromotionIdRequestDataAttributes and assigns it to the Attributes field.
