...
func NewPOSTPaypalGateways201ResponseData() *POSTPaypalGateways201ResponseData {
	this := POSTPaypalGateways201ResponseData{}
...
type NullablePOSTPaypalGateways201ResponseData struct {
	value *POSTPaypalGateways201ResponseData
	isSet bool
}

func (v NullablePOSTPaypalGateways201ResponseData) Get() *POSTPaypalGateways201ResponseData {
	return v.value
}

func (v *NullablePOSTPaypalGateways201ResponseData) Set(val *POSTPaypalGateways201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTPaypalGateways201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTPaypalGateways201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTPaypalGateways201ResponseData(val *POSTPaypalGateways201ResponseData) *NullablePOSTPaypalGateways201ResponseData {
	return &NullablePOSTPaypalGateways201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTPaypalGateways201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTPaypalGateways201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
