...
// checks if the PaypalGateway type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaypalGateway{}
...
func (o PaypalGateway) ToMap() (map[string]interface{}, error) {
