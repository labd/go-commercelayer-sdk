...
type POSTStripeGateways201ResponseData struct {
	...
	Attributes    *POSTStripeGatewaysRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTStripeGatewaysRequestDataAttributes and assigns it to the Attributes field.
