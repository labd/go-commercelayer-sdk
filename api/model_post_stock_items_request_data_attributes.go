...
// checks if the POSTStockItemsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTStockItemsRequestDataAttributes{}

// POSTStockItemsRequestDataAttributes struct for POSTStockItemsRequestDataAttributes
type POSTStockItemsRequestDataAttributes struct {
...
func NewPOSTStockItemsRequestDataAttributes(quantity interface{}) *POSTStockItemsRequestDataAttributes {
	this := POSTStockItemsRequestDataAttributes{}
...
func (o POSTStockItemsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTStockItemsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTStockItemsRequestDataAttributes struct {
	value *POSTStockItemsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTStockItemsRequestDataAttributes) Get() *POSTStockItemsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTStockItemsRequestDataAttributes) Set(val *POSTStockItemsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTStockItemsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTStockItemsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTStockItemsRequestDataAttributes(val *POSTStockItemsRequestDataAttributes) *NullablePOSTStockItemsRequestDataAttributes {
	return &NullablePOSTStockItemsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTStockItemsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTStockItemsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
