...
// StripePaymentUpdateDataAttributes struct for StripePaymentUpdateDataAttributes
type StripePaymentUpdateDataAttributes struct {
...
func NewStripePaymentUpdateDataAttributes() *StripePaymentUpdateDataAttributes {
	this := StripePaymentUpdateDataAttributes{}
	return &this
}
...
func (o StripePaymentUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableStripePaymentUpdateDataAttributes struct {
	value *StripePaymentUpdateDataAttributes
	isSet bool
}

func (v NullableStripePaymentUpdateDataAttributes) Get() *StripePaymentUpdateDataAttributes {
	return v.value
}

func (v *NullableStripePaymentUpdateDataAttributes) Set(val *StripePaymentUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableStripePaymentUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableStripePaymentUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStripePaymentUpdateDataAttributes(val *StripePaymentUpdateDataAttributes) *NullableStripePaymentUpdateDataAttributes {
	return &NullableStripePaymentUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableStripePaymentUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStripePaymentUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
