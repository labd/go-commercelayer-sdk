...
// checks if the GETMerchantsMerchantId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETMerchantsMerchantId200ResponseData{}

// GETMerchantsMerchantId200ResponseData struct for GETMerchantsMerchantId200ResponseData
type GETMerchantsMerchantId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                      `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks               `json:"links,omitempty"`
	Attributes    *GETMerchantsMerchantId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETMerchantsMerchantId200ResponseData() *GETMerchantsMerchantId200ResponseData {
	this := GETMerchantsMerchantId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETMerchantsMerchantId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETMerchantsMerchantId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETMerchantsMerchantId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETMerchantsMerchantId200ResponseData struct {
	value *GETMerchantsMerchantId200ResponseData
	isSet bool
}

func (v NullableGETMerchantsMerchantId200ResponseData) Get() *GETMerchantsMerchantId200ResponseData {
	return v.value
}

func (v *NullableGETMerchantsMerchantId200ResponseData) Set(val *GETMerchantsMerchantId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETMerchantsMerchantId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETMerchantsMerchantId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETMerchantsMerchantId200ResponseData(val *GETMerchantsMerchantId200ResponseData) *NullableGETMerchantsMerchantId200ResponseData {
	return &NullableGETMerchantsMerchantId200ResponseData{value: val, isSet: true}
}

func (v NullableGETMerchantsMerchantId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETMerchantsMerchantId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
