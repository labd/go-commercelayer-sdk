...
// KlarnaGatewayDataAttributes struct for KlarnaGatewayDataAttributes
type KlarnaGatewayDataAttributes struct {
...
func NewKlarnaGatewayDataAttributes() *KlarnaGatewayDataAttributes {
	this := KlarnaGatewayDataAttributes{}
	return &this
}
...
func (o KlarnaGatewayDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableKlarnaGatewayDataAttributes struct {
	value *KlarnaGatewayDataAttributes
	isSet bool
}

func (v NullableKlarnaGatewayDataAttributes) Get() *KlarnaGatewayDataAttributes {
	return v.value
}

func (v *NullableKlarnaGatewayDataAttributes) Set(val *KlarnaGatewayDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableKlarnaGatewayDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableKlarnaGatewayDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKlarnaGatewayDataAttributes(val *KlarnaGatewayDataAttributes) *NullableKlarnaGatewayDataAttributes {
	return &NullableKlarnaGatewayDataAttributes{value: val, isSet: true}
}

func (v NullableKlarnaGatewayDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKlarnaGatewayDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
