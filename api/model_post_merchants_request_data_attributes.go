...
// checks if the POSTMerchantsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTMerchantsRequestDataAttributes{}

// POSTMerchantsRequestDataAttributes struct for POSTMerchantsRequestDataAttributes
type POSTMerchantsRequestDataAttributes struct {
...
func NewPOSTMerchantsRequestDataAttributes(name interface{}) *POSTMerchantsRequestDataAttributes {
	this := POSTMerchantsRequestDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTMerchantsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTMerchantsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTMerchantsRequestDataAttributes struct {
	value *POSTMerchantsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTMerchantsRequestDataAttributes) Get() *POSTMerchantsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTMerchantsRequestDataAttributes) Set(val *POSTMerchantsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTMerchantsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTMerchantsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTMerchantsRequestDataAttributes(val *POSTMerchantsRequestDataAttributes) *NullablePOSTMerchantsRequestDataAttributes {
	return &NullablePOSTMerchantsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTMerchantsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTMerchantsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
