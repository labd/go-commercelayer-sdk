...
type PriceListDataRelationshipsPrices struct {
	Data *PriceListDataRelationshipsPricesData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given PriceListDataRelationshipsPricesData and assigns it to the Data field.
