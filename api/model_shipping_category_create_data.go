...
// checks if the ShippingCategoryCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingCategoryCreateData{}
...
func (o ShippingCategoryCreateData) ToMap() (map[string]interface{}, error) {
