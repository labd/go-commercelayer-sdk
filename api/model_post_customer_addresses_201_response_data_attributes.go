...
// checks if the POSTCustomerAddresses201ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTCustomerAddresses201ResponseDataAttributes{}

// POSTCustomerAddresses201ResponseDataAttributes struct for POSTCustomerAddresses201ResponseDataAttributes
type POSTCustomerAddresses201ResponseDataAttributes struct {
...
func NewPOSTCustomerAddresses201ResponseDataAttributes(customerEmail interface{}) *POSTCustomerAddresses201ResponseDataAttributes {
	this := POSTCustomerAddresses201ResponseDataAttributes{}
...
func (o POSTCustomerAddresses201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTCustomerAddresses201ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTCustomerAddresses201ResponseDataAttributes struct {
	value *POSTCustomerAddresses201ResponseDataAttributes
	isSet bool
}

func (v NullablePOSTCustomerAddresses201ResponseDataAttributes) Get() *POSTCustomerAddresses201ResponseDataAttributes {
	return v.value
}

func (v *NullablePOSTCustomerAddresses201ResponseDataAttributes) Set(val *POSTCustomerAddresses201ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTCustomerAddresses201ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTCustomerAddresses201ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTCustomerAddresses201ResponseDataAttributes(val *POSTCustomerAddresses201ResponseDataAttributes) *NullablePOSTCustomerAddresses201ResponseDataAttributes {
	return &NullablePOSTCustomerAddresses201ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTCustomerAddresses201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTCustomerAddresses201ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
