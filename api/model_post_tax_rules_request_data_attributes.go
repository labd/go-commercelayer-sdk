...
// checks if the POSTTaxRulesRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTTaxRulesRequestDataAttributes{}

// POSTTaxRulesRequestDataAttributes struct for POSTTaxRulesRequestDataAttributes
type POSTTaxRulesRequestDataAttributes struct {
...
func NewPOSTTaxRulesRequestDataAttributes(name interface{}) *POSTTaxRulesRequestDataAttributes {
	this := POSTTaxRulesRequestDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTTaxRulesRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTTaxRulesRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTTaxRulesRequestDataAttributes struct {
	value *POSTTaxRulesRequestDataAttributes
	isSet bool
}

func (v NullablePOSTTaxRulesRequestDataAttributes) Get() *POSTTaxRulesRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTTaxRulesRequestDataAttributes) Set(val *POSTTaxRulesRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTTaxRulesRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTTaxRulesRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTTaxRulesRequestDataAttributes(val *POSTTaxRulesRequestDataAttributes) *NullablePOSTTaxRulesRequestDataAttributes {
	return &NullablePOSTTaxRulesRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTTaxRulesRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTTaxRulesRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
