...
// checks if the StockItemUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StockItemUpdateData{}
...
func (o StockItemUpdateData) ToMap() (map[string]interface{}, error) {
