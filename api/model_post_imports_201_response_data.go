...
type POSTImports201ResponseData struct {
	...
	Attributes    *POSTImportsRequestDataAttributes         `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTImportsRequestDataAttributes and assigns it to the Attributes field.
