...
// BraintreeGatewayDataAttributes struct for BraintreeGatewayDataAttributes
type BraintreeGatewayDataAttributes struct {
...
func NewBraintreeGatewayDataAttributes() *BraintreeGatewayDataAttributes {
	this := BraintreeGatewayDataAttributes{}
	return &this
}
...
func (o BraintreeGatewayDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableBraintreeGatewayDataAttributes struct {
	value *BraintreeGatewayDataAttributes
	isSet bool
}

func (v NullableBraintreeGatewayDataAttributes) Get() *BraintreeGatewayDataAttributes {
	return v.value
}

func (v *NullableBraintreeGatewayDataAttributes) Set(val *BraintreeGatewayDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableBraintreeGatewayDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableBraintreeGatewayDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBraintreeGatewayDataAttributes(val *BraintreeGatewayDataAttributes) *NullableBraintreeGatewayDataAttributes {
	return &NullableBraintreeGatewayDataAttributes{value: val, isSet: true}
}

func (v NullableBraintreeGatewayDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBraintreeGatewayDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
