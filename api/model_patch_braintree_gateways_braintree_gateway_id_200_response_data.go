...
type PATCHBraintreeGatewaysBraintreeGatewayId200ResponseData struct {
	...
	Attributes    *PATCHBraintreeGatewaysBraintreeGatewayIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHBraintreeGatewaysBraintreeGatewayIdRequestDataAttributes and assigns it to the Attributes field.
