...
// OrganizationResponseData struct for OrganizationResponseData
...
func (o OrganizationResponseData) MarshalJSON() ([]byte, error) {
...
type NullableOrganizationResponseData struct {
	value *OrganizationResponseData
	isSet bool
}

func (v NullableOrganizationResponseData) Get() *OrganizationResponseData {
	return v.value
}

func (v *NullableOrganizationResponseData) Set(val *OrganizationResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationResponseData(val *OrganizationResponseData) *NullableOrganizationResponseData {
	return &NullableOrganizationResponseData{value: val, isSet: true}
}

func (v NullableOrganizationResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
