...
// checks if the POSTSkuListsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTSkuListsRequestDataAttributes{}

// POSTSkuListsRequestDataAttributes struct for POSTSkuListsRequestDataAttributes
type POSTSkuListsRequestDataAttributes struct {
...
func NewPOSTSkuListsRequestDataAttributes(name interface{}) *POSTSkuListsRequestDataAttributes {
	this := POSTSkuListsRequestDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTSkuListsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTSkuListsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTSkuListsRequestDataAttributes struct {
	value *POSTSkuListsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTSkuListsRequestDataAttributes) Get() *POSTSkuListsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTSkuListsRequestDataAttributes) Set(val *POSTSkuListsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTSkuListsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTSkuListsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTSkuListsRequestDataAttributes(val *POSTSkuListsRequestDataAttributes) *NullablePOSTSkuListsRequestDataAttributes {
	return &NullablePOSTSkuListsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTSkuListsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTSkuListsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
