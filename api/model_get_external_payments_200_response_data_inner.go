...
// GETExternalPayments200ResponseDataInner struct for GETExternalPayments200ResponseDataInner
type GETExternalPayments200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type *string `json:"type,omitempty"`
	Links *GETAddresses200ResponseDataInnerLinks `json:"links,omitempty"`
	Attributes *GETExternalPayments200ResponseDataInnerAttributes `json:"attributes,omitempty"`
...
func NewGETExternalPayments200ResponseDataInner() *GETExternalPayments200ResponseDataInner {
	this := GETExternalPayments200ResponseDataInner{}
...
// SetAttributes gets a reference to the given GETExternalPayments200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETExternalPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETExternalPayments200ResponseDataInner struct {
	value *GETExternalPayments200ResponseDataInner
	isSet bool
}

func (v NullableGETExternalPayments200ResponseDataInner) Get() *GETExternalPayments200ResponseDataInner {
	return v.value
}

func (v *NullableGETExternalPayments200ResponseDataInner) Set(val *GETExternalPayments200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETExternalPayments200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETExternalPayments200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETExternalPayments200ResponseDataInner(val *GETExternalPayments200ResponseDataInner) *NullableGETExternalPayments200ResponseDataInner {
	return &NullableGETExternalPayments200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETExternalPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETExternalPayments200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
