...
// GoogleGeocoderUpdateDataAttributes struct for GoogleGeocoderUpdateDataAttributes
type GoogleGeocoderUpdateDataAttributes struct {
...
func NewGoogleGeocoderUpdateDataAttributes() *GoogleGeocoderUpdateDataAttributes {
	this := GoogleGeocoderUpdateDataAttributes{}
	return &this
}
...
func (o GoogleGeocoderUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableGoogleGeocoderUpdateDataAttributes struct {
	value *GoogleGeocoderUpdateDataAttributes
	isSet bool
}

func (v NullableGoogleGeocoderUpdateDataAttributes) Get() *GoogleGeocoderUpdateDataAttributes {
	return v.value
}

func (v *NullableGoogleGeocoderUpdateDataAttributes) Set(val *GoogleGeocoderUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGoogleGeocoderUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGoogleGeocoderUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoogleGeocoderUpdateDataAttributes(val *GoogleGeocoderUpdateDataAttributes) *NullableGoogleGeocoderUpdateDataAttributes {
	return &NullableGoogleGeocoderUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableGoogleGeocoderUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoogleGeocoderUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
