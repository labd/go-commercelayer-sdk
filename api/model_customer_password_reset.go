...
// checks if the CustomerPasswordReset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerPasswordReset{}
...
func (o CustomerPasswordReset) ToMap() (map[string]interface{}, error) {
