...
// checks if the GETSatispayGatewaysSatispayGatewayId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETSatispayGatewaysSatispayGatewayId200ResponseData{}

// GETSatispayGatewaysSatispayGatewayId200ResponseData struct for GETSatispayGatewaysSatispayGatewayId200ResponseData
type GETSatispayGatewaysSatispayGatewayId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                             `json:"links,omitempty"`
	Attributes    *GETSatispayGatewaysSatispayGatewayId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETSatispayGatewaysSatispayGatewayId200ResponseData() *GETSatispayGatewaysSatispayGatewayId200ResponseData {
	this := GETSatispayGatewaysSatispayGatewayId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETSatispayGatewaysSatispayGatewayId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETSatispayGatewaysSatispayGatewayId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETSatispayGatewaysSatispayGatewayId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETSatispayGatewaysSatispayGatewayId200ResponseData struct {
	value *GETSatispayGatewaysSatispayGatewayId200ResponseData
	isSet bool
}

func (v NullableGETSatispayGatewaysSatispayGatewayId200ResponseData) Get() *GETSatispayGatewaysSatispayGatewayId200ResponseData {
	return v.value
}

func (v *NullableGETSatispayGatewaysSatispayGatewayId200ResponseData) Set(val *GETSatispayGatewaysSatispayGatewayId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETSatispayGatewaysSatispayGatewayId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETSatispayGatewaysSatispayGatewayId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETSatispayGatewaysSatispayGatewayId200ResponseData(val *GETSatispayGatewaysSatispayGatewayId200ResponseData) *NullableGETSatispayGatewaysSatispayGatewayId200ResponseData {
	return &NullableGETSatispayGatewaysSatispayGatewayId200ResponseData{value: val, isSet: true}
}

func (v NullableGETSatispayGatewaysSatispayGatewayId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETSatispayGatewaysSatispayGatewayId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
