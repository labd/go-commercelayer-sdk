...
// checks if the ModelPackage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelPackage{}
...
func (o ModelPackage) ToMap() (map[string]interface{}, error) {
