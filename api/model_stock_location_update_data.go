...
// checks if the StockLocationUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StockLocationUpdateData{}
...
func (o StockLocationUpdateData) ToMap() (map[string]interface{}, error) {
