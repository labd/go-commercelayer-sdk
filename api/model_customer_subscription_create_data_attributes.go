...
// CustomerSubscriptionCreateDataAttributes struct for CustomerSubscriptionCreateDataAttributes
type CustomerSubscriptionCreateDataAttributes struct {
...
func NewCustomerSubscriptionCreateDataAttributes(customerEmail string) *CustomerSubscriptionCreateDataAttributes {
	this := CustomerSubscriptionCreateDataAttributes{}
...
func (o CustomerSubscriptionCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableCustomerSubscriptionCreateDataAttributes struct {
	value *CustomerSubscriptionCreateDataAttributes
	isSet bool
}

func (v NullableCustomerSubscriptionCreateDataAttributes) Get() *CustomerSubscriptionCreateDataAttributes {
	return v.value
}

func (v *NullableCustomerSubscriptionCreateDataAttributes) Set(val *CustomerSubscriptionCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerSubscriptionCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerSubscriptionCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerSubscriptionCreateDataAttributes(val *CustomerSubscriptionCreateDataAttributes) *NullableCustomerSubscriptionCreateDataAttributes {
	return &NullableCustomerSubscriptionCreateDataAttributes{value: val, isSet: true}
}

func (v NullableCustomerSubscriptionCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerSubscriptionCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
