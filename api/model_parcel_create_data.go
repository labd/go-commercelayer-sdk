...
// checks if the ParcelCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParcelCreateData{}
...
func (o ParcelCreateData) ToMap() (map[string]interface{}, error) {
