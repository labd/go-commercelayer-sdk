...
// checks if the POSTBraintreePaymentsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTBraintreePaymentsRequestDataAttributes{}

// POSTBraintreePaymentsRequestDataAttributes struct for POSTBraintreePaymentsRequestDataAttributes
type POSTBraintreePaymentsRequestDataAttributes struct {
...
func NewPOSTBraintreePaymentsRequestDataAttributes() *POSTBraintreePaymentsRequestDataAttributes {
	this := POSTBraintreePaymentsRequestDataAttributes{}
	return &this
}
...
func (o POSTBraintreePaymentsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTBraintreePaymentsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTBraintreePaymentsRequestDataAttributes struct {
	value *POSTBraintreePaymentsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTBraintreePaymentsRequestDataAttributes) Get() *POSTBraintreePaymentsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTBraintreePaymentsRequestDataAttributes) Set(val *POSTBraintreePaymentsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTBraintreePaymentsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTBraintreePaymentsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTBraintreePaymentsRequestDataAttributes(val *POSTBraintreePaymentsRequestDataAttributes) *NullablePOSTBraintreePaymentsRequestDataAttributes {
	return &NullablePOSTBraintreePaymentsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTBraintreePaymentsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTBraintreePaymentsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
