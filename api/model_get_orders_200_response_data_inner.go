...
// GETOrders200ResponseDataInner struct for GETOrders200ResponseDataInner
type GETOrders200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                     `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks      `json:"links,omitempty"`
	Attributes    *GETOrders200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETOrders200ResponseDataInner() *GETOrders200ResponseDataInner {
	this := GETOrders200ResponseDataInner{}
...
// SetAttributes gets a reference to the given GETOrders200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETOrders200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETOrders200ResponseDataInner struct {
	value *GETOrders200ResponseDataInner
	isSet bool
}

func (v NullableGETOrders200ResponseDataInner) Get() *GETOrders200ResponseDataInner {
	return v.value
}

func (v *NullableGETOrders200ResponseDataInner) Set(val *GETOrders200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETOrders200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETOrders200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETOrders200ResponseDataInner(val *GETOrders200ResponseDataInner) *NullableGETOrders200ResponseDataInner {
	return &NullableGETOrders200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETOrders200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETOrders200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
