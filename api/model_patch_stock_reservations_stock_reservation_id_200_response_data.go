...
// checks if the PATCHStockReservationsStockReservationId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHStockReservationsStockReservationId200ResponseData{}

// PATCHStockReservationsStockReservationId200ResponseData struct for PATCHStockReservationsStockReservationId200ResponseData
type PATCHStockReservationsStockReservationId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                        `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                 `json:"links,omitempty"`
	Attributes    *PATCHStockReservationsStockReservationId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewPATCHStockReservationsStockReservationId200ResponseData() *PATCHStockReservationsStockReservationId200ResponseData {
	this := PATCHStockReservationsStockReservationId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given PATCHStockReservationsStockReservationId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHStockReservationsStockReservationId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHStockReservationsStockReservationId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHStockReservationsStockReservationId200ResponseData struct {
	value *PATCHStockReservationsStockReservationId200ResponseData
	isSet bool
}

func (v NullablePATCHStockReservationsStockReservationId200ResponseData) Get() *PATCHStockReservationsStockReservationId200ResponseData {
	return v.value
}

func (v *NullablePATCHStockReservationsStockReservationId200ResponseData) Set(val *PATCHStockReservationsStockReservationId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHStockReservationsStockReservationId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHStockReservationsStockReservationId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHStockReservationsStockReservationId200ResponseData(val *PATCHStockReservationsStockReservationId200ResponseData) *NullablePATCHStockReservationsStockReservationId200ResponseData {
	return &NullablePATCHStockReservationsStockReservationId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHStockReservationsStockReservationId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHStockReservationsStockReservationId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
