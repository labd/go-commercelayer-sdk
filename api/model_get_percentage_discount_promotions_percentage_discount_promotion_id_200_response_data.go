...
// checks if the GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData{}

// GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData struct for GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData
type GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                                            `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                                     `json:"links,omitempty"`
	Attributes    *GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData() *GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData {
	this := GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData struct {
	value *GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData
	isSet bool
}

func (v NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) Get() *GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData {
	return v.value
}

func (v *NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) Set(val *GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData(val *GETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) *NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData {
	return &NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData{value: val, isSet: true}
}

func (v NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPercentageDiscountPromotionsPercentageDiscountPromotionId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
