...
func NewGETSubscriptionModelsSubscriptionModelId200ResponseData() *GETSubscriptionModelsSubscriptionModelId200ResponseData {
	this := GETSubscriptionModelsSubscriptionModelId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETSubscriptionModelsSubscriptionModelId200ResponseDataAttributes and assigns it to the Attributes field.
...
type NullableGETSubscriptionModelsSubscriptionModelId200ResponseData struct {
	value *GETSubscriptionModelsSubscriptionModelId200ResponseData
	isSet bool
}

func (v NullableGETSubscriptionModelsSubscriptionModelId200ResponseData) Get() *GETSubscriptionModelsSubscriptionModelId200ResponseData {
	return v.value
}

func (v *NullableGETSubscriptionModelsSubscriptionModelId200ResponseData) Set(val *GETSubscriptionModelsSubscriptionModelId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETSubscriptionModelsSubscriptionModelId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETSubscriptionModelsSubscriptionModelId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETSubscriptionModelsSubscriptionModelId200ResponseData(val *GETSubscriptionModelsSubscriptionModelId200ResponseData) *NullableGETSubscriptionModelsSubscriptionModelId200ResponseData {
	return &NullableGETSubscriptionModelsSubscriptionModelId200ResponseData{value: val, isSet: true}
}

func (v NullableGETSubscriptionModelsSubscriptionModelId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETSubscriptionModelsSubscriptionModelId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
