...
// StockItemResponseDataRelationships struct for StockItemResponseDataRelationships
type StockItemResponseDataRelationships struct {
...
func NewStockItemResponseDataRelationships() *StockItemResponseDataRelationships {
	this := StockItemResponseDataRelationships{}
	return &this
}
...
func (o StockItemResponseDataRelationships) MarshalJSON() ([]byte, error) {
...
type NullableStockItemResponseDataRelationships struct {
	value *StockItemResponseDataRelationships
	isSet bool
}

func (v NullableStockItemResponseDataRelationships) Get() *StockItemResponseDataRelationships {
	return v.value
}

func (v *NullableStockItemResponseDataRelationships) Set(val *StockItemResponseDataRelationships) {
	v.value = val
	v.isSet = true
}

func (v NullableStockItemResponseDataRelationships) IsSet() bool {
	return v.isSet
}

func (v *NullableStockItemResponseDataRelationships) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStockItemResponseDataRelationships(val *StockItemResponseDataRelationships) *NullableStockItemResponseDataRelationships {
	return &NullableStockItemResponseDataRelationships{value: val, isSet: true}
}

func (v NullableStockItemResponseDataRelationships) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStockItemResponseDataRelationships) UnmarshalJSON(src []byte) error {
	v.isSet = true
