...
// AdyenGatewayUpdateDataAttributes struct for AdyenGatewayUpdateDataAttributes
type AdyenGatewayUpdateDataAttributes struct {
...
func NewAdyenGatewayUpdateDataAttributes() *AdyenGatewayUpdateDataAttributes {
	this := AdyenGatewayUpdateDataAttributes{}
	return &this
}
...
func (o AdyenGatewayUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableAdyenGatewayUpdateDataAttributes struct {
	value *AdyenGatewayUpdateDataAttributes
	isSet bool
}

func (v NullableAdyenGatewayUpdateDataAttributes) Get() *AdyenGatewayUpdateDataAttributes {
	return v.value
}

func (v *NullableAdyenGatewayUpdateDataAttributes) Set(val *AdyenGatewayUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableAdyenGatewayUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableAdyenGatewayUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdyenGatewayUpdateDataAttributes(val *AdyenGatewayUpdateDataAttributes) *NullableAdyenGatewayUpdateDataAttributes {
	return &NullableAdyenGatewayUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableAdyenGatewayUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdyenGatewayUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
