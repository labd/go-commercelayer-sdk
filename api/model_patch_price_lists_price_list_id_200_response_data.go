...
type PATCHPriceListsPriceListId200ResponseData struct {
	...
	Attributes    *PATCHPriceListsPriceListId200ResponseDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHPriceListsPriceListId200ResponseDataAttributes and assigns it to the Attributes field.
