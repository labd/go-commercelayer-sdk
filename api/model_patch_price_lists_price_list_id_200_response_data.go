...
// checks if the PATCHPriceListsPriceListId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPriceListsPriceListId200ResponseData{}

// PATCHPriceListsPriceListId200ResponseData struct for PATCHPriceListsPriceListId200ResponseData
type PATCHPriceListsPriceListId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                      `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks               `json:"links,omitempty"`
	Attributes    *PATCHPriceListsPriceListIdRequestDataAttributes `json:"attributes,omitempty"`
...
func NewPATCHPriceListsPriceListId200ResponseData() *PATCHPriceListsPriceListId200ResponseData {
	this := PATCHPriceListsPriceListId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given PATCHPriceListsPriceListIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHPriceListsPriceListId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHPriceListsPriceListId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHPriceListsPriceListId200ResponseData struct {
	value *PATCHPriceListsPriceListId200ResponseData
	isSet bool
}

func (v NullablePATCHPriceListsPriceListId200ResponseData) Get() *PATCHPriceListsPriceListId200ResponseData {
	return v.value
}

func (v *NullablePATCHPriceListsPriceListId200ResponseData) Set(val *PATCHPriceListsPriceListId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHPriceListsPriceListId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHPriceListsPriceListId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHPriceListsPriceListId200ResponseData(val *PATCHPriceListsPriceListId200ResponseData) *NullablePATCHPriceListsPriceListId200ResponseData {
	return &NullablePATCHPriceListsPriceListId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHPriceListsPriceListId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHPriceListsPriceListId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
