...
type POSTStripePayments201ResponseData struct {
	...
	Attributes    *POSTStripePaymentsRequestDataAttributes       `json:"attributes,omitempty"`
...
func (o *POSTStripePayments201ResponseData) GetAttributes() POSTStripePaymentsRequestDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret POSTStripePaymentsRequestDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given POSTStripePaymentsRequestDataAttributes and assigns it to the Attributes field.
