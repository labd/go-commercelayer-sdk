...
// GETFixedPricePromotions200ResponseDataInner struct for GETFixedPricePromotions200ResponseDataInner
type GETFixedPricePromotions200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                                   `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                    `json:"links,omitempty"`
	Attributes    *GETFixedPricePromotions200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETFixedPricePromotions200ResponseDataInner() *GETFixedPricePromotions200ResponseDataInner {
	this := GETFixedPricePromotions200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETFixedPricePromotions200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETFixedPricePromotions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETFixedPricePromotions200ResponseDataInner struct {
	value *GETFixedPricePromotions200ResponseDataInner
	isSet bool
}

func (v NullableGETFixedPricePromotions200ResponseDataInner) Get() *GETFixedPricePromotions200ResponseDataInner {
	return v.value
}

func (v *NullableGETFixedPricePromotions200ResponseDataInner) Set(val *GETFixedPricePromotions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETFixedPricePromotions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETFixedPricePromotions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETFixedPricePromotions200ResponseDataInner(val *GETFixedPricePromotions200ResponseDataInner) *NullableGETFixedPricePromotions200ResponseDataInner {
	return &NullableGETFixedPricePromotions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETFixedPricePromotions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETFixedPricePromotions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
