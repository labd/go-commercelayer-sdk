...
// checks if the TaxCategoryCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxCategoryCreateData{}
...
func (o TaxCategoryCreateData) ToMap() (map[string]interface{}, error) {
