...
// checks if the GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes{}

// GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes struct for GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes
...
func NewGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes() *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes {
	this := GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes{}
	return &this
}
...
func (o GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes struct {
	value *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) Get() *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) Set(val *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes(val *GETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) *NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes {
	return &NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETManualTaxCalculatorsManualTaxCalculatorId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
