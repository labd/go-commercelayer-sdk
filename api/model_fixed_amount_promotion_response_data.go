...
// FixedAmountPromotionResponseData struct for FixedAmountPromotionResponseData
type FixedAmountPromotionResponseData struct {
	// The resource's id
...
func NewFixedAmountPromotionResponseData() *FixedAmountPromotionResponseData {
	this := FixedAmountPromotionResponseData{}
	return &this
}
...
func (o FixedAmountPromotionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableFixedAmountPromotionResponseData struct {
	value *FixedAmountPromotionResponseData
	isSet bool
}

func (v NullableFixedAmountPromotionResponseData) Get() *FixedAmountPromotionResponseData {
	return v.value
}

func (v *NullableFixedAmountPromotionResponseData) Set(val *FixedAmountPromotionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableFixedAmountPromotionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableFixedAmountPromotionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFixedAmountPromotionResponseData(val *FixedAmountPromotionResponseData) *NullableFixedAmountPromotionResponseData {
	return &NullableFixedAmountPromotionResponseData{value: val, isSet: true}
}

func (v NullableFixedAmountPromotionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFixedAmountPromotionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
