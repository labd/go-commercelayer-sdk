...
// checks if the CustomerPasswordResetCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerPasswordResetCreateData{}
...
func (o CustomerPasswordResetCreateData) ToMap() (map[string]interface{}, error) {
