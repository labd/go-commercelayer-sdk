...
// checks if the PATCHAdyenPaymentsAdyenPaymentId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHAdyenPaymentsAdyenPaymentId200ResponseData{}
...
type PATCHAdyenPaymentsAdyenPaymentId200ResponseData struct {
	...
	Attributes    *PATCHAdyenPaymentsAdyenPaymentIdRequestDataAttributes `json:"attributes,omitempty"`
...
func (o *PATCHAdyenPaymentsAdyenPaymentId200ResponseData) GetAttributes() PATCHAdyenPaymentsAdyenPaymentIdRequestDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret PATCHAdyenPaymentsAdyenPaymentIdRequestDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given PATCHAdyenPaymentsAdyenPaymentIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHAdyenPaymentsAdyenPaymentId200ResponseData) ToMap() (map[string]interface{}, error) {
