...
// checks if the POSTKlarnaPayments201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTKlarnaPayments201ResponseData{}

// POSTKlarnaPayments201ResponseData struct for POSTKlarnaPayments201ResponseData
type POSTKlarnaPayments201ResponseData struct {
	// The resource's id
...
func NewPOSTKlarnaPayments201ResponseData() *POSTKlarnaPayments201ResponseData {
	this := POSTKlarnaPayments201ResponseData{}
	return &this
}
...
func (o POSTKlarnaPayments201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTKlarnaPayments201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTKlarnaPayments201ResponseData struct {
	value *POSTKlarnaPayments201ResponseData
	isSet bool
}

func (v NullablePOSTKlarnaPayments201ResponseData) Get() *POSTKlarnaPayments201ResponseData {
	return v.value
}

func (v *NullablePOSTKlarnaPayments201ResponseData) Set(val *POSTKlarnaPayments201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTKlarnaPayments201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTKlarnaPayments201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTKlarnaPayments201ResponseData(val *POSTKlarnaPayments201ResponseData) *NullablePOSTKlarnaPayments201ResponseData {
	return &NullablePOSTKlarnaPayments201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTKlarnaPayments201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTKlarnaPayments201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
