...
type POSTSkuOptions201ResponseData struct {
	...
	Attributes    *POSTSkuOptionsRequestDataAttributes                        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTSkuOptionsRequestDataAttributes and assigns it to the Attributes field.
