...
// GETInventoryReturnLocations200ResponseDataInner struct for GETInventoryReturnLocations200ResponseDataInner
type GETInventoryReturnLocations200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                   `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                        `json:"links,omitempty"`
	Attributes    *GETInventoryReturnLocations200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETInventoryReturnLocations200ResponseDataInner() *GETInventoryReturnLocations200ResponseDataInner {
	this := GETInventoryReturnLocations200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETInventoryReturnLocations200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETInventoryReturnLocations200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETInventoryReturnLocations200ResponseDataInner struct {
	value *GETInventoryReturnLocations200ResponseDataInner
	isSet bool
}

func (v NullableGETInventoryReturnLocations200ResponseDataInner) Get() *GETInventoryReturnLocations200ResponseDataInner {
	return v.value
}

func (v *NullableGETInventoryReturnLocations200ResponseDataInner) Set(val *GETInventoryReturnLocations200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETInventoryReturnLocations200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETInventoryReturnLocations200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETInventoryReturnLocations200ResponseDataInner(val *GETInventoryReturnLocations200ResponseDataInner) *NullableGETInventoryReturnLocations200ResponseDataInner {
	return &NullableGETInventoryReturnLocations200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETInventoryReturnLocations200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETInventoryReturnLocations200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
