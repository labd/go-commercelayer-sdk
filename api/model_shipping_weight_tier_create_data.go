...
// checks if the ShippingWeightTierCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingWeightTierCreateData{}
...
func (o ShippingWeightTierCreateData) ToMap() (map[string]interface{}, error) {
