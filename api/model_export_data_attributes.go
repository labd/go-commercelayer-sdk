...
// ExportDataAttributes struct for ExportDataAttributes
type ExportDataAttributes struct {
...
func (o ExportDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableExportDataAttributes struct {
	value *ExportDataAttributes
	isSet bool
}

func (v NullableExportDataAttributes) Get() *ExportDataAttributes {
	return v.value
}

func (v *NullableExportDataAttributes) Set(val *ExportDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableExportDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableExportDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportDataAttributes(val *ExportDataAttributes) *NullableExportDataAttributes {
	return &NullableExportDataAttributes{value: val, isSet: true}
}

func (v NullableExportDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
