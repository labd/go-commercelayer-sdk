...
// checks if the GETPriceVolumeTiersPriceVolumeTierId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPriceVolumeTiersPriceVolumeTierId200ResponseData{}

// GETPriceVolumeTiersPriceVolumeTierId200ResponseData struct for GETPriceVolumeTiersPriceVolumeTierId200ResponseData
type GETPriceVolumeTiersPriceVolumeTierId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                             `json:"links,omitempty"`
	Attributes    *GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETPriceVolumeTiersPriceVolumeTierId200ResponseData() *GETPriceVolumeTiersPriceVolumeTierId200ResponseData {
	this := GETPriceVolumeTiersPriceVolumeTierId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETPriceVolumeTiersPriceVolumeTierId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETPriceVolumeTiersPriceVolumeTierId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETPriceVolumeTiersPriceVolumeTierId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData struct {
	value *GETPriceVolumeTiersPriceVolumeTierId200ResponseData
	isSet bool
}

func (v NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData) Get() *GETPriceVolumeTiersPriceVolumeTierId200ResponseData {
	return v.value
}

func (v *NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData) Set(val *GETPriceVolumeTiersPriceVolumeTierId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData(val *GETPriceVolumeTiersPriceVolumeTierId200ResponseData) *NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData {
	return &NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData{value: val, isSet: true}
}

func (v NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPriceVolumeTiersPriceVolumeTierId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
