...
// checks if the POSTCarrierAccounts201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTCarrierAccounts201ResponseData{}

// POSTCarrierAccounts201ResponseData struct for POSTCarrierAccounts201ResponseData
type POSTCarrierAccounts201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                 `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                          `json:"links,omitempty"`
	Attributes    *POSTCarrierAccounts201ResponseDataAttributes               `json:"attributes,omitempty"`
...
func NewPOSTCarrierAccounts201ResponseData() *POSTCarrierAccounts201ResponseData {
	this := POSTCarrierAccounts201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTCarrierAccounts201ResponseDataAttributes and assigns it to the Attributes field.
...
func (o POSTCarrierAccounts201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTCarrierAccounts201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTCarrierAccounts201ResponseData struct {
	value *POSTCarrierAccounts201ResponseData
	isSet bool
}

func (v NullablePOSTCarrierAccounts201ResponseData) Get() *POSTCarrierAccounts201ResponseData {
	return v.value
}

func (v *NullablePOSTCarrierAccounts201ResponseData) Set(val *POSTCarrierAccounts201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTCarrierAccounts201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTCarrierAccounts201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTCarrierAccounts201ResponseData(val *POSTCarrierAccounts201ResponseData) *NullablePOSTCarrierAccounts201ResponseData {
	return &NullablePOSTCarrierAccounts201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTCarrierAccounts201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTCarrierAccounts201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
