...
// PaymentMethodUpdateDataAttributes struct for PaymentMethodUpdateDataAttributes
type PaymentMethodUpdateDataAttributes struct {
...
func NewPaymentMethodUpdateDataAttributes() *PaymentMethodUpdateDataAttributes {
	this := PaymentMethodUpdateDataAttributes{}
	return &this
}
...
func (o PaymentMethodUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullablePaymentMethodUpdateDataAttributes struct {
	value *PaymentMethodUpdateDataAttributes
	isSet bool
}

func (v NullablePaymentMethodUpdateDataAttributes) Get() *PaymentMethodUpdateDataAttributes {
	return v.value
}

func (v *NullablePaymentMethodUpdateDataAttributes) Set(val *PaymentMethodUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodUpdateDataAttributes(val *PaymentMethodUpdateDataAttributes) *NullablePaymentMethodUpdateDataAttributes {
	return &NullablePaymentMethodUpdateDataAttributes{value: val, isSet: true}
}

func (v NullablePaymentMethodUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
