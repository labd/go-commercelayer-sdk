...
// ExternalGatewayResponseData struct for ExternalGatewayResponseData
type ExternalGatewayResponseData struct {
	// The resource's id
	...
	Relationships *ExternalGatewayResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewExternalGatewayResponseData() *ExternalGatewayResponseData {
	this := ExternalGatewayResponseData{}
	return &this
}
...
func (o *ExternalGatewayResponseData) GetRelationships() ExternalGatewayResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ExternalGatewayResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ExternalGatewayResponseDataRelationships and assigns it to the Relationships field.
func (o *ExternalGatewayResponseData) SetRelationships(v ExternalGatewayResponseDataRelationships) {
	o.Relationships = &v
}

func (o ExternalGatewayResponseData) MarshalJSON() ([]byte, error) {
...
type NullableExternalGatewayResponseData struct {
	value *ExternalGatewayResponseData
	isSet bool
}

func (v NullableExternalGatewayResponseData) Get() *ExternalGatewayResponseData {
	return v.value
}

func (v *NullableExternalGatewayResponseData) Set(val *ExternalGatewayResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalGatewayResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalGatewayResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalGatewayResponseData(val *ExternalGatewayResponseData) *NullableExternalGatewayResponseData {
	return &NullableExternalGatewayResponseData{value: val, isSet: true}
}

func (v NullableExternalGatewayResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalGatewayResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
