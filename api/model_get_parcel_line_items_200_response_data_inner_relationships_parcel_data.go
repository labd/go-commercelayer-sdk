...
func (o *GETParcelLineItems200ResponseDataInnerRelationshipsParcelData) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *GETParcelLineItems200ResponseDataInnerRelationshipsParcelData) GetTypeOk() (*interface{}, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GETParcelLineItems200ResponseDataInnerRelationshipsParcelData) SetType(v interface{}) {
	o.Type = v
}

// GetId returns the Id field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GETParcelLineItems200ResponseDataInnerRelationshipsParcelData) GetId() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GETParcelLineItems200ResponseDataInnerRelationshipsParcelData) GetIdOk() (*interface{}, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *GETParcelLineItems200ResponseDataInnerRelationshipsParcelData) SetId(v interface{}) {
	o.Id = v
}
