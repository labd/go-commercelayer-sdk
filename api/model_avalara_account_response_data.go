...
// AvalaraAccountResponseData struct for AvalaraAccountResponseData
type AvalaraAccountResponseData struct {
	// The resource's id
...
func NewAvalaraAccountResponseData() *AvalaraAccountResponseData {
	this := AvalaraAccountResponseData{}
	return &this
}
...
func (o AvalaraAccountResponseData) MarshalJSON() ([]byte, error) {
...
type NullableAvalaraAccountResponseData struct {
	value *AvalaraAccountResponseData
	isSet bool
}

func (v NullableAvalaraAccountResponseData) Get() *AvalaraAccountResponseData {
	return v.value
}

func (v *NullableAvalaraAccountResponseData) Set(val *AvalaraAccountResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableAvalaraAccountResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableAvalaraAccountResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvalaraAccountResponseData(val *AvalaraAccountResponseData) *NullableAvalaraAccountResponseData {
	return &NullableAvalaraAccountResponseData{value: val, isSet: true}
}

func (v NullableAvalaraAccountResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvalaraAccountResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
