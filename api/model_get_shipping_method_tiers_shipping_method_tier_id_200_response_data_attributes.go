...
// checks if the GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes{}

// GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes struct for GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes
type GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes struct {
	// The shipping method tier's name.
	Name interface{} `json:"name,omitempty"`
	// The shipping method tier's type.
...
func NewGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes() *GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes {
	this := GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes{}
	return &this
}
...
func (o *GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) SetType(v interface{}) {
	o.Type = v
}
...
func (o GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes struct {
	value *GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) Get() *GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) Set(val *GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes(val *GETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) *NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes {
	return &NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETShippingMethodTiersShippingMethodTierId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
