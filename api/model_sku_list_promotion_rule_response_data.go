...
// SkuListPromotionRuleResponseData struct for SkuListPromotionRuleResponseData
type SkuListPromotionRuleResponseData struct {
	// The resource's id
	...
	Relationships *SkuListPromotionRuleResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewSkuListPromotionRuleResponseData() *SkuListPromotionRuleResponseData {
	this := SkuListPromotionRuleResponseData{}
	return &this
}
...
func (o *SkuListPromotionRuleResponseData) GetRelationships() SkuListPromotionRuleResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret SkuListPromotionRuleResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given SkuListPromotionRuleResponseDataRelationships and assigns it to the Relationships field.
func (o *SkuListPromotionRuleResponseData) SetRelationships(v SkuListPromotionRuleResponseDataRelationships) {
	o.Relationships = &v
}

func (o SkuListPromotionRuleResponseData) MarshalJSON() ([]byte, error) {
...
type NullableSkuListPromotionRuleResponseData struct {
	value *SkuListPromotionRuleResponseData
	isSet bool
}

func (v NullableSkuListPromotionRuleResponseData) Get() *SkuListPromotionRuleResponseData {
	return v.value
}

func (v *NullableSkuListPromotionRuleResponseData) Set(val *SkuListPromotionRuleResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableSkuListPromotionRuleResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableSkuListPromotionRuleResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkuListPromotionRuleResponseData(val *SkuListPromotionRuleResponseData) *NullableSkuListPromotionRuleResponseData {
	return &NullableSkuListPromotionRuleResponseData{value: val, isSet: true}
}

func (v NullableSkuListPromotionRuleResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkuListPromotionRuleResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
