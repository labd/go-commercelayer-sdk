...
// ExternalPaymentResponseData struct for ExternalPaymentResponseData
type ExternalPaymentResponseData struct {
	// The resource's id
	...
	Relationships *ExternalPaymentResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewExternalPaymentResponseData() *ExternalPaymentResponseData {
	this := ExternalPaymentResponseData{}
	return &this
}
...
func (o *ExternalPaymentResponseData) GetRelationships() ExternalPaymentResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ExternalPaymentResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ExternalPaymentResponseDataRelationships and assigns it to the Relationships field.
func (o *ExternalPaymentResponseData) SetRelationships(v ExternalPaymentResponseDataRelationships) {
	o.Relationships = &v
}

func (o ExternalPaymentResponseData) MarshalJSON() ([]byte, error) {
...
type NullableExternalPaymentResponseData struct {
	value *ExternalPaymentResponseData
	isSet bool
}

func (v NullableExternalPaymentResponseData) Get() *ExternalPaymentResponseData {
	return v.value
}

func (v *NullableExternalPaymentResponseData) Set(val *ExternalPaymentResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalPaymentResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalPaymentResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalPaymentResponseData(val *ExternalPaymentResponseData) *NullableExternalPaymentResponseData {
	return &NullableExternalPaymentResponseData{value: val, isSet: true}
}

func (v NullableExternalPaymentResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalPaymentResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
