...
// checks if the POSTCustomerPaymentSources201ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTCustomerPaymentSources201ResponseDataAttributes{}

// POSTCustomerPaymentSources201ResponseDataAttributes struct for POSTCustomerPaymentSources201ResponseDataAttributes
type POSTCustomerPaymentSources201ResponseDataAttributes struct {
...
func NewPOSTCustomerPaymentSources201ResponseDataAttributes() *POSTCustomerPaymentSources201ResponseDataAttributes {
	this := POSTCustomerPaymentSources201ResponseDataAttributes{}
	return &this
}
...
func (o POSTCustomerPaymentSources201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTCustomerPaymentSources201ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTCustomerPaymentSources201ResponseDataAttributes struct {
	value *POSTCustomerPaymentSources201ResponseDataAttributes
	isSet bool
}

func (v NullablePOSTCustomerPaymentSources201ResponseDataAttributes) Get() *POSTCustomerPaymentSources201ResponseDataAttributes {
	return v.value
}

func (v *NullablePOSTCustomerPaymentSources201ResponseDataAttributes) Set(val *POSTCustomerPaymentSources201ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTCustomerPaymentSources201ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTCustomerPaymentSources201ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTCustomerPaymentSources201ResponseDataAttributes(val *POSTCustomerPaymentSources201ResponseDataAttributes) *NullablePOSTCustomerPaymentSources201ResponseDataAttributes {
	return &NullablePOSTCustomerPaymentSources201ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTCustomerPaymentSources201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTCustomerPaymentSources201ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
