...
// StockItemDataAttributes struct for StockItemDataAttributes
type StockItemDataAttributes struct {
...
func (o StockItemDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableStockItemDataAttributes struct {
	value *StockItemDataAttributes
	isSet bool
}

func (v NullableStockItemDataAttributes) Get() *StockItemDataAttributes {
	return v.value
}

func (v *NullableStockItemDataAttributes) Set(val *StockItemDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableStockItemDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableStockItemDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStockItemDataAttributes(val *StockItemDataAttributes) *NullableStockItemDataAttributes {
	return &NullableStockItemDataAttributes{value: val, isSet: true}
}

func (v NullableStockItemDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStockItemDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
