...
// GETInventoryStockLocations200ResponseDataInner struct for GETInventoryStockLocations200ResponseDataInner
type GETInventoryStockLocations200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                   `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                        `json:"links,omitempty"`
	Attributes    *GETInventoryStockLocations200ResponseDataInnerAttributes     `json:"attributes,omitempty"`
...
func NewGETInventoryStockLocations200ResponseDataInner() *GETInventoryStockLocations200ResponseDataInner {
	this := GETInventoryStockLocations200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETInventoryStockLocations200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETInventoryStockLocations200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETInventoryStockLocations200ResponseDataInner struct {
	value *GETInventoryStockLocations200ResponseDataInner
	isSet bool
}

func (v NullableGETInventoryStockLocations200ResponseDataInner) Get() *GETInventoryStockLocations200ResponseDataInner {
	return v.value
}

func (v *NullableGETInventoryStockLocations200ResponseDataInner) Set(val *GETInventoryStockLocations200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETInventoryStockLocations200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETInventoryStockLocations200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETInventoryStockLocations200ResponseDataInner(val *GETInventoryStockLocations200ResponseDataInner) *NullableGETInventoryStockLocations200ResponseDataInner {
	return &NullableGETInventoryStockLocations200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETInventoryStockLocations200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETInventoryStockLocations200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
