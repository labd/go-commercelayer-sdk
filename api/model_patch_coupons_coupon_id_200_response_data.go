...
type PATCHCouponsCouponId200ResponseData struct {
	...
	Attributes    *PATCHCouponsCouponIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHCouponsCouponIdRequestDataAttributes and assigns it to the Attributes field.
