...
// checks if the GETShippingMethodsShippingMethodId200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETShippingMethodsShippingMethodId200Response{}
...
type GETShippingMethodsShippingMethodId200Response struct {
	Data *GETShippingMethodsShippingMethodId200ResponseData `json:"data,omitempty"`
}
...
func (o *GETShippingMethodsShippingMethodId200Response) GetData() GETShippingMethodsShippingMethodId200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret GETShippingMethodsShippingMethodId200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given GETShippingMethodsShippingMethodId200ResponseData and assigns it to the Data field.
...
func (o GETShippingMethodsShippingMethodId200Response) ToMap() (map[string]interface{}, error) {
