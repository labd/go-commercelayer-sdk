...
// CustomerSubscriptionDataAttributes struct for CustomerSubscriptionDataAttributes
type CustomerSubscriptionDataAttributes struct {
...
func NewCustomerSubscriptionDataAttributes() *CustomerSubscriptionDataAttributes {
	this := CustomerSubscriptionDataAttributes{}
	return &this
}
...
func (o CustomerSubscriptionDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableCustomerSubscriptionDataAttributes struct {
	value *CustomerSubscriptionDataAttributes
	isSet bool
}

func (v NullableCustomerSubscriptionDataAttributes) Get() *CustomerSubscriptionDataAttributes {
	return v.value
}

func (v *NullableCustomerSubscriptionDataAttributes) Set(val *CustomerSubscriptionDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerSubscriptionDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerSubscriptionDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerSubscriptionDataAttributes(val *CustomerSubscriptionDataAttributes) *NullableCustomerSubscriptionDataAttributes {
	return &NullableCustomerSubscriptionDataAttributes{value: val, isSet: true}
}

func (v NullableCustomerSubscriptionDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerSubscriptionDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
