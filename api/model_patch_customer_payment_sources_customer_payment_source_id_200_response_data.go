...
// checks if the PATCHCustomerPaymentSourcesCustomerPaymentSourceId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHCustomerPaymentSourcesCustomerPaymentSourceId200ResponseData{}
...
func (o PATCHCustomerPaymentSourcesCustomerPaymentSourceId200ResponseData) ToMap() (map[string]interface{}, error) {
