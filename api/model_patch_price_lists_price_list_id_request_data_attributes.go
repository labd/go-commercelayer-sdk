...
// checks if the PATCHPriceListsPriceListIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPriceListsPriceListIdRequestDataAttributes{}

// PATCHPriceListsPriceListIdRequestDataAttributes struct for PATCHPriceListsPriceListIdRequestDataAttributes
type PATCHPriceListsPriceListIdRequestDataAttributes struct {
...
func NewPATCHPriceListsPriceListIdRequestDataAttributes() *PATCHPriceListsPriceListIdRequestDataAttributes {
	this := PATCHPriceListsPriceListIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHPriceListsPriceListIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHPriceListsPriceListIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHPriceListsPriceListIdRequestDataAttributes struct {
	value *PATCHPriceListsPriceListIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHPriceListsPriceListIdRequestDataAttributes) Get() *PATCHPriceListsPriceListIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHPriceListsPriceListIdRequestDataAttributes) Set(val *PATCHPriceListsPriceListIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHPriceListsPriceListIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHPriceListsPriceListIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHPriceListsPriceListIdRequestDataAttributes(val *PATCHPriceListsPriceListIdRequestDataAttributes) *NullablePATCHPriceListsPriceListIdRequestDataAttributes {
	return &NullablePATCHPriceListsPriceListIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHPriceListsPriceListIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHPriceListsPriceListIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
