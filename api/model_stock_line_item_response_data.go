...
// StockLineItemResponseData struct for StockLineItemResponseData
type StockLineItemResponseData struct {
	// The resource's id
	...
	Relationships *StockLineItemResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewStockLineItemResponseData() *StockLineItemResponseData {
	this := StockLineItemResponseData{}
	return &this
}
...
func (o *StockLineItemResponseData) GetRelationships() StockLineItemResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret StockLineItemResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given StockLineItemResponseDataRelationships and assigns it to the Relationships field.
func (o *StockLineItemResponseData) SetRelationships(v StockLineItemResponseDataRelationships) {
	o.Relationships = &v
}

func (o StockLineItemResponseData) MarshalJSON() ([]byte, error) {
...
type NullableStockLineItemResponseData struct {
	value *StockLineItemResponseData
	isSet bool
}

func (v NullableStockLineItemResponseData) Get() *StockLineItemResponseData {
	return v.value
}

func (v *NullableStockLineItemResponseData) Set(val *StockLineItemResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableStockLineItemResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableStockLineItemResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStockLineItemResponseData(val *StockLineItemResponseData) *NullableStockLineItemResponseData {
	return &NullableStockLineItemResponseData{value: val, isSet: true}
}

func (v NullableStockLineItemResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStockLineItemResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
