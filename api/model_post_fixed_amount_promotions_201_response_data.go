...
type POSTFixedAmountPromotions201ResponseData struct {
	...
	Attributes    *POSTFixedAmountPromotionsRequestDataAttributes     `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTFixedAmountPromotionsRequestDataAttributes and assigns it to the Attributes field.
