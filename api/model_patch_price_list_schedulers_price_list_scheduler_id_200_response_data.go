...
// checks if the PATCHPriceListSchedulersPriceListSchedulerId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPriceListSchedulersPriceListSchedulerId200ResponseData{}
...
type PATCHPriceListSchedulersPriceListSchedulerId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                            `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                     `json:"links,omitempty"`
	Attributes    *PATCHPriceListSchedulersPriceListSchedulerId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func (o *PATCHPriceListSchedulersPriceListSchedulerId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
// SetAttributes gets a reference to the given PATCHPriceListSchedulersPriceListSchedulerId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHPriceListSchedulersPriceListSchedulerId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHPriceListSchedulersPriceListSchedulerId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData struct {
	value *PATCHPriceListSchedulersPriceListSchedulerId200ResponseData
	isSet bool
}

func (v NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData) Get() *PATCHPriceListSchedulersPriceListSchedulerId200ResponseData {
	return v.value
}

func (v *NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData) Set(val *PATCHPriceListSchedulersPriceListSchedulerId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData(val *PATCHPriceListSchedulersPriceListSchedulerId200ResponseData) *NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData {
	return &NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHPriceListSchedulersPriceListSchedulerId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
