...
// ParcelResponseData struct for ParcelResponseData
type ParcelResponseData struct {
	// The resource's id
	...
	Relationships *ParcelResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *ParcelResponseData) GetRelationships() ParcelResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ParcelResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ParcelResponseDataRelationships and assigns it to the Relationships field.
func (o *ParcelResponseData) SetRelationships(v ParcelResponseDataRelationships) {
	o.Relationships = &v
}

func (o ParcelResponseData) MarshalJSON() ([]byte, error) {
...
type NullableParcelResponseData struct {
	value *ParcelResponseData
	isSet bool
}

func (v NullableParcelResponseData) Get() *ParcelResponseData {
	return v.value
}

func (v *NullableParcelResponseData) Set(val *ParcelResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableParcelResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableParcelResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParcelResponseData(val *ParcelResponseData) *NullableParcelResponseData {
	return &NullableParcelResponseData{value: val, isSet: true}
}

func (v NullableParcelResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParcelResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
