...
// KlarnaPaymentResponseData struct for KlarnaPaymentResponseData
type KlarnaPaymentResponseData struct {
	// The resource's id
...
func NewKlarnaPaymentResponseData() *KlarnaPaymentResponseData {
	this := KlarnaPaymentResponseData{}
	return &this
}
...
func (o KlarnaPaymentResponseData) MarshalJSON() ([]byte, error) {
...
type NullableKlarnaPaymentResponseData struct {
	value *KlarnaPaymentResponseData
	isSet bool
}

func (v NullableKlarnaPaymentResponseData) Get() *KlarnaPaymentResponseData {
	return v.value
}

func (v *NullableKlarnaPaymentResponseData) Set(val *KlarnaPaymentResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableKlarnaPaymentResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableKlarnaPaymentResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKlarnaPaymentResponseData(val *KlarnaPaymentResponseData) *NullableKlarnaPaymentResponseData {
	return &NullableKlarnaPaymentResponseData{value: val, isSet: true}
}

func (v NullableKlarnaPaymentResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKlarnaPaymentResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
