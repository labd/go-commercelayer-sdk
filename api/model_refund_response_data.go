...
// RefundResponseData struct for RefundResponseData
type RefundResponseData struct {
	...
	Relationships *RefundResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *RefundResponseData) GetRelationships() RefundResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret RefundResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given RefundResponseDataRelationships and assigns it to the Relationships field.
func (o *RefundResponseData) SetRelationships(v RefundResponseDataRelationships) {
	o.Relationships = &v
}

func (o RefundResponseData) MarshalJSON() ([]byte, error) {
...
type NullableRefundResponseData struct {
	value *RefundResponseData
	isSet bool
}

func (v NullableRefundResponseData) Get() *RefundResponseData {
	return v.value
}

func (v *NullableRefundResponseData) Set(val *RefundResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableRefundResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableRefundResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRefundResponseData(val *RefundResponseData) *NullableRefundResponseData {
	return &NullableRefundResponseData{value: val, isSet: true}
}

func (v NullableRefundResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRefundResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
