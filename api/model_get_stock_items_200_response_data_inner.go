...
// GETStockItems200ResponseDataInner struct for GETStockItems200ResponseDataInner
type GETStockItems200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                         `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks          `json:"links,omitempty"`
	Attributes    *GETStockItems200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETStockItems200ResponseDataInner() *GETStockItems200ResponseDataInner {
	this := GETStockItems200ResponseDataInner{}
...
// SetAttributes gets a reference to the given GETStockItems200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETStockItems200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETStockItems200ResponseDataInner struct {
	value *GETStockItems200ResponseDataInner
	isSet bool
}

func (v NullableGETStockItems200ResponseDataInner) Get() *GETStockItems200ResponseDataInner {
	return v.value
}

func (v *NullableGETStockItems200ResponseDataInner) Set(val *GETStockItems200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETStockItems200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETStockItems200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETStockItems200ResponseDataInner(val *GETStockItems200ResponseDataInner) *NullableGETStockItems200ResponseDataInner {
	return &NullableGETStockItems200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETStockItems200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETStockItems200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
