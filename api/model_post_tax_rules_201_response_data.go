...
type POSTTaxRules201ResponseData struct {
	...
	Attributes    *POSTTaxRulesRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTTaxRulesRequestDataAttributes and assigns it to the Attributes field.
