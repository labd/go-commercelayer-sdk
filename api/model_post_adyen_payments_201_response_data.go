...
// checks if the POSTAdyenPayments201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTAdyenPayments201ResponseData{}

// POSTAdyenPayments201ResponseData struct for POSTAdyenPayments201ResponseData
type POSTAdyenPayments201ResponseData struct {
	// The resource's id
...
func NewPOSTAdyenPayments201ResponseData() *POSTAdyenPayments201ResponseData {
	this := POSTAdyenPayments201ResponseData{}
	return &this
}
...
func (o POSTAdyenPayments201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTAdyenPayments201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTAdyenPayments201ResponseData struct {
	value *POSTAdyenPayments201ResponseData
	isSet bool
}

func (v NullablePOSTAdyenPayments201ResponseData) Get() *POSTAdyenPayments201ResponseData {
	return v.value
}

func (v *NullablePOSTAdyenPayments201ResponseData) Set(val *POSTAdyenPayments201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTAdyenPayments201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTAdyenPayments201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTAdyenPayments201ResponseData(val *POSTAdyenPayments201ResponseData) *NullablePOSTAdyenPayments201ResponseData {
	return &NullablePOSTAdyenPayments201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTAdyenPayments201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTAdyenPayments201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
