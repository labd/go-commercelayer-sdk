...
// GETInStockSubscriptions200ResponseDataInner struct for GETInStockSubscriptions200ResponseDataInner
type GETInStockSubscriptions200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                               `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks                    `json:"links,omitempty"`
	Attributes    *GETInStockSubscriptions200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETInStockSubscriptions200ResponseDataInner() *GETInStockSubscriptions200ResponseDataInner {
	this := GETInStockSubscriptions200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETInStockSubscriptions200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETInStockSubscriptions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETInStockSubscriptions200ResponseDataInner struct {
	value *GETInStockSubscriptions200ResponseDataInner
	isSet bool
}

func (v NullableGETInStockSubscriptions200ResponseDataInner) Get() *GETInStockSubscriptions200ResponseDataInner {
	return v.value
}

func (v *NullableGETInStockSubscriptions200ResponseDataInner) Set(val *GETInStockSubscriptions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETInStockSubscriptions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETInStockSubscriptions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETInStockSubscriptions200ResponseDataInner(val *GETInStockSubscriptions200ResponseDataInner) *NullableGETInStockSubscriptions200ResponseDataInner {
	return &NullableGETInStockSubscriptions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETInStockSubscriptions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETInStockSubscriptions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
