...
// checks if the GETCustomersCustomerId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETCustomersCustomerId200ResponseData{}

// GETCustomersCustomerId200ResponseData struct for GETCustomersCustomerId200ResponseData
type GETCustomersCustomerId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                      `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks               `json:"links,omitempty"`
	Attributes    *GETCustomersCustomerId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETCustomersCustomerId200ResponseData() *GETCustomersCustomerId200ResponseData {
	this := GETCustomersCustomerId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETCustomersCustomerId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETCustomersCustomerId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETCustomersCustomerId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETCustomersCustomerId200ResponseData struct {
	value *GETCustomersCustomerId200ResponseData
	isSet bool
}

func (v NullableGETCustomersCustomerId200ResponseData) Get() *GETCustomersCustomerId200ResponseData {
	return v.value
}

func (v *NullableGETCustomersCustomerId200ResponseData) Set(val *GETCustomersCustomerId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomersCustomerId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomersCustomerId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomersCustomerId200ResponseData(val *GETCustomersCustomerId200ResponseData) *NullableGETCustomersCustomerId200ResponseData {
	return &NullableGETCustomersCustomerId200ResponseData{value: val, isSet: true}
}

func (v NullableGETCustomersCustomerId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCustomersCustomerId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
