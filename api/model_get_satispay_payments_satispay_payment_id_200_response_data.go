...
// checks if the GETSatispayPaymentsSatispayPaymentId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETSatispayPaymentsSatispayPaymentId200ResponseData{}

// GETSatispayPaymentsSatispayPaymentId200ResponseData struct for GETSatispayPaymentsSatispayPaymentId200ResponseData
type GETSatispayPaymentsSatispayPaymentId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                             `json:"links,omitempty"`
	Attributes    *GETSatispayPaymentsSatispayPaymentId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETSatispayPaymentsSatispayPaymentId200ResponseData() *GETSatispayPaymentsSatispayPaymentId200ResponseData {
	this := GETSatispayPaymentsSatispayPaymentId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETSatispayPaymentsSatispayPaymentId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETSatispayPaymentsSatispayPaymentId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETSatispayPaymentsSatispayPaymentId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETSatispayPaymentsSatispayPaymentId200ResponseData struct {
	value *GETSatispayPaymentsSatispayPaymentId200ResponseData
	isSet bool
}

func (v NullableGETSatispayPaymentsSatispayPaymentId200ResponseData) Get() *GETSatispayPaymentsSatispayPaymentId200ResponseData {
	return v.value
}

func (v *NullableGETSatispayPaymentsSatispayPaymentId200ResponseData) Set(val *GETSatispayPaymentsSatispayPaymentId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETSatispayPaymentsSatispayPaymentId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETSatispayPaymentsSatispayPaymentId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETSatispayPaymentsSatispayPaymentId200ResponseData(val *GETSatispayPaymentsSatispayPaymentId200ResponseData) *NullableGETSatispayPaymentsSatispayPaymentId200ResponseData {
	return &NullableGETSatispayPaymentsSatispayPaymentId200ResponseData{value: val, isSet: true}
}

func (v NullableGETSatispayPaymentsSatispayPaymentId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETSatispayPaymentsSatispayPaymentId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
