...
type POSTCustomerSubscriptions201ResponseData struct {
	...
	Attributes    *POSTCustomerSubscriptionsRequestDataAttributes         `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTCustomerSubscriptionsRequestDataAttributes and assigns it to the Attributes field.
