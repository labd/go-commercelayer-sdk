...
// checks if the PATCHSkusSkuIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHSkusSkuIdRequestDataAttributes{}

// PATCHSkusSkuIdRequestDataAttributes struct for PATCHSkusSkuIdRequestDataAttributes
type PATCHSkusSkuIdRequestDataAttributes struct {
...
func NewPATCHSkusSkuIdRequestDataAttributes() *PATCHSkusSkuIdRequestDataAttributes {
	this := PATCHSkusSkuIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHSkusSkuIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHSkusSkuIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHSkusSkuIdRequestDataAttributes struct {
	value *PATCHSkusSkuIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHSkusSkuIdRequestDataAttributes) Get() *PATCHSkusSkuIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHSkusSkuIdRequestDataAttributes) Set(val *PATCHSkusSkuIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHSkusSkuIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHSkusSkuIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHSkusSkuIdRequestDataAttributes(val *PATCHSkusSkuIdRequestDataAttributes) *NullablePATCHSkusSkuIdRequestDataAttributes {
	return &NullablePATCHSkusSkuIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHSkusSkuIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHSkusSkuIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
