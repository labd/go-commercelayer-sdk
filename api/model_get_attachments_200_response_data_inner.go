...
// GETAttachments200ResponseDataInner struct for GETAttachments200ResponseDataInner
type GETAttachments200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                          `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks           `json:"links,omitempty"`
	Attributes    *GETAttachments200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETAttachments200ResponseDataInner() *GETAttachments200ResponseDataInner {
	this := GETAttachments200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETAttachments200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETAttachments200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETAttachments200ResponseDataInner struct {
	value *GETAttachments200ResponseDataInner
	isSet bool
}

func (v NullableGETAttachments200ResponseDataInner) Get() *GETAttachments200ResponseDataInner {
	return v.value
}

func (v *NullableGETAttachments200ResponseDataInner) Set(val *GETAttachments200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAttachments200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAttachments200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAttachments200ResponseDataInner(val *GETAttachments200ResponseDataInner) *NullableGETAttachments200ResponseDataInner {
	return &NullableGETAttachments200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETAttachments200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAttachments200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
