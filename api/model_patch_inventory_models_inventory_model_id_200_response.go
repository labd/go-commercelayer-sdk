...
// checks if the PATCHInventoryModelsInventoryModelId200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHInventoryModelsInventoryModelId200Response{}
...
func (o PATCHInventoryModelsInventoryModelId200Response) ToMap() (map[string]interface{}, error) {
