...
// checks if the GETReturnLineItemsReturnLineItemId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETReturnLineItemsReturnLineItemId200ResponseData{}

// GETReturnLineItemsReturnLineItemId200ResponseData struct for GETReturnLineItemsReturnLineItemId200ResponseData
type GETReturnLineItemsReturnLineItemId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                           `json:"links,omitempty"`
	Attributes    *GETReturnLineItemsReturnLineItemId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETReturnLineItemsReturnLineItemId200ResponseData() *GETReturnLineItemsReturnLineItemId200ResponseData {
	this := GETReturnLineItemsReturnLineItemId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETReturnLineItemsReturnLineItemId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETReturnLineItemsReturnLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETReturnLineItemsReturnLineItemId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETReturnLineItemsReturnLineItemId200ResponseData struct {
	value *GETReturnLineItemsReturnLineItemId200ResponseData
	isSet bool
}

func (v NullableGETReturnLineItemsReturnLineItemId200ResponseData) Get() *GETReturnLineItemsReturnLineItemId200ResponseData {
	return v.value
}

func (v *NullableGETReturnLineItemsReturnLineItemId200ResponseData) Set(val *GETReturnLineItemsReturnLineItemId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETReturnLineItemsReturnLineItemId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETReturnLineItemsReturnLineItemId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETReturnLineItemsReturnLineItemId200ResponseData(val *GETReturnLineItemsReturnLineItemId200ResponseData) *NullableGETReturnLineItemsReturnLineItemId200ResponseData {
	return &NullableGETReturnLineItemsReturnLineItemId200ResponseData{value: val, isSet: true}
}

func (v NullableGETReturnLineItemsReturnLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETReturnLineItemsReturnLineItemId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
