...
// checks if the GETPromotionRulesPromotionRuleId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPromotionRulesPromotionRuleId200ResponseData{}

// GETPromotionRulesPromotionRuleId200ResponseData struct for GETPromotionRulesPromotionRuleId200ResponseData
type GETPromotionRulesPromotionRuleId200ResponseData struct {
	// The resource's id
...
func NewGETPromotionRulesPromotionRuleId200ResponseData() *GETPromotionRulesPromotionRuleId200ResponseData {
	this := GETPromotionRulesPromotionRuleId200ResponseData{}
	return &this
}
...
func (o GETPromotionRulesPromotionRuleId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETPromotionRulesPromotionRuleId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETPromotionRulesPromotionRuleId200ResponseData struct {
	value *GETPromotionRulesPromotionRuleId200ResponseData
	isSet bool
}

func (v NullableGETPromotionRulesPromotionRuleId200ResponseData) Get() *GETPromotionRulesPromotionRuleId200ResponseData {
	return v.value
}

func (v *NullableGETPromotionRulesPromotionRuleId200ResponseData) Set(val *GETPromotionRulesPromotionRuleId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPromotionRulesPromotionRuleId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPromotionRulesPromotionRuleId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPromotionRulesPromotionRuleId200ResponseData(val *GETPromotionRulesPromotionRuleId200ResponseData) *NullableGETPromotionRulesPromotionRuleId200ResponseData {
	return &NullableGETPromotionRulesPromotionRuleId200ResponseData{value: val, isSet: true}
}

func (v NullableGETPromotionRulesPromotionRuleId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPromotionRulesPromotionRuleId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
