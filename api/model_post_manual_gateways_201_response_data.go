...
type POSTManualGateways201ResponseData struct {
	...
	Attributes    *POSTManualGatewaysRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTManualGatewaysRequestDataAttributes and assigns it to the Attributes field.
