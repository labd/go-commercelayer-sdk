...
// ManualTaxCalculatorUpdateDataAttributes struct for ManualTaxCalculatorUpdateDataAttributes
type ManualTaxCalculatorUpdateDataAttributes struct {
...
func NewManualTaxCalculatorUpdateDataAttributes() *ManualTaxCalculatorUpdateDataAttributes {
	this := ManualTaxCalculatorUpdateDataAttributes{}
	return &this
}
...
func (o ManualTaxCalculatorUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableManualTaxCalculatorUpdateDataAttributes struct {
	value *ManualTaxCalculatorUpdateDataAttributes
	isSet bool
}

func (v NullableManualTaxCalculatorUpdateDataAttributes) Get() *ManualTaxCalculatorUpdateDataAttributes {
	return v.value
}

func (v *NullableManualTaxCalculatorUpdateDataAttributes) Set(val *ManualTaxCalculatorUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableManualTaxCalculatorUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableManualTaxCalculatorUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualTaxCalculatorUpdateDataAttributes(val *ManualTaxCalculatorUpdateDataAttributes) *NullableManualTaxCalculatorUpdateDataAttributes {
	return &NullableManualTaxCalculatorUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableManualTaxCalculatorUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualTaxCalculatorUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
