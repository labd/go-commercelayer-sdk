...
// checks if the GETLineItemsLineItemId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETLineItemsLineItemId200ResponseData{}

// GETLineItemsLineItemId200ResponseData struct for GETLineItemsLineItemId200ResponseData
type GETLineItemsLineItemId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                      `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks               `json:"links,omitempty"`
	Attributes    *GETLineItemsLineItemId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETLineItemsLineItemId200ResponseData() *GETLineItemsLineItemId200ResponseData {
	this := GETLineItemsLineItemId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETLineItemsLineItemId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETLineItemsLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETLineItemsLineItemId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETLineItemsLineItemId200ResponseData struct {
	value *GETLineItemsLineItemId200ResponseData
	isSet bool
}

func (v NullableGETLineItemsLineItemId200ResponseData) Get() *GETLineItemsLineItemId200ResponseData {
	return v.value
}

func (v *NullableGETLineItemsLineItemId200ResponseData) Set(val *GETLineItemsLineItemId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETLineItemsLineItemId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETLineItemsLineItemId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETLineItemsLineItemId200ResponseData(val *GETLineItemsLineItemId200ResponseData) *NullableGETLineItemsLineItemId200ResponseData {
	return &NullableGETLineItemsLineItemId200ResponseData{value: val, isSet: true}
}

func (v NullableGETLineItemsLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETLineItemsLineItemId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
