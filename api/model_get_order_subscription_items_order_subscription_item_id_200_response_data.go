...
// checks if the GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData{}

// GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData struct for GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData
type GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                         `json:"links,omitempty"`
	Attributes    *GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData() *GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData {
	this := GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData{}
	return &this
}
...
func (o *GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
// SetAttributes gets a reference to the given GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData struct {
	value *GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData
	isSet bool
}

func (v NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) Get() *GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData {
	return v.value
}

func (v *NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) Set(val *GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData(val *GETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) *NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData {
	return &NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData{value: val, isSet: true}
}

func (v NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETOrderSubscriptionItemsOrderSubscriptionItemId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
