...
// checks if the PATCHSkuListsSkuListId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHSkuListsSkuListId200ResponseData{}
...
func (o PATCHSkuListsSkuListId200ResponseData) ToMap() (map[string]interface{}, error) {
