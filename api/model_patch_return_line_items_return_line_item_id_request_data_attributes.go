...
// checks if the PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes{}

// PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes struct for PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes
type PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes struct {
...
func NewPATCHReturnLineItemsReturnLineItemIdRequestDataAttributes() *PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes {
	this := PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes struct {
	value *PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) Get() *PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) Set(val *PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes(val *PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) *NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes {
	return &NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
