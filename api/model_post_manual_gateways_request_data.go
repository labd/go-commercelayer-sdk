...
// checks if the POSTManualGatewaysRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTManualGatewaysRequestData{}

// POSTManualGatewaysRequestData struct for POSTManualGatewaysRequestData
type POSTManualGatewaysRequestData struct {
	// The resource's type
...
func NewPOSTManualGatewaysRequestData(type_ interface{}, attributes POSTManualGatewaysRequestDataAttributes) *POSTManualGatewaysRequestData {
	this := POSTManualGatewaysRequestData{}
	this.Type = type_
...
func (o POSTManualGatewaysRequestData) MarshalJSON() ([]byte, error) {
...
func (o POSTManualGatewaysRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTManualGatewaysRequestData struct {
	value *POSTManualGatewaysRequestData
	isSet bool
}

func (v NullablePOSTManualGatewaysRequestData) Get() *POSTManualGatewaysRequestData {
	return v.value
}

func (v *NullablePOSTManualGatewaysRequestData) Set(val *POSTManualGatewaysRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTManualGatewaysRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTManualGatewaysRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTManualGatewaysRequestData(val *POSTManualGatewaysRequestData) *NullablePOSTManualGatewaysRequestData {
	return &NullablePOSTManualGatewaysRequestData{value: val, isSet: true}
}

func (v NullablePOSTManualGatewaysRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTManualGatewaysRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
