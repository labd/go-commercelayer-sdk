...
// checks if the ShippingCategoryUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingCategoryUpdateData{}

// ShippingCategoryUpdateData struct for ShippingCategoryUpdateData
type ShippingCategoryUpdateData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                                        `json:"id"`
	Attributes    PATCHShippingCategoriesShippingCategoryId200ResponseDataAttributes `json:"attributes"`
...
func NewShippingCategoryUpdateData(type_ interface{}, id interface{}, attributes PATCHShippingCategoriesShippingCategoryId200ResponseDataAttributes) *ShippingCategoryUpdateData {
	this := ShippingCategoryUpdateData{}
	this.Type = type_
	this.Id = id
...
func (o ShippingCategoryUpdateData) MarshalJSON() ([]byte, error) {
...
func (o ShippingCategoryUpdateData) ToMap() (map[string]interface{}, error) {
...
type NullableShippingCategoryUpdateData struct {
	value *ShippingCategoryUpdateData
	isSet bool
}

func (v NullableShippingCategoryUpdateData) Get() *ShippingCategoryUpdateData {
	return v.value
}

func (v *NullableShippingCategoryUpdateData) Set(val *ShippingCategoryUpdateData) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingCategoryUpdateData) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingCategoryUpdateData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingCategoryUpdateData(val *ShippingCategoryUpdateData) *NullableShippingCategoryUpdateData {
	return &NullableShippingCategoryUpdateData{value: val, isSet: true}
}

func (v NullableShippingCategoryUpdateData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingCategoryUpdateData) UnmarshalJSON(src []byte) error {
	v.isSet = true
