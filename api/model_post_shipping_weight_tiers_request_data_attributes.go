...
// checks if the POSTShippingWeightTiersRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTShippingWeightTiersRequestDataAttributes{}

// POSTShippingWeightTiersRequestDataAttributes struct for POSTShippingWeightTiersRequestDataAttributes
type POSTShippingWeightTiersRequestDataAttributes struct {
...
func NewPOSTShippingWeightTiersRequestDataAttributes(name interface{}, priceAmountCents interface{}) *POSTShippingWeightTiersRequestDataAttributes {
	this := POSTShippingWeightTiersRequestDataAttributes{}
	this.Name = name
...
func (o POSTShippingWeightTiersRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTShippingWeightTiersRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTShippingWeightTiersRequestDataAttributes struct {
	value *POSTShippingWeightTiersRequestDataAttributes
	isSet bool
}

func (v NullablePOSTShippingWeightTiersRequestDataAttributes) Get() *POSTShippingWeightTiersRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTShippingWeightTiersRequestDataAttributes) Set(val *POSTShippingWeightTiersRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTShippingWeightTiersRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTShippingWeightTiersRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTShippingWeightTiersRequestDataAttributes(val *POSTShippingWeightTiersRequestDataAttributes) *NullablePOSTShippingWeightTiersRequestDataAttributes {
	return &NullablePOSTShippingWeightTiersRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTShippingWeightTiersRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTShippingWeightTiersRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
