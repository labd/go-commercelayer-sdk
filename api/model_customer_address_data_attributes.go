...
// CustomerAddressDataAttributes struct for CustomerAddressDataAttributes
type CustomerAddressDataAttributes struct {
...
func NewCustomerAddressDataAttributes() *CustomerAddressDataAttributes {
	this := CustomerAddressDataAttributes{}
	return &this
}
...
func (o CustomerAddressDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableCustomerAddressDataAttributes struct {
	value *CustomerAddressDataAttributes
	isSet bool
}

func (v NullableCustomerAddressDataAttributes) Get() *CustomerAddressDataAttributes {
	return v.value
}

func (v *NullableCustomerAddressDataAttributes) Set(val *CustomerAddressDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerAddressDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerAddressDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerAddressDataAttributes(val *CustomerAddressDataAttributes) *NullableCustomerAddressDataAttributes {
	return &NullableCustomerAddressDataAttributes{value: val, isSet: true}
}

func (v NullableCustomerAddressDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerAddressDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
