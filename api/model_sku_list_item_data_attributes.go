...
// SkuListItemDataAttributes struct for SkuListItemDataAttributes
type SkuListItemDataAttributes struct {
...
func NewSkuListItemDataAttributes() *SkuListItemDataAttributes {
	this := SkuListItemDataAttributes{}
	return &this
}
...
func (o SkuListItemDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableSkuListItemDataAttributes struct {
	value *SkuListItemDataAttributes
	isSet bool
}

func (v NullableSkuListItemDataAttributes) Get() *SkuListItemDataAttributes {
	return v.value
}

func (v *NullableSkuListItemDataAttributes) Set(val *SkuListItemDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableSkuListItemDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableSkuListItemDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkuListItemDataAttributes(val *SkuListItemDataAttributes) *NullableSkuListItemDataAttributes {
	return &NullableSkuListItemDataAttributes{value: val, isSet: true}
}

func (v NullableSkuListItemDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkuListItemDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
