...
// checks if the GETBraintreeGatewaysBraintreeGatewayId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETBraintreeGatewaysBraintreeGatewayId200ResponseData{}

// GETBraintreeGatewaysBraintreeGatewayId200ResponseData struct for GETBraintreeGatewaysBraintreeGatewayId200ResponseData
type GETBraintreeGatewaysBraintreeGatewayId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                      `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                               `json:"links,omitempty"`
	Attributes    *GETBraintreeGatewaysBraintreeGatewayId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETBraintreeGatewaysBraintreeGatewayId200ResponseData() *GETBraintreeGatewaysBraintreeGatewayId200ResponseData {
	this := GETBraintreeGatewaysBraintreeGatewayId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETBraintreeGatewaysBraintreeGatewayId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETBraintreeGatewaysBraintreeGatewayId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETBraintreeGatewaysBraintreeGatewayId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData struct {
	value *GETBraintreeGatewaysBraintreeGatewayId200ResponseData
	isSet bool
}

func (v NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData) Get() *GETBraintreeGatewaysBraintreeGatewayId200ResponseData {
	return v.value
}

func (v *NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData) Set(val *GETBraintreeGatewaysBraintreeGatewayId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData(val *GETBraintreeGatewaysBraintreeGatewayId200ResponseData) *NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData {
	return &NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData{value: val, isSet: true}
}

func (v NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBraintreeGatewaysBraintreeGatewayId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
