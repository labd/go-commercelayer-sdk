...
// checks if the GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData{}

// GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData struct for GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData
type GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData struct {
	// The resource's id
...
func (o GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData struct {
	value *GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData
	isSet bool
}

func (v NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) Get() *GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData {
	return v.value
}

func (v *NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) Set(val *GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData(val *GETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) *NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData {
	return &NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData{value: val, isSet: true}
}

func (v NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETBillingInfoValidationRulesBillingInfoValidationRuleId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
