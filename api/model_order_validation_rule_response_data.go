...
// OrderValidationRuleResponseData struct for OrderValidationRuleResponseData
type OrderValidationRuleResponseData struct {
	// The resource's id
...
func NewOrderValidationRuleResponseData() *OrderValidationRuleResponseData {
	this := OrderValidationRuleResponseData{}
	return &this
}
...
func (o OrderValidationRuleResponseData) MarshalJSON() ([]byte, error) {
...
type NullableOrderValidationRuleResponseData struct {
	value *OrderValidationRuleResponseData
	isSet bool
}

func (v NullableOrderValidationRuleResponseData) Get() *OrderValidationRuleResponseData {
	return v.value
}

func (v *NullableOrderValidationRuleResponseData) Set(val *OrderValidationRuleResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderValidationRuleResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderValidationRuleResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderValidationRuleResponseData(val *OrderValidationRuleResponseData) *NullableOrderValidationRuleResponseData {
	return &NullableOrderValidationRuleResponseData{value: val, isSet: true}
}

func (v NullableOrderValidationRuleResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderValidationRuleResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
