...
// GETParcelLineItems200ResponseDataInner struct for GETParcelLineItems200ResponseDataInner
type GETParcelLineItems200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                              `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks               `json:"links,omitempty"`
	Attributes    *GETParcelLineItems200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETParcelLineItems200ResponseDataInner() *GETParcelLineItems200ResponseDataInner {
	this := GETParcelLineItems200ResponseDataInner{}
...
func (o *GETParcelLineItems200ResponseDataInner) GetAttributes() GETParcelLineItems200ResponseDataInnerAttributes {
	if o == nil || o.Attributes == nil {
		var ret GETParcelLineItems200ResponseDataInnerAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given GETParcelLineItems200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETParcelLineItems200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETParcelLineItems200ResponseDataInner struct {
	value *GETParcelLineItems200ResponseDataInner
	isSet bool
}

func (v NullableGETParcelLineItems200ResponseDataInner) Get() *GETParcelLineItems200ResponseDataInner {
	return v.value
}

func (v *NullableGETParcelLineItems200ResponseDataInner) Set(val *GETParcelLineItems200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETParcelLineItems200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETParcelLineItems200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETParcelLineItems200ResponseDataInner(val *GETParcelLineItems200ResponseDataInner) *NullableGETParcelLineItems200ResponseDataInner {
	return &NullableGETParcelLineItems200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETParcelLineItems200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETParcelLineItems200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
