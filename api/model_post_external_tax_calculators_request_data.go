...
// checks if the POSTExternalTaxCalculatorsRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTExternalTaxCalculatorsRequestData{}

// POSTExternalTaxCalculatorsRequestData struct for POSTExternalTaxCalculatorsRequestData
type POSTExternalTaxCalculatorsRequestData struct {
	// The resource's type
	Type          interface{}                                     `json:"type"`
	Attributes    POSTExternalTaxCalculatorsRequestDataAttributes `json:"attributes"`
...
func NewPOSTExternalTaxCalculatorsRequestData(type_ interface{}, attributes POSTExternalTaxCalculatorsRequestDataAttributes) *POSTExternalTaxCalculatorsRequestData {
	this := POSTExternalTaxCalculatorsRequestData{}
	this.Type = type_
...
func (o POSTExternalTaxCalculatorsRequestData) MarshalJSON() ([]byte, error) {
...
func (o POSTExternalTaxCalculatorsRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTExternalTaxCalculatorsRequestData struct {
	value *POSTExternalTaxCalculatorsRequestData
	isSet bool
}

func (v NullablePOSTExternalTaxCalculatorsRequestData) Get() *POSTExternalTaxCalculatorsRequestData {
	return v.value
}

func (v *NullablePOSTExternalTaxCalculatorsRequestData) Set(val *POSTExternalTaxCalculatorsRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTExternalTaxCalculatorsRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTExternalTaxCalculatorsRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTExternalTaxCalculatorsRequestData(val *POSTExternalTaxCalculatorsRequestData) *NullablePOSTExternalTaxCalculatorsRequestData {
	return &NullablePOSTExternalTaxCalculatorsRequestData{value: val, isSet: true}
}

func (v NullablePOSTExternalTaxCalculatorsRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTExternalTaxCalculatorsRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
