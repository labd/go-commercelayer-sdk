...
// checks if the GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData{}

// GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData struct for GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData
type GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                          `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                   `json:"links,omitempty"`
	Attributes    *GETPriceFrequencyTiersPriceFrequencyTierId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData() *GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData {
	this := GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETPriceFrequencyTiersPriceFrequencyTierId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData struct {
	value *GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData
	isSet bool
}

func (v NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) Get() *GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData {
	return v.value
}

func (v *NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) Set(val *GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData(val *GETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) *NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData {
	return &NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData{value: val, isSet: true}
}

func (v NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETPriceFrequencyTiersPriceFrequencyTierId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
