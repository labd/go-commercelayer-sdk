...
type POSTExternalTaxCalculators201ResponseData struct {
	...
	Attributes    *POSTExternalTaxCalculatorsRequestDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTExternalTaxCalculators201ResponseData() *POSTExternalTaxCalculators201ResponseData {
	this := POSTExternalTaxCalculators201ResponseData{}
	return &this
}
...
func (o *POSTExternalTaxCalculators201ResponseData) GetAttributes() POSTExternalTaxCalculatorsRequestDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret POSTExternalTaxCalculatorsRequestDataAttributes
		return ret
	}
	return *o.Attributes
}
...
// and a boolean to check if the value has been set.
func (o *POSTExternalTaxCalculators201ResponseData) GetAttributesOk() (*POSTExternalTaxCalculatorsRequestDataAttributes, bool) {
	if o == nil || IsNil(o.Attributes) {
		return nil, false
	}
...
// SetAttributes gets a reference to the given POSTExternalTaxCalculatorsRequestDataAttributes and assigns it to the Attributes field.
func (o *POSTExternalTaxCalculators201ResponseData) SetAttributes(v POSTExternalTaxCalculatorsRequestDataAttributes) {
	o.Attributes = &v
}
...
type NullablePOSTExternalTaxCalculators201ResponseData struct {
	value *POSTExternalTaxCalculators201ResponseData
	isSet bool
}

func (v NullablePOSTExternalTaxCalculators201ResponseData) Get() *POSTExternalTaxCalculators201ResponseData {
	return v.value
}

func (v *NullablePOSTExternalTaxCalculators201ResponseData) Set(val *POSTExternalTaxCalculators201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTExternalTaxCalculators201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTExternalTaxCalculators201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTExternalTaxCalculators201ResponseData(val *POSTExternalTaxCalculators201ResponseData) *NullablePOSTExternalTaxCalculators201ResponseData {
	return &NullablePOSTExternalTaxCalculators201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTExternalTaxCalculators201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTExternalTaxCalculators201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
