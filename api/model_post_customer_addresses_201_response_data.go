...
// checks if the POSTCustomerAddresses201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTCustomerAddresses201ResponseData{}
...
type POSTCustomerAddresses201ResponseData struct {
	...
	Attributes    *POSTCustomerAddresses201ResponseDataAttributes    `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTCustomerAddresses201ResponseDataAttributes and assigns it to the Attributes field.
...
func (o POSTCustomerAddresses201ResponseData) ToMap() (map[string]interface{}, error) {
