...
// BingGeocoderResponseData struct for BingGeocoderResponseData
type BingGeocoderResponseData struct {
	// The resource's id
...
func (o BingGeocoderResponseData) MarshalJSON() ([]byte, error) {
...
type NullableBingGeocoderResponseData struct {
	value *BingGeocoderResponseData
	isSet bool
}

func (v NullableBingGeocoderResponseData) Get() *BingGeocoderResponseData {
	return v.value
}

func (v *NullableBingGeocoderResponseData) Set(val *BingGeocoderResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableBingGeocoderResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableBingGeocoderResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBingGeocoderResponseData(val *BingGeocoderResponseData) *NullableBingGeocoderResponseData {
	return &NullableBingGeocoderResponseData{value: val, isSet: true}
}

func (v NullableBingGeocoderResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBingGeocoderResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
