...
// checks if the POSTPriceFrequencyTiers201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTPriceFrequencyTiers201ResponseData{}

// POSTPriceFrequencyTiers201ResponseData struct for POSTPriceFrequencyTiers201ResponseData
type POSTPriceFrequencyTiers201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                          `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                   `json:"links,omitempty"`
	Attributes    *POSTPriceFrequencyTiersRequestDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTPriceFrequencyTiers201ResponseData() *POSTPriceFrequencyTiers201ResponseData {
	this := POSTPriceFrequencyTiers201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTPriceFrequencyTiersRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTPriceFrequencyTiers201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTPriceFrequencyTiers201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTPriceFrequencyTiers201ResponseData struct {
	value *POSTPriceFrequencyTiers201ResponseData
	isSet bool
}

func (v NullablePOSTPriceFrequencyTiers201ResponseData) Get() *POSTPriceFrequencyTiers201ResponseData {
	return v.value
}

func (v *NullablePOSTPriceFrequencyTiers201ResponseData) Set(val *POSTPriceFrequencyTiers201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTPriceFrequencyTiers201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTPriceFrequencyTiers201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTPriceFrequencyTiers201ResponseData(val *POSTPriceFrequencyTiers201ResponseData) *NullablePOSTPriceFrequencyTiers201ResponseData {
	return &NullablePOSTPriceFrequencyTiers201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTPriceFrequencyTiers201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTPriceFrequencyTiers201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
