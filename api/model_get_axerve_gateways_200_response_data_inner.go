...
// GETAxerveGateways200ResponseDataInner struct for GETAxerveGateways200ResponseDataInner
type GETAxerveGateways200ResponseDataInner struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                         `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks              `json:"links,omitempty"`
	Attributes    *GETAxerveGateways200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETAxerveGateways200ResponseDataInner() *GETAxerveGateways200ResponseDataInner {
	this := GETAxerveGateways200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETAxerveGateways200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETAxerveGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETAxerveGateways200ResponseDataInner struct {
	value *GETAxerveGateways200ResponseDataInner
	isSet bool
}

func (v NullableGETAxerveGateways200ResponseDataInner) Get() *GETAxerveGateways200ResponseDataInner {
	return v.value
}

func (v *NullableGETAxerveGateways200ResponseDataInner) Set(val *GETAxerveGateways200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAxerveGateways200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAxerveGateways200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAxerveGateways200ResponseDataInner(val *GETAxerveGateways200ResponseDataInner) *NullableGETAxerveGateways200ResponseDataInner {
	return &NullableGETAxerveGateways200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETAxerveGateways200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAxerveGateways200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
