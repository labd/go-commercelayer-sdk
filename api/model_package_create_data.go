...
// checks if the PackageCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackageCreateData{}
...
func (o PackageCreateData) ToMap() (map[string]interface{}, error) {
