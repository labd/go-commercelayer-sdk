...
// checks if the POSTBillingInfoValidationRules201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTBillingInfoValidationRules201ResponseData{}

// POSTBillingInfoValidationRules201ResponseData struct for POSTBillingInfoValidationRules201ResponseData
type POSTBillingInfoValidationRules201ResponseData struct {
	// The resource's id
...
func NewPOSTBillingInfoValidationRules201ResponseData() *POSTBillingInfoValidationRules201ResponseData {
	this := POSTBillingInfoValidationRules201ResponseData{}
	return &this
}
...
func (o POSTBillingInfoValidationRules201ResponseData) MarshalJSON() ([]byte, error) {
...
func (o POSTBillingInfoValidationRules201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTBillingInfoValidationRules201ResponseData struct {
	value *POSTBillingInfoValidationRules201ResponseData
	isSet bool
}

func (v NullablePOSTBillingInfoValidationRules201ResponseData) Get() *POSTBillingInfoValidationRules201ResponseData {
	return v.value
}

func (v *NullablePOSTBillingInfoValidationRules201ResponseData) Set(val *POSTBillingInfoValidationRules201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTBillingInfoValidationRules201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTBillingInfoValidationRules201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTBillingInfoValidationRules201ResponseData(val *POSTBillingInfoValidationRules201ResponseData) *NullablePOSTBillingInfoValidationRules201ResponseData {
	return &NullablePOSTBillingInfoValidationRules201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTBillingInfoValidationRules201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTBillingInfoValidationRules201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
