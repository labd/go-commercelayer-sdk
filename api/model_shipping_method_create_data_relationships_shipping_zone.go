...
// checks if the ShippingMethodCreateDataRelationshipsShippingZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingMethodCreateDataRelationshipsShippingZone{}
...
func (o ShippingMethodCreateDataRelationshipsShippingZone) ToMap() (map[string]interface{}, error) {
