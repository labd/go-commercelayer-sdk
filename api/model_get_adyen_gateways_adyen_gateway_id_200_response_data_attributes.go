...
// checks if the GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes{}

// GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes struct for GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes
type GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes struct {
...
func NewGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes() *GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes {
	this := GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes{}
	return &this
}
...
func (o GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes struct {
	value *GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes
	isSet bool
}

func (v NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) Get() *GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes {
	return v.value
}

func (v *NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) Set(val *GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes(val *GETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) *NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes {
	return &NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes{value: val, isSet: true}
}

func (v NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETAdyenGatewaysAdyenGatewayId200ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
