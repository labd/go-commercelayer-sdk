...
// checks if the POSTPricesRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTPricesRequestDataAttributes{}

// POSTPricesRequestDataAttributes struct for POSTPricesRequestDataAttributes
type POSTPricesRequestDataAttributes struct {
...
func NewPOSTPricesRequestDataAttributes(amountCents interface{}, compareAtAmountCents interface{}) *POSTPricesRequestDataAttributes {
	this := POSTPricesRequestDataAttributes{}
...
func (o POSTPricesRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTPricesRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTPricesRequestDataAttributes struct {
	value *POSTPricesRequestDataAttributes
	isSet bool
}

func (v NullablePOSTPricesRequestDataAttributes) Get() *POSTPricesRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTPricesRequestDataAttributes) Set(val *POSTPricesRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTPricesRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTPricesRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTPricesRequestDataAttributes(val *POSTPricesRequestDataAttributes) *NullablePOSTPricesRequestDataAttributes {
	return &NullablePOSTPricesRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTPricesRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTPricesRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
