...
// SkuResponseData struct for SkuResponseData
type SkuResponseData struct {
	// The resource's id
	...
	Relationships *SkuResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *SkuResponseData) GetRelationships() SkuResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret SkuResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given SkuResponseDataRelationships and assigns it to the Relationships field.
func (o *SkuResponseData) SetRelationships(v SkuResponseDataRelationships) {
	o.Relationships = &v
}

func (o SkuResponseData) MarshalJSON() ([]byte, error) {
...
type NullableSkuResponseData struct {
	value *SkuResponseData
	isSet bool
}

func (v NullableSkuResponseData) Get() *SkuResponseData {
	return v.value
}

func (v *NullableSkuResponseData) Set(val *SkuResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableSkuResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableSkuResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkuResponseData(val *SkuResponseData) *NullableSkuResponseData {
	return &NullableSkuResponseData{value: val, isSet: true}
}

func (v NullableSkuResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkuResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
