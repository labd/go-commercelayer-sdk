...
// GETMarkets200ResponseDataInner struct for GETMarkets200ResponseDataInner
type GETMarkets200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type *string `json:"type,omitempty"`
	Links *GETAddresses200ResponseDataInnerLinks `json:"links,omitempty"`
	Attributes *GETMarkets200ResponseDataInnerAttributes `json:"attributes,omitempty"`
...
func NewGETMarkets200ResponseDataInner() *GETMarkets200ResponseDataInner {
	this := GETMarkets200ResponseDataInner{}
...
// SetAttributes gets a reference to the given GETMarkets200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETMarkets200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETMarkets200ResponseDataInner struct {
	value *GETMarkets200ResponseDataInner
	isSet bool
}

func (v NullableGETMarkets200ResponseDataInner) Get() *GETMarkets200ResponseDataInner {
	return v.value
}

func (v *NullableGETMarkets200ResponseDataInner) Set(val *GETMarkets200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETMarkets200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETMarkets200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETMarkets200ResponseDataInner(val *GETMarkets200ResponseDataInner) *NullableGETMarkets200ResponseDataInner {
	return &NullableGETMarkets200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETMarkets200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETMarkets200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
