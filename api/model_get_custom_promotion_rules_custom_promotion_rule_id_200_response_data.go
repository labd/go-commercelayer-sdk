...
// checks if the GETCustomPromotionRulesCustomPromotionRuleId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETCustomPromotionRulesCustomPromotionRuleId200ResponseData{}

// GETCustomPromotionRulesCustomPromotionRuleId200ResponseData struct for GETCustomPromotionRulesCustomPromotionRuleId200ResponseData
type GETCustomPromotionRulesCustomPromotionRuleId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                            `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                     `json:"links,omitempty"`
	Attributes    *GETCustomPromotionRulesCustomPromotionRuleId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETCustomPromotionRulesCustomPromotionRuleId200ResponseData() *GETCustomPromotionRulesCustomPromotionRuleId200ResponseData {
	this := GETCustomPromotionRulesCustomPromotionRuleId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETCustomPromotionRulesCustomPromotionRuleId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETCustomPromotionRulesCustomPromotionRuleId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETCustomPromotionRulesCustomPromotionRuleId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData struct {
	value *GETCustomPromotionRulesCustomPromotionRuleId200ResponseData
	isSet bool
}

func (v NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData) Get() *GETCustomPromotionRulesCustomPromotionRuleId200ResponseData {
	return v.value
}

func (v *NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData) Set(val *GETCustomPromotionRulesCustomPromotionRuleId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData(val *GETCustomPromotionRulesCustomPromotionRuleId200ResponseData) *NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData {
	return &NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData{value: val, isSet: true}
}

func (v NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCustomPromotionRulesCustomPromotionRuleId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
