...
// checks if the GETShippingMethodsShippingMethodId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETShippingMethodsShippingMethodId200ResponseData{}

// GETShippingMethodsShippingMethodId200ResponseData struct for GETShippingMethodsShippingMethodId200ResponseData
type GETShippingMethodsShippingMethodId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                           `json:"links,omitempty"`
	Attributes    *GETShippingMethodsShippingMethodId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETShippingMethodsShippingMethodId200ResponseData() *GETShippingMethodsShippingMethodId200ResponseData {
	this := GETShippingMethodsShippingMethodId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETShippingMethodsShippingMethodId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETShippingMethodsShippingMethodId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETShippingMethodsShippingMethodId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETShippingMethodsShippingMethodId200ResponseData struct {
	value *GETShippingMethodsShippingMethodId200ResponseData
	isSet bool
}

func (v NullableGETShippingMethodsShippingMethodId200ResponseData) Get() *GETShippingMethodsShippingMethodId200ResponseData {
	return v.value
}

func (v *NullableGETShippingMethodsShippingMethodId200ResponseData) Set(val *GETShippingMethodsShippingMethodId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETShippingMethodsShippingMethodId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETShippingMethodsShippingMethodId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETShippingMethodsShippingMethodId200ResponseData(val *GETShippingMethodsShippingMethodId200ResponseData) *NullableGETShippingMethodsShippingMethodId200ResponseData {
	return &NullableGETShippingMethodsShippingMethodId200ResponseData{value: val, isSet: true}
}

func (v NullableGETShippingMethodsShippingMethodId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETShippingMethodsShippingMethodId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
