...
// checks if the POSTFixedPricePromotionsRequestDataRelationships type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTFixedPricePromotionsRequestDataRelationships{}

// POSTFixedPricePromotionsRequestDataRelationships struct for POSTFixedPricePromotionsRequestDataRelationships
type POSTFixedPricePromotionsRequestDataRelationships struct {
...
func NewPOSTFixedPricePromotionsRequestDataRelationships(skuList POSTBundlesRequestDataRelationshipsSkuList) *POSTFixedPricePromotionsRequestDataRelationships {
	this := POSTFixedPricePromotionsRequestDataRelationships{}
...
func (o POSTFixedPricePromotionsRequestDataRelationships) MarshalJSON() ([]byte, error) {
...
func (o POSTFixedPricePromotionsRequestDataRelationships) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTFixedPricePromotionsRequestDataRelationships struct {
	value *POSTFixedPricePromotionsRequestDataRelationships
	isSet bool
}

func (v NullablePOSTFixedPricePromotionsRequestDataRelationships) Get() *POSTFixedPricePromotionsRequestDataRelationships {
	return v.value
}

func (v *NullablePOSTFixedPricePromotionsRequestDataRelationships) Set(val *POSTFixedPricePromotionsRequestDataRelationships) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTFixedPricePromotionsRequestDataRelationships) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTFixedPricePromotionsRequestDataRelationships) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTFixedPricePromotionsRequestDataRelationships(val *POSTFixedPricePromotionsRequestDataRelationships) *NullablePOSTFixedPricePromotionsRequestDataRelationships {
	return &NullablePOSTFixedPricePromotionsRequestDataRelationships{value: val, isSet: true}
}

func (v NullablePOSTFixedPricePromotionsRequestDataRelationships) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTFixedPricePromotionsRequestDataRelationships) UnmarshalJSON(src []byte) error {
	v.isSet = true
