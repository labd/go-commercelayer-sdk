...
// CustomerGroupResponseData struct for CustomerGroupResponseData
type CustomerGroupResponseData struct {
	...
	Relationships *CustomerGroupResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewCustomerGroupResponseData() *CustomerGroupResponseData {
	this := CustomerGroupResponseData{}
	return &this
}
...
func (o *CustomerGroupResponseData) GetRelationships() CustomerGroupResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret CustomerGroupResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given CustomerGroupResponseDataRelationships and assigns it to the Relationships field.
func (o *CustomerGroupResponseData) SetRelationships(v CustomerGroupResponseDataRelationships) {
	o.Relationships = &v
}

func (o CustomerGroupResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCustomerGroupResponseData struct {
	value *CustomerGroupResponseData
	isSet bool
}

func (v NullableCustomerGroupResponseData) Get() *CustomerGroupResponseData {
	return v.value
}

func (v *NullableCustomerGroupResponseData) Set(val *CustomerGroupResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerGroupResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerGroupResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerGroupResponseData(val *CustomerGroupResponseData) *NullableCustomerGroupResponseData {
	return &NullableCustomerGroupResponseData{value: val, isSet: true}
}

func (v NullableCustomerGroupResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerGroupResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
