...
// TaxRuleUpdateDataAttributes struct for TaxRuleUpdateDataAttributes
type TaxRuleUpdateDataAttributes struct {
...
func NewTaxRuleUpdateDataAttributes() *TaxRuleUpdateDataAttributes {
	this := TaxRuleUpdateDataAttributes{}
	return &this
}
...
func (o TaxRuleUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableTaxRuleUpdateDataAttributes struct {
	value *TaxRuleUpdateDataAttributes
	isSet bool
}

func (v NullableTaxRuleUpdateDataAttributes) Get() *TaxRuleUpdateDataAttributes {
	return v.value
}

func (v *NullableTaxRuleUpdateDataAttributes) Set(val *TaxRuleUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxRuleUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxRuleUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxRuleUpdateDataAttributes(val *TaxRuleUpdateDataAttributes) *NullableTaxRuleUpdateDataAttributes {
	return &NullableTaxRuleUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableTaxRuleUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxRuleUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
