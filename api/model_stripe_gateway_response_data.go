...
// StripeGatewayResponseData struct for StripeGatewayResponseData
type StripeGatewayResponseData struct {
	// The resource's id
	...
	Relationships *StripeGatewayResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewStripeGatewayResponseData() *StripeGatewayResponseData {
	this := StripeGatewayResponseData{}
	return &this
}
...
func (o *StripeGatewayResponseData) GetRelationships() StripeGatewayResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret StripeGatewayResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given StripeGatewayResponseDataRelationships and assigns it to the Relationships field.
func (o *StripeGatewayResponseData) SetRelationships(v StripeGatewayResponseDataRelationships) {
	o.Relationships = &v
}

func (o StripeGatewayResponseData) MarshalJSON() ([]byte, error) {
...
type NullableStripeGatewayResponseData struct {
	value *StripeGatewayResponseData
	isSet bool
}

func (v NullableStripeGatewayResponseData) Get() *StripeGatewayResponseData {
	return v.value
}

func (v *NullableStripeGatewayResponseData) Set(val *StripeGatewayResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableStripeGatewayResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableStripeGatewayResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStripeGatewayResponseData(val *StripeGatewayResponseData) *NullableStripeGatewayResponseData {
	return &NullableStripeGatewayResponseData{value: val, isSet: true}
}

func (v NullableStripeGatewayResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStripeGatewayResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
