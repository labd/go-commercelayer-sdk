...
// InventoryStockLocationResponseData struct for InventoryStockLocationResponseData
type InventoryStockLocationResponseData struct {
	// The resource's id
...
func NewInventoryStockLocationResponseData() *InventoryStockLocationResponseData {
	this := InventoryStockLocationResponseData{}
	return &this
}
...
func (o InventoryStockLocationResponseData) MarshalJSON() ([]byte, error) {
...
type NullableInventoryStockLocationResponseData struct {
	value *InventoryStockLocationResponseData
	isSet bool
}

func (v NullableInventoryStockLocationResponseData) Get() *InventoryStockLocationResponseData {
	return v.value
}

func (v *NullableInventoryStockLocationResponseData) Set(val *InventoryStockLocationResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryStockLocationResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryStockLocationResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryStockLocationResponseData(val *InventoryStockLocationResponseData) *NullableInventoryStockLocationResponseData {
	return &NullableInventoryStockLocationResponseData{value: val, isSet: true}
}

func (v NullableInventoryStockLocationResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryStockLocationResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
