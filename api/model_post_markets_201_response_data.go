...
type POSTMarkets201ResponseData struct {
	...
	Attributes    *POSTMarketsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTMarketsRequestDataAttributes and assigns it to the Attributes field.
