...
// checks if the PATCHTaxRulesTaxRuleId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHTaxRulesTaxRuleId200ResponseData{}
...
type PATCHTaxRulesTaxRuleId200ResponseData struct {
	...
	Attributes    *PATCHTaxRulesTaxRuleIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHTaxRulesTaxRuleIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHTaxRulesTaxRuleId200ResponseData) ToMap() (map[string]interface{}, error) {
