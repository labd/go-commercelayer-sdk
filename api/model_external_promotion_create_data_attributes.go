...
// ExternalPromotionCreateDataAttributes struct for ExternalPromotionCreateDataAttributes
type ExternalPromotionCreateDataAttributes struct {
...
func NewExternalPromotionCreateDataAttributes(name string, startsAt string, expiresAt string, totalUsageLimit int32, promotionUrl string) *ExternalPromotionCreateDataAttributes {
	this := ExternalPromotionCreateDataAttributes{}
	this.Name = name
...
func (o ExternalPromotionCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableExternalPromotionCreateDataAttributes struct {
	value *ExternalPromotionCreateDataAttributes
	isSet bool
}

func (v NullableExternalPromotionCreateDataAttributes) Get() *ExternalPromotionCreateDataAttributes {
	return v.value
}

func (v *NullableExternalPromotionCreateDataAttributes) Set(val *ExternalPromotionCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalPromotionCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalPromotionCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalPromotionCreateDataAttributes(val *ExternalPromotionCreateDataAttributes) *NullableExternalPromotionCreateDataAttributes {
	return &NullableExternalPromotionCreateDataAttributes{value: val, isSet: true}
}

func (v NullableExternalPromotionCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalPromotionCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
