...
// checks if the PATCHCarrierAccountsCarrierAccountId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHCarrierAccountsCarrierAccountId200ResponseData{}

// PATCHCarrierAccountsCarrierAccountId200ResponseData struct for PATCHCarrierAccountsCarrierAccountId200ResponseData
type PATCHCarrierAccountsCarrierAccountId200ResponseData struct {
	// The resource's id
...
func NewPATCHCarrierAccountsCarrierAccountId200ResponseData() *PATCHCarrierAccountsCarrierAccountId200ResponseData {
	this := PATCHCarrierAccountsCarrierAccountId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given PATCHCarrierAccountsCarrierAccountId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHCarrierAccountsCarrierAccountId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHCarrierAccountsCarrierAccountId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHCarrierAccountsCarrierAccountId200ResponseData struct {
	value *PATCHCarrierAccountsCarrierAccountId200ResponseData
	isSet bool
}

func (v NullablePATCHCarrierAccountsCarrierAccountId200ResponseData) Get() *PATCHCarrierAccountsCarrierAccountId200ResponseData {
	return v.value
}

func (v *NullablePATCHCarrierAccountsCarrierAccountId200ResponseData) Set(val *PATCHCarrierAccountsCarrierAccountId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHCarrierAccountsCarrierAccountId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHCarrierAccountsCarrierAccountId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHCarrierAccountsCarrierAccountId200ResponseData(val *PATCHCarrierAccountsCarrierAccountId200ResponseData) *NullablePATCHCarrierAccountsCarrierAccountId200ResponseData {
	return &NullablePATCHCarrierAccountsCarrierAccountId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHCarrierAccountsCarrierAccountId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHCarrierAccountsCarrierAccountId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
