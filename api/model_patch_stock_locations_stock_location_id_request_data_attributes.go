...
// checks if the PATCHStockLocationsStockLocationIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHStockLocationsStockLocationIdRequestDataAttributes{}

// PATCHStockLocationsStockLocationIdRequestDataAttributes struct for PATCHStockLocationsStockLocationIdRequestDataAttributes
type PATCHStockLocationsStockLocationIdRequestDataAttributes struct {
...
func NewPATCHStockLocationsStockLocationIdRequestDataAttributes() *PATCHStockLocationsStockLocationIdRequestDataAttributes {
	this := PATCHStockLocationsStockLocationIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHStockLocationsStockLocationIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHStockLocationsStockLocationIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHStockLocationsStockLocationIdRequestDataAttributes struct {
	value *PATCHStockLocationsStockLocationIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHStockLocationsStockLocationIdRequestDataAttributes) Get() *PATCHStockLocationsStockLocationIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHStockLocationsStockLocationIdRequestDataAttributes) Set(val *PATCHStockLocationsStockLocationIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHStockLocationsStockLocationIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHStockLocationsStockLocationIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHStockLocationsStockLocationIdRequestDataAttributes(val *PATCHStockLocationsStockLocationIdRequestDataAttributes) *NullablePATCHStockLocationsStockLocationIdRequestDataAttributes {
	return &NullablePATCHStockLocationsStockLocationIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHStockLocationsStockLocationIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHStockLocationsStockLocationIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
