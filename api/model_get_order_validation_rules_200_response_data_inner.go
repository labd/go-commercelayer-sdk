...
// GETOrderValidationRules200ResponseDataInner struct for GETOrderValidationRules200ResponseDataInner
type GETOrderValidationRules200ResponseDataInner struct {
	// The resource's id
...
func NewGETOrderValidationRules200ResponseDataInner() *GETOrderValidationRules200ResponseDataInner {
	this := GETOrderValidationRules200ResponseDataInner{}
...
func (o GETOrderValidationRules200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETOrderValidationRules200ResponseDataInner struct {
	value *GETOrderValidationRules200ResponseDataInner
	isSet bool
}

func (v NullableGETOrderValidationRules200ResponseDataInner) Get() *GETOrderValidationRules200ResponseDataInner {
	return v.value
}

func (v *NullableGETOrderValidationRules200ResponseDataInner) Set(val *GETOrderValidationRules200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETOrderValidationRules200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETOrderValidationRules200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETOrderValidationRules200ResponseDataInner(val *GETOrderValidationRules200ResponseDataInner) *NullableGETOrderValidationRules200ResponseDataInner {
	return &NullableGETOrderValidationRules200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETOrderValidationRules200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETOrderValidationRules200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
