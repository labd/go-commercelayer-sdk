...
// checks if the PATCHPricesPriceId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHPricesPriceId200ResponseData{}
...
type PATCHPricesPriceId200ResponseData struct {
	...
	Attributes    *PATCHPricesPriceIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHPricesPriceIdRequestDataAttributes and assigns it to the Attributes field.
...
func (o PATCHPricesPriceId200ResponseData) ToMap() (map[string]interface{}, error) {
