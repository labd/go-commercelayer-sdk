...
// GETTaxCategories200ResponseDataInnerAttributes struct for GETTaxCategories200ResponseDataInnerAttributes
type GETTaxCategories200ResponseDataInnerAttributes struct {
...
func NewGETTaxCategories200ResponseDataInnerAttributes() *GETTaxCategories200ResponseDataInnerAttributes {
	this := GETTaxCategories200ResponseDataInnerAttributes{}
	return &this
}
...
func (o GETTaxCategories200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
...
type NullableGETTaxCategories200ResponseDataInnerAttributes struct {
	value *GETTaxCategories200ResponseDataInnerAttributes
	isSet bool
}

func (v NullableGETTaxCategories200ResponseDataInnerAttributes) Get() *GETTaxCategories200ResponseDataInnerAttributes {
	return v.value
}

func (v *NullableGETTaxCategories200ResponseDataInnerAttributes) Set(val *GETTaxCategories200ResponseDataInnerAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableGETTaxCategories200ResponseDataInnerAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableGETTaxCategories200ResponseDataInnerAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETTaxCategories200ResponseDataInnerAttributes(val *GETTaxCategories200ResponseDataInnerAttributes) *NullableGETTaxCategories200ResponseDataInnerAttributes {
	return &NullableGETTaxCategories200ResponseDataInnerAttributes{value: val, isSet: true}
}

func (v NullableGETTaxCategories200ResponseDataInnerAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETTaxCategories200ResponseDataInnerAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
