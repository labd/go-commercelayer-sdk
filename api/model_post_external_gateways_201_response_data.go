...
// checks if the POSTExternalGateways201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTExternalGateways201ResponseData{}

// POSTExternalGateways201ResponseData struct for POSTExternalGateways201ResponseData
type POSTExternalGateways201ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                       `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                `json:"links,omitempty"`
	Attributes    *POSTExternalGatewaysRequestDataAttributes        `json:"attributes,omitempty"`
...
func NewPOSTExternalGateways201ResponseData() *POSTExternalGateways201ResponseData {
	this := POSTExternalGateways201ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given POSTExternalGatewaysRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTExternalGateways201ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTExternalGateways201ResponseData struct {
	value *POSTExternalGateways201ResponseData
	isSet bool
}

func (v NullablePOSTExternalGateways201ResponseData) Get() *POSTExternalGateways201ResponseData {
	return v.value
}

func (v *NullablePOSTExternalGateways201ResponseData) Set(val *POSTExternalGateways201ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTExternalGateways201ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTExternalGateways201ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTExternalGateways201ResponseData(val *POSTExternalGateways201ResponseData) *NullablePOSTExternalGateways201ResponseData {
	return &NullablePOSTExternalGateways201ResponseData{value: val, isSet: true}
}

func (v NullablePOSTExternalGateways201ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTExternalGateways201ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
