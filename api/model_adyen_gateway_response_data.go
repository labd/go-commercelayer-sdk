...
// AdyenGatewayResponseData struct for AdyenGatewayResponseData
type AdyenGatewayResponseData struct {
	// The resource's id
	...
	Relationships *AdyenGatewayResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *AdyenGatewayResponseData) GetRelationships() AdyenGatewayResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret AdyenGatewayResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given AdyenGatewayResponseDataRelationships and assigns it to the Relationships field.
func (o *AdyenGatewayResponseData) SetRelationships(v AdyenGatewayResponseDataRelationships) {
	o.Relationships = &v
}

func (o AdyenGatewayResponseData) MarshalJSON() ([]byte, error) {
...
type NullableAdyenGatewayResponseData struct {
	value *AdyenGatewayResponseData
	isSet bool
}

func (v NullableAdyenGatewayResponseData) Get() *AdyenGatewayResponseData {
	return v.value
}

func (v *NullableAdyenGatewayResponseData) Set(val *AdyenGatewayResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableAdyenGatewayResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableAdyenGatewayResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdyenGatewayResponseData(val *AdyenGatewayResponseData) *NullableAdyenGatewayResponseData {
	return &NullableAdyenGatewayResponseData{value: val, isSet: true}
}

func (v NullableAdyenGatewayResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdyenGatewayResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
