...
// checks if the GoogleGeocoderCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GoogleGeocoderCreateData{}
...
func (o GoogleGeocoderCreateData) ToMap() (map[string]interface{}, error) {
