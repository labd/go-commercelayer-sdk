...
// checks if the GETStockLocationsStockLocationId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETStockLocationsStockLocationId200ResponseData{}

// GETStockLocationsStockLocationId200ResponseData struct for GETStockLocationsStockLocationId200ResponseData
type GETStockLocationsStockLocationId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                         `json:"links,omitempty"`
	Attributes    *GETStockLocationsStockLocationId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETStockLocationsStockLocationId200ResponseData() *GETStockLocationsStockLocationId200ResponseData {
	this := GETStockLocationsStockLocationId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETStockLocationsStockLocationId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETStockLocationsStockLocationId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETStockLocationsStockLocationId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETStockLocationsStockLocationId200ResponseData struct {
	value *GETStockLocationsStockLocationId200ResponseData
	isSet bool
}

func (v NullableGETStockLocationsStockLocationId200ResponseData) Get() *GETStockLocationsStockLocationId200ResponseData {
	return v.value
}

func (v *NullableGETStockLocationsStockLocationId200ResponseData) Set(val *GETStockLocationsStockLocationId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETStockLocationsStockLocationId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETStockLocationsStockLocationId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETStockLocationsStockLocationId200ResponseData(val *GETStockLocationsStockLocationId200ResponseData) *NullableGETStockLocationsStockLocationId200ResponseData {
	return &NullableGETStockLocationsStockLocationId200ResponseData{value: val, isSet: true}
}

func (v NullableGETStockLocationsStockLocationId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETStockLocationsStockLocationId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
