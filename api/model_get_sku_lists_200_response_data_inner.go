...
// GETSkuLists200ResponseDataInner struct for GETSkuLists200ResponseDataInner
type GETSkuLists200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type          *string                                       `json:"type,omitempty"`
	Links         *GETAddresses200ResponseDataInnerLinks        `json:"links,omitempty"`
	Attributes    *GETSkuLists200ResponseDataInnerAttributes    `json:"attributes,omitempty"`
...
func NewGETSkuLists200ResponseDataInner() *GETSkuLists200ResponseDataInner {
	this := GETSkuLists200ResponseDataInner{}
	return &this
}
...
// SetAttributes gets a reference to the given GETSkuLists200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETSkuLists200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETSkuLists200ResponseDataInner struct {
	value *GETSkuLists200ResponseDataInner
	isSet bool
}

func (v NullableGETSkuLists200ResponseDataInner) Get() *GETSkuLists200ResponseDataInner {
	return v.value
}

func (v *NullableGETSkuLists200ResponseDataInner) Set(val *GETSkuLists200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETSkuLists200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETSkuLists200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETSkuLists200ResponseDataInner(val *GETSkuLists200ResponseDataInner) *NullableGETSkuLists200ResponseDataInner {
	return &NullableGETSkuLists200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETSkuLists200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETSkuLists200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
