...
// checks if the PATCHGiftCardsGiftCardIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHGiftCardsGiftCardIdRequestDataAttributes{}

// PATCHGiftCardsGiftCardIdRequestDataAttributes struct for PATCHGiftCardsGiftCardIdRequestDataAttributes
type PATCHGiftCardsGiftCardIdRequestDataAttributes struct {
...
func NewPATCHGiftCardsGiftCardIdRequestDataAttributes() *PATCHGiftCardsGiftCardIdRequestDataAttributes {
	this := PATCHGiftCardsGiftCardIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHGiftCardsGiftCardIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHGiftCardsGiftCardIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHGiftCardsGiftCardIdRequestDataAttributes struct {
	value *PATCHGiftCardsGiftCardIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHGiftCardsGiftCardIdRequestDataAttributes) Get() *PATCHGiftCardsGiftCardIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHGiftCardsGiftCardIdRequestDataAttributes) Set(val *PATCHGiftCardsGiftCardIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHGiftCardsGiftCardIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHGiftCardsGiftCardIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHGiftCardsGiftCardIdRequestDataAttributes(val *PATCHGiftCardsGiftCardIdRequestDataAttributes) *NullablePATCHGiftCardsGiftCardIdRequestDataAttributes {
	return &NullablePATCHGiftCardsGiftCardIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHGiftCardsGiftCardIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHGiftCardsGiftCardIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
