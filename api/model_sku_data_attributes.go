...
// SkuDataAttributes struct for SkuDataAttributes
type SkuDataAttributes struct {
...
func (o SkuDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableSkuDataAttributes struct {
	value *SkuDataAttributes
	isSet bool
}

func (v NullableSkuDataAttributes) Get() *SkuDataAttributes {
	return v.value
}

func (v *NullableSkuDataAttributes) Set(val *SkuDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableSkuDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableSkuDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkuDataAttributes(val *SkuDataAttributes) *NullableSkuDataAttributes {
	return &NullableSkuDataAttributes{value: val, isSet: true}
}

func (v NullableSkuDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkuDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
