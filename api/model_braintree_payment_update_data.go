...
// checks if the BraintreePaymentUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BraintreePaymentUpdateData{}
...
func (o BraintreePaymentUpdateData) ToMap() (map[string]interface{}, error) {
