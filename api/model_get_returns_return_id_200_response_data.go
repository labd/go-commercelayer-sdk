...
// checks if the GETReturnsReturnId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETReturnsReturnId200ResponseData{}

// GETReturnsReturnId200ResponseData struct for GETReturnsReturnId200ResponseData
type GETReturnsReturnId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                  `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks           `json:"links,omitempty"`
	Attributes    *GETReturnsReturnId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETReturnsReturnId200ResponseData() *GETReturnsReturnId200ResponseData {
	this := GETReturnsReturnId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETReturnsReturnId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETReturnsReturnId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETReturnsReturnId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETReturnsReturnId200ResponseData struct {
	value *GETReturnsReturnId200ResponseData
	isSet bool
}

func (v NullableGETReturnsReturnId200ResponseData) Get() *GETReturnsReturnId200ResponseData {
	return v.value
}

func (v *NullableGETReturnsReturnId200ResponseData) Set(val *GETReturnsReturnId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETReturnsReturnId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETReturnsReturnId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETReturnsReturnId200ResponseData(val *GETReturnsReturnId200ResponseData) *NullableGETReturnsReturnId200ResponseData {
	return &NullableGETReturnsReturnId200ResponseData{value: val, isSet: true}
}

func (v NullableGETReturnsReturnId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETReturnsReturnId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
