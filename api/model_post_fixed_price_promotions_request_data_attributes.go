...
// checks if the POSTFixedPricePromotionsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTFixedPricePromotionsRequestDataAttributes{}

// POSTFixedPricePromotionsRequestDataAttributes struct for POSTFixedPricePromotionsRequestDataAttributes
type POSTFixedPricePromotionsRequestDataAttributes struct {
...
func NewPOSTFixedPricePromotionsRequestDataAttributes(name interface{}, startsAt interface{}, expiresAt interface{}, totalUsageLimit interface{}, fixedAmountCents interface{}) *POSTFixedPricePromotionsRequestDataAttributes {
	this := POSTFixedPricePromotionsRequestDataAttributes{}
	this.Name = name
...
func (o POSTFixedPricePromotionsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTFixedPricePromotionsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTFixedPricePromotionsRequestDataAttributes struct {
	value *POSTFixedPricePromotionsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTFixedPricePromotionsRequestDataAttributes) Get() *POSTFixedPricePromotionsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTFixedPricePromotionsRequestDataAttributes) Set(val *POSTFixedPricePromotionsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTFixedPricePromotionsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTFixedPricePromotionsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTFixedPricePromotionsRequestDataAttributes(val *POSTFixedPricePromotionsRequestDataAttributes) *NullablePOSTFixedPricePromotionsRequestDataAttributes {
	return &NullablePOSTFixedPricePromotionsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTFixedPricePromotionsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTFixedPricePromotionsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
