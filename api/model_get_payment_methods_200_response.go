...
// checks if the GETPaymentMethods200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETPaymentMethods200Response{}
...
func (o GETPaymentMethods200Response) ToMap() (map[string]interface{}, error) {
