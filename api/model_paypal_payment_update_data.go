...
// checks if the PaypalPaymentUpdateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaypalPaymentUpdateData{}
...
func (o PaypalPaymentUpdateData) ToMap() (map[string]interface{}, error) {
