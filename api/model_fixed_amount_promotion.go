...
// checks if the FixedAmountPromotion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FixedAmountPromotion{}
...
func (o FixedAmountPromotion) ToMap() (map[string]interface{}, error) {
