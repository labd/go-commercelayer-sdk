...
// StripeGatewayCreateDataAttributes struct for StripeGatewayCreateDataAttributes
type StripeGatewayCreateDataAttributes struct {
...
func NewStripeGatewayCreateDataAttributes(name string, login string) *StripeGatewayCreateDataAttributes {
	this := StripeGatewayCreateDataAttributes{}
	this.Name = name
	this.Login = login
	return &this
}
...
func (o StripeGatewayCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableStripeGatewayCreateDataAttributes struct {
	value *StripeGatewayCreateDataAttributes
	isSet bool
}

func (v NullableStripeGatewayCreateDataAttributes) Get() *StripeGatewayCreateDataAttributes {
	return v.value
}

func (v *NullableStripeGatewayCreateDataAttributes) Set(val *StripeGatewayCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableStripeGatewayCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableStripeGatewayCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStripeGatewayCreateDataAttributes(val *StripeGatewayCreateDataAttributes) *NullableStripeGatewayCreateDataAttributes {
	return &NullableStripeGatewayCreateDataAttributes{value: val, isSet: true}
}

func (v NullableStripeGatewayCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStripeGatewayCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
