...
// checks if the PATCHAttachmentsAttachmentIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHAttachmentsAttachmentIdRequestData{}

// PATCHAttachmentsAttachmentIdRequestData struct for PATCHAttachmentsAttachmentIdRequestData
type PATCHAttachmentsAttachmentIdRequestData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                           `json:"id"`
	Attributes    PATCHAttachmentsAttachmentIdRequestDataAttributes     `json:"attributes"`
	Relationships *PATCHAttachmentsAttachmentIdRequestDataRelationships `json:"relationships,omitempty"`
}
...
func NewPATCHAttachmentsAttachmentIdRequestData(type_ interface{}, id interface{}, attributes PATCHAttachmentsAttachmentIdRequestDataAttributes) *PATCHAttachmentsAttachmentIdRequestData {
	this := PATCHAttachmentsAttachmentIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o *PATCHAttachmentsAttachmentIdRequestData) GetRelationships() PATCHAttachmentsAttachmentIdRequestDataRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret PATCHAttachmentsAttachmentIdRequestDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given PATCHAttachmentsAttachmentIdRequestDataRelationships and assigns it to the Relationships field.
func (o *PATCHAttachmentsAttachmentIdRequestData) SetRelationships(v PATCHAttachmentsAttachmentIdRequestDataRelationships) {
	o.Relationships = &v
}

func (o PATCHAttachmentsAttachmentIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHAttachmentsAttachmentIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHAttachmentsAttachmentIdRequestData struct {
	value *PATCHAttachmentsAttachmentIdRequestData
	isSet bool
}

func (v NullablePATCHAttachmentsAttachmentIdRequestData) Get() *PATCHAttachmentsAttachmentIdRequestData {
	return v.value
}

func (v *NullablePATCHAttachmentsAttachmentIdRequestData) Set(val *PATCHAttachmentsAttachmentIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHAttachmentsAttachmentIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHAttachmentsAttachmentIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHAttachmentsAttachmentIdRequestData(val *PATCHAttachmentsAttachmentIdRequestData) *NullablePATCHAttachmentsAttachmentIdRequestData {
	return &NullablePATCHAttachmentsAttachmentIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHAttachmentsAttachmentIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHAttachmentsAttachmentIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
