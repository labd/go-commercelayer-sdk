...
type NullableParcelCreateDataAttributes struct {
	value *ParcelCreateDataAttributes
	isSet bool
}

func (v NullableParcelCreateDataAttributes) Get() *ParcelCreateDataAttributes {
	return v.value
}

func (v *NullableParcelCreateDataAttributes) Set(val *ParcelCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableParcelCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableParcelCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParcelCreateDataAttributes(val *ParcelCreateDataAttributes) *NullableParcelCreateDataAttributes {
	return &NullableParcelCreateDataAttributes{value: val, isSet: true}
}

func (v NullableParcelCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParcelCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
