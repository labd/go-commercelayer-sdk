...
// ShippingMethodTierResponseData struct for ShippingMethodTierResponseData
type ShippingMethodTierResponseData struct {
	// The resource's id
...
func NewShippingMethodTierResponseData() *ShippingMethodTierResponseData {
	this := ShippingMethodTierResponseData{}
	return &this
}
...
func (o ShippingMethodTierResponseData) MarshalJSON() ([]byte, error) {
...
type NullableShippingMethodTierResponseData struct {
	value *ShippingMethodTierResponseData
	isSet bool
}

func (v NullableShippingMethodTierResponseData) Get() *ShippingMethodTierResponseData {
	return v.value
}

func (v *NullableShippingMethodTierResponseData) Set(val *ShippingMethodTierResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingMethodTierResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingMethodTierResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingMethodTierResponseData(val *ShippingMethodTierResponseData) *NullableShippingMethodTierResponseData {
	return &NullableShippingMethodTierResponseData{value: val, isSet: true}
}

func (v NullableShippingMethodTierResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingMethodTierResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
