...
type PATCHAxervePaymentsAxervePaymentId200ResponseData struct {
	...
	Attributes    *PATCHAxervePaymentsAxervePaymentId200ResponseDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHAxervePaymentsAxervePaymentId200ResponseDataAttributes and assigns it to the Attributes field.
