...
// checks if the PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData{}

// PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData struct for PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData
type PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                          `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                   `json:"links,omitempty"`
	Attributes    *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewPATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData() *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData {
	this := PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData{}
	return &this
}
...
func (o *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) GetAttributes() PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes
		return ret
	}
	return *o.Attributes
}
...
func (o *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) HasAttributes() bool {
	if o != nil && !IsNil(o.Attributes) {
		return true
	}
...
// SetAttributes gets a reference to the given PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData struct {
	value *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData
	isSet bool
}

func (v NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) Get() *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData {
	return v.value
}

func (v *NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) Set(val *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData(val *PATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) *NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData {
	return &NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData{value: val, isSet: true}
}

func (v NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHBuyXPayYPromotionsBuyXPayYPromotionId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
