...
// checks if the POSTSkuListItemsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTSkuListItemsRequestDataAttributes{}

// POSTSkuListItemsRequestDataAttributes struct for POSTSkuListItemsRequestDataAttributes
type POSTSkuListItemsRequestDataAttributes struct {
...
func NewPOSTSkuListItemsRequestDataAttributes() *POSTSkuListItemsRequestDataAttributes {
	this := POSTSkuListItemsRequestDataAttributes{}
	return &this
}
...
func (o *POSTSkuListItemsRequestDataAttributes) HasReference() bool {
	if o != nil && IsNil(o.Reference) {
		return true
	}
...
func (o POSTSkuListItemsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTSkuListItemsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTSkuListItemsRequestDataAttributes struct {
	value *POSTSkuListItemsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTSkuListItemsRequestDataAttributes) Get() *POSTSkuListItemsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTSkuListItemsRequestDataAttributes) Set(val *POSTSkuListItemsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTSkuListItemsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTSkuListItemsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTSkuListItemsRequestDataAttributes(val *POSTSkuListItemsRequestDataAttributes) *NullablePOSTSkuListItemsRequestDataAttributes {
	return &NullablePOSTSkuListItemsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTSkuListItemsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTSkuListItemsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
