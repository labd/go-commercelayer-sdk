...
type PATCHReturnLineItemsReturnLineItemId200ResponseData struct {
	...
	Attributes    *PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes `json:"attributes,omitempty"`
...
func (o *PATCHReturnLineItemsReturnLineItemId200ResponseData) GetAttributes() PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes {
...
// and a boolean to check if the value has been set.
func (o *PATCHReturnLineItemsReturnLineItemId200ResponseData) GetAttributesOk() (*PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes, bool) {
	if o == nil || IsNil(o.Attributes) {
		return nil, false
	}
...
// SetAttributes gets a reference to the given PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes and assigns it to the Attributes field.
func (o *PATCHReturnLineItemsReturnLineItemId200ResponseData) SetAttributes(v PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) {
	o.Attributes = &v
}
