...
// checks if the TaxCalculator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxCalculator{}
...
func (o TaxCalculator) ToMap() (map[string]interface{}, error) {
