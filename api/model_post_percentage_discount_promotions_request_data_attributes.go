...
// checks if the POSTPercentageDiscountPromotionsRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTPercentageDiscountPromotionsRequestDataAttributes{}

// POSTPercentageDiscountPromotionsRequestDataAttributes struct for POSTPercentageDiscountPromotionsRequestDataAttributes
type POSTPercentageDiscountPromotionsRequestDataAttributes struct {
...
func NewPOSTPercentageDiscountPromotionsRequestDataAttributes(name interface{}, startsAt interface{}, expiresAt interface{}, totalUsageLimit interface{}, percentage interface{}) *POSTPercentageDiscountPromotionsRequestDataAttributes {
	this := POSTPercentageDiscountPromotionsRequestDataAttributes{}
	this.Name = name
...
func (o POSTPercentageDiscountPromotionsRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTPercentageDiscountPromotionsRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTPercentageDiscountPromotionsRequestDataAttributes struct {
	value *POSTPercentageDiscountPromotionsRequestDataAttributes
	isSet bool
}

func (v NullablePOSTPercentageDiscountPromotionsRequestDataAttributes) Get() *POSTPercentageDiscountPromotionsRequestDataAttributes {
	return v.value
}

func (v *NullablePOSTPercentageDiscountPromotionsRequestDataAttributes) Set(val *POSTPercentageDiscountPromotionsRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTPercentageDiscountPromotionsRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTPercentageDiscountPromotionsRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTPercentageDiscountPromotionsRequestDataAttributes(val *POSTPercentageDiscountPromotionsRequestDataAttributes) *NullablePOSTPercentageDiscountPromotionsRequestDataAttributes {
	return &NullablePOSTPercentageDiscountPromotionsRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTPercentageDiscountPromotionsRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTPercentageDiscountPromotionsRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
