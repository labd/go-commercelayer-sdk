...
type CustomersApi interface {
	...
	*/
	DELETECustomersCustomerId(ctx context.Context, customerId string) ApiDELETECustomersCustomerIdRequest

	// DELETECustomersCustomerIdExecute executes the request
	DELETECustomersCustomerIdExecute(r ApiDELETECustomersCustomerIdRequest) (*http.Response, error)
	...
	*/
	...
	GETCustomersExecute(r ApiGETCustomersRequest) (*http.Response, error)
	...
	*/
	GETCustomersCustomerId(ctx context.Context, customerId string) ApiGETCustomersCustomerIdRequest

	// GETCustomersCustomerIdExecute executes the request
	//  @return Customer
	GETCustomersCustomerIdExecute(r ApiGETCustomersCustomerIdRequest) (*Customer, *http.Response, error)
	...
	*/
	PATCHCustomersCustomerId(ctx context.Context, customerId string) ApiPATCHCustomersCustomerIdRequest

	// PATCHCustomersCustomerIdExecute executes the request
	PATCHCustomersCustomerIdExecute(r ApiPATCHCustomersCustomerIdRequest) (*http.Response, error)
	...
	*/
	POSTCustomers(ctx context.Context) ApiPOSTCustomersRequest

	// POSTCustomersExecute executes the request
	POSTCustomersExecute(r ApiPOSTCustomersRequest) (*http.Response, error)
}
