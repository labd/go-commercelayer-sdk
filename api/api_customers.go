...
func (r CustomersApiPATCHCustomersCustomerIdRequest) PATCHCustomersCustomerIdRequest(pATCHCustomersCustomerIdRequest PATCHCustomersCustomerIdRequest) CustomersApiPATCHCustomersCustomerIdRequest {
	r.pATCHCustomersCustomerIdRequest = &pATCHCustomersCustomerIdRequest
	return r
}
...
func (a *CustomersApiService) PATCHCustomersCustomerIdExecute(r CustomersApiPATCHCustomersCustomerIdRequest) (*PATCHCustomersCustomerId200Response, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.pATCHCustomersCustomerIdRequest == nil {
		return localVarReturnValue, nil, reportError("pATCHCustomersCustomerIdRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.pATCHCustomersCustomerIdRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r CustomersApiPOSTCustomersRequest) POSTCustomersRequest(pOSTCustomersRequest POSTCustomersRequest) CustomersApiPOSTCustomersRequest {
	r.pOSTCustomersRequest = &pOSTCustomersRequest
	return r
}
...
func (a *CustomersApiService) POSTCustomersExecute(r CustomersApiPOSTCustomersRequest) (*POSTCustomers201Response, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.pOSTCustomersRequest == nil {
		return localVarReturnValue, nil, reportError("pOSTCustomersRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.pOSTCustomersRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
