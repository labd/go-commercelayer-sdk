...
type GETWireTransfers200ResponseDataInner struct {
	...
	Attributes    *GETWireTransfers200ResponseDataInnerAttributes   `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given GETWireTransfers200ResponseDataInnerAttributes and assigns it to the Attributes field.
