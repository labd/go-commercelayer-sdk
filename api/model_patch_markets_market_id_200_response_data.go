...
type PATCHMarketsMarketId200ResponseData struct {
	...
	Attributes    *PATCHMarketsMarketIdRequestDataAttributes `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given PATCHMarketsMarketIdRequestDataAttributes and assigns it to the Attributes field.
