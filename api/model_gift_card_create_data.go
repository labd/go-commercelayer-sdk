...
// checks if the GiftCardCreateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardCreateData{}

// GiftCardCreateData struct for GiftCardCreateData
type GiftCardCreateData struct {
	// The resource's type
	Type          interface{}                            `json:"type"`
	Attributes    POSTGiftCards201ResponseDataAttributes `json:"attributes"`
...
func (o GiftCardCreateData) ToMap() (map[string]interface{}, error) {
