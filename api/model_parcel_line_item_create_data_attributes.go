...
// ParcelLineItemCreateDataAttributes struct for ParcelLineItemCreateDataAttributes
type ParcelLineItemCreateDataAttributes struct {
...
func NewParcelLineItemCreateDataAttributes(quantity int32) *ParcelLineItemCreateDataAttributes {
	this := ParcelLineItemCreateDataAttributes{}
...
func (o ParcelLineItemCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableParcelLineItemCreateDataAttributes struct {
	value *ParcelLineItemCreateDataAttributes
	isSet bool
}

func (v NullableParcelLineItemCreateDataAttributes) Get() *ParcelLineItemCreateDataAttributes {
	return v.value
}

func (v *NullableParcelLineItemCreateDataAttributes) Set(val *ParcelLineItemCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableParcelLineItemCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableParcelLineItemCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParcelLineItemCreateDataAttributes(val *ParcelLineItemCreateDataAttributes) *NullableParcelLineItemCreateDataAttributes {
	return &NullableParcelLineItemCreateDataAttributes{value: val, isSet: true}
}

func (v NullableParcelLineItemCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParcelLineItemCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
