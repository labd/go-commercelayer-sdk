...
// GETCheckoutComPayments200ResponseDataInner struct for GETCheckoutComPayments200ResponseDataInner
type GETCheckoutComPayments200ResponseDataInner struct {
	// The resource's id
	Id *string `json:"id,omitempty"`
	// The resource's type
	Type *string `json:"type,omitempty"`
	Links *GETAddresses200ResponseDataInnerLinks `json:"links,omitempty"`
	Attributes *GETCheckoutComPayments200ResponseDataInnerAttributes `json:"attributes,omitempty"`
...
func NewGETCheckoutComPayments200ResponseDataInner() *GETCheckoutComPayments200ResponseDataInner {
	this := GETCheckoutComPayments200ResponseDataInner{}
...
// SetAttributes gets a reference to the given GETCheckoutComPayments200ResponseDataInnerAttributes and assigns it to the Attributes field.
...
func (o GETCheckoutComPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableGETCheckoutComPayments200ResponseDataInner struct {
	value *GETCheckoutComPayments200ResponseDataInner
	isSet bool
}

func (v NullableGETCheckoutComPayments200ResponseDataInner) Get() *GETCheckoutComPayments200ResponseDataInner {
	return v.value
}

func (v *NullableGETCheckoutComPayments200ResponseDataInner) Set(val *GETCheckoutComPayments200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGETCheckoutComPayments200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGETCheckoutComPayments200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETCheckoutComPayments200ResponseDataInner(val *GETCheckoutComPayments200ResponseDataInner) *NullableGETCheckoutComPayments200ResponseDataInner {
	return &NullableGETCheckoutComPayments200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGETCheckoutComPayments200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETCheckoutComPayments200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
