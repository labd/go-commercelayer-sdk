...
// CaptureResponseData struct for CaptureResponseData
type CaptureResponseData struct {
	...
	Relationships *CaptureResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *CaptureResponseData) GetRelationships() CaptureResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret CaptureResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given CaptureResponseDataRelationships and assigns it to the Relationships field.
func (o *CaptureResponseData) SetRelationships(v CaptureResponseDataRelationships) {
	o.Relationships = &v
}

func (o CaptureResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCaptureResponseData struct {
	value *CaptureResponseData
	isSet bool
}

func (v NullableCaptureResponseData) Get() *CaptureResponseData {
	return v.value
}

func (v *NullableCaptureResponseData) Set(val *CaptureResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCaptureResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCaptureResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaptureResponseData(val *CaptureResponseData) *NullableCaptureResponseData {
	return &NullableCaptureResponseData{value: val, isSet: true}
}

func (v NullableCaptureResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaptureResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
