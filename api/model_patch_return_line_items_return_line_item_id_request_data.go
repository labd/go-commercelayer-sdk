...
// checks if the PATCHReturnLineItemsReturnLineItemIdRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHReturnLineItemsReturnLineItemIdRequestData{}

// PATCHReturnLineItemsReturnLineItemIdRequestData struct for PATCHReturnLineItemsReturnLineItemIdRequestData
type PATCHReturnLineItemsReturnLineItemIdRequestData struct {
	// The resource's type
	Type interface{} `json:"type"`
	// The resource's id
	Id            interface{}                                               `json:"id"`
	Attributes    PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes `json:"attributes"`
...
func NewPATCHReturnLineItemsReturnLineItemIdRequestData(type_ interface{}, id interface{}, attributes PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes) *PATCHReturnLineItemsReturnLineItemIdRequestData {
	this := PATCHReturnLineItemsReturnLineItemIdRequestData{}
	this.Type = type_
	this.Id = id
...
func (o *PATCHReturnLineItemsReturnLineItemIdRequestData) GetAttributes() PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes {
	if o == nil {
		var ret PATCHReturnLineItemsReturnLineItemIdRequestDataAttributes
		return ret
	}
...
func (o PATCHReturnLineItemsReturnLineItemIdRequestData) MarshalJSON() ([]byte, error) {
...
func (o PATCHReturnLineItemsReturnLineItemIdRequestData) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHReturnLineItemsReturnLineItemIdRequestData struct {
	value *PATCHReturnLineItemsReturnLineItemIdRequestData
	isSet bool
}

func (v NullablePATCHReturnLineItemsReturnLineItemIdRequestData) Get() *PATCHReturnLineItemsReturnLineItemIdRequestData {
	return v.value
}

func (v *NullablePATCHReturnLineItemsReturnLineItemIdRequestData) Set(val *PATCHReturnLineItemsReturnLineItemIdRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHReturnLineItemsReturnLineItemIdRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHReturnLineItemsReturnLineItemIdRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHReturnLineItemsReturnLineItemIdRequestData(val *PATCHReturnLineItemsReturnLineItemIdRequestData) *NullablePATCHReturnLineItemsReturnLineItemIdRequestData {
	return &NullablePATCHReturnLineItemsReturnLineItemIdRequestData{value: val, isSet: true}
}

func (v NullablePATCHReturnLineItemsReturnLineItemIdRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHReturnLineItemsReturnLineItemIdRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
