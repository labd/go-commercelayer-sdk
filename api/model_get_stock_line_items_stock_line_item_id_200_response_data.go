...
// checks if the GETStockLineItemsStockLineItemId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETStockLineItemsStockLineItemId200ResponseData{}

// GETStockLineItemsStockLineItemId200ResponseData struct for GETStockLineItemsStockLineItemId200ResponseData
type GETStockLineItemsStockLineItemId200ResponseData struct {
	// The resource's id
...
func NewGETStockLineItemsStockLineItemId200ResponseData() *GETStockLineItemsStockLineItemId200ResponseData {
	this := GETStockLineItemsStockLineItemId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETStockLineItemsStockLineItemId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETStockLineItemsStockLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETStockLineItemsStockLineItemId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETStockLineItemsStockLineItemId200ResponseData struct {
	value *GETStockLineItemsStockLineItemId200ResponseData
	isSet bool
}

func (v NullableGETStockLineItemsStockLineItemId200ResponseData) Get() *GETStockLineItemsStockLineItemId200ResponseData {
	return v.value
}

func (v *NullableGETStockLineItemsStockLineItemId200ResponseData) Set(val *GETStockLineItemsStockLineItemId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETStockLineItemsStockLineItemId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETStockLineItemsStockLineItemId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETStockLineItemsStockLineItemId200ResponseData(val *GETStockLineItemsStockLineItemId200ResponseData) *NullableGETStockLineItemsStockLineItemId200ResponseData {
	return &NullableGETStockLineItemsStockLineItemId200ResponseData{value: val, isSet: true}
}

func (v NullableGETStockLineItemsStockLineItemId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETStockLineItemsStockLineItemId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
