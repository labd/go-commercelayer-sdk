...
type POSTInventoryModels201ResponseData struct {
	...
	Attributes    *POSTInventoryModelsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTInventoryModelsRequestDataAttributes and assigns it to the Attributes field.
