...
// InventoryModelResponseData struct for InventoryModelResponseData
type InventoryModelResponseData struct {
	// The resource's id
	...
	Relationships *InventoryModelResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewInventoryModelResponseData() *InventoryModelResponseData {
	this := InventoryModelResponseData{}
	return &this
}
...
func (o *InventoryModelResponseData) GetRelationships() InventoryModelResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret InventoryModelResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given InventoryModelResponseDataRelationships and assigns it to the Relationships field.
func (o *InventoryModelResponseData) SetRelationships(v InventoryModelResponseDataRelationships) {
	o.Relationships = &v
}

func (o InventoryModelResponseData) MarshalJSON() ([]byte, error) {
...
type NullableInventoryModelResponseData struct {
	value *InventoryModelResponseData
	isSet bool
}

func (v NullableInventoryModelResponseData) Get() *InventoryModelResponseData {
	return v.value
}

func (v *NullableInventoryModelResponseData) Set(val *InventoryModelResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryModelResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryModelResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryModelResponseData(val *InventoryModelResponseData) *NullableInventoryModelResponseData {
	return &NullableInventoryModelResponseData{value: val, isSet: true}
}

func (v NullableInventoryModelResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryModelResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
