...
// ManualTaxCalculatorCreateDataAttributes struct for ManualTaxCalculatorCreateDataAttributes
type ManualTaxCalculatorCreateDataAttributes struct {
...
func NewManualTaxCalculatorCreateDataAttributes(name string) *ManualTaxCalculatorCreateDataAttributes {
	this := ManualTaxCalculatorCreateDataAttributes{}
	this.Name = name
	return &this
}
...
func (o ManualTaxCalculatorCreateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableManualTaxCalculatorCreateDataAttributes struct {
	value *ManualTaxCalculatorCreateDataAttributes
	isSet bool
}

func (v NullableManualTaxCalculatorCreateDataAttributes) Get() *ManualTaxCalculatorCreateDataAttributes {
	return v.value
}

func (v *NullableManualTaxCalculatorCreateDataAttributes) Set(val *ManualTaxCalculatorCreateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableManualTaxCalculatorCreateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableManualTaxCalculatorCreateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualTaxCalculatorCreateDataAttributes(val *ManualTaxCalculatorCreateDataAttributes) *NullableManualTaxCalculatorCreateDataAttributes {
	return &NullableManualTaxCalculatorCreateDataAttributes{value: val, isSet: true}
}

func (v NullableManualTaxCalculatorCreateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualTaxCalculatorCreateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
