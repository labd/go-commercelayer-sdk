...
// checks if the PATCHStockItemsStockItemIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHStockItemsStockItemIdRequestDataAttributes{}

// PATCHStockItemsStockItemIdRequestDataAttributes struct for PATCHStockItemsStockItemIdRequestDataAttributes
type PATCHStockItemsStockItemIdRequestDataAttributes struct {
...
func NewPATCHStockItemsStockItemIdRequestDataAttributes() *PATCHStockItemsStockItemIdRequestDataAttributes {
	this := PATCHStockItemsStockItemIdRequestDataAttributes{}
	return &this
}
...
func (o *PATCHStockItemsStockItemIdRequestDataAttributes) SetReferenceOrigin(v interface{}) {
	o.ReferenceOrigin = v
}
...
func (o PATCHStockItemsStockItemIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHStockItemsStockItemIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHStockItemsStockItemIdRequestDataAttributes struct {
	value *PATCHStockItemsStockItemIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHStockItemsStockItemIdRequestDataAttributes) Get() *PATCHStockItemsStockItemIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHStockItemsStockItemIdRequestDataAttributes) Set(val *PATCHStockItemsStockItemIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHStockItemsStockItemIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHStockItemsStockItemIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHStockItemsStockItemIdRequestDataAttributes(val *PATCHStockItemsStockItemIdRequestDataAttributes) *NullablePATCHStockItemsStockItemIdRequestDataAttributes {
	return &NullablePATCHStockItemsStockItemIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHStockItemsStockItemIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHStockItemsStockItemIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
