...
// checks if the PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes{}

// PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes struct for PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes
type PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes struct {
...
func NewPATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes() *PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes {
	this := PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes struct {
	value *PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) Get() *PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) Set(val *PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes(val *PATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) *NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes {
	return &NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHOrderAmountPromotionRulesOrderAmountPromotionRuleIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
