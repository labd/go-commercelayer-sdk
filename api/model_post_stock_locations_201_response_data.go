...
type POSTStockLocations201ResponseData struct {
	...
	Attributes    *POSTStockLocationsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTStockLocationsRequestDataAttributes and assigns it to the Attributes field.
