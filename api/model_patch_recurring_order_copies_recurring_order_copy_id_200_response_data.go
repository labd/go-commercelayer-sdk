...
func (o *PATCHRecurringOrderCopiesRecurringOrderCopyId200ResponseData) GetAttributes() PATCHCleanupsCleanupId200ResponseDataAttributes {
...
// and a boolean to check if the value has been set.
func (o *PATCHRecurringOrderCopiesRecurringOrderCopyId200ResponseData) GetAttributesOk() (*PATCHCleanupsCleanupId200ResponseDataAttributes, bool) {
	if o == nil || IsNil(o.Attributes) {
		return nil, false
	}
...
func (o *PATCHRecurringOrderCopiesRecurringOrderCopyId200ResponseData) SetAttributes(v PATCHCleanupsCleanupId200ResponseDataAttributes) {
	o.Attributes = &v
}
