...
// checks if the POSTLineItemOptions201ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTLineItemOptions201ResponseData{}
...
type POSTLineItemOptions201ResponseData struct {
	...
	Attributes    *POSTLineItemOptionsRequestDataAttributes        `json:"attributes,omitempty"`
...
// SetAttributes gets a reference to the given POSTLineItemOptionsRequestDataAttributes and assigns it to the Attributes field.
...
func (o POSTLineItemOptions201ResponseData) ToMap() (map[string]interface{}, error) {
