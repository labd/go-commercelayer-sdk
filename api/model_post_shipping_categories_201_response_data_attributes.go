...
// checks if the POSTShippingCategories201ResponseDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &POSTShippingCategories201ResponseDataAttributes{}

// POSTShippingCategories201ResponseDataAttributes struct for POSTShippingCategories201ResponseDataAttributes
type POSTShippingCategories201ResponseDataAttributes struct {
...
func NewPOSTShippingCategories201ResponseDataAttributes(name interface{}) *POSTShippingCategories201ResponseDataAttributes {
	this := POSTShippingCategories201ResponseDataAttributes{}
	this.Name = name
	return &this
}
...
func (o POSTShippingCategories201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o POSTShippingCategories201ResponseDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePOSTShippingCategories201ResponseDataAttributes struct {
	value *POSTShippingCategories201ResponseDataAttributes
	isSet bool
}

func (v NullablePOSTShippingCategories201ResponseDataAttributes) Get() *POSTShippingCategories201ResponseDataAttributes {
	return v.value
}

func (v *NullablePOSTShippingCategories201ResponseDataAttributes) Set(val *POSTShippingCategories201ResponseDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePOSTShippingCategories201ResponseDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePOSTShippingCategories201ResponseDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePOSTShippingCategories201ResponseDataAttributes(val *POSTShippingCategories201ResponseDataAttributes) *NullablePOSTShippingCategories201ResponseDataAttributes {
	return &NullablePOSTShippingCategories201ResponseDataAttributes{value: val, isSet: true}
}

func (v NullablePOSTShippingCategories201ResponseDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePOSTShippingCategories201ResponseDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
