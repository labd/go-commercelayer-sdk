...
// checks if the GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData{}

// GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData struct for GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData
type GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                                    `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                                             `json:"links,omitempty"`
	Attributes    *GETInventoryReturnLocationsInventoryReturnLocationId200ResponseDataAttributes `json:"attributes,omitempty"`
...
func NewGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData() *GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData {
	this := GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETInventoryReturnLocationsInventoryReturnLocationId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData struct {
	value *GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData
	isSet bool
}

func (v NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) Get() *GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData {
	return v.value
}

func (v *NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) Set(val *GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData(val *GETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) *NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData {
	return &NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData{value: val, isSet: true}
}

func (v NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETInventoryReturnLocationsInventoryReturnLocationId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
