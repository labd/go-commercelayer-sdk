...
// checks if the PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes{}

// PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes struct for PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes
type PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes struct {
...
func NewPATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes() *PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes {
	this := PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes{}
	return &this
}
...
func (o PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
...
func (o PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) ToMap() (map[string]interface{}, error) {
...
type NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes struct {
	value *PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes
	isSet bool
}

func (v NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) Get() *PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes {
	return v.value
}

func (v *NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) Set(val *PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes(val *PATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) *NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes {
	return &NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes{value: val, isSet: true}
}

func (v NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePATCHAdyenGatewaysAdyenGatewayIdRequestDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
