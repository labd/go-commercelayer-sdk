...
// checks if the GETReservedStocksReservedStockId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GETReservedStocksReservedStockId200ResponseData{}

// GETReservedStocksReservedStockId200ResponseData struct for GETReservedStocksReservedStockId200ResponseData
type GETReservedStocksReservedStockId200ResponseData struct {
	// The resource's id
	Id interface{} `json:"id,omitempty"`
	// The resource's type
	Type          interface{}                                                   `json:"type,omitempty"`
	Links         *POSTAddresses201ResponseDataLinks                            `json:"links,omitempty"`
	Attributes    *GETReservedStocksReservedStockId200ResponseDataAttributes    `json:"attributes,omitempty"`
	Relationships *GETReservedStocksReservedStockId200ResponseDataRelationships `json:"relationships,omitempty"`
}
...
func NewGETReservedStocksReservedStockId200ResponseData() *GETReservedStocksReservedStockId200ResponseData {
	this := GETReservedStocksReservedStockId200ResponseData{}
	return &this
}
...
// SetAttributes gets a reference to the given GETReservedStocksReservedStockId200ResponseDataAttributes and assigns it to the Attributes field.
...
func (o *GETReservedStocksReservedStockId200ResponseData) GetRelationships() GETReservedStocksReservedStockId200ResponseDataRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret GETReservedStocksReservedStockId200ResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given GETReservedStocksReservedStockId200ResponseDataRelationships and assigns it to the Relationships field.
...
func (o GETReservedStocksReservedStockId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GETReservedStocksReservedStockId200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGETReservedStocksReservedStockId200ResponseData struct {
	value *GETReservedStocksReservedStockId200ResponseData
	isSet bool
}

func (v NullableGETReservedStocksReservedStockId200ResponseData) Get() *GETReservedStocksReservedStockId200ResponseData {
	return v.value
}

func (v *NullableGETReservedStocksReservedStockId200ResponseData) Set(val *GETReservedStocksReservedStockId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGETReservedStocksReservedStockId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGETReservedStocksReservedStockId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGETReservedStocksReservedStockId200ResponseData(val *GETReservedStocksReservedStockId200ResponseData) *NullableGETReservedStocksReservedStockId200ResponseData {
	return &NullableGETReservedStocksReservedStockId200ResponseData{value: val, isSet: true}
}

func (v NullableGETReservedStocksReservedStockId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGETReservedStocksReservedStockId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
