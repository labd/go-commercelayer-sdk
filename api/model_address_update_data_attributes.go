...
// AddressUpdateDataAttributes struct for AddressUpdateDataAttributes
type AddressUpdateDataAttributes struct {
...
func NewAddressUpdateDataAttributes() *AddressUpdateDataAttributes {
	this := AddressUpdateDataAttributes{}
	return &this
}
...
func (o AddressUpdateDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableAddressUpdateDataAttributes struct {
	value *AddressUpdateDataAttributes
	isSet bool
}

func (v NullableAddressUpdateDataAttributes) Get() *AddressUpdateDataAttributes {
	return v.value
}

func (v *NullableAddressUpdateDataAttributes) Set(val *AddressUpdateDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressUpdateDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressUpdateDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressUpdateDataAttributes(val *AddressUpdateDataAttributes) *NullableAddressUpdateDataAttributes {
	return &NullableAddressUpdateDataAttributes{value: val, isSet: true}
}

func (v NullableAddressUpdateDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressUpdateDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
