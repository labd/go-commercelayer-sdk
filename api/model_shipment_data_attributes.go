...
// ShipmentDataAttributes struct for ShipmentDataAttributes
type ShipmentDataAttributes struct {
...
func (o ShipmentDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullableShipmentDataAttributes struct {
	value *ShipmentDataAttributes
	isSet bool
}

func (v NullableShipmentDataAttributes) Get() *ShipmentDataAttributes {
	return v.value
}

func (v *NullableShipmentDataAttributes) Set(val *ShipmentDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableShipmentDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableShipmentDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShipmentDataAttributes(val *ShipmentDataAttributes) *NullableShipmentDataAttributes {
	return &NullableShipmentDataAttributes{value: val, isSet: true}
}

func (v NullableShipmentDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShipmentDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
