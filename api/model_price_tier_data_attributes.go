...
// PriceTierDataAttributes struct for PriceTierDataAttributes
type PriceTierDataAttributes struct {
...
func (o PriceTierDataAttributes) MarshalJSON() ([]byte, error) {
...
type NullablePriceTierDataAttributes struct {
	value *PriceTierDataAttributes
	isSet bool
}

func (v NullablePriceTierDataAttributes) Get() *PriceTierDataAttributes {
	return v.value
}

func (v *NullablePriceTierDataAttributes) Set(val *PriceTierDataAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceTierDataAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceTierDataAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceTierDataAttributes(val *PriceTierDataAttributes) *NullablePriceTierDataAttributes {
	return &NullablePriceTierDataAttributes{value: val, isSet: true}
}

func (v NullablePriceTierDataAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceTierDataAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
