...
// ShippingZoneResponseData struct for ShippingZoneResponseData
type ShippingZoneResponseData struct {
	// The resource's id
	...
	Relationships *ShippingZoneResponseDataRelationships `json:"relationships,omitempty"`
}
...
func (o *ShippingZoneResponseData) GetRelationships() ShippingZoneResponseDataRelationships {
	if o == nil || o.Relationships == nil {
		var ret ShippingZoneResponseDataRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given ShippingZoneResponseDataRelationships and assigns it to the Relationships field.
func (o *ShippingZoneResponseData) SetRelationships(v ShippingZoneResponseDataRelationships) {
	o.Relationships = &v
}

func (o ShippingZoneResponseData) MarshalJSON() ([]byte, error) {
...
type NullableShippingZoneResponseData struct {
	value *ShippingZoneResponseData
	isSet bool
}

func (v NullableShippingZoneResponseData) Get() *ShippingZoneResponseData {
	return v.value
}

func (v *NullableShippingZoneResponseData) Set(val *ShippingZoneResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingZoneResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingZoneResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingZoneResponseData(val *ShippingZoneResponseData) *NullableShippingZoneResponseData {
	return &NullableShippingZoneResponseData{value: val, isSet: true}
}

func (v NullableShippingZoneResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingZoneResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
